...
MONTHLY_SECTIONS = [
    ...
    SectionSpec("performance_diagnosis", "Performance Diagnosis", mandatory=True, min_lines=4,
                description="Evidence-backed strengths, vulnerabilities, competitive gaps"),
    SectionSpec("review_intelligence", "Review & Reputation Intelligence", mandatory=True, min_lines=3,
                description="Narrative-rich: aspect sentiment, quotes, themes. Structured: volume analysis, coverage statement"),
    ...
    SectionSpec("priority_actions", "Priority Actions", mandatory=True, min_lines=9,
                description="Exactly 3 actions with title, description, owner, dimension, evidence, upside"),
