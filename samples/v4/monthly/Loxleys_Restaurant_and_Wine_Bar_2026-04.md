...
*2026-04 · Engine v4.0.0 · Rankable-B · single-platform*

*FSA legal entity:* Loxleys Restaurant And Wine Bar
*Also trading as:* Loxleys, Loxley's
...
1. **Add a second customer-platform listing** [FIX] — Customer Validation is currently single-platform; spec §4.4 caps the venue at Rankable-B regardless of score until a sec
...
**V4 Score:** 8.771 / 10 · Rankable-B.
**Components:** Trust 8.72; Customer Validation 9.24; Commercial Readiness 7.50.
**Local (5 mi) peer position:** #27 of 182 (peer pool scoped to league-eligible venues).

*External-evidence diagnosis. No POS or internal data required. See Data Basis below.*

## Financial Impact & Value at Stake

**Confidence: Low.** Figures are directional. Exact numbers require internal cover and spend data.

*Observed commercial-readiness gaps driving this estimate:*
- no reachable booking / contact path
...
Acceptable evidence. Eligible for the secondary league table. Single customer platform — peer comparisons are directional.
...
|---|---:|---|
| Trust & Compliance | 8.722 | compliance; not food quality · signals used: 5 |
| Customer Validation | 9.238 | Google 1669 @ 4.7 |
...
**Component score:** 8.722 / 10  ·  *compliance signal; not food quality.*
...
| Confidence in management sub-score | 7.5 |
| Last inspection date | 2026-03-24T00:00:00 |

## Customer Validation

**Component score:** 9.238 / 10  ·  *public rating metadata; shrinkage applied to low-count evidence.*

| Platform | Raw rating | Reviews | Shrunk rating | Coverage weight |
|---|---:|---:|---:|---:|
| Google | 4.7 | 1669 | 4.68 | 1.00 |
...
| Proposition Clarity | Partial | Insufficient review data to cross-reference proposition. Google types show: restaurant, wine_bar, british_restaurant, bar. Whether this matches the lived experience cannot be confirmed. |
...
|---|---|---:|---:|
| Local (5 mi) | #27 of 182 | 7.99 | 9.30 |
| Catchment (15 mi) | #25 of 167 | 8.02 | 9.30 |
| UK category cohort | #27 of 182 | 7.99 | 9.30 |
...
### Priority 1: Add a second customer-platform listing [FIX | NEW]

Customer Validation is currently single-platform; spec §4.4 caps the venue at Rankable-B regardless of score until a second platform is present.

**Evidence:** Only platform present: google.

**Expected upside:** raises the achievable confidence class to Rankable-A.

*Targets component: Customer Validation. V4 components feed the headline — this priority is how the score moves in the direction the observable evidence supports. (No specific score-movement number is forecast.)*
...
|---|---|---|---|---|---|---|
| Add a second customer-platform listing | Customer Validation | New | 09 May 2026 | Low (< £200) | raises the achievable confidence class to Rankable-A. | Claim a TripAdvisor business listing if not present, or seed your second platform via a soft launch — do not solicit fake reviews. |
...
**Confidence class:** Rankable-B. Acceptable evidence. Eligible for the secondary league table. Single customer platform — peer comparisons are directional.
...
| Last inspection date | 2026-03-24T00:00:00 |
| Google rating | 4.7 |
| Google review count | 1669 |
| Google place ID | ChIJPakIOjLOcEgRqV2Dw8uh8QU |
| TripAdvisor rating | — |
...
**Formed from:** Trust 8.72 + Customer 9.24 + Commercial 7.50. Final: 8.771.

<details>
<summary>Raw engine trace (for audit)</summary>

```
TrustCompliance=8.722 (r_norm ok, signals_used=5, recency=0.944)
CustomerValidation=9.238 (google n=1669 raw=4.7 shrunk=4.68 w=1.00)
CommercialReadiness=7.500 (web=True, menu=True, hours=1.00, booking=False)
base=8.771; distinction+0.000; adjusted=8.771; final=8.771
...
*Engine version: v4.0.0 · Computed at: 2026-04-18T14:47:05Z*
