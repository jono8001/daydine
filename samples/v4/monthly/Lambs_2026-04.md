...
*Also trading as:* Lambs Restaurant
...
**V4 Score:** 8.939 / 10 · Rankable-B.
**Components:** Trust 9.15; Customer Validation 9.23; Commercial Readiness 7.50.
**Local (5 mi) peer position:** #12 of 182 (peer pool scoped to league-eligible venues).
...
|---|---|---|---|
| Monthly revenue impact | — | £250 – £760 | subject to gap closure |
| Annual projection | — | £3,000 – £9,120 | directional |

*Range ratio 3.0× and spread £510 — within the expected band for **Low** confidence. The figures are directional; internal cover and spend data would tighten them.*
...
|---|---:|---|
| Trust & Compliance | 9.152 | compliance; not food quality · signals used: 5 |
| Customer Validation | 9.229 | Google 1372 @ 4.7 |
...
**Component score:** 9.152 / 10  ·  *compliance signal; not food quality.*
...
| Last inspection date | 2026-01-13T00:00:00 |

## Customer Validation

**Component score:** 9.229 / 10  ·  *public rating metadata; shrinkage applied to low-count evidence.*

| Platform | Raw rating | Reviews | Shrunk rating | Coverage weight |
|---|---:|---:|---:|---:|
| Google | 4.7 | 1372 | 4.68 | 1.00 |
...
| Proposition Clarity | Partial | Insufficient review data to cross-reference proposition. Google types show: restaurant, british_restaurant. Whether this matches the lived experience cannot be confirmed. |
...
|---|---|---:|---:|
| Local (5 mi) | #12 of 182 | 7.99 | 9.30 |
| Catchment (15 mi) | #11 of 167 | 8.02 | 9.30 |
| UK category cohort | #12 of 182 | 7.99 | 9.30 |
...
| Last inspection date | 2026-01-13T00:00:00 |
| Google rating | 4.7 |
| Google review count | 1372 |
| Google place ID | ChIJ07kQJjLOcEgR6LZ0g4f17Eg |
| TripAdvisor rating | — |
...
**Formed from:** Trust 9.15 + Customer 9.23 + Commercial 7.50. Final: 8.939.

<details>
<summary>Raw engine trace (for audit)</summary>

```
TrustCompliance=9.152 (r_norm ok, signals_used=5, recency=0.804)
CustomerValidation=9.229 (google n=1372 raw=4.7 shrunk=4.68 w=1.00)
CommercialReadiness=7.500 (web=True, menu=True, hours=1.00, booking=False)
base=8.939; distinction+0.000; adjusted=8.939; final=8.939
