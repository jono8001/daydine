...
|---|---:|---|
| Trust & Compliance | 9.153 | compliance; not food quality · signals used: 5 |
...
**Component score:** 9.153 / 10  ·  *compliance signal; not food quality.*
...
```
TrustCompliance=9.153 (r_norm ok, signals_used=5, recency=0.806)
