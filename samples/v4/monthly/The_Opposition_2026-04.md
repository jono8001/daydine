...
|---|---:|---|
| Trust & Compliance | 8.882 | compliance; not food quality · signals used: 5 |
...
**Component score:** 8.882 / 10  ·  *compliance signal; not food quality.*
...
**Formed from:** Trust 8.88 + Customer 9.37 + Commercial 7.50. Final: 8.894.

<details>
<summary>Raw engine trace (for audit)</summary>

```
TrustCompliance=8.882 (r_norm ok, signals_used=5, recency=0.514)
...
base=8.894; distinction+0.000; adjusted=8.894; final=8.894
