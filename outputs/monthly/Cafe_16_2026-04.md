# Cafe 16 — Monthly Intelligence Report
...
**Overall score: 6.1/10** (baseline month — no prior comparison)
 | Strongest: Trust (8.6) | Weakest: Visibility (3.3)

**Competitive position:** Local Peers (5mi): #3 of 6 (P60.0) — peer avg 5.88, top 6.92
  Catchment (15mi): #12 of 28 (P59.3) — peer avg 5.8, top 6.92
...
Based on publicly observable data for Cafe 16, your current operational gaps are putting an estimated **9–29 covers per week** at risk — representing approximately **£580–£3,480 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£290–£1,740/mo); Fix the digital shopfront — you're losing walk-ins (£290–£1,740/mo); Protect the 4.7/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~180–290 | Derived from 215 Google reviews (mid venue indicator), price level £ |
...
| Aggregate signals | Rating and volume from all platforms | 215 Google (4.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.7 rating across 215 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Cafe 16 operates as a credible cafe venue with a 4.7/5 Google rating across 215 reviews — solid but not yet commanding.
...
With 215 reviews at 4.7/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 215 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: coffee_shop, breakfast_restaurant, cafe, restaurant, food_store, store. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: coffee_shop, breakfast_restaurant, cafe, restaurant, food_store, store*
...
Online visibility (3.3) hasn't kept pace with guest experience quality (8.6). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 215 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 215 reviews (Moderate) | Visibility 3.3/10 (Weak) |
...
Cafe 16 is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 3 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | coffee_shop, breakfast_restaurant, cafe, restaurant, food_store, store | Primary |
| Price Level | £ (1/4) — Budget | Supportive |
| Name | "Cafe 16" contains "cafe" | Supportive |
...
- **Southam Gateway Coffee Shop Ltd** (6.1): Dining with similar price band; 0.1 miles away
- **Harbury Library Cafe** (5.8): Dining with comparable price band; 3.0 miles away
- **The Tea Shed** (5.7): Dining with comparable price band; 3.0 miles away
- **Bishops Bowls Lake Cafe** (4.8): Dining with comparable price band; 2.4 miles away

## Competitive Market Intelligence

**Local market:** 5 direct competitors identified.

Above the median (P60) but not leading. Peer average is 5.9; the top performer scores 6.9. The gap to the top is closeable.

**Where you lead:** Trust (+1.1), Conversion (+0.7), Visibility (+0.7)

*Commercial implication: you capture an adequate share of a 6-venue market, but the gap to the top (6.9) represents demand you could win. Closing the gap typically requires 1–2 targeted dimension improvements (indicative).*
...
You sit above the median but below the top tier. Your 6.1 compares to a peer average of 5.9. The gap to the top (6.9) is 0.8 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 8.6 (+1.1 above peer avg 7.6)
- Conversion: 3.5 (+0.7 above peer avg 2.8)
- Visibility: 3.3 (+0.7 above peer avg 2.6)

**Closest competitors:**

- Puddleduck Cafe Ltd (6.9) — leads you by 0.8
- Southam Gateway Coffee Shop Ltd (6.1) — leads you by 0.0
- Harbury Library Cafe (5.8) — you lead by 0.2
- The Tea Shed (5.7) — you lead by 0.4
- Bishops Bowls Lake Cafe (4.8) — you lead by 1.2

### Competitor Strategy

**Southam Gateway Coffee Shop Ltd** (signal-backed)

- **Wins on:** Experience (+1.0): same Google rating (4.7/5) but higher experience score — likely stronger FSA food hygiene sub-scores
...
- **Defend:** Defend your conversion readiness (+1.0) — you are easier to book/find and your 215-review advantage vs their 26 (discovery moat).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

### Extended Catchment (27 peers within 15 miles)

**Position:** #12 of 28 (Percentile 59.3)
...
- Trust: 8.6 (+1.2 above peer avg 7.5)
...
| Visibility | 3.3 | — | 2.6 | +0.7 | Above peers |
| Trust | 8.6 | — | 7.6 | +1.1 | Above peers |
...
**Assessment: Strong.** This is a genuine competitive strength at 8.6.
 Slightly below peer average (8.9).
...
**Management note:** At 215 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 8.6.
 You lead peers by 1.1 points (peer avg 7.6).
...
| Inspection Recency | 6.6/10 | ⚠️ Room to improve | Last inspected 2025-10-09 (6 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-10-09 (6 months ago). Full confidence. No action needed. 
...
| Google review count | 215 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.7★ (215 reviews) | observed | ✓ |
...
| Last Inspection | 2025-10-09 | FSA | observed |
| Google Rating | 4.7/5 | Google Places API | observed |
| Google Reviews | 215 | Google Places API | observed |
