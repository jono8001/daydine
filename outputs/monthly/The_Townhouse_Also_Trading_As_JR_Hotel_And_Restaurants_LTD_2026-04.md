# The Townhouse Also Trading As JR Hotel And Restaurants LTD — Monthly Intelligence Report
...
**Competitive position:** Local Peers (5mi): #4 of 9 (P62.5) — peer avg 6.08, top 7.34
  Catchment (15mi): #5 of 19 (P77.8) — peer avg 5.89, top 7.34
  UK Category Cohort: #5 of 19 (P77.8) — peer avg 5.89, top 7.34
...
Based on publicly observable data for The Townhouse Also Trading As JR Hotel And Restaurants LTD, your current operational gaps are putting an estimated **11–35 covers per week** at risk — representing approximately **£1,320–£8,400 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£660–£4,200/mo); Fix the digital shopfront — you're losing walk-ins (£660–£4,200/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~220–350 | Derived from 576 Google reviews (large venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 576 Google (4.4★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.4 rating across 576 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Townhouse Also Trading As JR Hotel And Restaurants LTD operates as a credible pub dining venue with a 4.4/5 Google rating across 576 reviews — solid but not yet commanding.
...
- **Review momentum.** At 576 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: hotel, gastropub, pub, bar, restaurant, lodging. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: hotel, gastropub, pub, bar, restaurant, lodging*
...
Online visibility (3.6) hasn't kept pace with guest experience quality (9.3). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 576 reviews — strong base. Rating is stable but a sustained negative pattern could shift it.
...
| Review Volume | 576 reviews (High) | Visibility 3.6/10 (Weak) |
...
The Townhouse Also Trading As JR Hotel And Restaurants LTD is classified as **Pub / Bar** (confidence: medium). Google's raw category is "Pub / Bar" but the resolved category triangulates across 3 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | hotel, gastropub, pub, bar, restaurant, lodging | Primary |
| Price Level | ££ (2/4) — Casual dining | Supportive |
| Name | "The Townhouse Also Trading As JR Hotel And Restaurants LTD" contains "restaurant" | Supportive |
...
- **The Fox Inn** (6.5): Pub Dining with similar price band; 3.7 miles away
...
- **The Bell Inn** (5.9): Pub Dining with similar price band; 3.6 miles away

## Competitive Market Intelligence

**Local market:** 8 direct competitors identified.

Above the median (P62) but not leading. Peer average is 6.1; the top performer scores 7.3. The gap to the top is closeable.
...
You sit above the median but below the top tier. Your 6.3 compares to a peer average of 6.1. The gap to the top (7.3) is 1.0 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 9.2 (+1.1 above peer avg 8.0)
- Visibility: 3.6 (-0.6 below peer avg 4.2)

**Closest competitors:**

- Vintner Wine Bar (7.3) — leads you by 1.0
- The Fox Inn (6.5) — leads you by 0.2
- The Red Lion (6.4) — leads you by 0.1
- Snitterfield Arms (6.2) — you lead by 0.1
- The Bell Inn (5.9) — you lead by 0.4
...
- **Why it matters:** You are closely matched — small improvements on either side shift the balance.
- **Copy / test:** No clear action to copy — maintain current standards.
- **Defend:** Defend your conversion readiness (+1.0) — you are easier to book/find and your 576-review advantage vs their 102 (discovery moat).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

### Extended Catchment (18 peers within 15 miles)

**Position:** #5 of 19 (Percentile 77.8)

You sit above the median but below the top tier. Your 6.3 compares to a peer average of 5.9. The gap to the top (7.3) is 1.0 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 9.2 (+1.2 above peer avg 8.0)
- Experience: 9.3 (+0.5 above peer avg 8.8)

**Closest competitors:**

- Vintner Wine Bar (7.3) — leads you by 1.0
- Arrow Mill (6.7) — leads you by 0.4
- The Fox Inn (6.5) — leads you by 0.2
- The Red Lion (6.4) — leads you by 0.1
- The Bull's Head (6.3) — you lead by 0.0
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.3 | — | 9.0 | +0.3 | Above peers |
| Visibility | 3.6 | — | 4.2 | -0.6 | Below peers |
| Trust | 9.2 | — | 8.0 | +1.1 | Above peers |
...
**Management note:** At 576 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 9.2.
 You lead peers by 1.1 points (peer avg 8.0).
...
| Inspection Recency | 8.1/10 | ✅ Adequate | Last inspected 2026-01-09 (3 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2026-01-09 (3 months ago). Full confidence. No action needed. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.5 on trust, +0.1 on overall (6.3 → 6.4).
...
| Google review count | 576 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.4★ (576 reviews) | observed | ✓ |
...
| Last Inspection | 2026-01-09 | FSA | observed |
| Google Rating | 4.4/5 | Google Places API | observed |
| Google Reviews | 576 | Google Places API | observed |
...
| Postcode | CV37 6HB | FSA | observed |
| Companies House | — | Not checked | not_assessed |
