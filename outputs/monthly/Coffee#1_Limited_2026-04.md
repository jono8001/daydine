# Coffee#1 Limited — Monthly Intelligence Report
...
- Ranked #12 of 18 locally — peers are ahead

**Do not prioritise:** Establish basic web presence — you don't exist online beyond Google

**Overall score: 5.4/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.1) | Weakest: Conversion (1.0)

**Competitive position:** Local Peers (5mi): #12 of 18 (P35.3) — peer avg 5.5, top 6.64
  Catchment (15mi): #36 of 46 (P22.2) — peer avg 5.74, top 6.78
  UK Category Cohort: #43 of 53 (P19.2) — peer avg 5.79, top 6.92
...
Based on publicly observable data for Coffee#1 Limited, your current operational gaps are putting an estimated **18–52 covers per week** at risk — representing approximately **£3,180–£18,900 per month** in lost or leaked revenue. The main drivers are: Publish opening hours — you're invisible to 'open now' searches (£1,060–£6,300/mo); Get your menu online — 77% of diners check before visiting (£1,060–£6,300/mo); Fix the digital shopfront — you're losing walk-ins (£1,060–£6,300/mo). Taking action on **Publish opening hours — you're invisible to 'open now' searches** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~220–350 | Derived from 538 Google reviews (large venue indicator), price level ££ |
| Average spend per head | ~£22 | UK hospitality benchmark for price level ££ |
| Covers at risk per week | 18–52 | Conversion score 1.0/10 → 8%–15% leakage |
| Weekly revenue at risk | £800–£4,720 | Recoverable with priority action fixes |
| Monthly revenue at risk | £3,180–£18,900 | Aggregate across top 3 priorities |
| Annual projection | £38,160–£226,800 | If current gaps persist 12 months |
...
| Aggregate signals | Rating and volume from all platforms | 538 Google (4.2★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.2 rating across 538 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Coffee#1 Limited operates as a credible cafe venue with a 4.2/5 Google rating across 538 reviews — solid but not yet commanding.
...
- **Evidence:** `goh missing`
  ...
  **Commercial consequence** (directional):
  Value at stake: £260–£3,360/month | Cost to fix: Zero cost (profile update) | Payback: Immediate (same week)
...
- **Evidence:** `experience=9.07, conversion=1.0`
...
- **Review momentum.** At 538 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
- **Volume:** 538 reviews — strong base. Rating is stable but a sustained negative pattern could shift it.
...
| Review Volume | 538 reviews (High) | Visibility 3.6/10 (Weak) |
...
Coffee#1 Limited is classified as **Cafe / Coffee Shop** (confidence: high). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 2 signal sources.
...
Below the median (P35). Customers have higher-rated alternatives nearby (peer avg 5.5, top 6.6).

**Where you lead:** Experience (+0.8)
**Where peers beat you:** Conversion (-2.0)
...
**Position:** #12 of 18 (Percentile 35.3)

You are below the median of your peer set. At 5.4 vs peer average 5.5, competitors are outperforming you. The top performer scores 6.6. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Experience: 9.1 (+0.8 above peer avg 8.3)
- Conversion: 1.0 (-2.0 below peer avg 3.0)

**Closest competitors:**

- Shakespaw Cat Cafe (6.6) — leads you by 1.3
- No 37 Cafe (6.3) — leads you by 1.0
- Costa (6.3) — leads you by 1.0
- Espresso Barn (6.3) — leads you by 1.0
- Coffee Clouds (6.0) — leads you by 0.6
...
- **Also wins on:** Trust (+2.4): same FSA rating but likely stronger sub-scores or more recent inspection
- **Why it matters:** They lead on both Conversion and Trust — a combined advantage that is harder to close than a single-dimension gap.
- **Copy / test:** Audit your Google profile vs theirs: hours, menu, booking, delivery. Review inspection documentation and sub-score gaps.
- **Defend:** No clear defensive advantage — you are closely matched across dimensions.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*
...
- **Wins on:** Trust (+2.5): same FSA rating but likely stronger sub-scores or more recent inspection; Conversion (+2.5): more complete operational signals (hours, menu, delivery/takeaway, booking)
...
**Position:** #36 of 46 (Percentile 22.2)

You are below the median of your peer set. At 5.4 vs peer average 5.7, competitors are outperforming you. The top performer scores 6.8. Customers in this area have demonstrably better-rated alternatives.
...
- South Costa (6.8) — leads you by 1.4
- Building 523 Costa And Kitchen (6.8) — leads you by 1.4
- Dec X Canteen (6.7) — leads you by 1.3
- Gilks' Garage Cafe (6.7) — leads you by 1.3
- Shakespaw Cat Cafe (6.6) — leads you by 1.3

### UK Category Cohort (52 peers in Cafe / Coffee Shop)

**Position:** #43 of 53 (Percentile 19.2)

You are below the median of your peer set. At 5.4 vs peer average 5.8, competitors are outperforming you. The top performer scores 6.9. Customers in this area have demonstrably better-rated alternatives.
...
- Puddleduck Cafe Ltd (6.9) — leads you by 1.5
- South Costa (6.8) — leads you by 1.4
- Nanas Caff (6.8) — leads you by 1.4
- Building 523 Costa And Kitchen (6.8) — leads you by 1.4
- Dec X Canteen (6.7) — leads you by 1.3
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.1 | — | 8.3 | +0.8 | Above peers |
| Visibility | 3.6 | — | 3.4 | +0.2 | Needs work |
| Trust | 7.1 | — | 7.2 | -0.1 | In line |
...
**Assessment: Strong.** This is a genuine competitive strength at 9.1.
 Slightly above peer average (8.3).
...
**Management note:** At 538 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 2.0/10 | ⚠️ Significant drag | Last inspected 2024-05-07 (23 months ago). Meaningful score drag. Consider pr... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-05-07 (23 months ago). Meaningful score drag. Consider proactive action. The system discounts older inspections because they carry less certainty.

**Peer context:** Shakespaw Cat Cafe's trust lead (+2.5) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.

**What you can do:**

1. **Request voluntary reinspection** (free, 4–8 weeks) — would recover ~2.0 trust points and overtake 2 peers. Only request reinspection if confident of maintaining 5/5. A drop to 4 would be worse than the staleness drag.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +2.0 on trust, +0.5 on overall (5.4 → 5.9).
...
You trail peers by 2.0 points on conversion. This isn't a label problem — it means customers are getting a measurably better experience on this dimension from your competitors.

**Ranked #12 of 18 locally — peers are ahead** [ESCALATED]

At percentile 35.3, customers in this area have higher-rated alternatives. This isn't a crisis but it means you're competing on convenience rather than reputation.
...
**Target date:** 08 April 2026 | **Cost:** Low (< £200) | **Expected upside:** Close the 2.0-point gap
**Owner:** management
...
### Action 5: Ranked #12 of 18 locally — peers are ahead
**Status:** Stale (4 months) | **Priority:** Medium
...
| Google review count | 538 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.2★ (538 reviews) | observed | ✓ |
...
| Last Inspection | 2024-05-07 | FSA | observed |
| Google Rating | 4.2/5 | Google Places API | observed |
| Google Reviews | 538 | Google Places API | observed |
...
| Postcode | CV37 6EY | FSA | observed |
| Companies House | — | Not checked | not_assessed |
