# Bella Italia Also Trading As Super Nonna — Monthly Intelligence Report
...
**Overall score: 5.6/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.2) | Weakest: Conversion (1.0)

**Competitive position:** Local Peers (5mi): #8 of 10 (P22.2) — peer avg 5.78, top 6.41
  Catchment (15mi): #10 of 12 (P18.2) — peer avg 5.84, top 6.41
  UK Category Cohort: #11 of 13 (P16.7) — peer avg 5.84, top 6.41
...
| Aggregate signals | Rating and volume from all platforms | 1,029 Google (4.3★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.3 rating across 1,029 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Bella Italia Also Trading As Super Nonna operates as a credible Italian dining venue with a 4.3/5 Google rating across 1029 reviews — solid but not yet commanding.
...
- **Review momentum.** At 1029 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: restaurant, lounge_bar, vegan_restaurant, vegetarian_restaurant, night_club, bar, italian_restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: restaurant, lounge_bar, vegan_restaurant, vegetarian_restaurant, night_club, bar, italian_restaurant*
...
- **Volume:** 1,029 reviews — statistically robust rating. Individual reviews have negligible impact.
...
| Review Volume | 1029 reviews (High) | Visibility 3.8/10 (Weak) |
...
Bella Italia Also Trading As Super Nonna is classified as **Restaurant** (confidence: low). Google's raw category is "Italian Restaurant" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | restaurant, lounge_bar, vegan_restaurant, vegetarian_restaurant, night_club, bar, italian_restaurant | Primary |
...
Below the median (P22). Customers have higher-rated alternatives nearby (peer avg 5.8, top 6.4).
...
- Conversion: 1.0 (-2.1 below peer avg 3.1)

**Closest competitors:**

- The Phoenix (6.4) — leads you by 0.9
- Soma (6.2) — leads you by 0.6
- Carluccio's (6.1) — leads you by 0.5
- Pizza Hut Restaurants - Dine In (6.0) — leads you by 0.5
...
- **Why it matters:** A large conversion gap (+1.5) — they convert interest into visits more effectively — their digital shopfront is more complete. This is a structural disadvantage, not a rounding error.
- **Copy / test:** Audit your Google profile vs theirs: hours, menu, booking, delivery.
- **Defend:** Defend your 1029-review advantage vs their 121 (discovery moat).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*
...
| Visibility | 3.8 | — | 3.4 | +0.3 | Above peers |
| Trust | 7.6 | — | 7.5 | +0.1 | In line |
| Conversion | 1.0 | — | 3.1 | -2.1 | Significant gap |
| **Overall** | **5.6** | **—** | | | |
...
**Management note:** At 1029 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Critical.** At 1.0, this represents a material operational gap.
 You trail peers by 2.1 points (peer avg 3.1).
...
| Inspection Recency | 1.9/10 | ⚠️ Significant drag | Last inspected 2024-04-10 (24 months ago). Meaningful score drag. Consider pr... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-04-10 (24 months ago). Meaningful score drag. Consider proactive action. The system discounts older inspections because they carry less certainty.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +2.0 on trust, +0.5 on overall (5.6 → 6.1).
...
| Google review count | 1029 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.3★ (1029 reviews) | observed | ✓ |
...
| Last Inspection | 2024-04-10 | FSA | observed |
| Google Rating | 4.3/5 | Google Places API | observed |
| Google Reviews | 1029 | Google Places API | observed |
...
| Postcode | CV37 6JG | FSA | observed |
| Companies House | — | Not checked | not_assessed |
