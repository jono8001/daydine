# The Olde Mint — Monthly Intelligence Report
...
**Overall score: 5.5/10** (baseline month — no prior comparison)
 | Strongest: Trust (8.1) | Weakest: Visibility (3.0)

**Competitive position:** Local Peers (5mi): #1 of 2 (P100.0) — peer avg 5.35, top 5.35
  Catchment (15mi): #10 of 12 (P18.2) — peer avg 6.02, top 7.34
  UK Category Cohort: #15 of 19 (P22.2) — peer avg 5.93, top 7.34
...
| Aggregate signals | Rating and volume from all platforms | 89 Google (4★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4 rating across 89 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Olde Mint is a pub dining venue with an adequate public reputation (4.0/5, 89 reviews) that has room to build stronger proof.

Within the local pub dining market (1 peers), this venue leads the field. The identity is that of a category leader — the venue others are compared against.
...
- **Review momentum.** At 89 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Online visibility (3.0) hasn't kept pace with guest experience quality (7.8). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Unrealised review authority.** At 89 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** Only 89 reviews — rating is volatile. A single 1-star review moves the average measurably.
...
| Review Volume | 89 reviews (Low) | Visibility 3.0/10 (Weak) |
...
The Olde Mint is classified as **Pub / Bar** (confidence: medium). Google's raw category is "Pub / Bar" but the resolved category triangulates across 2 signal sources.
...
- **The Buck And Bell** (5.3): Pub Dining with comparable price band; 2.1 miles away
...
**Where you lead:** Trust (+2.1)
**Where peers beat you:** Experience (-0.6)

### Competitive Position

| Competitor | Score | Google Rating | Reviews |
|---|---|---|---|
| The Buck And Bell | 5.3 | 4.5★ | 331 |
...
You are in the top quintile of this peer set. Your overall score of 5.5 exceeds the peer average of 5.3 by 0.1 points. The competitive risk here is complacency — the nearest competitor scores 5.3.

**Dimension gaps vs peers:**

- Trust: 8.1 (+2.1 above peer avg 5.9)
- Experience: 7.8 (-0.6 below peer avg 8.4)

**Closest competitors:**

- The Buck And Bell (5.3) — you lead by 0.1

### Competitor Strategy

**The Buck And Bell** (signal-backed)

- **Wins on:** Experience (+0.6): Google 4.5/5 vs your 4.0/5
...
- **Defend:** Defend your trust advantage (+2.1).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

**Vintner Wine Bar** (signal-backed)

- **Wins on:** Visibility (+6.8): 887 Google reviews vs your 89 — they have volume advantage; Conversion (+2.0): more complete operational signals (hours, menu, delivery/takeaway, booking)
...
- **Copy / test:** Build review volume — they have 887 to your 89. Audit your Google profile vs theirs: hours, menu, booking, delivery.
- **Defend:** Defend your trust advantage (+0.9).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

**The Fox Inn** (signal-backed)

- **Wins on:** Trust (+1.4): same FSA rating but likely stronger sub-scores or more recent inspection; Experience (+1.4): Google 4.6/5 vs your 4.0/5
...
**Position:** #10 of 12 (Percentile 18.2)

You are below the median of your peer set. At 5.5 vs peer average 6.0, competitors are outperforming you. The top performer scores 7.3. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Visibility: 3.0 (-1.0 below peer avg 3.9)
- Experience: 7.8 (-1.2 below peer avg 9.0)

**Closest competitors:**

- Vintner Wine Bar (7.3) — leads you by 1.9
- The Fox Inn (6.5) — leads you by 1.0
- The Red Lion (6.4) — leads you by 0.9
- The Townhouse Also Trading As JR Hotel And Restaurants LTD (6.3) — leads you by 0.8
- Snitterfield Arms (6.2) — leads you by 0.7

### UK Category Cohort (18 peers in Pub / Bar)

**Position:** #15 of 19 (Percentile 22.2)

You are below the median of your peer set. At 5.5 vs peer average 5.9, competitors are outperforming you. The top performer scores 7.3. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Visibility: 3.0 (-0.9 below peer avg 3.8)
- Experience: 7.8 (-1.1 below peer avg 8.8)

**Closest competitors:**

- Vintner Wine Bar (7.3) — leads you by 1.9
- Arrow Mill (6.7) — leads you by 1.2
- The Fox Inn (6.5) — leads you by 1.0
- The Red Lion (6.4) — leads you by 0.9
- The Townhouse Also Trading As JR Hotel And Restaurants LTD (6.3) — leads you by 0.8
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 7.8 | — | 8.4 | -0.6 | Below peers |
| Visibility | 3.0 | — | 3.4 | -0.4 | Below peers |
| Trust | 8.1 | — | 5.9 | +2.1 | Clear strength |
...
**Assessment: Adequate.** At 7.8, this is functional but not distinctive.
 Slightly below peer average (8.4).
...
**Management note:** At 89 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 8.1.
 You lead peers by 2.1 points (peer avg 5.9).
...
| Inspection Recency | 5.8/10 | ⚠️ Room to improve | Last inspected 2025-08-14 (8 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-08-14 (8 months ago). Full confidence. No action needed. 

**Peer context:** The Buck And Bell's trust lead (+2.1) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.1 on trust, +0.3 on overall (5.5 → 5.7).
...
| Google review count | 89 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.0★ (89 reviews) | observed | ✓ |
...
| Last Inspection | 2025-08-14 | FSA | observed |
| Google Rating | 4.0/5 | Google Places API | observed |
| Google Reviews | 89 | Google Places API | observed |
...
| Postcode | CV47 0EP | FSA | observed |
| Companies House | — | Not checked | not_assessed |
