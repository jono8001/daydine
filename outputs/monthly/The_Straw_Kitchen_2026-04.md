# The Straw Kitchen — Monthly Intelligence Report
...
**Overall score: 6.1/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.9) | Weakest: Visibility (3.3)

**Competitive position:** Local Peers (5mi): #4 of 4 (P0.0) — peer avg 6.26, top 6.44
  Catchment (15mi): #13 of 29 (P57.1) — peer avg 5.86, top 6.78
  UK Category Cohort: #19 of 53 (P65.4) — peer avg 5.78, top 6.92
...
Based on publicly observable data for The Straw Kitchen, your current operational gaps are putting an estimated **7–22 covers per week** at risk — representing approximately **£840–£5,280 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£420–£2,640/mo); Fix the digital shopfront — you're losing walk-ins (£420–£2,640/mo); Protect the 4.9/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~140–220 | Derived from 250 Google reviews (mid venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 250 Google (4.9★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.9 rating across 250 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Straw Kitchen operates as a credible cafe venue with a 4.9/5 Google rating across 250 reviews — solid but not yet commanding.
...
- **Evidence:** `experience=9.88, conversion=3.5`
...
With 250 reviews at 4.9/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Your 4.9/5 Google rating.** This is your primary commercial asset. Protect it through consistent delivery.
...
- **Review momentum.** At 250 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: restaurant, breakfast_restaurant, cafe. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: restaurant, breakfast_restaurant, cafe*
...
- **The 4.9/5 rating feels dominant but isn't.** In this market, peer venues achieve similar ratings. Your percentile position (P0.0) shows the rating is table stakes, not a differentiator.
...
- **Volume:** 250 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 250 reviews (Moderate) | Visibility 3.3/10 (Weak) |
...
The Straw Kitchen is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | restaurant, breakfast_restaurant, cafe | Primary |
...
- **Cotswold Cafe** (6.4): Dining with comparable price band; 4.8 miles away
- **Feel Good Crystals** (6.2): Dining with comparable price band; 2.3 miles away
- **Cotswold Distillery Cafe** (6.2): Dining with comparable price band; 1.7 miles away

## Competitive Market Intelligence

**Local market:** 3 direct competitors identified.

Below the median (P0). Customers have higher-rated alternatives nearby (peer avg 6.3, top 6.4).
...
**Position:** #4 of 4 (Percentile 0.0)

You are below the median of your peer set. At 6.1 vs peer average 6.3, competitors are outperforming you. The top performer scores 6.4. Customers in this area have demonstrably better-rated alternatives.
...
- Cotswold Cafe (6.4) — leads you by 0.4
- Feel Good Crystals (6.2) — leads you by 0.1
- Cotswold Distillery Cafe (6.2) — leads you by 0.1
...
- **Wins on:** Visibility (+0.5): 1239 Google reviews vs your 250 — they have volume advantage
- **Why it matters:** Their visibility lead means they are easier to find online — this controls top-of-funnel discovery.
- **Copy / test:** Build review volume — they have 1239 to your 250.
- **Defend:** Defend your conversion readiness (+1.0) — you are easier to book/find.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

### Extended Catchment (28 peers within 15 miles)

**Position:** #13 of 29 (Percentile 57.1)

You sit above the median but below the top tier. Your 6.1 compares to a peer average of 5.9. The gap to the top (6.8) is 0.7 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Experience: 9.9 (+1.1 above peer avg 8.8)
- Conversion: 3.5 (+0.6 above peer avg 2.9)
- Trust: 7.2 (-0.6 below peer avg 7.8)

**Closest competitors:**

- South Costa (6.8) — leads you by 0.7
- Building 523 Costa And Kitchen (6.8) — leads you by 0.7
- Dec X Canteen (6.7) — leads you by 0.6
- Gilks' Garage Cafe (6.7) — leads you by 0.6
- Shakespaw Cat Cafe (6.6) — leads you by 0.5

### UK Category Cohort (52 peers in Cafe / Coffee Shop)

**Position:** #19 of 53 (Percentile 65.4)

You sit above the median but below the top tier. Your 6.1 compares to a peer average of 5.8. The gap to the top (6.9) is 0.8 points — closeable with focused improvement on your weakest dimension.
...
- South Costa (6.8) — leads you by 0.7
- Nanas Caff (6.8) — leads you by 0.7
- Building 523 Costa And Kitchen (6.8) — leads you by 0.7
- Dec X Canteen (6.7) — leads you by 0.6
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.9 | — | 9.8 | +0.1 | Strong |
| Visibility | 3.3 | — | 3.4 | -0.1 | Needs work |
...
**Management note:** At 250 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Adequate.** At 7.2, this is functional but not distinctive.
 You trail peers by 1.1 points (peer avg 8.3).
...
| Inspection Recency | 2.1/10 | ⚠️ Significant drag | Last inspected 2024-06-07 (22 months ago). Meaningful score drag. Consider pr... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-06-07 (22 months ago). Meaningful score drag. Consider proactive action. The system discounts older inspections because they carry less certainty.

**Peer context:** Cotswold Cafe's trust lead (+1.6) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +2.0 on trust, +0.5 on overall (6.1 → 6.6).
...
⚠️ **FSA inspection recency:** Last inspected 22 months ago — re-inspection likely within 6 months.

## Watch List

**Strong rating masks weak competitive position** [ESCALATED]

Your 4.9/5 Google rating feels dominant but you sit below the local median (P0.0). Peer venues achieve similar or better ratings — in this market, 4.5 is table stakes, not a differentiator. Don't mistake the number for an advantage.
...
### Action 4: Protect the 4.9/5 rating — it took years to build
**Status:** Overdue (6 months) | **Priority:** High
...
|--:|---------------|--------|--------|------|
| 6 | Ranked #4 of 4 locally — peers are ahead | Overdue (6 months) | 01 May 2026 | Medium (£200–£1,000) |
...
| Google review count | 250 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.9★ (250 reviews) | observed | ✓ |
...
| Last Inspection | 2024-06-07 | FSA | observed |
| Google Rating | 4.9/5 | Google Places API | observed |
| Google Reviews | 250 | Google Places API | observed |
...
| Postcode | CV36 5PG | FSA | observed |
| Companies House | — | Not checked | not_assessed |
