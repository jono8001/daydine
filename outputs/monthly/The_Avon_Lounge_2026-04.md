# The Avon Lounge — Monthly Intelligence Report
...
**Watch this month:**
- Ranked #8 of 9 locally — peers are ahead
...
**Overall score: 5.5/10** (baseline month — no prior comparison)
 | Strongest: Experience (8.9) | Weakest: Conversion (2.5)

**Competitive position:** Local Peers (5mi): #8 of 9 (P12.5) — peer avg 6.18, top 7.34
  Catchment (15mi): #14 of 19 (P27.8) — peer avg 5.93, top 7.34
  UK Category Cohort: #14 of 19 (P27.8) — peer avg 5.93, top 7.34
...
| Aggregate signals | Rating and volume from all platforms | 83 Google (4.1★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.1 rating across 83 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Avon Lounge is a pub dining venue with an adequate public reputation (4.1/5, 83 reviews) that has room to build stronger proof.
...
- **Review momentum.** At 83 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: beer_garden, pub, live_music_venue, bar, event_venue, restaurant, store. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: beer_garden, pub, live_music_venue, bar, event_venue, restaurant, store*
...
Online visibility (3.0) hasn't kept pace with guest experience quality (8.9). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Unrealised review authority.** At 83 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** Only 83 reviews — rating is volatile. A single 1-star review moves the average measurably.
...
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 7.5/10 (Adequate) |
| Review Volume | 83 reviews (Low) | Visibility 3.0/10 (Weak) |
...
The Avon Lounge is classified as **Pub / Bar** (confidence: medium). Google's raw category is "Pub / Bar" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | beer_garden, pub, live_music_venue, bar, event_venue, restaurant, store | Primary |

**Resolved category:** Pub / Bar (confidence: medium)

### Peer Justification

- **Vintner Wine Bar** (7.3): Pub Dining with comparable price band; 0.2 miles away
- **The Fox Inn** (6.5): Pub Dining with comparable price band; 3.8 miles away
...
- **Snitterfield Arms** (6.2): Pub Dining with comparable price band; 3.2 miles away

## Competitive Market Intelligence

**Local market:** 8 direct competitors identified.

Below the median (P12). Customers have higher-rated alternatives nearby (peer avg 6.2, top 7.3).

**Where peers beat you:** Visibility (-1.3), Trust (-0.7), Conversion (-0.7)
...
You are below the median of your peer set. At 5.5 vs peer average 6.2, competitors are outperforming you. The top performer scores 7.3. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Conversion: 2.5 (-0.7 below peer avg 3.2)
- Trust: 7.5 (-0.7 below peer avg 8.2)
- Visibility: 3.0 (-1.3 below peer avg 4.2)

**Closest competitors:**

- Vintner Wine Bar (7.3) — leads you by 1.8
- The Fox Inn (6.5) — leads you by 0.9
...
- **Wins on:** Visibility (+6.8): 887 Google reviews vs your 83 — they have volume advantage; Conversion (+3.0): more complete operational signals (hours, menu, delivery/takeaway, booking)
...
- **Copy / test:** Build review volume — they have 887 to your 83. Audit your Google profile vs theirs: hours, menu, booking, delivery.
...
- **Also wins on:** Experience (+0.7): Google 4.7/5 vs your 4.1/5
...
**Position:** #14 of 19 (Percentile 27.8)
...
- Conversion: 2.5 (-0.8 below peer avg 3.3)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.9 | — | 9.0 | -0.1 | Strong |
| Visibility | 3.0 | — | 4.2 | -1.3 | Below peers |
| Trust | 7.5 | — | 8.2 | -0.7 | Below peers |
...
**Assessment: Critical.** At 3.0, this represents a material operational gap.
 You trail peers by 1.3 points (peer avg 4.2).
...
**Management note:** At 83 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Adequate.** At 7.5, this is functional but not distinctive.
 Slightly below peer average (8.2).
...
| Inspection Recency | 3.7/10 | ⚠️ Significant drag | Last inspected 2025-01-31 (14 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-01-31 (14 months ago). Score starting to decay. Note it but don't escalate. 

**Peer context:** Vintner Wine Bar's trust lead (+1.9) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.6 on trust, +0.4 on overall (5.5 → 5.9).
...
**Ranked #8 of 9 locally — peers are ahead** [ESCALATED]

At percentile 12.5, customers in this area have higher-rated alternatives. This isn't a crisis but it means you're competing on convenience rather than reputation.
...
### Action 4: Ranked #8 of 9 locally — peers are ahead
**Status:** Stale (4 months) | **Priority:** Medium
...
| Google review count | 83 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.1★ (83 reviews) | observed | ✓ |
...
| Last Inspection | 2025-01-31 | FSA | observed |
| Google Rating | 4.1/5 | Google Places API | observed |
| Google Reviews | 83 | Google Places API | observed |
...
| Postcode | CV37 6LP | FSA | observed |
| Companies House | — | Not checked | not_assessed |
