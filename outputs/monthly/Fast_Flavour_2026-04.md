# Fast Flavour — Monthly Intelligence Report
...
**Overall score: 5.8/10** (baseline month — no prior comparison)
 | Strongest: Trust (8.8) | Weakest: Conversion (2.5)

**Competitive position:** Local Peers (5mi): #4 of 8 (P57.1) — peer avg 5.78, top 6.91
  Catchment (15mi): #7 of 14 (P53.8) — peer avg 5.67, top 6.91
  UK Category Cohort: #8 of 15 (P50.0) — peer avg 5.73, top 6.91
...
Based on publicly observable data for Fast Flavour, your current operational gaps are putting an estimated **3–12 covers per week** at risk — representing approximately **£380–£2,880 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£190–£1,440/mo); Fix the digital shopfront — you're losing walk-ins (£190–£1,440/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~40–80 | Derived from 27 Google reviews (micro venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 27 Google (4.6★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.6 rating across 27 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Fast Flavour is a restaurant venue with an adequate public reputation (4.6/5, 27 reviews) that has room to build stronger proof.
...
- **Review momentum.** At 27 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Online visibility (2.6) hasn't kept pace with guest experience quality (8.5). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Unrealised review authority.** At 27 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** Only 27 reviews — rating is volatile. A single 1-star review moves the average measurably.
...
| Review Volume | 27 reviews (Low) | Visibility 2.6/10 (Weak) |
...
Fast Flavour is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Restaurant (General)" but the resolved category triangulates across 1 signal sources.
...
- **11/17 Salt Beef Bar** (6.9): Dining with comparable price band; 0.0 miles away
- **Red Hot Mamma Pizzeria** (6.3): Dining with comparable price band; 0.1 miles away
- **Bannatyne Health Club And Spa Wildmoor** (5.8): Dining with comparable price band; 2.0 miles away
...
Above the median (P57) but not leading. Peer average is 5.8; the top performer scores 6.9. The gap to the top is closeable.

**Where you lead:** Trust (+0.9)
**Where peers beat you:** Visibility (-0.6)

*Commercial implication: you capture an adequate share of a 8-venue market, but the gap to the top (6.9) represents demand you could win. Closing the gap typically requires 1–2 targeted dimension improvements (indicative).*
...
- Trust: 8.8 (+0.9 above peer avg 7.9)
- Visibility: 2.6 (-0.6 below peer avg 3.1)

**Closest competitors:**

- 11/17 Salt Beef Bar (6.9) — leads you by 1.1
- Red Hot Mamma Pizzeria (6.3) — leads you by 0.5
- Bannatyne Health Club And Spa Wildmoor (5.8) — leads you by 0.0
...
- **Copy / test:** Build review volume — they have 530 to your 27. Read their recent positive reviews (4.3/5) for operational clues.
...
- **Copy / test:** Build review volume — they have 184 to your 27.
- **Defend:** Defend your trust advantage (+0.9).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

**Lily's** (signal-backed)
...
**Position:** #7 of 14 (Percentile 53.8)
...
- 11/17 Salt Beef Bar (6.9) — leads you by 1.1
- Lithos Restaurant (6.5) — leads you by 0.8
- The Bluebell (6.4) — leads you by 0.6
- Red Hot Mamma Pizzeria (6.3) — leads you by 0.5
- The Bridge (6.0) — leads you by 0.2

### UK Category Cohort (14 peers in Restaurant (General))

**Position:** #8 of 15 (Percentile 50.0)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.5 | — | 8.7 | -0.2 | Strong |
| Visibility | 2.6 | — | 3.1 | -0.6 | Below peers |
| Trust | 8.8 | — | 7.9 | +0.9 | Above peers |
...
**Management note:** At 27 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 5.1/10 | ⚠️ Room to improve | Last inspected 2025-06-23 (10 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-06-23 (10 months ago). Full confidence. No action needed. 
...
| Google review count | 27 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.6★ (27 reviews) | observed | ✓ |
...
| Last Inspection | 2025-06-23 | FSA | observed |
| Google Rating | 4.6/5 | Google Places API | observed |
| Google Reviews | 27 | Google Places API | observed |
