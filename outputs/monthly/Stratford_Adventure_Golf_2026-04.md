# Stratford Adventure Golf — Monthly Intelligence Report
...
**Competitive position:** Local Peers (5mi): #2 of 3 (P50.0) — peer avg 5.79, top 6.27
  Catchment (15mi): #5 of 8 (P42.9) — peer avg 6.03, top 7.07
  UK Category Cohort: #6 of 10 (P44.4) — peer avg 6.16, top 7.85
...
Based on publicly observable data for Stratford Adventure Golf, your current operational gaps are putting an estimated **11–33 covers per week** at risk — representing approximately **£1,340–£7,920 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£670–£3,960/mo); Fix the digital shopfront — you're losing walk-ins (£670–£3,960/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~140–220 | Derived from 292 Google reviews (mid venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 292 Google (4.4★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.4 rating across 292 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Stratford Adventure Golf operates as a credible other venue with a 4.4/5 Google rating across 292 reviews — solid but not yet commanding.
...
- **Review momentum.** At 292 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Online visibility (3.4) hasn't kept pace with guest experience quality (9.3). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 292 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 292 reviews (Moderate) | Visibility 3.4/10 (Weak) |
...
Stratford Adventure Golf is classified as **Sports Club** (confidence: low). Google's raw category is "Other" but the resolved category triangulates across 1 signal sources.
...
- **Escape Arts** (5.3): Dining with comparable price band; 0.2 miles away

## Competitive Market Intelligence

**Local market:** 2 direct competitors identified.

Above the median (P50) but not leading. Peer average is 5.8; the top performer scores 6.3. The gap to the top is closeable.

**Where you lead:** Visibility (+1.3)

*Commercial implication: you capture an adequate share of a 3-venue market, but the gap to the top (6.3) represents demand you could win. Closing the gap typically requires 1–2 targeted dimension improvements (indicative).*
...
You sit above the median but below the top tier. Your 5.8 compares to a peer average of 5.8. The gap to the top (6.3) is 0.4 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Visibility: 3.4 (+1.3 above peer avg 2.1)

**Closest competitors:**

- The Lime Tree Restaurant (6.3) — leads you by 0.4
- Escape Arts (5.3) — you lead by 0.5

### Competitor Strategy

**The Lime Tree Restaurant** (signal-backed)

- **Wins on:** Trust (+1.2): same FSA rating but likely stronger sub-scores or more recent inspection; Visibility (+0.6): 1817 Google reviews vs your 292 — they have volume advantage
...
- **Copy / test:** Review inspection documentation and sub-score gaps. Build review volume — they have 1817 to your 292.
...
- **Wins on:** Conversion (+1.0): more complete operational signals (hours, menu, delivery/takeaway, booking); Visibility (+0.6): 3261 Google reviews vs your 292 — they have volume advantage
...
- **Copy / test:** Audit your Google profile vs theirs: hours, menu, booking, delivery. Build review volume — they have 3261 to your 292.
- **Defend:** No clear defensive advantage — you are closely matched across dimensions.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*
...
- **Defend:** Defend your 292-review advantage vs their 6 (discovery moat).
- *Based on Google rating/reviews, FSA record, 3 dimension scores*

### Extended Catchment (7 peers within 15 miles)

**Position:** #5 of 8 (Percentile 42.9)

You are below the median of your peer set. At 5.8 vs peer average 6.0, competitors are outperforming you. The top performer scores 7.1. Customers in this area have demonstrably better-rated alternatives.

**Closest competitors:**

- Ashorne Hill Management College (7.1) — leads you by 1.2
- The Pavillion (6.3) — leads you by 0.5
- The Lime Tree Restaurant (6.3) — leads you by 0.4
- Lexi's Loving Spoonful (6.0) — leads you by 0.2
- Shakespeare's (5.7) — you lead by 0.1

### UK Category Cohort (9 peers in Other)

**Position:** #6 of 10 (Percentile 44.4)

You are below the median of your peer set. At 5.8 vs peer average 6.2, competitors are outperforming you. The top performer scores 7.8. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Visibility: 3.4 (+0.5 above peer avg 2.9)

**Closest competitors:**

- Digby's Events (7.8) — leads you by 2.0
- Ashorne Hill Management College (7.1) — leads you by 1.2
- The Pavillion (6.3) — leads you by 0.5
- The Lime Tree Restaurant (6.3) — leads you by 0.4
- Lexi's Loving Spoonful (6.0) — leads you by 0.2
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.3 | — | 9.7 | -0.3 | Below peers |
| Visibility | 3.4 | — | 2.1 | +1.3 | Above peers |
| Trust | 8.1 | — | 8.2 | -0.1 | Strong |
...
**Assessment: Strong.** This is a genuine competitive strength at 9.3.
 Slightly below peer average (9.7).
...
**Assessment: Critical.** At 3.4, this represents a material operational gap.
 You lead peers by 1.3 points (peer avg 2.1).
...
**Management note:** At 292 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 2.2/10 | ⚠️ Significant drag | Last inspected 2024-06-20 (22 months ago). Meaningful score drag. Consider pr... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-06-20 (22 months ago). Meaningful score drag. Consider proactive action. The system discounts older inspections because they carry less certainty.

**Peer context:** The Lime Tree Restaurant's trust lead (+1.2) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.

**What you can do:**

1. **Request voluntary reinspection** (free, 4–8 weeks) — would recover ~1.9 trust points and overtake 1 peers. Only request reinspection if confident of maintaining 5/5. A drop to 4 would be worse than the staleness drag.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.9 on trust, +0.5 on overall (5.8 → 6.3).
...
⚠️ **FSA inspection recency:** Last inspected 21 months ago — re-inspection likely within 6 months.
...
| Google review count | 292 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.4★ (292 reviews) | observed | ✓ |
...
| Last Inspection | 2024-06-20 | FSA | observed |
| Google Rating | 4.4/5 | Google Places API | observed |
| Google Reviews | 292 | Google Places API | observed |
