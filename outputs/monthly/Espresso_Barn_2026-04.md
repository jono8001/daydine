# Espresso Barn — Monthly Intelligence Report
...
**Competitive position:** Local Peers (5mi): #3 of 15 (P85.7) — peer avg 5.43, top 6.64
  Catchment (15mi): #10 of 43 (P78.6) — peer avg 5.73, top 6.78
  UK Category Cohort: #12 of 53 (P78.8) — peer avg 5.78, top 6.92
...
Based on publicly observable data for Espresso Barn, your current operational gaps are putting an estimated **18–52 covers per week** at risk — representing approximately **£2,120–£12,600 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£1,060–£6,300/mo); Fix the digital shopfront — you're losing walk-ins (£1,060–£6,300/mo); Protect the 4.5/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~220–350 | Derived from 501 Google reviews (large venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 501 Google (4.5★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.5 rating across 501 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Espresso Barn is a well-established cafe venue with a strong public reputation — 4.5/5 across 501 Google reviews. That volume means the reputation is earned, not manufactured.
...
Within the local cafe market (14 peers), this venue leads the field. The identity is that of a category leader — the venue others are compared against.
...
- **Evidence:** `experience=9.42, conversion=2.5`
...
With 501 reviews at 4.5/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 501 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: furniture_store, home_improvement_store, home_goods_store, store. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: furniture_store, home_improvement_store, home_goods_store, store*
...
Online visibility (3.5) hasn't kept pace with guest experience quality (9.4). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 501 reviews — strong base. Rating is stable but a sustained negative pattern could shift it.
...
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 9.1/10 (Strong) |
| Review Volume | 501 reviews (High) | Visibility 3.5/10 (Weak) |
...
Espresso Barn is classified as **Furniture Store** (confidence: low). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | furniture_store, home_improvement_store, home_goods_store, store | Primary |

**Resolved category:** Furniture Store (confidence: low)

### Peer Justification

- **Shakespaw Cat Cafe** (6.6): Dining with comparable price band; 4.7 miles away
- **No 37 Cafe** (6.3): Dining with comparable price band; 4.7 miles away
- **Coffee Clouds** (6.0): Dining with comparable price band; 4.7 miles away
- **George's Cafe** (5.8): Dining with comparable price band; 3.9 miles away
- **Mr Odie's** (5.8): Dining with comparable price band; 4.7 miles away

## Competitive Market Intelligence

**Local market:** 14 direct competitors identified.

You are in the top quintile (P86). The competitive risk is complacency — the nearest competitor scores 6.6.

**Where you lead:** Trust (+1.8), Experience (+1.1)

**Density alert:** 14 competitors within range. Differentiation is critical — competing on fundamentals alone is insufficient in a dense market.
...
| George's Cafe | 5.8 | 4.7★ | 124 |
| Mr Odie's | 5.8 | 5.0★ | 89 |
...
14 direct competitors within 5mi. Differentiation critical.
...
### Local Competitive Set (14 peers within 5 miles)

**Position:** #3 of 15 (Percentile 85.7)

You are in the top quintile of this peer set. Your overall score of 6.3 exceeds the peer average of 5.4 by 0.9 points. The competitive risk here is complacency — the nearest competitor scores 6.6.

**Dimension gaps vs peers:**

- Trust: 9.1 (+1.8 above peer avg 7.2)
- Experience: 9.4 (+1.1 above peer avg 8.3)

**Closest competitors:**

- Shakespaw Cat Cafe (6.6) — leads you by 0.3
- No 37 Cafe (6.3) — leads you by 0.0
- Coffee Clouds (6.0) — you lead by 0.3
- George's Cafe (5.8) — you lead by 0.5
- Mr Odie's (5.8) — you lead by 0.6
...
- **Defend:** Defend your trust advantage (+1.1).
- *Based on Google rating/reviews, FSA record, 3 dimension scores*

### Extended Catchment (42 peers within 15 miles)

**Position:** #10 of 43 (Percentile 78.6)

You sit above the median but below the top tier. Your 6.3 compares to a peer average of 5.7. The gap to the top (6.8) is 0.5 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 9.1 (+1.7 above peer avg 7.4)
- Experience: 9.4 (+0.6 above peer avg 8.8)

**Closest competitors:**

- South Costa (6.8) — leads you by 0.5
- Building 523 Costa And Kitchen (6.8) — leads you by 0.5
- Dec X Canteen (6.7) — leads you by 0.3
- Gilks' Garage Cafe (6.7) — leads you by 0.3
- Shakespaw Cat Cafe (6.6) — leads you by 0.3

### UK Category Cohort (52 peers in Cafe / Coffee Shop)

**Position:** #12 of 53 (Percentile 78.8)

You sit above the median but below the top tier. Your 6.3 compares to a peer average of 5.8. The gap to the top (6.9) is 0.6 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 9.1 (+1.6 above peer avg 7.5)
- Experience: 9.4 (+0.6 above peer avg 8.9)

**Closest competitors:**

- Puddleduck Cafe Ltd (6.9) — leads you by 0.6
- South Costa (6.8) — leads you by 0.5
- Nanas Caff (6.8) — leads you by 0.5
- Building 523 Costa And Kitchen (6.8) — leads you by 0.5
- Dec X Canteen (6.7) — leads you by 0.3
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.4 | — | 8.3 | +1.1 | Above peers |
| Visibility | 3.5 | — | 3.1 | +0.4 | Above peers |
| Trust | 9.1 | — | 7.2 | +1.8 | Clear strength |
...
**Assessment: Strong.** This is a genuine competitive strength at 9.4.
 You lead peers by 1.1 points (peer avg 8.3).
...
**Management note:** At 501 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 9.1.
 You lead peers by 1.8 points (peer avg 7.2).
...
| Inspection Recency | 6.2/10 | ⚠️ Room to improve | Last inspected 2025-09-15 (7 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-09-15 (7 months ago). Full confidence. No action needed. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.9 on trust, +0.2 on overall (6.3 → 6.5).
...
| Google review count | 501 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.5★ (501 reviews) | observed | ✓ |
...
| Last Inspection | 2025-09-15 | FSA | observed |
| Google Rating | 4.5/5 | Google Places API | observed |
| Google Reviews | 501 | Google Places API | observed |
...
| Postcode | CV37 8RB | FSA | observed |
| Companies House | — | Not checked | not_assessed |
