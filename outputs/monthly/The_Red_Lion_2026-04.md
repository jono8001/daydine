# The Red Lion — Monthly Intelligence Report
...
**Competitive position:** Local Peers (5mi): #3 of 9 (P75.0) — peer avg 6.08, top 7.34
  Catchment (15mi): #4 of 19 (P83.3) — peer avg 5.88, top 7.34
  UK Category Cohort: #4 of 19 (P83.3) — peer avg 5.88, top 7.34
...
Based on publicly observable data for The Red Lion, your current operational gaps are putting an estimated **11–33 covers per week** at risk — representing approximately **£1,340–£7,920 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£670–£3,960/mo); Fix the digital shopfront — you're losing walk-ins (£670–£3,960/mo); Protect the 4.7/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).
...
| Aggregate signals | Rating and volume from all platforms | 277 Google (4.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.7 rating across 277 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Red Lion operates as a credible pub dining venue with a 4.7/5 Google rating across 277 reviews — solid but not yet commanding.
...
With 277 reviews at 4.7/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
Online visibility (3.4) hasn't kept pace with guest experience quality (9.7). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
The Red Lion is classified as **Pub / Bar** (confidence: medium). Google's raw category is "Pub / Bar" but the resolved category triangulates across 1 signal sources.
...
- **The Fox Inn** (6.5): Pub Dining with comparable price band; 3.6 miles away
- **The Townhouse Also Trading As JR Hotel And Restaurants LTD** (6.3): Hotel restaurant — different occasion type, may not compete for walk-in trade; 0.3 miles away *(marginal comparator)*
- **Snitterfield Arms** (6.2): Pub Dining with comparable price band; 3.1 miles away
- **The Bell Inn** (5.9): Pub Dining with comparable price band; 3.8 miles away

## Competitive Market Intelligence

**Local market:** 8 direct competitors identified.

Above the median (P75) but not leading. Peer average is 6.1; the top performer scores 7.3. The gap to the top is closeable.

**Where you lead:** Trust (+1.2), Experience (+0.7)
**Where peers beat you:** Visibility (-0.8), Conversion (-0.7)

*Commercial implication: you capture an adequate share of a 9-venue market, but the gap to the top (7.3) represents demand you could win. Closing the gap typically requires 1–2 targeted dimension improvements (indicative).*
...
You sit above the median but below the top tier. Your 6.4 compares to a peer average of 6.1. The gap to the top (7.3) is 0.9 points — closeable with focused improvement on your weakest dimension.
...
- Visibility: 3.4 (-0.8 below peer avg 4.2)

**Closest competitors:**

- Vintner Wine Bar (7.3) — leads you by 0.9
- The Fox Inn (6.5) — leads you by 0.1
- The Townhouse Also Trading As JR Hotel And Restaurants LTD (6.3) — you lead by 0.1
- Snitterfield Arms (6.2) — you lead by 0.2
- The Bell Inn (5.9) — you lead by 0.5
...
**Snitterfield Arms** (signal-backed)
...
**Position:** #4 of 19 (Percentile 83.3)

You are in the top quintile of this peer set. Your overall score of 6.4 exceeds the peer average of 5.9 by 0.5 points. The competitive risk here is complacency — the nearest competitor scores 7.3.

**Dimension gaps vs peers:**

- Trust: 9.2 (+1.3 above peer avg 8.0)
...
- Vintner Wine Bar (7.3) — leads you by 0.9
- Arrow Mill (6.7) — leads you by 0.3
- The Fox Inn (6.5) — leads you by 0.1
- The Townhouse Also Trading As JR Hotel And Restaurants LTD (6.3) — you lead by 0.1
- The Bull's Head (6.3) — you lead by 0.1
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.7 | — | 8.9 | +0.7 | Above peers |
| Visibility | 3.4 | — | 4.2 | -0.8 | Below peers |
| Trust | 9.2 | — | 8.0 | +1.2 | Above peers |
...
**Assessment: Strong.** This is a genuine competitive strength at 9.2.
 You lead peers by 1.2 points (peer avg 8.0).
...
| Inspection Recency | 7.0/10 | ⚠️ Room to improve | Last inspected 2025-11-03 (5 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-11-03 (5 months ago). Full confidence. No action needed. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.8 on trust, +0.2 on overall (6.4 → 6.6).
...
| Google Business Profile | 4.7★ (277 reviews) | observed | ✓ |
...
| Last Inspection | 2025-11-03 | FSA | observed |
...
| Postcode | CV37 6YW | FSA | observed |
| Companies House | — | Not checked | not_assessed |
