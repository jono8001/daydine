...
Based on publicly observable data for Ashorne Hill Management College, your current operational gaps are putting an estimated **7–25 covers per week** at risk — representing approximately **£800–£5,880 per month** in lost or leaked revenue. The main drivers are: Publish opening hours — you're invisible to 'open now' searches (£400–£2,940/mo); Get your menu online — 77% of diners check before visiting (£400–£2,940/mo); Protect the 4.5/5 rating — it took years to build (discovery protection). Taking action on **Publish opening hours — you're invisible to 'open now' searches** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~220–350 | Derived from 489 Google reviews (large venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 489 Google (4.5★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
...
Ashorne Hill Management College operates as a credible other venue with a 4.5/5 Google rating across 489 reviews — solid but not yet commanding.
...
- **Review momentum.** At 489 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: event_venue, service. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: event_venue, service*
...
- **Volume:** 489 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 489 reviews (Moderate) | Visibility 3.5/10 (Weak) |
...
Ashorne Hill Management College is classified as **Event Venue** (confidence: low). Google's raw category is "Other" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | event_venue, service | Primary |

**Resolved category:** Event Venue (confidence: low)

### Peer Justification

- **Lexi's Loving Spoonful** (6.0): Dining with comparable price band; 4.7 miles away
- **Good Breakfast** (5.5): Dining with comparable price band; 1.9 miles away

## Competitive Market Intelligence

**Local market:** 2 direct competitors identified.

You are in the top quintile (P100). The competitive risk is complacency — the nearest competitor scores 6.0.

**Where you lead:** Trust (+1.4), Experience (+1.0), Visibility (+0.5)
...
You are in the top quintile of this peer set. Your overall score of 7.1 exceeds the peer average of 5.8 by 1.3 points. The competitive risk here is complacency — the nearest competitor scores 6.0.

**Dimension gaps vs peers:**

- Trust: 9.3 (+1.4 above peer avg 8.0)
- Experience: 9.4 (+1.0 above peer avg 8.4)
- Visibility: 3.5 (+0.5 above peer avg 3.0)

**Closest competitors:**

- Lexi's Loving Spoonful (6.0) — you lead by 1.1
- Good Breakfast (5.5) — you lead by 1.6
...
- **Defend:** Defend your trust advantage (+1.5) and your 489-review advantage vs their 6 (discovery moat).
- *Based on Google rating/reviews, FSA record, 3 dimension scores*

**Good Breakfast** (signal-backed)

- **Wins on:** No Significant Dimension Lead — Scores Within 0.5 Of Yours Across The Board (see pattern above)
- **Why it matters:** You are closely matched — small improvements on either side shift the balance.
- **Copy / test:** No clear action to copy — maintain current standards.
- **Defend:** Defend your experience lead (+1.7) — drives repeats and word-of-mouth and your trust advantage (+1.2).
...
You are in the top quintile of this peer set. Your overall score of 7.1 exceeds the peer average of 5.8 by 1.3 points. The competitive risk here is complacency — the nearest competitor scores 6.3.
...
- The Pavillion (6.3) — you lead by 0.8
- The Lime Tree Restaurant (6.3) — you lead by 0.8
- Lexi's Loving Spoonful (6.0) — you lead by 1.1
- Stratford Adventure Golf (5.8) — you lead by 1.2
- Good Breakfast (5.5) — you lead by 1.6
...
- Trust: 9.3 (+1.3 above peer avg 8.0)
- Visibility: 3.5 (+0.7 above peer avg 2.8)

**Closest competitors:**

- Digby's Events (7.8) — leads you by 0.8
- The Pavillion (6.3) — you lead by 0.8
- The Lime Tree Restaurant (6.3) — you lead by 0.8
- Lexi's Loving Spoonful (6.0) — you lead by 1.1
- Stratford Adventure Golf (5.8) — you lead by 1.2
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.4 | — | 8.4 | +1.0 | Above peers |
| Visibility | 3.5 | — | 3.0 | +0.5 | Above peers |
| Trust | 9.3 | — | 8.0 | +1.4 | Above peers |
| Conversion | — | — | — | — | No data |
| **Overall** | **7.1** | **—** | | | |
...
**Management note:** At 489 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 9.3.
 You lead peers by 1.4 points (peer avg 8.0).
...
**Biggest drag:** Inspection Recency. Last inspected 2025-11-20 (5 months ago). Full confidence. No action needed. 

**Peer context:** Lexi's Loving Spoonful's trust lead (+1.2) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
| Google review count | 489 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.5★ (489 reviews) | observed | ✓ |
...
| Google Reviews | 489 | Google Places API | observed |
...
| Postcode | CV33 9QW | FSA | observed |
| Companies House | — | Not checked | not_assessed |
