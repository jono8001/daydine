# Shakespaw Cat Cafe — Monthly Intelligence Report
...
**Competitive position:** Local Peers (5mi): #1 of 18 (P100.0) — peer avg 5.43, top 6.35
  Catchment (15mi): #5 of 46 (P91.1) — peer avg 5.71, top 6.78
  UK Category Cohort: #7 of 53 (P88.5) — peer avg 5.77, top 6.92
...
Based on publicly observable data for Shakespaw Cat Cafe, your current operational gaps are putting an estimated **16–50 covers per week** at risk — representing approximately **£1,920–£12,000 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£960–£6,000/mo); Fix the digital shopfront — you're losing walk-ins (£960–£6,000/mo); Protect the 4.6/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~320–500 | Derived from 952 Google reviews (high-traffic venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 952 Google (4.6★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.6 rating across 952 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Shakespaw Cat Cafe is a well-established cafe venue with a strong public reputation — 4.6/5 across 952 Google reviews. That volume means the reputation is earned, not manufactured.
...
Within the local cafe market (17 peers), this venue leads the field. The identity is that of a category leader — the venue others are compared against.
...
With 952 reviews at 4.6/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 952 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: cat_cafe, tea_house. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: cat_cafe, tea_house*
...
- **Volume:** 952 reviews — strong base. Rating is stable but a sustained negative pattern could shift it.
...
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 9.4/10 (Strong) |
| Review Volume | 952 reviews (High) | Visibility 3.8/10 (Weak) |
...
Shakespaw Cat Cafe is classified as **Cat Cafe** (confidence: low). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 3 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | cat_cafe, tea_house | Primary |
| Price Level | ££ (2/4) — Casual dining | Supportive |
| Name | "Shakespaw Cat Cafe" contains "cafe" | Supportive |

**Resolved category:** Cat Cafe (confidence: low)
...
You are in the top quintile (P100). The competitive risk is complacency — the nearest competitor scores 6.3.

**Where you lead:** Trust (+2.3), Experience (+1.3), Conversion (+0.6)
...
**Position:** #1 of 18 (Percentile 100.0)

You are in the top quintile of this peer set. Your overall score of 6.6 exceeds the peer average of 5.4 by 1.2 points. The competitive risk here is complacency — the nearest competitor scores 6.3.

**Dimension gaps vs peers:**

- Trust: 9.4 (+2.3 above peer avg 7.1)
- Experience: 9.5 (+1.3 above peer avg 8.3)
- Conversion: 3.5 (+0.6 above peer avg 2.9)

**Closest competitors:**

- No 37 Cafe (6.3) — you lead by 0.3
- Costa (6.3) — you lead by 0.3
- Espresso Barn (6.3) — you lead by 0.3
- Coffee Clouds (6.0) — you lead by 0.7
- Touchdown Cafe (5.8) — you lead by 0.9
...
**Position:** #5 of 46 (Percentile 91.1)

You are in the top quintile of this peer set. Your overall score of 6.6 exceeds the peer average of 5.7 by 0.9 points. The competitive risk here is complacency — the nearest competitor scores 6.8.

**Dimension gaps vs peers:**

- Trust: 9.4 (+2.0 above peer avg 7.4)
- Experience: 9.5 (+0.8 above peer avg 8.8)
- Conversion: 3.5 (+0.6 above peer avg 2.9)
- Visibility: 3.8 (+0.6 above peer avg 3.2)

**Closest competitors:**

- South Costa (6.8) — leads you by 0.1
- Building 523 Costa And Kitchen (6.8) — leads you by 0.1
- Dec X Canteen (6.7) — leads you by 0.0
- Gilks' Garage Cafe (6.7) — leads you by 0.0
- Nel's At The Pavilion (6.6) — you lead by 0.0

### UK Category Cohort (52 peers in Cafe / Coffee Shop)

**Position:** #7 of 53 (Percentile 88.5)

You are in the top quintile of this peer set. Your overall score of 6.6 exceeds the peer average of 5.8 by 0.9 points. The competitive risk here is complacency — the nearest competitor scores 6.9.

**Dimension gaps vs peers:**

- Trust: 9.4 (+1.9 above peer avg 7.5)
...
- Puddleduck Cafe Ltd (6.9) — leads you by 0.3
- South Costa (6.8) — leads you by 0.1
- Nanas Caff (6.8) — leads you by 0.1
- Building 523 Costa And Kitchen (6.8) — leads you by 0.1
- Dec X Canteen (6.7) — leads you by 0.0
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.5 | — | 8.3 | +1.3 | Above peers |
| Visibility | 3.8 | — | 3.4 | +0.4 | Above peers |
| Trust | 9.4 | — | 7.1 | +2.3 | Clear strength |
...
**Assessment: Strong.** This is a genuine competitive strength at 9.5.
 You lead peers by 1.3 points (peer avg 8.3).
...
**Management note:** At 952 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 9.4.
 You lead peers by 2.3 points (peer avg 7.1).
...
| Inspection Recency | 7.6/10 | ✅ Adequate | Last inspected 2025-12-11 (4 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-12-11 (4 months ago). Full confidence. No action needed. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.6 on trust, +0.1 on overall (6.6 → 6.8).
...
| Google review count | 952 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.6★ (952 reviews) | observed | ✓ |
...
| Last Inspection | 2025-12-11 | FSA | observed |
| Google Rating | 4.6/5 | Google Places API | observed |
| Google Reviews | 952 | Google Places API | observed |
...
| Postcode | CV37 6QT | FSA | observed |
| Companies House | — | Not checked | not_assessed |
