# Loxleys Restaurant And Wine Bar — Monthly Intelligence Report
...
**Overall score: 6.3/10** (baseline month — no prior comparison)
 | Strongest: Trust (9.0) | Weakest: Conversion (3.5)

**Competitive position:** Local Peers (5mi): #4 of 6 (P40.0) — peer avg 6.39, top 6.83
  Catchment (15mi): #4 of 7 (P50.0) — peer avg 6.33, top 6.83
  UK Category Cohort: #4 of 7 (P50.0) — peer avg 6.33, top 6.83
...
Based on publicly observable data for Loxleys Restaurant And Wine Bar, your current operational gaps are putting an estimated **16–50 covers per week** at risk — representing approximately **£1,920–£12,000 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£960–£6,000/mo); Fix the digital shopfront — you're losing walk-ins (£960–£6,000/mo); Protect the 4.7/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~320–500 | Derived from 1,669 Google reviews (high-traffic venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 1,669 Google (4.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.7 rating across 1,669 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Loxleys Restaurant And Wine Bar is a well-established British dining venue with a strong public reputation — 4.7/5 across 1,669 Google reviews. That volume means the reputation is earned, not manufactured.
...
With 1669 reviews at 4.7/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 1669 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: restaurant, wine_bar, british_restaurant, bar. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: restaurant, wine_bar, british_restaurant, bar*
...
- **The 4.7/5 rating feels dominant but isn't.** In this market, peer venues achieve similar ratings. Your percentile position (P40.0) shows the rating is table stakes, not a differentiator.
...
- **Volume:** 1,669 reviews — statistically robust rating. Individual reviews have negligible impact.
...
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 9.0/10 (Strong) |
| Review Volume | 1669 reviews (High) | Visibility 3.9/10 (Weak) |
...
Loxleys Restaurant And Wine Bar is classified as **Restaurant** (confidence: low). Google's raw category is "British Restaurant" but the resolved category triangulates across 3 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | restaurant, wine_bar, british_restaurant, bar | Primary |
| Price Level | ££ (2/4) — Casual dining | Supportive |
| Name | "Loxleys Restaurant And Wine Bar" contains "restaurant" | Supportive |

**Resolved category:** Restaurant (confidence: low)

### Peer Justification

- **Deli Cafe** (6.8): Takeaway-focused — different service model; 0.2 miles away *(weak comparator)*
- **Lambs** (6.5): Dining with similar price band; 0.0 miles away
...
Below the median (P40). Customers have higher-rated alternatives nearby (peer avg 6.4, top 6.8).

**Where peers beat you:** Experience (-0.7), Conversion (-0.6)
...
You are below the median of your peer set. At 6.3 vs peer average 6.4, competitors are outperforming you. The top performer scores 6.8. Customers in this area have demonstrably better-rated alternatives.
...
- Deli Cafe (6.8) — leads you by 0.5
- Lambs (6.5) — leads you by 0.2
- Barnabys (6.4) — leads you by 0.1
- The Kings Head (6.2) — you lead by 0.1
- Prospero Lounge (6.0) — you lead by 0.3
...
- **Wins on:** Conversion (+1.5): more complete operational signals (hours, menu, delivery/takeaway, booking)
...
**Position:** #4 of 7 (Percentile 50.0)

You sit above the median but below the top tier. Your 6.3 compares to a peer average of 6.3. The gap to the top (6.8) is 0.5 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Conversion: 3.5 (-0.5 below peer avg 4.0)
- Experience: 8.6 (-0.5 below peer avg 9.2)
...
- Barnabys (6.4) — leads you by 0.1
- The Kings Head (6.2) — you lead by 0.1
- The George Hotel (6.0) — you lead by 0.3
...
| Visibility | 3.9 | — | 3.8 | +0.2 | Needs work |
| Trust | 9.0 | — | 8.7 | +0.3 | Above peers |
...
**Management note:** At 1669 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 9.0.
 Slightly above peer average (8.7).
...
| Inspection Recency | 9.6/10 | ✅ Strong | Last inspected 2026-03-24 (1 months ago). Full confidence. No action needed.  |
...
Your 4.7/5 Google rating feels dominant but you sit below the local median (P40.0). Peer venues achieve similar or better ratings — in this market, 4.5 is table stakes, not a differentiator. Don't mistake the number for an advantage.
...
### Action 5: Ranked #4 of 6 locally — peers are ahead
...
| Google review count | 1669 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.7★ (1669 reviews) | observed | ✓ |
...
| Last Inspection | 2026-03-24 | FSA | observed |
| Google Rating | 4.7/5 | Google Places API | observed |
| Google Reviews | 1669 | Google Places API | observed |
