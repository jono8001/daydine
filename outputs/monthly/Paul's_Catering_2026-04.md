# Paul's Catering — Monthly Intelligence Report
...
**Overall score: 5.4/10** (baseline month — no prior comparison)
 | Strongest: Experience (10.0) | Weakest: Visibility (0.4)

**Competitive position:** UK Category Cohort: #3 of 3 (P0.0) — peer avg 6.05, top 6.33
...
Based on publicly observable data for Paul's Catering, your current operational gaps are putting an estimated **3–12 covers per week** at risk — representing approximately **£380–£2,880 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£190–£1,440/mo); Build review volume — you lack statistical credibility (discovery protection); Fix the digital shopfront — you're losing walk-ins (£190–£1,440/mo). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~40–80 | Derived from 3 Google reviews (micro venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 3 Google (5★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 5 rating across 3 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Paul's Catering is a food & drink venue with an adequate public reputation (5.0/5, 3 reviews) that has room to build stronger proof.
...
Only 3 Google reviews. A single bad review moves your average visibly. Encourage satisfied customers to leave reviews.
...
- **Review momentum.** At 3 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
GBP profile is only 5/10 complete. Significant gaps: Has photos (>0), Has price level, Review count >= 10, Review count >= 100, Has website.

**Commercial consequence:** Incomplete GBP profile suppresses Google Maps visibility and customer action.

*Signals: GBP completeness: 5/10; Missing: Has photos (>0), Has price level, Review count >= 10, Review count >= 100, Has website*
...
Insufficient review data to cross-reference proposition. Google types show: butcher_shop, food_store, manufacturer, service, store. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: butcher_shop, food_store, manufacturer, service, store*
...
- **Unrealised review authority.** At 3 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** Only 3 reviews — insufficient for reliable assessment. Priority: build review count.
...
| Review Volume | 3 reviews (Low) | Visibility 0.4/10 (Weak) |
...
Paul's Catering is classified as **Butcher Shop** (confidence: low). Google's raw category is "Food & Drink" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | butcher_shop, food_store, manufacturer, service, store | Primary |

**Resolved category:** Butcher Shop (confidence: low)
...
### UK Category Cohort (2 peers in Food & Drink)

**Position:** #3 of 3 (Percentile 0.0)

You are below the median of your peer set. At 5.4 vs peer average 6.0, competitors are outperforming you. The top performer scores 6.3. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Experience: 10.0 (+0.8 above peer avg 9.2)
- Conversion: 2.5 (-0.5 below peer avg 3.0)
- Trust: 7.3 (-0.8 below peer avg 8.2)
- Visibility: 0.4 (-3.3 below peer avg 3.6)

**Closest competitors:**

- The Garden Cafe (6.3) — leads you by 0.9
- Costa (5.8) — leads you by 0.3
...
**Assessment: Critical.** At 0.4, this represents a material operational gap.
...
**Management note:** At 3 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 2.9/10 | ⚠️ Significant drag | Last inspected 2024-10-18 (18 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-10-18 (18 months ago). Score starting to decay. Note it but don't escalate. 
...
| Google review count | 3 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 5.0★ (3 reviews) | observed | ✓ |
