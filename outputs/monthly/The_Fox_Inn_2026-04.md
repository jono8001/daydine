# The Fox Inn — Monthly Intelligence Report
...
**Overall score: 6.5/10** (baseline month — no prior comparison)
 | Strongest: Trust (9.5) | Weakest: Visibility (3.3)

**Competitive position:** Local Peers (5mi): #2 of 7 (P83.3) — peer avg 6.07, top 7.34
  Catchment (15mi): #3 of 19 (P88.9) — peer avg 5.88, top 7.34
  UK Category Cohort: #3 of 19 (P88.9) — peer avg 5.88, top 7.34
...
Based on publicly observable data for The Fox Inn, your current operational gaps are putting an estimated **7–22 covers per week** at risk — representing approximately **£840–£5,280 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£420–£2,640/mo); Fix the digital shopfront — you're losing walk-ins (£420–£2,640/mo); Lean into service & hospitality — it's what guests are buying (upside opportunity). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~140–220 | Derived from 271 Google reviews (mid venue indicator), price level ££ |
| Average spend per head | ~£22 | UK hospitality benchmark for price level ££ |
| Covers at risk per week | 7–22 | Conversion score 3.5/10 → 5%–10% leakage |
| Weekly revenue at risk | £210–£1,320 | Recoverable with priority action fixes |
| Monthly revenue at risk | £840–£5,280 | Aggregate across top 3 priorities |
| Annual projection | £10,080–£63,360 | If current gaps persist 12 months |
...
| Aggregate signals | Rating and volume from all platforms | 271 Google (4.6★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 5 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.6 rating across 271 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Fox Inn operates as a credible pub dining venue with a 4.6/5 Google rating across 271 reviews — solid but not yet commanding.

**From deep analysis of 5 recent reviews:**

Based on a limited sample of 5 reviews (Google's 'most relevant' selection), **service & hospitality** (4 mentions) and **food quality** (2 mentions) are the most frequent themes. Whether these represent settled guest perception or sampling artefact cannot be determined from this evidence base alone.

Within the local pub dining market (6 peers), this venue leads the field. The identity is that of a category leader — the venue others are compared against.
...
**Data basis:** 5 of 5 reviews (100%) contained enough context to identify the guest type. Segments below require ≥2 reviews to surface a pattern.

### Tourists & Visitors (3 reviews)

**What they value:** Food Quality (2x) — *"You can feel the love from the community which flows in to t"*; Atmosphere & Setting (2x) — *"You can feel the love from the community which flows in to t"*; Service & Hospitality (2x) — *"This place is a rare gem"*
...
**What they value:** Service & Hospitality (3x) — *"We had a wonderful Sunday roast at The Fox in Loxley"*; Atmosphere & Setting (2x) — *"You can feel the love from the community which flows in to t"*; Speed & Efficiency (1x) — *"We had a wonderful Sunday roast at The Fox in Loxley"*
...
- **Evidence:** `experience=9.2, conversion=3.5`
...
- **Evidence:** `review_praise: Service & Hospitality=4`
...
- **Review momentum.** At 271 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
> *"We had a wonderful Sunday roast at The Fox in Loxley. We arrived just after 12 and were seated at a table by the firepla..."*
...
> *"Not local to the area, we had asked for recommendations for dining and The Fox lived delightfully up to them. You can fe..."*
...
Google types (pub, bar, restaurant) are broadly consistent with what guests praise (Service & Hospitality, Food Quality).

**Commercial consequence:** No major proposition mismatch detected.

*Signals: Google types: pub, bar, restaurant; Top review themes: Service & Hospitality, Food Quality, Atmosphere & Setting*
...
Online visibility (3.3) hasn't kept pace with guest experience quality (9.2). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
**Confidence: Anecdotal** (5 from Google).
 ...
 Note: Google's API surfaces only its 'most relevant' reviews (max 5 per venue) from 271 total — this sample likely skews toward popular positive reviews.
...
No specific dish mentions detected in current review sample. This may indicate reviews focus on service and atmosphere rather than individual dishes, or that the review volume is too low for dish-level extraction.
...
**Opportunity gap:** Category trend — smash burger: Smash burgers growing strongly on UK pub menus. No guest mentions detected in current reviews. Worth exploring if this aligns with your offering.
...
|--------|-------------|---------------------|
| Customer Rating | 4.6/5 Google (Strong) | Experience 9.2/10 (Strong) — Aligned |
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 9.5/10 (Strong) |
| Review Volume | 271 reviews (Moderate) | Visibility 3.3/10 (Weak) |
...
The Fox Inn is classified as **Pub / Bar** (confidence: high). Google's raw category is "Pub / Bar" but the resolved category triangulates across 4 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | pub, bar, restaurant | Primary |
| Review Language | "pub" (5x), "restaurant" (1x) | Strong |
| Service Model | table service (1x), reservation (1x), named staff (1x) | Supportive |
| Price Level | ££ (2/4) — Casual dining | Supportive |

**Resolved category:** Pub / Bar (confidence: high)

### Peer Justification

- **Vintner Wine Bar** (7.3): Pub Dining with similar price band; 3.6 miles away
- **The Red Lion** (6.4): Pub Dining with comparable price band; 3.6 miles away
- **The Townhouse Also Trading As JR Hotel And Restaurants LTD** (6.3): Hotel restaurant — different occasion type, may not compete for walk-in trade; 3.7 miles away *(marginal comparator)*
- **The Coach House** (5.6): Pub Dining with similar price band; 3.8 miles away
- **The Avon Lounge** (5.5): Pub Dining with comparable price band; 3.8 miles away

## Competitive Market Intelligence

**Local market:** 6 direct competitors identified.

You are in the top quintile (P83). The competitive risk is complacency — the nearest competitor scores 7.3.
...
### Local Competitive Set (6 peers within 5 miles)

**Position:** #2 of 7 (Percentile 83.3)

You are in the top quintile of this peer set. Your overall score of 6.5 exceeds the peer average of 6.1 by 0.4 points. The competitive risk here is complacency — the nearest competitor scores 7.3.

**Dimension gaps vs peers:**

- Trust: 9.5 (+1.6 above peer avg 7.9)
- Visibility: 3.3 (-1.1 below peer avg 4.4)

**Closest competitors:**

- Vintner Wine Bar (7.3) — leads you by 0.9
- The Red Lion (6.4) — you lead by 0.1
- The Townhouse Also Trading As JR Hotel And Restaurants LTD (6.3) — you lead by 0.2
- The Coach House (5.6) — you lead by 0.9
- The Avon Lounge (5.5) — you lead by 0.9
...
- **Defend:** Defend your conversion readiness (+1.0) — you are easier to book/find.
...
**Arrow Mill** (signal-backed)

- **Wins on:** Visibility (+0.7): 1988 Google reviews vs your 271 — they have volume advantage
- **Why it matters:** Their visibility lead means they are easier to find online — this controls top-of-funnel discovery.
- **Copy / test:** Build review volume — they have 1988 to your 271.
- **Defend:** No clear defensive advantage — you are closely matched across dimensions.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

### Extended Catchment (18 peers within 15 miles)

**Position:** #3 of 19 (Percentile 88.9)

You are in the top quintile of this peer set. Your overall score of 6.5 exceeds the peer average of 5.9 by 0.6 points. The competitive risk here is complacency — the nearest competitor scores 7.3.
...
- Vintner Wine Bar (7.3) — leads you by 0.9
- Arrow Mill (6.7) — leads you by 0.2
- The Red Lion (6.4) — you lead by 0.1
- The Townhouse Also Trading As JR Hotel And Restaurants LTD (6.3) — you lead by 0.2
- The Bull's Head (6.3) — you lead by 0.2
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.2 | — | 8.9 | +0.2 | Strong |
| Visibility | 3.3 | — | 4.4 | -1.1 | Below peers |
| Trust | 9.5 | — | 7.9 | +1.6 | Clear strength |
| Conversion | 3.5 | — | 3.1 | +0.4 | Above peers |
| **Overall** | **6.5** | **—** | | | |

*Prestige (editorial recognition): 1.5/10 (peer avg 0.5) — tracked but not a headline operational lever for most independents.*
...
**Assessment: Strong.** This is a genuine competitive strength at 9.2.
 In line with peers (avg 8.9).
...
**Assessment: Critical.** At 3.3, this represents a material operational gap.
 You trail peers by 1.1 points (peer avg 4.4).
...
**Management note:** At 271 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 9.5.
 You lead peers by 1.6 points (peer avg 7.9).
...
**Assessment: Critical.** At 3.5, this represents a material operational gap.
 Slightly above peer average (3.1).
...
| Inspection Recency | 8.7/10 | ✅ Adequate | Last inspected 2026-02-06 (2 months ago). Full confidence. No action needed.  |

**Biggest drag:** Inspection Recency. Last inspected 2026-02-06 (2 months ago). Full confidence. No action needed. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.3 on trust, +0.1 on overall (6.5 → 6.6).
...
| Google review count | 271 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.6★ (271 reviews) | observed | ✓ |
...
| Last Inspection | 2026-02-06 | FSA | observed |
| Google Rating | 4.6/5 | Google Places API | observed |
| Google Reviews | 271 | Google Places API | observed |
...
| Postcode | CV35 9JS | FSA | observed |
| Companies House | — | Not checked | not_assessed |
...
|-------|--------|--------:|
| Service & Hospitality | consistent praise | 4 |
| Food Quality | positive signal, limited evidence | 2 |
| Atmosphere & Setting | positive signal, limited evidence | 2 |
| Speed & Efficiency | positive signal, limited evidence | 1 |
...
**Review 1** | Unknown | Undated | 5★ | positive | Service & Hospitality, Speed & Efficiency
> We had a wonderful Sunday roast at The Fox in Loxley. We arrived just after 12 and were seated at a table by the fireplace. The service was incredible, James, our waiter was friendly, chatty and very efficient. The food was great and it was nice to be able to see the chef serving up the meals at the pass and the smooth transition from the pass to the tables. The atmosphere was bubbly and light and the pub was full by 13.30. Would definitely recommend booking before you go to guarantee a table. We hadn't booked but the staff were incredibly kind and squeezed us in and we are really happy they did! It was honestly one of the best Sunday roasts we had eaten out and really reasonably priced as well. There were the options to have a small or large portion and even the small had plenty on it (I was enjoying it so much I forgot to take a photo.)

Set in the middle of the village you can tell that the pub is popular and the heart of the local community. Would definitely visit again!

**Review 2** | Unknown | Undated | 5★ | positive | Food Quality, Atmosphere & Setting
> Not local to the area, we had asked for recommendations for dining and The Fox lived delightfully up to them. You can feel the love from the community which flows in to the pub. Beautifully decorated with a charming modern food menu. Do excuse the bite out of the cheesecake/lemon meringue photo - it was that delicious, we couldn’t wait! Belinda and Adrian deserve all the success here, with the merge of Belinda’s homely hospitality and Adrian’s flair for elevated pub cuisine - you’re lucky if this is your local. Keep supporting it!

**Review 3** | Unknown | Undated | 5★ | positive | Service & Hospitality, Atmosphere & Setting
> Wow! This place is a rare gem!
From the cosy atmosphere, with locals and tourists alike, to the kind and welcoming staff who are attentive to your needs. In love with the food, hearty fare full of love and care. Portion sizes are generous. So many gluten free options all home made. The pie has a reputation, and doesn't disappoint. Will come back again and can't recommend enough. Thank you chef Gemma and Andy and Sally for a joyful and fulfilling evening.

**Review 4** | Unknown | Undated | 5★ | positive | Food Quality, Service & Hospitality
> Really enjoyed our bank holiday lunch here Portion sizes were so generous we had to take some home but that in no way affected the quality, everything from starter through to desert was absolutely delicious! Staff were attentive and friendly throughout, and there are a couple of cracking pints on draught. I wouldn't hesitate to recommend this great pub to anyone in the area.

**Review 5** | Unknown | Undated | 5★ | positive | Service & Hospitality, Value for Money
> Reasonable amount of parking space. Great welcome and very friendly staff. Good British pub atmosphere. Varied tables and seating either in the main area or quieter off to one side. Good selection of dishes and drinks. Super local food well prepared and presented. Sensible prices and no pressure. A really great place and I hope you enjoy your visit as much as I did.
