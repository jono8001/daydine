# Nanas Caff — Monthly Intelligence Report
...
**Competitive position:** UK Category Cohort: #2 of 53 (P98.1) — peer avg 5.77, top 6.92
...
Nanas Caff operates in the cafe category with a public rating of None/5 that is currently limiting discovery.
...
GBP profile is only 3/10 complete. Significant gaps: Has rating, Has reviews (>0), Has photos (>0), Has price level, Review count >= 10, Review count >= 100, Has website.

**Commercial consequence:** Incomplete GBP profile suppresses Google Maps visibility and customer action.

*Signals: GBP completeness: 3/10; Missing: Has rating, Has reviews (>0), Has photos (>0), Has price level, Review count >= 10, Review count >= 100, Has website*
...
Insufficient review data to cross-reference proposition. Google types show: real_estate_agency, service. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: real_estate_agency, service*
...
Nanas Caff is classified as **Real Estate Agency** (confidence: low). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | real_estate_agency, service | Primary |

**Resolved category:** Real Estate Agency (confidence: low)
...
- Experience: 10.0 (+1.2 above peer avg 8.8)
...
| Inspection Recency | 2.8/10 | ⚠️ Significant drag | Last inspected 2024-09-30 (19 months ago). Meaningful score drag. Consider pr... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-09-30 (19 months ago). Meaningful score drag. Consider proactive action. The system discounts older inspections because they carry less certainty.
...
| Last Inspection | 2024-09-30 | FSA | observed |
...
| Postcode | CV37 9NQ | FSA | observed |
| Companies House | — | Not checked | not_assessed |
