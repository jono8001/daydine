# Greggs PLC — Monthly Intelligence Report
...
**Overall score: 5.9/10** (baseline month — no prior comparison)
 | Strongest: Trust (9.2) | Weakest: Visibility (2.8)

**Competitive position:** Catchment (15mi): #3 of 3 (P0.0) — peer avg 6.09, top 6.1
  UK Category Cohort: #3 of 3 (P0.0) — peer avg 6.09, top 6.1
...
Based on publicly observable data for Greggs PLC, your current operational gaps are putting an estimated **5–18 covers per week** at risk — representing approximately **£420–£3,240 per month** in lost or leaked revenue. The main drivers are: Identify and fix the recurring guest complaint (£100–£1,080/mo); Get your menu online — 77% of diners check before visiting (£160–£1,080/mo); Fix the digital shopfront — you're losing walk-ins (£160–£1,080/mo). Taking action on **Identify and fix the recurring guest complaint** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~100–180 | Derived from 58 Google reviews (small venue indicator), price level £ |
...
| Weekly revenue at risk | £100–£810 | Recoverable with priority action fixes |
| Monthly revenue at risk | £420–£3,240 | Aggregate across top 3 priorities |
| Annual projection | £5,040–£38,880 | If current gaps persist 12 months |
...
| Aggregate signals | Rating and volume from all platforms | 58 Google (3.6★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 3.6 rating across 58 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Greggs PLC operates in the bakery category with a public rating of 3.6/5 that is currently limiting discovery.
...
At 3.6/5 on Google, something specific is landing badly. Read the 5 most recent negative reviews, identify the common thread, and fix it at source. The rating won't move until the root cause does.
...
- **Evidence:** `gr=3.6`
  ...
  **Commercial consequence** (directional):
  Value at stake: £100–£1,080/month | Cost to fix: Medium (1–2 days or < £200) | Payback: 1–3 months
...
- **Evidence:** `experience=8.37, conversion=3.5`
...
- **Review momentum.** At 58 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: bakery, food_store, store. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: bakery, food_store, store*
...
**Discovery suppression.** A 3.6/5 Google rating actively prevents customers from finding you. Google deprioritises sub-4.0 venues, and most customers filter by 4+ stars. Until this lifts, all other investment underperforms because fewer people see it.

### Secondary Drag

Online visibility (2.8) hasn't kept pace with guest experience quality (8.4). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** Only 58 reviews — rating is volatile. A single 1-star review moves the average measurably.
- **Rating position:** 3.6/5 is below the threshold where most customers filter. You're losing discovery.
...
|--------|-------------|---------------------|
| Customer Rating | 3.6/5 Google (Weak) | Experience 8.4/10 (Strong) — Gap |
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 9.2/10 (Strong) |
| Review Volume | 58 reviews (Low) | Visibility 2.8/10 (Weak) |
...
Greggs PLC is classified as **Bakery** (confidence: low). Google's raw category is "Bakery / Desserts" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | bakery, food_store, store | Primary |
| Price Level | £ (1/4) — Budget | Supportive |

**Resolved category:** Bakery (confidence: low)
...
You are below the median of your peer set. At 5.9 vs peer average 6.1, competitors are outperforming you. The top performer scores 6.1. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Trust: 9.2 (+1.1 above peer avg 8.1)
- Conversion: 3.5 (+1.0 above peer avg 2.5)
- Visibility: 2.8 (-0.6 below peer avg 3.4)
- Experience: 8.4 (-1.2 below peer avg 9.5)

**Closest competitors:**

- Mor (6.1) — leads you by 0.2
- International Circus Churros 2 (6.1) — leads you by 0.2
...
**Assessment: Critical.** At 2.8, this represents a material operational gap.
...
**Management note:** At 58 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 6.9/10 | ⚠️ Room to improve | Last inspected 2025-10-30 (5 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-10-30 (5 months ago). Full confidence. No action needed. 
...
|-----------|---------|---------------------|--------|
| Google star rating | 3.6/5 | Drop below 3.6 = experience drift; rise = guest improvements landing | Google Maps |
| Google review count | 58 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 3.6★ (58 reviews) | observed | ✓ |
...
| Last Inspection | 2025-10-30 | FSA | observed |
| Google Rating | 3.6/5 | Google Places API | observed |
| Google Reviews | 58 | Google Places API | observed |
