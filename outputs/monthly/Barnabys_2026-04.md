# Barnabys — Monthly Intelligence Report
...
**Overall score: 6.4/10** (baseline month — no prior comparison)
 | Strongest: Trust (8.9) | Weakest: Visibility (3.8)

**Competitive position:** Local Peers (5mi): #3 of 6 (P60.0) — peer avg 6.37, top 6.83
  Catchment (15mi): #3 of 7 (P66.7) — peer avg 6.32, top 6.83
  UK Category Cohort: #3 of 7 (P66.7) — peer avg 6.32, top 6.83
...
Based on publicly observable data for Barnabys, your current operational gaps are putting an estimated **6–25 covers per week** at risk — representing approximately **£760–£6,000 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£380–£3,000/mo); Fix the digital shopfront — you're losing walk-ins (£380–£3,000/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).
...
| Covers at risk per week | 6–25 | Conversion score 5.0/10 → 2%–5% leakage |
| Weekly revenue at risk | £190–£1,500 | Recoverable with priority action fixes |
| Monthly revenue at risk | £760–£6,000 | Aggregate across top 3 priorities |
| Annual projection | £9,120–£72,000 | If current gaps persist 12 months |
...
Barnabys operates as a credible British dining venue with a 4.0/5 Google rating across 1179 reviews — solid but not yet commanding.
...
- **Evidence:** `experience=8.83, conversion=5.0`
...
Insufficient review data to cross-reference proposition. Google types show: fast_food_restaurant, fish_and_chips_restaurant, meal_takeaway, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: fast_food_restaurant, fish_and_chips_restaurant, meal_takeaway, restaurant*
...
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 8.9/10 (Strong) |
...
Barnabys is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "British Restaurant" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | fast_food_restaurant, fish_and_chips_restaurant, meal_takeaway, restaurant | Primary |
...
Above the median (P60) but not leading. Peer average is 6.4; the top performer scores 6.8. The gap to the top is closeable.

**Where you lead:** Conversion (+1.2)

*Commercial implication: you capture an adequate share of a 6-venue market, but the gap to the top (6.8) represents demand you could win. Closing the gap typically requires 1–2 targeted dimension improvements (indicative).*
...
**Position:** #3 of 6 (Percentile 60.0)

You sit above the median but below the top tier. Your 6.4 compares to a peer average of 6.4. The gap to the top (6.8) is 0.4 points — closeable with focused improvement on your weakest dimension.
...
- Deli Cafe (6.8) — leads you by 0.4
- Lambs (6.5) — leads you by 0.1
- Loxleys Restaurant And Wine Bar (6.3) — you lead by 0.1
- The Kings Head (6.2) — you lead by 0.2
- Prospero Lounge (6.0) — you lead by 0.4
...
- **Copy / test:** Read their recent positive reviews (4.6/5) for operational clues. Review inspection documentation and sub-score gaps.
...
You sit above the median but below the top tier. Your 6.4 compares to a peer average of 6.3. The gap to the top (6.8) is 0.4 points — closeable with focused improvement on your weakest dimension.
...
- Loxleys Restaurant And Wine Bar (6.3) — you lead by 0.1
- The Kings Head (6.2) — you lead by 0.2
- The George Hotel (6.0) — you lead by 0.4
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.8 | — | 9.2 | -0.4 | Below peers |
| Visibility | 3.8 | — | 3.8 | +0.0 | Needs work |
| Trust | 8.9 | — | 8.7 | +0.2 | Strong |
| Conversion | 5.0 | — | 3.8 | +1.2 | Above peers |
| **Overall** | **6.4** | **—** | | | |
...
**Assessment: Weak.** At 5.0, this dimension is actively limiting your overall position.
 You lead peers by 1.2 points (peer avg 3.8).
...
| Inspection Recency | 9.2/10 | ✅ Strong | Last inspected 2026-03-04 (1 months ago). Full confidence. No action needed.  |
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.2 on trust, +0.1 on overall (6.4 → 6.5).
...
| Last Inspection | 2026-03-04 | FSA | observed |
