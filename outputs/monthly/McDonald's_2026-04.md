# McDonald's — Monthly Intelligence Report
...
**Watch this month:**
- Ranked #4 of 6 locally — peers are ahead
...
**Competitive position:** Local Peers (5mi): #4 of 6 (P40.0) — peer avg 5.9, top 6.52
  Catchment (15mi): #6 of 9 (P37.5) — peer avg 5.86, top 6.52
  UK Category Cohort: #6 of 9 (P37.5) — peer avg 5.86, top 6.52
...
Based on publicly observable data for McDonald's, your current operational gaps are putting an estimated **21–65 covers per week** at risk — representing approximately **£1,740–£11,700 per month** in lost or leaked revenue. The main drivers are: Identify and fix the recurring guest complaint (£400–£3,900/mo); Get your menu online — 77% of diners check before visiting (£670–£3,900/mo); Fix the digital shopfront — you're losing walk-ins (£670–£3,900/mo). Taking action on **Identify and fix the recurring guest complaint** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~420–650 | Derived from 1,562 Google reviews (high-traffic venue indicator), price level £ |
...
| Weekly revenue at risk | £440–£2,920 | Recoverable with priority action fixes |
| Monthly revenue at risk | £1,740–£11,700 | Aggregate across top 3 priorities |
| Annual projection | £20,880–£140,400 | If current gaps persist 12 months |
...
| Aggregate signals | Rating and volume from all platforms | 1,562 Google (3.8★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 3.8 rating across 1,562 Google reviews is the reputation bedrock and is factored into scoring separately.
...
McDonald's operates in the american / grill category with a public rating of 3.8/5 that is currently limiting discovery.
...
At 3.8/5 on Google, something specific is landing badly. Read the 5 most recent negative reviews, identify the common thread, and fix it at source. The rating won't move until the root cause does.
...
- **Evidence:** `gr=3.8`
  ...
  **Commercial consequence** (directional):
  Value at stake: £400–£3,900/month | Cost to fix: Medium (1–2 days or < £200) | Payback: 1–3 months
...
- **Evidence:** `experience=8.6, conversion=3.5`
...
- **Review momentum.** At 1562 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: fast_food_restaurant, chicken_restaurant, breakfast_restaurant, hamburger_restaurant, diner, american_restaurant, restaurant, service. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: fast_food_restaurant, chicken_restaurant, breakfast_restaurant, hamburger_restaurant, diner, american_restaurant, restaurant, service*
...
**Discovery suppression.** A 3.8/5 Google rating actively prevents customers from finding you. Google deprioritises sub-4.0 venues, and most customers filter by 4+ stars. Until this lifts, all other investment underperforms because fewer people see it.

### Secondary Drag

Online visibility (3.9) hasn't kept pace with guest experience quality (8.6). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 1,562 reviews — statistically robust rating. Individual reviews have negligible impact.
- **Rating position:** 3.8/5 is below the threshold where most customers filter. You're losing discovery.
...
|--------|-------------|---------------------|
| Customer Rating | 3.8/5 Google (Weak) | Experience 8.6/10 (Strong) — Gap |
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 7.6/10 (Adequate) |
| Review Volume | 1562 reviews (High) | Visibility 3.9/10 (Weak) |
...
McDonald's is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "American / Grill" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | fast_food_restaurant, chicken_restaurant, breakfast_restaurant, hamburger_restaurant, diner, american_restaurant, restaurant, service | Primary |
...
- **The Crofts Cafe Also Trading As New York Pizzas** (6.5): Dining with comparable price band; 0.4 miles away
- **Beleza Rodizio** (6.2): Dining with comparable price band; 0.1 miles away
- **McDonald's** (6.0): Dining with similar price band; 0.5 miles away
- **WINGERS STRATFORD** (5.5): Dining with comparable price band; 0.8 miles away
- **Libertine Burger** (5.4): Dining with comparable price band; 0.2 miles away

## Competitive Market Intelligence

**Local market:** 5 direct competitors identified.

Below the median (P40). Customers have higher-rated alternatives nearby (peer avg 5.9, top 6.5).

**Where you lead:** Conversion (+0.8), Visibility (+0.5)
...
**Position:** #4 of 6 (Percentile 40.0)

You are below the median of your peer set. At 5.8 vs peer average 5.9, competitors are outperforming you. The top performer scores 6.5. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Conversion: 3.5 (+0.8 above peer avg 2.8)
- Visibility: 3.9 (+0.5 above peer avg 3.4)

**Closest competitors:**

- The Crofts Cafe Also Trading As New York Pizzas (6.5) — leads you by 0.7
- Beleza Rodizio (6.2) — leads you by 0.4
- McDonald's (6.0) — leads you by 0.2
- WINGERS STRATFORD (5.5) — you lead by 0.3
- Libertine Burger (5.4) — you lead by 0.4
...
**Beleza Rodizio** (signal-backed)

- **Wins on:** Experience (+1.3): Google 4.9/5 vs your 3.8/5
- **Why it matters:** Their experience lead means guests rate their visit higher — this drives reviews, repeats, and word-of-mouth.
- **Copy / test:** Read their recent positive reviews (4.9/5) for operational clues.
...
- **Why it matters:** A large trust gap (+1.9) — their compliance record is stronger — this creates a ceiling you hit and they don't. This is a structural disadvantage, not a rounding error.
...
- **Defend:** Defend your experience lead (+1.6) — drives repeats and word-of-mouth.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*
...
- Trust: 7.6 (-0.5 below peer avg 8.2)

**Closest competitors:**

- The Crofts Cafe Also Trading As New York Pizzas (6.5) — leads you by 0.7
- Miller And Carter (6.3) — leads you by 0.5
- Beleza Rodizio (6.2) — leads you by 0.4
- McDonald's (6.0) — leads you by 0.2
- KFC - Southbound (5.8) — leads you by 0.0
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.6 | — | 8.5 | +0.1 | Strong |
| Visibility | 3.9 | — | 3.4 | +0.5 | Above peers |
| Trust | 7.6 | — | 8.0 | -0.3 | Below peers |
| Conversion | 3.5 | — | 2.8 | +0.8 | Above peers |
| **Overall** | **5.8** | **—** | | | |
...
**Management note:** At 1562 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 2.0/10 | ⚠️ Significant drag | Last inspected 2024-05-03 (24 months ago). Meaningful score drag. Consider pr... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-05-03 (24 months ago). Meaningful score drag. Consider proactive action. The system discounts older inspections because they carry less certainty.

**Peer context:** The Crofts Cafe Also Trading As New York Pizzas's trust lead (+1.9) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +2.0 on trust, +0.5 on overall (5.8 → 6.3).
...
**Ranked #4 of 6 locally — peers are ahead** [ESCALATED]

At percentile 40.0, customers in this area have higher-rated alternatives. This isn't a crisis but it means you're competing on convenience rather than reputation.
...
### Action 4: Ranked #4 of 6 locally — peers are ahead
...
|-----------|---------|---------------------|--------|
| Google star rating | 3.8/5 | Drop below 3.8 = experience drift; rise = guest improvements landing | Google Maps |
| Google review count | 1562 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 3.8★ (1562 reviews) | observed | ✓ |
...
| Last Inspection | 2024-05-03 | FSA | observed |
| Google Rating | 3.8/5 | Google Places API | observed |
| Google Reviews | 1562 | Google Places API | observed |
