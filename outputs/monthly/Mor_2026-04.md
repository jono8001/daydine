# Mor — Monthly Intelligence Report
...
**Competitive position:** Local Peers (5mi): #1 of 2 (P100.0) — peer avg 6.08, top 6.08
  Catchment (15mi): #1 of 3 (P100.0) — peer avg 6.0, top 6.08
  UK Category Cohort: #1 of 3 (P100.0) — peer avg 6.0, top 6.08
...
Based on publicly observable data for Mor, your current operational gaps are putting an estimated **11–33 covers per week** at risk — representing approximately **£1,340–£7,920 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£670–£3,960/mo); Fix the digital shopfront — you're losing walk-ins (£670–£3,960/mo); Protect the 4.6/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).
...
| Aggregate signals | Rating and volume from all platforms | 275 Google (4.6★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.6 rating across 275 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Mor operates as a credible bakery venue with a 4.6/5 Google rating across 275 reviews — solid but not yet commanding.
...
Within the local bakery market (1 peers), this venue leads the field. The identity is that of a category leader — the venue others are compared against.
...
With 275 reviews at 4.6/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
Mor is classified as **Bakery** (confidence: low). Google's raw category is "Bakery / Desserts" but the resolved category triangulates across 1 signal sources.
...
- **International Circus Churros 2** (6.1): Dining with comparable price band; 1.8 miles away
...
|---|---|---|---|
| International Circus Churros 2 | 6.1 | 4.6★ | 441 |
...
You are in the top quintile of this peer set. Your overall score of 6.1 exceeds the peer average of 6.1 by 0.0 points. The competitive risk here is complacency — the nearest competitor scores 6.1.

**Closest competitors:**

- International Circus Churros 2 (6.1) — you lead by 0.0

### Competitor Strategy

**International Circus Churros 2** (signal-backed)
...
- **Wins on:** Trust (+1.1): same FSA rating but likely stronger sub-scores or more recent inspection; Conversion (+1.0): more complete operational signals (hours, menu, delivery/takeaway, booking)
...
- **Defend:** Defend your experience lead (+1.2) — drives repeats and word-of-mouth and your 275-review advantage vs their 58 (discovery moat).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*
...
You are in the top quintile of this peer set. Your overall score of 6.1 exceeds the peer average of 6.0 by 0.1 points. The competitive risk here is complacency — the nearest competitor scores 6.1.
...
| Inspection Recency | 4.7/10 | ⚠️ Significant drag | Last inspected 2025-05-19 (11 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-05-19 (11 months ago). Full confidence. No action needed. 
...
| Google Business Profile | 4.6★ (275 reviews) | observed | ✓ |
...
| Last Inspection | 2025-05-19 | FSA | observed |
