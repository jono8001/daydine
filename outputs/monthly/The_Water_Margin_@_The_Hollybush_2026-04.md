...
Based on publicly observable data for The Water Margin @ The Hollybush, your current operational gaps are putting an estimated **3–30 covers per week** at risk — representing approximately **£360–£7,700 per month** in lost or leaked revenue. The main drivers are: Close the hygiene gap — 4 to 5 (£0–£500/mo (defensive)); Get your menu online — 77% of diners check before visiting (£180–£3,600/mo); Fix the digital shopfront — you're losing walk-ins (£180–£3,600/mo). Taking action on **Close the hygiene gap — 4 to 5** could begin recovering this within weeks at low cost (< £200).
