# Crowne Plaza — Monthly Intelligence Report
...
**Overall score: 6.5/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.2) | Weakest: Visibility (4.0)

**Competitive position:** Local Peers (5mi): #4 of 9 (P62.5) — peer avg 5.97, top 6.78
  Catchment (15mi): #6 of 15 (P64.3) — peer avg 6.05, top 6.78
  UK Category Cohort: #6 of 17 (P68.8) — peer avg 6.0, top 6.78
...
Based on publicly observable data for Crowne Plaza, your current operational gaps are putting an estimated **10–35 covers per week** at risk — representing approximately **£1,160–£8,400 per month** in lost or leaked revenue. The main drivers are: Publish opening hours — you're invisible to 'open now' searches (£580–£4,200/mo); Get your menu online — 77% of diners check before visiting (£580–£4,200/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Publish opening hours — you're invisible to 'open now' searches** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~320–500 | Derived from 3,165 Google reviews (high-traffic venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 3,165 Google (4.3★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.3 rating across 3,165 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Crowne Plaza operates as a credible hotel dining venue with a 4.3/5 Google rating across 3165 reviews — solid but not yet commanding.
...
- **Review momentum.** At 3165 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: hotel, lodging, wedding_venue, event_venue, service. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: hotel, lodging, wedding_venue, event_venue, service*
...
- **Volume:** 3,165 reviews — statistically robust rating. Individual reviews have negligible impact.
...
| Review Volume | 3165 reviews (High) | Visibility 4.0/10 (Weak) |

## Category & Peer Validation

### Why This Venue Is In This Cohort

Crowne Plaza is classified as **Hotel** (confidence: low). Google's raw category is "Hotel / Accommodation" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | hotel, lodging, wedding_venue, event_venue, service | Primary |

**Resolved category:** Hotel (confidence: low)

### Peer Justification

- **Premier Inn** (6.8): Hotel restaurant — different occasion type, may not compete for walk-in trade; 0.2 miles away *(marginal comparator)*
- **Hotel Indigo And The Woodsman** (6.6): Hotel restaurant — different occasion type, may not compete for walk-in trade; 0.4 miles away *(marginal comparator)*
...
- **Premier Inn** (6.4): Hotel restaurant — different occasion type, may not compete for walk-in trade; 1.0 miles away *(marginal comparator)*
- **Stratford Manor Hotel** (6.2): Hotel restaurant — different occasion type, may not compete for walk-in trade; 2.8 miles away *(marginal comparator)*

## Competitive Market Intelligence

**Local market:** 8 direct competitors identified.

Above the median (P62) but not leading. Peer average is 6.0; the top performer scores 6.8. The gap to the top is closeable.
...
- Hotel Indigo And The Woodsman (6.6) — leads you by 0.1
- Alveston Manor Hotel (6.5) — leads you by 0.0
...
**Position:** #6 of 15 (Percentile 64.3)
...
- Premier Inn (6.8) — leads you by 0.3
- Ragley Hall Catering (6.8) — leads you by 0.3
...
**Management note:** At 3165 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Peer context:** Premier Inn's trust lead (+1.8) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.8 on trust, +0.5 on overall (6.5 → 6.9).
...
| Google review count | 3165 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.3★ (3165 reviews) | observed | ✓ |
...
| Google Reviews | 3165 | Google Places API | observed |
...
| Postcode | CV37 6YR | FSA | observed |
| Companies House | — | Not checked | not_assessed |
