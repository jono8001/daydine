# Lounge@26 — Monthly Intelligence Report
...
**Competitive position:** Local Peers (5mi): #1 of 6 (P100.0) — peer avg 5.14, top 6.07
  Catchment (15mi): #8 of 34 (P78.8) — peer avg 5.55, top 6.64
  UK Category Cohort: #16 of 53 (P71.2) — peer avg 5.78, top 6.92
...
Based on publicly observable data for Lounge@26, your current operational gaps are putting an estimated **9–29 covers per week** at risk — representing approximately **£580–£3,480 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£290–£1,740/mo); Fix the digital shopfront — you're losing walk-ins (£290–£1,740/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~180–290 | Derived from 198 Google reviews (mid venue indicator), price level £ |
...
| Aggregate signals | Rating and volume from all platforms | 198 Google (4.5★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.5 rating across 198 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Lounge@26 operates as a credible cafe venue with a 4.5/5 Google rating across 198 reviews — solid but not yet commanding.
...
- **Review momentum.** At 198 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: coffee_shop, cafe, tea_house, food_store, store. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: coffee_shop, cafe, tea_house, food_store, store*
...
- **Unrealised review authority.** At 198 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** 198 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 198 reviews (Moderate) | Visibility 3.2/10 (Weak) |
...
Lounge@26 is classified as **Cafe / Coffee Shop** (confidence: high). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | coffee_shop, cafe, tea_house, food_store, store | Primary |
...
- **Chapter 23** (6.1): Dining with comparable price band; 0.0 miles away
- **Costa Coffee** (6.0): Dining with comparable price band; 0.7 miles away
- **George's Cafe** (5.8): Dining with similar price band; 2.9 miles away
- **Coughton Court Cafe** (3.9): Dining with comparable price band; 2.1 miles away
- **Karen's Korner** (3.9): Dining with similar price band; 3.3 miles away
...
**Where you lead:** Trust (+2.6), Conversion (+1.1), Visibility (+0.7)
...
You are in the top quintile of this peer set. Your overall score of 6.2 exceeds the peer average of 5.1 by 1.0 points. The competitive risk here is complacency — the nearest competitor scores 6.1.

**Dimension gaps vs peers:**

- Trust: 8.1 (+2.6 above peer avg 5.5)
- Conversion: 3.5 (+1.1 above peer avg 2.4)
- Visibility: 3.2 (+0.7 above peer avg 2.6)

**Closest competitors:**

- Chapter 23 (6.1) — you lead by 0.1
- Costa Coffee (6.0) — you lead by 0.1
- George's Cafe (5.8) — you lead by 0.4
- Coughton Court Cafe (3.9) — you lead by 2.3
- Karen's Korner (3.9) — you lead by 2.3
...
- **Also wins on:** Experience (+0.6): Google 5.0/5 vs your 4.5/5
...
- **Copy / test:** Review inspection documentation and sub-score gaps. Read their recent positive reviews (5.0/5) for operational clues.
- **Defend:** Defend your 198-review advantage vs their 9 (discovery moat) and your conversion readiness (+1.0) — you are easier to book/find.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

**Shakespaw Cat Cafe** (signal-backed)

- **Also wins on:** Visibility (+0.5): 952 Google reviews vs your 198 — they have volume advantage
...
- **Copy / test:** Review inspection documentation and sub-score gaps. Build review volume — they have 952 to your 198.
- **Defend:** No clear defensive advantage — you are closely matched across dimensions.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

### Extended Catchment (33 peers within 15 miles)

**Position:** #8 of 34 (Percentile 78.8)

You sit above the median but below the top tier. Your 6.2 compares to a peer average of 5.5. The gap to the top (6.6) is 0.5 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 8.1 (+0.9 above peer avg 7.2)
...
- No 37 Cafe (6.3) — leads you by 0.2
- Costa (6.3) — leads you by 0.2
- Espresso Barn (6.3) — leads you by 0.1

### UK Category Cohort (52 peers in Cafe / Coffee Shop)

**Position:** #16 of 53 (Percentile 71.2)
...
- Trust: 8.1 (+0.6 above peer avg 7.5)
- Conversion: 3.5 (+0.6 above peer avg 2.9)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.4 | — | 9.0 | +0.4 | Above peers |
| Visibility | 3.2 | — | 2.6 | +0.7 | Above peers |
| Trust | 8.1 | — | 5.5 | +2.6 | Clear strength |
| Conversion | 3.5 | — | 2.4 | +1.1 | Above peers |
| **Overall** | **6.2** | **—** | | | |
...
**Management note:** At 198 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 8.1.
 You lead peers by 2.6 points (peer avg 5.5).
...
**Assessment: Critical.** At 3.5, this represents a material operational gap.
 You lead peers by 1.1 points (peer avg 2.4).
...
| Inspection Recency | 2.5/10 | ⚠️ Significant drag | Last inspected 2024-08-19 (20 months ago). Meaningful score drag. Consider pr... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-08-19 (20 months ago). Meaningful score drag. Consider proactive action. The system discounts older inspections because they carry less certainty.
...
| Google review count | 198 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.5★ (198 reviews) | observed | ✓ |
...
| Last Inspection | 2024-08-19 | FSA | observed |
| Google Rating | 4.5/5 | Google Places API | observed |
| Google Reviews | 198 | Google Places API | observed |
