# The Phoenix — Monthly Intelligence Report
...
**Competitive position:** Local Peers (5mi): #1 of 10 (P100.0) — peer avg 5.69, top 6.15
  Catchment (15mi): #1 of 12 (P100.0) — peer avg 5.76, top 6.15
  UK Category Cohort: #1 of 13 (P100.0) — peer avg 5.77, top 6.15
...
Based on publicly observable data for The Phoenix, your current operational gaps are putting an estimated **3–11 covers per week** at risk — representing approximately **£340–£2,640 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£170–£1,320/mo); Fix the digital shopfront — you're losing walk-ins (£170–£1,320/mo); Protect the 4.7/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~140–220 | Derived from 272 Google reviews (mid venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 272 Google (4.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.7 rating across 272 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Phoenix operates as a credible Italian dining venue with a 4.7/5 Google rating across 272 reviews — solid but not yet commanding.
...
- **Evidence:** `experience=9.65, conversion=5.0`
...
With 272 reviews at 4.7/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 272 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: bar, pizza_restaurant, meal_takeaway, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: bar, pizza_restaurant, meal_takeaway, restaurant*
...
- **Volume:** 272 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 272 reviews (Moderate) | Visibility 3.3/10 (Weak) |
...
The Phoenix is classified as **Bar** (confidence: low). Google's raw category is "Italian Restaurant" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | bar, pizza_restaurant, meal_takeaway, restaurant | Primary |
| Price Level | ££ (2/4) — Casual dining | Supportive |

**Resolved category:** Bar (confidence: low)
...
- **Impasto Micro-Pizzeria** (5.8): Dining with comparable price band; 0.0 miles away
...
**Where you lead:** Conversion (+2.3), Experience (+0.9)
...
**Position:** #1 of 10 (Percentile 100.0)

You are in the top quintile of this peer set. Your overall score of 6.4 exceeds the peer average of 5.7 by 0.7 points. The competitive risk here is complacency — the nearest competitor scores 6.2.

**Dimension gaps vs peers:**

- Conversion: 5.0 (+2.3 above peer avg 2.7)
- Experience: 9.7 (+0.9 above peer avg 8.8)

**Closest competitors:**

- Soma (6.2) — you lead by 0.3
- Carluccio's (6.1) — you lead by 0.4
- Pizza Hut Restaurants - Dine In (6.0) — you lead by 0.4
- Impasto Micro-Pizzeria (5.8) — you lead by 0.6
- Corte Campana (5.7) — you lead by 0.7

### Competitor Strategy

**Soma** (signal-backed)

- **Wins on:** Trust (+0.7): same FSA rating but likely stronger sub-scores or more recent inspection
...
- **Defend:** Defend your conversion readiness (+2.5) — you are easier to book/find.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

**The Still House Café** (signal-backed)
...
**Position:** #1 of 12 (Percentile 100.0)

You are in the top quintile of this peer set. Your overall score of 6.4 exceeds the peer average of 5.8 by 0.7 points. The competitive risk here is complacency — the nearest competitor scores 6.2.

**Dimension gaps vs peers:**

- Conversion: 5.0 (+2.2 above peer avg 2.8)
- Experience: 9.7 (+0.7 above peer avg 8.9)

**Closest competitors:**

- Soma (6.2) — you lead by 0.3
- The Still House Café (6.1) — you lead by 0.3
- Bumbles (6.1) — you lead by 0.3
- Carluccio's (6.1) — you lead by 0.4
- Pizza Hut Restaurants - Dine In (6.0) — you lead by 0.4

### UK Category Cohort (12 peers in Italian Restaurant)

**Position:** #1 of 13 (Percentile 100.0)

You are in the top quintile of this peer set. Your overall score of 6.4 exceeds the peer average of 5.8 by 0.6 points. The competitive risk here is complacency — the nearest competitor scores 6.2.
...
| Visibility | 3.3 | — | 3.5 | -0.1 | Needs work |
| Trust | 7.8 | — | 7.4 | +0.3 | Above peers |
| Conversion | 5.0 | — | 2.7 | +2.3 | Clear strength |
| **Overall** | **6.4** | **—** | | | |
...
**Management note:** At 272 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Weak.** At 5.0, this dimension is actively limiting your overall position.
 You lead peers by 2.3 points (peer avg 2.7).
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.7 on trust, +0.4 on overall (6.4 → 6.8).
...
| Google review count | 272 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.7★ (272 reviews) | observed | ✓ |
...
| Google Reviews | 272 | Google Places API | observed |
