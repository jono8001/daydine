# Shipston Bengal Cuisine — Monthly Intelligence Report
...
**Overall score: 3.7/10** (baseline month — no prior comparison)
 | Strongest: Experience (8.4) | Weakest: Trust (0.0)

**Competitive position:** Catchment (15mi): #12 of 12 (P0.0) — peer avg 5.88, top 6.59
  UK Category Cohort: #17 of 17 (P0.0) — peer avg 5.74, top 6.59
...
| Aggregate signals | Rating and volume from all platforms | 127 Google (4.2★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 1 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.2 rating across 127 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Shipston Bengal Cuisine operates as a credible Indian dining venue with a 4.2/5 Google rating across 127 reviews — solid but not yet commanding.
...
- **Evidence:** `experience=8.4, conversion=3.5`
...
Online visibility (3.1) hasn't kept pace with guest experience quality (8.4). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
|--------|-------------|---------------------|
| Customer Rating | 4.2/5 Google (Good) | Experience 8.4/10 (Strong) — Gap |
...
Shipston Bengal Cuisine is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Indian Restaurant" but the resolved category triangulates across 2 signal sources.
...
You are below the median of your peer set. At 3.7 vs peer average 5.9, competitors are outperforming you. The top performer scores 6.6. Customers in this area have demonstrably better-rated alternatives.
...
- Simla Takeaway (6.6) — leads you by 2.9
- Cardamom (6.6) — leads you by 2.9
- Avon Spice (6.4) — leads you by 2.8
- Shah's (6.3) — leads you by 2.6
- Hussains (6.2) — leads you by 2.5

### UK Category Cohort (16 peers in Indian Restaurant)

**Position:** #17 of 17 (Percentile 0.0)

You are below the median of your peer set. At 3.7 vs peer average 5.7, competitors are outperforming you. The top performer scores 6.6. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Trust: 0.0 (-7.5 below peer avg 7.5)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.4 | — | — | — | Strong |
| Visibility | 3.1 | — | — | — | Needs work |
| Trust | 0.0 | — | — | — | Needs work |
...
| Google Business Profile | 4.2★ (127 reviews) | observed | ✓ |
