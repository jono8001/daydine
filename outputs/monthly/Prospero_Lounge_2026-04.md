# Prospero Lounge — Monthly Intelligence Report
...
- Ranked #6 of 6 locally — peers are ahead

**Do not prioritise:** Don't chase prestige before fixing fundamentals

**Overall score: 6.0/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.3) | Weakest: Conversion (3.5)

**Competitive position:** Local Peers (5mi): #6 of 6 (P0.0) — peer avg 6.45, top 6.83
  Catchment (15mi): #7 of 7 (P0.0) — peer avg 6.38, top 6.83
  UK Category Cohort: #7 of 7 (P0.0) — peer avg 6.38, top 6.83
...
Based on publicly observable data for Prospero Lounge, your current operational gaps are putting an estimated **11–35 covers per week** at risk — representing approximately **£1,320–£8,400 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£660–£4,200/mo); Fix the digital shopfront — you're losing walk-ins (£660–£4,200/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~220–350 | Derived from 711 Google reviews (large venue indicator), price level ££ |
...
| Weekly revenue at risk | £330–£2,100 | Recoverable with priority action fixes |
| Monthly revenue at risk | £1,320–£8,400 | Aggregate across top 3 priorities |
| Annual projection | £15,840–£100,800 | If current gaps persist 12 months |
...
| Aggregate signals | Rating and volume from all platforms | 711 Google (4.4★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.4 rating across 711 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Prospero Lounge operates as a credible British dining venue with a 4.4/5 Google rating across 711 reviews — solid but not yet commanding.
...
- **Evidence:** `experience=9.3, conversion=3.5`
...
- **Review momentum.** At 711 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: restaurant, family_restaurant, breakfast_restaurant, vegan_restaurant, vegetarian_restaurant, cafe, british_restaurant, bar. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: restaurant, family_restaurant, breakfast_restaurant, vegan_restaurant, vegetarian_restaurant, cafe, british_restaurant, bar*
...
Online visibility (3.7) hasn't kept pace with guest experience quality (9.3). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 711 reviews — strong base. Rating is stable but a sustained negative pattern could shift it.
...
| Review Volume | 711 reviews (High) | Visibility 3.7/10 (Weak) |
...
Prospero Lounge is classified as **Cafe / Coffee Shop** (confidence: high). Google's raw category is "British Restaurant" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | restaurant, family_restaurant, breakfast_restaurant, vegan_restaurant, vegetarian_restaurant, cafe, british_restaurant, bar | Primary |
...
- **Lambs** (6.5): Dining with similar price band; 0.1 miles away
- **Barnabys** (6.4): Takeaway-focused — different service model; 0.1 miles away *(weak comparator)*
- **Loxleys Restaurant And Wine Bar** (6.3): Pub Dining with similar price band; 0.1 miles away
...
Below the median (P0). Customers have higher-rated alternatives nearby (peer avg 6.5, top 6.8).

**Where peers beat you:** Trust (-1.0), Conversion (-0.6)
...
|---|---|---|---|
| Deli Cafe | 6.8 | 4.6★ | 510 |
| Lambs | 6.5 | 4.7★ | 1,372 |
| Barnabys | 6.4 | 4.0★ | 1,179 |
| Loxleys Restaurant And Wine Bar | 6.3 | 4.7★ | 1,669 |
| The Kings Head | 6.2 | 4.3★ | 1,952 |
...
You are below the median of your peer set. At 6.0 vs peer average 6.5, competitors are outperforming you. The top performer scores 6.8. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Conversion: 3.5 (-0.6 below peer avg 4.1)
- Trust: 7.9 (-1.0 below peer avg 8.9)

**Closest competitors:**

- Deli Cafe (6.8) — leads you by 0.8
- Lambs (6.5) — leads you by 0.5
- Barnabys (6.4) — leads you by 0.4
- Loxleys Restaurant And Wine Bar (6.3) — leads you by 0.3
- The Kings Head (6.2) — leads you by 0.2
...
- **Wins on:** Conversion (+1.5): more complete operational signals (hours, menu, delivery/takeaway, booking); Trust (+1.0): same FSA rating but likely stronger sub-scores or more recent inspection
...
**Position:** #7 of 7 (Percentile 0.0)

You are below the median of your peer set. At 6.0 vs peer average 6.4, competitors are outperforming you. The top performer scores 6.8. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Conversion: 3.5 (-0.5 below peer avg 4.0)
- Trust: 7.9 (-0.9 below peer avg 8.8)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.3 | — | 9.2 | +0.1 | Strong |
| Visibility | 3.7 | — | 3.8 | -0.2 | Needs work |
| Trust | 7.9 | — | 8.9 | -1.0 | Below peers |
...
**Management note:** At 711 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Adequate.** At 7.9, this is functional but not distinctive.
 You trail peers by 1.0 points (peer avg 8.9).
...
| Inspection Recency | 3.0/10 | ⚠️ Significant drag | Last inspected 2024-11-07 (17 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-11-07 (17 months ago). Score starting to decay. Note it but don't escalate. 

**Peer context:** Deli Cafe's trust lead (+1.6) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.7 on trust, +0.4 on overall (6.0 → 6.5).
...
You trail peers by 1.0 points on trust. This isn't a label problem — it means customers are getting a measurably better experience on this dimension from your competitors.

**Ranked #6 of 6 locally — peers are ahead** [ESCALATED]
...
### Action 5: Ranked #6 of 6 locally — peers are ahead
**Status:** Stale (5 months) | **Priority:** Medium
...
| Google review count | 711 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.4★ (711 reviews) | observed | ✓ |
...
| Last Inspection | 2024-11-07 | FSA | observed |
| Google Rating | 4.4/5 | Google Places API | observed |
| Google Reviews | 711 | Google Places API | observed |
...
| Postcode | CV37 6AD | FSA | observed |
| Companies House | — | Not checked | not_assessed |
