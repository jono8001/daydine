# Ettington Garden Cafe — Monthly Intelligence Report
...
**Competitive position:** Local Peers (5mi): #2 of 5 (P75.0) — peer avg 5.86, top 6.66
  Catchment (15mi): #16 of 49 (P68.8) — peer avg 5.75, top 6.92
  UK Category Cohort: #17 of 53 (P69.2) — peer avg 5.78, top 6.92
...
| Aggregate signals | Rating and volume from all platforms | 73 Google (4.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.7 rating across 73 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Ettington Garden Cafe is a cafe venue with an adequate public reputation (4.7/5, 73 reviews) that has room to build stronger proof.
...
Online visibility (2.9) hasn't kept pace with guest experience quality (9.7). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
Ettington Garden Cafe is classified as **Cafe / Coffee Shop** (confidence: high). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 2 signal sources.
...
| Name | "Ettington Garden Cafe" contains "cafe" | Supportive |

**Resolved category:** Cafe / Coffee Shop (confidence: high)

### Peer Justification

- **Gilks' Garage Cafe** (6.7): Dining with comparable price band; 4.6 miles away
- **Touchdown Cafe** (5.8): Dining with comparable price band; 4.1 miles away
- **Costa Coffee** (5.6): Dining with comparable price band; 4.8 miles away
- **The Garden Shed Cafe** (5.5): Dining with comparable price band; 4.1 miles away

## Competitive Market Intelligence

**Local market:** 4 direct competitors identified.

Above the median (P75) but not leading. Peer average is 5.9; the top performer scores 6.7. The gap to the top is closeable.

**Where you lead:** Trust (+0.9), Experience (+0.8)
**Where peers beat you:** Conversion (-1.0)
...
| The Garden Shed Cafe | 5.5 | 4.6★ | 494 |
...
You sit above the median but below the top tier. Your 6.2 compares to a peer average of 5.9. The gap to the top (6.7) is 0.5 points — closeable with focused improvement on your weakest dimension.
...
- Touchdown Cafe (5.8) — you lead by 0.4
- Costa Coffee (5.6) — you lead by 0.6
- The Garden Shed Cafe (5.5) — you lead by 0.7

### Competitor Strategy

**Gilks' Garage Cafe** (signal-backed)

- **Wins on:** Conversion (+1.0): more complete operational signals (hours, menu, delivery/takeaway, booking); Visibility (+0.8): 935 Google reviews vs your 73 — they have volume advantage
...
- **Copy / test:** Audit your Google profile vs theirs: hours, menu, booking, delivery. Build review volume — they have 935 to your 73.
...
- **Wins on:** Visibility (+0.7): 600 Google reviews vs your 73 — they have volume advantage
- **Why it matters:** Their visibility lead means they are easier to find online — this controls top-of-funnel discovery.
- **Copy / test:** Build review volume — they have 600 to your 73.
...
**Position:** #16 of 49 (Percentile 68.8)
...
**Position:** #17 of 53 (Percentile 69.2)
...
| Visibility | 2.9 | — | 3.1 | -0.2 | Needs work |
...
| Inspection Recency | 4.8/10 | ⚠️ Significant drag | Last inspected 2025-05-20 (11 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-05-20 (11 months ago). Full confidence. No action needed. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.3 on trust, +0.3 on overall (6.2 → 6.5).
...
| Google Business Profile | 4.7★ (73 reviews) | observed | ✓ |
...
| Last Inspection | 2025-05-20 | FSA | observed |
...
| Postcode | CV37 7TB | FSA | observed |
| Companies House | — | Not checked | not_assessed |
