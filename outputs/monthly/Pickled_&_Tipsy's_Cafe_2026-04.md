# Pickled & Tipsy's Cafe — Monthly Intelligence Report
...
**Overall score: 6.2/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.7) | Weakest: Visibility (2.5)

**Competitive position:** Local Peers (5mi): #2 of 4 (P66.7) — peer avg 6.06, top 6.51
  Catchment (15mi): #2 of 5 (P75.0) — peer avg 5.84, top 6.51
  UK Category Cohort: #2 of 6 (P80.0) — peer avg 5.86, top 6.51
...
Based on publicly observable data for Pickled & Tipsy's Cafe, your current operational gaps are putting an estimated **2–8 covers per week** at risk — representing approximately **£240–£1,920 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£120–£960/mo); Fix the digital shopfront — you're losing walk-ins (£120–£960/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~40–80 | Derived from 23 Google reviews (micro venue indicator), price level ££ |
| Average spend per head | ~£22 | UK hospitality benchmark for price level ££ |
| Covers at risk per week | 2–8 | Conversion score 4.0/10 → 5%–10% leakage |
| Weekly revenue at risk | £60–£480 | Recoverable with priority action fixes |
| Monthly revenue at risk | £240–£1,920 | Aggregate across top 3 priorities |
| Annual projection | £2,880–£23,040 | If current gaps persist 12 months |
...
| Aggregate signals | Rating and volume from all platforms | 23 Google (4.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.7 rating across 23 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Pickled & Tipsy's Cafe is a takeaway venue with an adequate public reputation (4.7/5, 23 reviews) that has room to build stronger proof.
...
- **Evidence:** `experience=9.65, conversion=4.0`
...
- **Review momentum.** At 23 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
*Conversion dimension score: 4.0/10 — this audit explains what is behind that number.*
...
Insufficient review data to cross-reference proposition. Google types show: cafe, breakfast_restaurant, coffee_shop, meal_takeaway, food_store, store, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: cafe, breakfast_restaurant, coffee_shop, meal_takeaway, food_store, store, restaurant*
...
Online visibility (2.5) hasn't kept pace with guest experience quality (9.7). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Unrealised review authority.** At 23 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** Only 23 reviews — rating is volatile. A single 1-star review moves the average measurably.
...
| Review Volume | 23 reviews (Low) | Visibility 2.5/10 (Weak) |
| Booking/Ordering | What customers can find | Conversion 4.0/10 (Gaps) |
...
Pickled & Tipsy's Cafe is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Takeaway" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | cafe, breakfast_restaurant, coffee_shop, meal_takeaway, food_store, store, restaurant | Primary |
| Name | "Pickled & Tipsy's Cafe" contains "cafe" | Supportive |

**Resolved category:** Restaurant (General) (confidence: medium)

### Peer Justification

- **The Pickled Crab Deli** (6.5): Takeaway-focused — different service model; 0.1 miles away *(weak comparator)*
- **The Bishops Fryer** (6.1): Takeaway-focused — different service model; 3.1 miles away *(weak comparator)*
- **The Margin** (5.5): Takeaway-focused — different service model; 2.5 miles away *(weak comparator)*

## Competitive Market Intelligence

**Local market:** 3 direct competitors identified.

Above the median (P67) but not leading. Peer average is 6.1; the top performer scores 6.5. The gap to the top is closeable.

**Where you lead:** Experience (+0.7)
**Where peers beat you:** Conversion (-0.7)

*Commercial implication: you capture an adequate share of a 4-venue market, but the gap to the top (6.5) represents demand you could win. Closing the gap typically requires 1–2 targeted dimension improvements (indicative).*

### Competitive Position

| Competitor | Score | Google Rating | Reviews |
|---|---|---|---|
| The Pickled Crab Deli | 6.5 | 4.6★ | 188 |
| The Bishops Fryer | 6.1 | 4.3★ | 253 |
| The Margin | 5.5 | 4.3★ | 73 |
...
**Position:** #2 of 4 (Percentile 66.7)

You sit above the median but below the top tier. Your 6.2 compares to a peer average of 6.1. The gap to the top (6.5) is 0.3 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Experience: 9.7 (+0.7 above peer avg 8.9)
- Conversion: 4.0 (-0.7 below peer avg 4.7)

**Closest competitors:**

- The Pickled Crab Deli (6.5) — leads you by 0.3
- The Bishops Fryer (6.1) — you lead by 0.1
- The Margin (5.5) — you lead by 0.7
...
**The Pickled Crab Deli** (signal-backed)

- **Also wins on:** Visibility (+0.7): 188 Google reviews vs your 23 — they have volume advantage
...
- **Copy / test:** Audit your Google profile vs theirs: hours, menu, booking, delivery. Build review volume — they have 188 to your 23.
...
**The Bishops Fryer** (signal-backed)
...
### Extended Catchment (4 peers within 15 miles)

**Position:** #2 of 5 (Percentile 75.0)

You sit above the median but below the top tier. Your 6.2 compares to a peer average of 5.8. The gap to the top (6.5) is 0.3 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Experience: 9.7 (+0.9 above peer avg 8.8)
- Trust: 8.3 (+0.7 above peer avg 7.6)
- Conversion: 4.0 (-0.5 below peer avg 4.5)
...
- The Bishops Fryer (6.1) — you lead by 0.1
- The Margin (5.5) — you lead by 0.7
- The Water Margin @ The Hollybush (5.2) — you lead by 1.1

### UK Category Cohort (5 peers in Takeaway)

**Position:** #2 of 6 (Percentile 80.0)

You are in the top quintile of this peer set. Your overall score of 6.2 exceeds the peer average of 5.9 by 0.4 points. The competitive risk here is complacency — the nearest competitor scores 6.5.

**Dimension gaps vs peers:**

- Experience: 9.7 (+0.7 above peer avg 9.0)
- Trust: 8.3 (+0.6 above peer avg 7.7)

**Closest competitors:**

- The Pickled Crab Deli (6.5) — leads you by 0.3
- The Bishops Fryer (6.1) — you lead by 0.1
- Chrissie's Kitchen (5.9) — you lead by 0.3
- The Margin (5.5) — you lead by 0.7
- The Water Margin @ The Hollybush (5.2) — you lead by 1.1
...
| Visibility | 2.5 | — | 3.0 | -0.5 | Below peers |
| Trust | 8.3 | — | 8.1 | +0.2 | Strong |
| Conversion | 4.0 | — | 4.7 | -0.7 | Below peers |
| **Overall** | **6.2** | **—** | | | |
...
**Management note:** At 23 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Weak.** At 4.0, this dimension is actively limiting your overall position.
 Slightly below peer average (4.7).
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.3 on trust, +0.3 on overall (6.2 → 6.6).
...
| Google review count | 23 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.7★ (23 reviews) | observed | ✓ |
...
| Google Reviews | 23 | Google Places API | observed |
...
| Category | Takeaway | google_types | derived |
| Postcode | CV47 1PH | FSA | observed |
| Companies House | — | Not checked | not_assessed |
