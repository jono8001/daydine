# The Keys — Monthly Intelligence Report
...
**Overall score: 5.2/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.1) | Weakest: Conversion (1.0)

**Competitive position:** Local Peers (5mi): #9 of 9 (P0.0) — peer avg 6.23, top 7.34
  Catchment (15mi): #17 of 19 (P11.1) — peer avg 5.95, top 7.34
  UK Category Cohort: #17 of 19 (P11.1) — peer avg 5.95, top 7.34
...
Based on publicly observable data for The Keys, your current operational gaps are putting an estimated **11–33 covers per week** at risk — representing approximately **£670–£4,960 per month** in lost or leaked revenue. The main drivers are: Publish opening hours — you're invisible to 'open now' searches (£670–£3,960/mo); Close the hygiene gap — 4 to 5 (£0–£500/mo (defensive)); Renew formal trust proof before it becomes a visible drag (£0–£500/mo (defensive)). Taking action on **Publish opening hours — you're invisible to 'open now' searches** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~140–220 | Derived from 387 Google reviews (mid venue indicator), price level ££ |
| Average spend per head | ~£22 | UK hospitality benchmark for price level ££ |
| Covers at risk per week | 11–33 | Conversion score 1.0/10 → 8%–15% leakage |
| Weekly revenue at risk | £170–£1,240 | Recoverable with priority action fixes |
| Monthly revenue at risk | £670–£4,960 | Aggregate across top 3 priorities |
| Annual projection | £8,040–£59,520 | If current gaps persist 12 months |
...
| Aggregate signals | Rating and volume from all platforms | 387 Google (4.2★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.2 rating across 387 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Keys operates as a credible pub dining venue with a 4.2/5 Google rating across 387 reviews — solid but not yet commanding.
...
- **Review momentum.** At 387 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Online visibility (3.5) hasn't kept pace with guest experience quality (9.1). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 387 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
|--------|-------------|---------------------|
| Customer Rating | 4.2/5 Google (Good) | Experience 9.1/10 (Strong) — Gap |
| Hygiene Rating | FSA 4/5 (Acceptable) | Trust 6.4/10 (Adequate) |
| Review Volume | 387 reviews (Moderate) | Visibility 3.5/10 (Weak) |
...
The Keys is classified as **Pub / Bar** (confidence: medium). Google's raw category is "Pub / Bar" but the resolved category triangulates across 2 signal sources.
...
- **Vintner Wine Bar** (7.3): Pub Dining with similar price band; 0.1 miles away
- **The Fox Inn** (6.5): Pub Dining with similar price band; 3.8 miles away
- **The Red Lion** (6.4): Pub Dining with comparable price band; 0.3 miles away
...
Below the median (P0). Customers have higher-rated alternatives nearby (peer avg 6.2, top 7.3).

**Where peers beat you:** Conversion (-2.4), Trust (-2.0), Visibility (-0.7)
...
You are below the median of your peer set. At 5.2 vs peer average 6.2, competitors are outperforming you. The top performer scores 7.3. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Visibility: 3.5 (-0.7 below peer avg 4.2)
- Trust: 6.4 (-2.0 below peer avg 8.4)
- Conversion: 1.0 (-2.4 below peer avg 3.4)

**Closest competitors:**

- Vintner Wine Bar (7.3) — leads you by 2.2
- The Fox Inn (6.5) — leads you by 1.3
- The Red Lion (6.4) — leads you by 1.2
- The Townhouse Also Trading As JR Hotel And Restaurants LTD (6.3) — leads you by 1.2
- Snitterfield Arms (6.2) — leads you by 1.0
...
- **Wins on:** Visibility (+6.3): 887 Google reviews vs your 387 — they have volume advantage; Conversion (+4.5): more complete operational signals (hours, menu, delivery/takeaway, booking)
...
- **Copy / test:** Build review volume — they have 887 to your 387. Audit your Google profile vs theirs: hours, menu, booking, delivery.
...
**Position:** #17 of 19 (Percentile 11.1)

You are below the median of your peer set. At 5.2 vs peer average 6.0, competitors are outperforming you. The top performer scores 7.3. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Trust: 6.4 (-1.7 below peer avg 8.1)
- Conversion: 1.0 (-2.4 below peer avg 3.4)

**Closest competitors:**

- Vintner Wine Bar (7.3) — leads you by 2.2
- Arrow Mill (6.7) — leads you by 1.6
- The Fox Inn (6.5) — leads you by 1.3
- The Red Lion (6.4) — leads you by 1.2
- The Townhouse Also Trading As JR Hotel And Restaurants LTD (6.3) — leads you by 1.2
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.1 | — | 9.0 | +0.1 | Strong |
| Visibility | 3.5 | — | 4.2 | -0.7 | Below peers |
| Trust | 6.4 | — | 8.4 | -2.0 | Significant gap |
| Conversion | 1.0 | — | 3.4 | -2.4 | Significant gap |
| **Overall** | **5.2** | **—** | | | |

*Prestige (editorial recognition): 0.0/10 (peer avg 0.9) — tracked but not a headline operational lever for most independents.*
...
**Assessment: Strong.** This is a genuine competitive strength at 9.1.
 In line with peers (avg 9.0).
...
**Assessment: Critical.** At 3.5, this represents a material operational gap.
 Slightly below peer average (4.2).
...
**Management note:** At 387 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Adequate.** At 6.4, this is functional but not distinctive.
...
**Assessment: Critical.** At 1.0, this represents a material operational gap.
 You trail peers by 2.4 points (peer avg 3.4).
...
| Inspection Recency | 1.7/10 | ⚠️ Significant drag | Last inspected 2024-02-22 (26 months ago). Maximum decay applied. Reinspectio... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-02-22 (26 months ago). Maximum decay applied. Reinspection strongly recommended. The system discounts older inspections because they carry less certainty.

**Peer context:** Vintner Wine Bar's trust lead (+3.1) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
| Google review count | 387 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.2★ (387 reviews) | observed | ✓ |
...
| Last Inspection | 2024-02-22 | FSA | observed |
| Google Rating | 4.2/5 | Google Places API | observed |
| Google Reviews | 387 | Google Places API | observed |
