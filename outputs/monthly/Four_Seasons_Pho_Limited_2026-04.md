# Four Seasons Pho Limited — Monthly Intelligence Report
...
**Overall score: 5.2/10** (baseline month — no prior comparison)
 | Strongest: Experience (8.1) | Weakest: Conversion (2.5)

**Competitive position:** Catchment (15mi): #1 of 2 (P100.0) — peer avg 4.82, top 4.82
  UK Category Cohort: #1 of 2 (P100.0) — peer avg 4.82, top 4.82
...
Based on publicly observable data for Four Seasons Pho Limited, your current operational gaps are putting an estimated **11–33 covers per week** at risk — representing approximately **£1,340–£8,420 per month** in lost or leaked revenue. The main drivers are: Renew formal trust proof before it becomes a visible drag (£0–£500/mo (defensive)); Get your menu online — 77% of diners check before visiting (£670–£3,960/mo); Fix the digital shopfront — you're losing walk-ins (£670–£3,960/mo). Taking action on **Renew formal trust proof before it becomes a visible drag** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~140–220 | Derived from 167 Google reviews (mid venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 167 Google (4.3★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.3 rating across 167 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Four Seasons Pho Limited operates as a credible asian restaurant venue with a 4.3/5 Google rating across 167 reviews — solid but not yet commanding.
...
- **Evidence:** `experience=8.14, conversion=2.5`
...
- **Review momentum.** At 167 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: vietnamese_restaurant, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: vietnamese_restaurant, restaurant*
...
- **Unrealised review authority.** At 167 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** 167 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 167 reviews (Moderate) | Visibility 3.2/10 (Weak) |
...
Four Seasons Pho Limited is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Asian Restaurant" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | vietnamese_restaurant, restaurant | Primary |
...
You are in the top quintile of this peer set. Your overall score of 5.2 exceeds the peer average of 4.8 by 0.4 points. The competitive risk here is complacency — the nearest competitor scores 4.8.

**Dimension gaps vs peers:**

- Experience: 8.1 (+1.5 above peer avg 6.6)
- Visibility: 3.2 (+0.8 above peer avg 2.4)
- Trust: 7.1 (-0.9 below peer avg 7.9)

**Closest competitors:**

- Chopstix South (4.8) — you lead by 0.4
...
**Management note:** At 167 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Google review count | 167 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.3★ (167 reviews) | observed | ✓ |
...
| Google Reviews | 167 | Google Places API | observed |
...
| Category | Asian Restaurant | google_types | derived |
