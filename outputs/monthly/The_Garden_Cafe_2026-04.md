# The Garden Cafe — Monthly Intelligence Report
...
**Competitive position:** Catchment (15mi): #1 of 2 (P100.0) — peer avg 5.77, top 5.77
  UK Category Cohort: #1 of 3 (P100.0) — peer avg 5.6, top 5.77
...
Based on publicly observable data for The Garden Cafe, your current operational gaps are putting an estimated **26–75 covers per week** at risk — representing approximately **£3,080–£18,000 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£1,540–£9,000/mo); Fix the digital shopfront — you're losing walk-ins (£1,540–£9,000/mo); Protect the 4.6/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~320–500 | Derived from 1,191 Google reviews (high-traffic venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 1,191 Google (4.6★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.6 rating across 1,191 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Garden Cafe is a well-established food & drink venue with a strong public reputation — 4.6/5 across 1,191 Google reviews. That volume means the reputation is earned, not manufactured.
...
With 1191 reviews at 4.6/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 1191 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: food_store, store. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: food_store, store*
...
- **Volume:** 1,191 reviews — statistically robust rating. Individual reviews have negligible impact.
...
| Review Volume | 1191 reviews (High) | Visibility 3.8/10 (Weak) |
...
The Garden Cafe is classified as **Food Store** (confidence: low). Google's raw category is "Food & Drink" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | food_store, store | Primary |
| Name | "The Garden Cafe" contains "cafe" | Supportive |

**Resolved category:** Food Store (confidence: low)
...
You are in the top quintile of this peer set. Your overall score of 6.3 exceeds the peer average of 5.8 by 0.6 points. The competitive risk here is complacency — the nearest competitor scores 5.8.

**Dimension gaps vs peers:**

- Trust: 8.7 (+1.1 above peer avg 7.6)
- Experience: 9.5 (+0.7 above peer avg 8.8)
- Conversion: 2.5 (-1.0 below peer avg 3.5)

**Closest competitors:**

- Costa (5.8) — you lead by 0.6
...
- Visibility: 3.8 (+1.9 above peer avg 1.9)
- Trust: 8.7 (+1.3 above peer avg 7.5)
- Conversion: 2.5 (-0.5 below peer avg 3.0)

**Closest competitors:**

- Costa (5.8) — you lead by 0.6
- Paul's Catering (5.4) — you lead by 0.9
...
**Management note:** At 1191 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 8.4/10 | ✅ Adequate | Last inspected 2026-01-26 (2 months ago). Full confidence. No action needed.  |
...
| Google review count | 1191 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.6★ (1191 reviews) | observed | ✓ |
...
| Last Inspection | 2026-01-26 | FSA | observed |
| Google Rating | 4.6/5 | Google Places API | observed |
| Google Reviews | 1191 | Google Places API | observed |
