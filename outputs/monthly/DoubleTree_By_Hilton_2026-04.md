# DoubleTree By Hilton — Monthly Intelligence Report
...
**Overall score: 5.9/10** (baseline month — no prior comparison)
 | Strongest: Experience (8.1) | Weakest: Visibility (3.9)

**Competitive position:** UK Category Cohort: #13 of 17 (P25.0) — peer avg 6.04, top 6.78
...
Based on publicly observable data for DoubleTree By Hilton, your current operational gaps are putting an estimated **10–35 covers per week** at risk — representing approximately **£1,160–£8,400 per month** in lost or leaked revenue. The main drivers are: Publish opening hours — you're invisible to 'open now' searches (£580–£4,200/mo); Get your menu online — 77% of diners check before visiting (£580–£4,200/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Publish opening hours — you're invisible to 'open now' searches** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~320–500 | Derived from 1,314 Google reviews (high-traffic venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 1,314 Google (4.3★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.3 rating across 1,314 Google reviews is the reputation bedrock and is factored into scoring separately.
...
DoubleTree By Hilton operates as a credible hotel dining venue with a 4.3/5 Google rating across 1314 reviews — solid but not yet commanding.
...
- **Review momentum.** At 1314 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: hotel, business_center, lodging, event_venue, service. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: hotel, business_center, lodging, event_venue, service*
...
- **Volume:** 1,314 reviews — statistically robust rating. Individual reviews have negligible impact.
...
| Review Volume | 1314 reviews (High) | Visibility 3.9/10 (Weak) |

## Category & Peer Validation

### Why This Venue Is In This Cohort

DoubleTree By Hilton is classified as **Hotel** (confidence: low). Google's raw category is "Hotel / Accommodation" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | hotel, business_center, lodging, event_venue, service | Primary |
...
You are below the median of your peer set. At 5.9 vs peer average 6.0, competitors are outperforming you. The top performer scores 6.8. Customers in this area have demonstrably better-rated alternatives.

**Closest competitors:**

- Premier Inn (6.8) — leads you by 0.8
- Ragley Hall Catering (6.8) — leads you by 0.8
- Studley Castle (6.7) — leads you by 0.7
- Hotel Indigo And The Woodsman (6.6) — leads you by 0.6
- Alveston Manor Hotel (6.5) — leads you by 0.6
...
**Management note:** At 1314 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 2.8/10 | ⚠️ Significant drag | Last inspected 2024-10-03 (18 months ago). Meaningful score drag. Consider pr... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-10-03 (18 months ago). Meaningful score drag. Consider proactive action. The system discounts older inspections because they carry less certainty.
...
| Google review count | 1314 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.3★ (1314 reviews) | observed | ✓ |
...
| Last Inspection | 2024-10-03 | FSA | observed |
| Google Rating | 4.3/5 | Google Places API | observed |
| Google Reviews | 1314 | Google Places API | observed |
...
| Postcode | CV37 6QQ | FSA | observed |
| Companies House | — | Not checked | not_assessed |
