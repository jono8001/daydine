# Lily's — Monthly Intelligence Report
...
**Competitive position:** Local Peers (5mi): #6 of 8 (P28.6) — peer avg 5.8, top 6.91
  Catchment (15mi): #9 of 14 (P38.5) — peer avg 5.68, top 6.91
  UK Category Cohort: #10 of 15 (P35.7) — peer avg 5.74, top 6.91
...
| Aggregate signals | Rating and volume from all platforms | 116 Google (4.8★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.8 rating across 116 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Lily's operates as a credible restaurant venue with a 4.8/5 Google rating across 116 reviews — solid but not yet commanding.
...
- **Review momentum.** At 116 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
- **The 4.8/5 rating feels dominant but isn't.** In this market, peer venues achieve similar ratings. Your percentile position (P28.6) shows the rating is table stakes, not a differentiator.
...
- **Unrealised review authority.** At 116 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** 116 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 116 reviews (Moderate) | Visibility 3.1/10 (Weak) |
...
Lily's is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Restaurant (General)" but the resolved category triangulates across 1 signal sources.
...
- **Bannatyne Health Club And Spa Wildmoor** (5.8): Dining with comparable price band; 1.8 miles away
- **Fast Flavour** (5.8): Dining with comparable price band; 0.2 miles away
- **NO4 Bar And Restaurant** (5.7): Dining with comparable price band; 0.4 miles away

## Competitive Market Intelligence

**Local market:** 7 direct competitors identified.

Below the median (P29). Customers have higher-rated alternatives nearby (peer avg 5.8, top 6.9).
...
- Trust: 7.4 (-0.7 below peer avg 8.1)

**Closest competitors:**

- 11/17 Salt Beef Bar (6.9) — leads you by 1.3
- Red Hot Mamma Pizzeria (6.3) — leads you by 0.7
- Bannatyne Health Club And Spa Wildmoor (5.8) — leads you by 0.2
- Fast Flavour (5.8) — leads you by 0.2
- NO4 Bar And Restaurant (5.7) — leads you by 0.1
...
- **Also wins on:** Visibility (+0.5): 530 Google reviews vs your 116 — they have volume advantage
...
- **Copy / test:** Review inspection documentation and sub-score gaps. Build review volume — they have 530 to your 116.
...
**Position:** #9 of 14 (Percentile 38.5)

You are below the median of your peer set. At 5.6 vs peer average 5.7, competitors are outperforming you. The top performer scores 6.9. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Trust: 7.4 (-0.6 below peer avg 8.0)

**Closest competitors:**

- 11/17 Salt Beef Bar (6.9) — leads you by 1.3
- Lithos Restaurant (6.5) — leads you by 0.9
- The Bluebell (6.4) — leads you by 0.8
- Red Hot Mamma Pizzeria (6.3) — leads you by 0.7
- The Bridge (6.0) — leads you by 0.4
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.7 | — | 8.7 | +0.0 | Strong |
| Visibility | 3.1 | — | 3.1 | -0.0 | Needs work |
| Trust | 7.4 | — | 8.1 | -0.7 | Below peers |
...
**Management note:** At 116 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Peer context:** 11/17 Salt Beef Bar's trust lead (+1.4) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.8 on trust, +0.4 on overall (5.6 → 6.0).
...
Your 4.8/5 Google rating feels dominant but you sit below the local median (P28.6). Peer venues achieve similar or better ratings — in this market, 4.5 is table stakes, not a differentiator. Don't mistake the number for an advantage.
...
### Action 5: Ranked #6 of 8 locally — peers are ahead
**Status:** Stale (5 months) | **Priority:** Medium
...
| Google review count | 116 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.8★ (116 reviews) | observed | ✓ |
...
| Google Reviews | 116 | Google Places API | observed |
...
| Postcode | CV37 6LU | FSA | observed |
| Companies House | — | Not checked | not_assessed |
