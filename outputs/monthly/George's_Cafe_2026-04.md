# George's Cafe — Monthly Intelligence Report
...
**Overall score: 5.8/10** (baseline month — no prior comparison)
 | Strongest: Experience (8.6) | Weakest: Visibility (3.1)

**Competitive position:** Local Peers (5mi): #5 of 6 (P20.0) — peer avg 5.91, top 6.32
  Catchment (15mi): #17 of 37 (P55.6) — peer avg 5.62, top 6.66
  UK Category Cohort: #30 of 53 (P44.2) — peer avg 5.79, top 6.92
...
| Aggregate signals | Rating and volume from all platforms | 124 Google (4.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.7 rating across 124 Google reviews is the reputation bedrock and is factored into scoring separately.
...
George's Cafe operates as a credible cafe venue with a 4.7/5 Google rating across 124 reviews — solid but not yet commanding.
...
- **Review momentum.** At 124 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Online visibility (3.1) hasn't kept pace with guest experience quality (8.6). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **The 4.7/5 rating feels dominant but isn't.** In this market, peer venues achieve similar ratings. Your percentile position (P20.0) shows the rating is table stakes, not a differentiator.
...
- **Unrealised review authority.** At 124 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** 124 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 124 reviews (Moderate) | Visibility 3.1/10 (Weak) |
...
George's Cafe is classified as **Cafe / Coffee Shop** (confidence: high). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 3 signal sources.
...
| Name | "George's Cafe" contains "cafe" | Supportive |

**Resolved category:** Cafe / Coffee Shop (confidence: high)

### Peer Justification

- **Espresso Barn** (6.3): Dining with comparable price band; 3.9 miles away
- **Lounge@26** (6.2): Dining with similar price band; 2.9 miles away
- **Chapter 23** (6.1): Dining with comparable price band; 3.0 miles away
- **Costa Coffee** (6.0): Dining with comparable price band; 2.5 miles away
- **Hudson's** (4.9): Dining with comparable price band; 3.7 miles away

## Competitive Market Intelligence

**Local market:** 5 direct competitors identified.

Below the median (P20). Customers have higher-rated alternatives nearby (peer avg 5.9, top 6.3).

**Where you lead:** Conversion (+0.8)
**Where peers beat you:** Experience (-0.7)
...
You are below the median of your peer set. At 5.8 vs peer average 5.9, competitors are outperforming you. The top performer scores 6.3. Customers in this area have demonstrably better-rated alternatives.
...
- Espresso Barn (6.3) — leads you by 0.5
- Lounge@26 (6.2) — leads you by 0.4
- Chapter 23 (6.1) — leads you by 0.3
- Costa Coffee (6.0) — leads you by 0.3
- Hudson's (4.9) — you lead by 0.9
...
- **Also wins on:** Trust (+0.5): same FSA rating but likely stronger sub-scores or more recent inspection
...
- **Copy / test:** Read their recent positive reviews (4.7/5) for operational clues. Review inspection documentation and sub-score gaps.
...
- **Why it matters:** They lead on both Experience and Trust — a combined advantage that is harder to close than a single-dimension gap.
- **Copy / test:** Read their recent positive reviews (5.0/5) for operational clues. Review inspection documentation and sub-score gaps.
- **Defend:** Defend your 124-review advantage vs their 9 (discovery moat) and your conversion readiness (+1.0) — you are easier to book/find.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

### Extended Catchment (36 peers within 15 miles)

**Position:** #17 of 37 (Percentile 55.6)

You sit above the median but below the top tier. Your 5.8 compares to a peer average of 5.6. The gap to the top (6.7) is 0.9 points — closeable with focused improvement on your weakest dimension.
...
- Shakespaw Cat Cafe (6.6) — leads you by 0.8
- Nel's At The Pavilion (6.6) — leads you by 0.8
- Cotswold Cafe (6.4) — leads you by 0.7
- No 37 Cafe (6.3) — leads you by 0.6

### UK Category Cohort (52 peers in Cafe / Coffee Shop)

**Position:** #30 of 53 (Percentile 44.2)
...
- Puddleduck Cafe Ltd (6.9) — leads you by 1.1
...
| Visibility | 3.1 | — | 2.8 | +0.2 | Needs work |
| Trust | 7.7 | — | 8.0 | -0.4 | Below peers |
| Conversion | 3.5 | — | 2.7 | +0.8 | Above peers |
| **Overall** | **5.8** | **—** | | | |
...
**Management note:** At 124 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 2.6/10 | ⚠️ Significant drag | Last inspected 2024-09-09 (19 months ago). Meaningful score drag. Consider pr... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-09-09 (19 months ago). Meaningful score drag. Consider proactive action. The system discounts older inspections because they carry less certainty.

**Peer context:** Espresso Barn's trust lead (+1.4) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.

**What you can do:**

1. **Request voluntary reinspection** (free, 4–8 weeks) — would recover ~1.8 trust points and overtake 4 peers. Only request reinspection if confident of maintaining 5/5. A drop to 4 would be worse than the staleness drag.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.8 on trust, +0.5 on overall (5.8 → 6.2).
...
⚠️ **FSA inspection recency:** Last inspected 19 months ago — re-inspection likely within 6 months.

## Watch List

**Strong rating masks weak competitive position** [ESCALATED]

Your 4.7/5 Google rating feels dominant but you sit below the local median (P20.0). Peer venues achieve similar or better ratings — in this market, 4.5 is table stakes, not a differentiator. Don't mistake the number for an advantage.
...
| Google review count | 124 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.7★ (124 reviews) | observed | ✓ |
...
| Last Inspection | 2024-09-09 | FSA | observed |
| Google Rating | 4.7/5 | Google Places API | observed |
| Google Reviews | 124 | Google Places API | observed |
