# The Kings Head — Monthly Intelligence Report
...
**Competitive position:** Local Peers (5mi): #5 of 6 (P20.0) — peer avg 6.41, top 6.83
  Catchment (15mi): #5 of 7 (P33.3) — peer avg 6.35, top 6.83
  UK Category Cohort: #5 of 7 (P33.3) — peer avg 6.35, top 6.83
...
Based on publicly observable data for The Kings Head, your current operational gaps are putting an estimated **16–50 covers per week** at risk — representing approximately **£1,920–£12,000 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£960–£6,000/mo); Fix the digital shopfront — you're losing walk-ins (£960–£6,000/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~320–500 | Derived from 1,952 Google reviews (high-traffic venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 1,952 Google (4.3★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.3 rating across 1,952 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Kings Head operates as a credible British dining venue with a 4.3/5 Google rating across 1952 reviews — solid but not yet commanding.
...
- **Review momentum.** At 1952 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: pub, british_restaurant, gastropub, bar, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: pub, british_restaurant, gastropub, bar, restaurant*
...
Online visibility (4.0) hasn't kept pace with guest experience quality (9.2). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 1,952 reviews — statistically robust rating. Individual reviews have negligible impact.
...
| Review Volume | 1952 reviews (High) | Visibility 4.0/10 (Weak) |
...
The Kings Head is classified as **Pub / Bar** (confidence: medium). Google's raw category is "British Restaurant" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | pub, british_restaurant, gastropub, bar, restaurant | Primary |
...
- **Deli Cafe** (6.8): Takeaway-focused — different service model; 4.8 miles away *(weak comparator)*
- **Lambs** (6.5): Dining with similar price band; 4.7 miles away
- **Barnabys** (6.4): Takeaway-focused — different service model; 4.7 miles away *(weak comparator)*
- **Loxleys Restaurant And Wine Bar** (6.3): Pub Dining with similar price band; 4.7 miles away
- **Prospero Lounge** (6.0): Pub Dining with similar price band; 4.7 miles away

## Competitive Market Intelligence

**Local market:** 5 direct competitors identified.

Below the median (P20). Customers have higher-rated alternatives nearby (peer avg 6.4, top 6.8).
...
You are below the median of your peer set. At 6.2 vs peer average 6.4, competitors are outperforming you. The top performer scores 6.8. Customers in this area have demonstrably better-rated alternatives.
...
- Deli Cafe (6.8) — leads you by 0.6
- Lambs (6.5) — leads you by 0.3
- Barnabys (6.4) — leads you by 0.2
- Loxleys Restaurant And Wine Bar (6.3) — leads you by 0.1
- Prospero Lounge (6.0) — you lead by 0.2
...
- **Wins on:** Trust (+0.6): same FSA rating but likely stronger sub-scores or more recent inspection
...
You are below the median of your peer set. At 6.2 vs peer average 6.3, competitors are outperforming you. The top performer scores 6.8. Customers in this area have demonstrably better-rated alternatives.
...
- Barnabys (6.4) — leads you by 0.2
- Loxleys Restaurant And Wine Bar (6.3) — leads you by 0.1
- The George Hotel (6.0) — you lead by 0.2
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.2 | — | 9.2 | +0.0 | Strong |
| Visibility | 4.0 | — | 3.8 | +0.2 | Needs work |
| Trust | 8.4 | — | 8.8 | -0.4 | Below peers |
...
**Management note:** At 1952 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 3.8/10 | ⚠️ Significant drag | Last inspected 2025-02-12 (14 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-02-12 (14 months ago). Score starting to decay. Note it but don't escalate. 

**Peer context:** Deli Cafe's trust lead (+1.0) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
### Action 4: Ranked #5 of 6 locally — peers are ahead
**Status:** Stale (5 months) | **Priority:** Medium
...
| Google review count | 1952 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.3★ (1952 reviews) | observed | ✓ |
...
| Last Inspection | 2025-02-12 | FSA | observed |
| Google Rating | 4.3/5 | Google Places API | observed |
| Google Reviews | 1952 | Google Places API | observed |
...
| Postcode | CV35 9LT | FSA | observed |
| Companies House | — | Not checked | not_assessed |
