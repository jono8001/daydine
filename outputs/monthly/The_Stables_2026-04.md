# The Stables — Monthly Intelligence Report
...
**Overall score: 6.4/10** (baseline month — no prior comparison)
 | Strongest: Trust (8.5) | Weakest: Visibility (3.0)

**Competitive position:** Local Peers (5mi): #2 of 3 (P50.0) — peer avg 5.77, top 6.67
  Catchment (15mi): #8 of 14 (P46.2) — peer avg 6.04, top 6.78
  UK Category Cohort: #8 of 17 (P56.2) — peer avg 6.01, top 6.78
...
Based on publicly observable data for The Stables, your current operational gaps are putting an estimated **2–10 covers per week** at risk — representing approximately **£280–£2,360 per month** in lost or leaked revenue. The main drivers are: Publish opening hours — you're invisible to 'open now' searches (£140–£1,180/mo); Get your menu online — 77% of diners check before visiting (£140–£1,180/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Publish opening hours — you're invisible to 'open now' searches** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~80–140 | Derived from 98 Google reviews (small venue indicator), price level ££ |
| Average spend per head | ~£22 | UK hospitality benchmark for price level ££ |
| Covers at risk per week | 2–10 | Default 3–7% leakage (no conversion score) |
| Weekly revenue at risk | £70–£590 | Recoverable with priority action fixes |
| Monthly revenue at risk | £280–£2,360 | Aggregate across top 3 priorities |
| Annual projection | £3,360–£28,320 | If current gaps persist 12 months |
...
| Aggregate signals | Rating and volume from all platforms | 98 Google (4.6★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.6 rating across 98 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Stables is a hotel dining venue with an adequate public reputation (4.6/5, 98 reviews) that has room to build stronger proof.
...
- **Evidence:** `goh missing`
  ...
  **Commercial consequence** (directional):
  Value at stake: £100–£1,340/month | Cost to fix: Zero cost (profile update) | Payback: Immediate (same week)
...
- **Review momentum.** At 98 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: bed_and_breakfast, lodging. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: bed_and_breakfast, lodging*
...
Online visibility (3.0) hasn't kept pace with guest experience quality (8.5). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **The 4.6/5 rating feels dominant but isn't.** In this market, peer venues achieve similar ratings. Your percentile position (P50.0) shows the rating is table stakes, not a differentiator.
...
- **Unrealised review authority.** At 98 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** Only 98 reviews — rating is volatile. A single 1-star review moves the average measurably.
...
| Review Volume | 98 reviews (Low) | Visibility 3.0/10 (Weak) |
...
The Stables is classified as **Bed And Breakfast** (confidence: low). Google's raw category is "Hotel / Accommodation" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | bed_and_breakfast, lodging | Primary |

**Resolved category:** Bed And Breakfast (confidence: low)

### Peer Justification

- **Studley Castle** (6.7): Hotel restaurant — different occasion type, may not compete for walk-in trade; 4.0 miles away *(marginal comparator)*
- **Nuthurst Grange Country House** (4.9): Hotel restaurant — different occasion type, may not compete for walk-in trade; 2.2 miles away *(marginal comparator)*

## Competitive Market Intelligence

**Local market:** 2 direct competitors identified.

Above the median (P50) but not leading. Peer average is 5.8; the top performer scores 6.7. The gap to the top is closeable.

**Where you lead:** Trust (+2.0)
**Where peers beat you:** Visibility (-0.8)

*Commercial implication: you capture an adequate share of a 3-venue market, but the gap to the top (6.7) represents demand you could win. Closing the gap typically requires 1–2 targeted dimension improvements (indicative).*

### Competitive Position

| Competitor | Score | Google Rating | Reviews |
|---|---|---|---|
| Studley Castle | 6.7 | 4.5★ | 1,698 |
| Nuthurst Grange Country House | 4.9 | 4.6★ | 590 |
...
You sit above the median but below the top tier. Your 6.4 compares to a peer average of 5.8. The gap to the top (6.7) is 0.3 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 8.5 (+2.0 above peer avg 6.6)
- Visibility: 3.0 (-0.8 below peer avg 3.8)

**Closest competitors:**

- Studley Castle (6.7) — leads you by 0.3
- Nuthurst Grange Country House (4.9) — you lead by 1.5

### Competitor Strategy

**Studley Castle** (partial)

- **Wins on:** Visibility (+0.9): 1698 Google reviews vs your 98 — they have volume advantage; Experience (+0.9): higher composite experience score from rating + compliance signals
...
- **Copy / test:** Build review volume — they have 1698 to your 98. Read their recent positive reviews (4.5/5) for operational clues.
- **Defend:** Defend your trust advantage (+0.9).
- *Based on Google rating/reviews, FSA record, 3 dimension scores*

**Premier Inn** (partial)

- **Wins on:** Trust (+0.8): same FSA rating but likely stronger sub-scores or more recent inspection; Visibility (+0.7): 860 Google reviews vs your 98 — they have volume advantage
...
- **Copy / test:** Review inspection documentation and sub-score gaps. Build review volume — they have 860 to your 98.
- **Defend:** No clear defensive advantage — you are closely matched across dimensions.
- *Based on Google rating/reviews, FSA record, 3 dimension scores*

**Ragley Hall Catering** (partial)

- **Wins on:** Experience (+1.0): same Google rating (4.6/5) but higher experience score — likely stronger FSA food hygiene sub-scores; Visibility (+0.9): 1395 Google reviews vs your 98 — they have volume advantage
...
- **Copy / test:** Read their recent positive reviews (4.6/5) for operational clues. Build review volume — they have 1395 to your 98.
- **Defend:** Defend your trust advantage (+0.7).
- *Based on Google rating/reviews, FSA record, 3 dimension scores*

### Extended Catchment (13 peers within 15 miles)

**Position:** #8 of 14 (Percentile 46.2)

You are below the median of your peer set. At 6.4 vs peer average 6.0, competitors are outperforming you. The top performer scores 6.8. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Trust: 8.5 (+0.8 above peer avg 7.7)
- Visibility: 3.0 (-0.6 below peer avg 3.6)

**Closest competitors:**

- Premier Inn (6.8) — leads you by 0.4
- Ragley Hall Catering (6.8) — leads you by 0.4
- Studley Castle (6.7) — leads you by 0.3
- Hotel Indigo And The Woodsman (6.6) — leads you by 0.2
- Alveston Manor Hotel (6.5) — leads you by 0.1

### UK Category Cohort (16 peers in Hotel / Accommodation)

**Position:** #8 of 17 (Percentile 56.2)

You sit above the median but below the top tier. Your 6.4 compares to a peer average of 6.0. The gap to the top (6.8) is 0.4 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 8.5 (+0.9 above peer avg 7.7)
- Visibility: 3.0 (-0.6 below peer avg 3.6)
...
| Visibility | 3.0 | — | 3.8 | -0.8 | Below peers |
| Trust | 8.5 | — | 6.6 | +2.0 | Clear strength |
| Conversion | — | — | — | — | No data |
| **Overall** | **6.4** | **—** | | | |
...
**Management note:** At 98 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 8.5.
 You lead peers by 2.0 points (peer avg 6.6).
...
| Inspection Recency | 4.2/10 | ⚠️ Significant drag | Last inspected 2025-03-25 (13 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-03-25 (13 months ago). Score starting to decay. Note it but don't escalate. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.5 on trust, +0.4 on overall (6.4 → 6.8).
...
| Google review count | 98 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.6★ (98 reviews) | observed | ✓ |
...
| Last Inspection | 2025-03-25 | FSA | observed |
| Google Rating | 4.6/5 | Google Places API | observed |
| Google Reviews | 98 | Google Places API | observed |
