# Stratford Manor Hotel — Monthly Intelligence Report
...
**Watch this month:**
- Ranked #6 of 8 locally — peers are ahead
...
**Overall score: 6.2/10** (baseline month — no prior comparison)
 | Strongest: Trust (9.6) | Weakest: Conversion (2.5)

**Competitive position:** Local Peers (5mi): #6 of 8 (P28.6) — peer avg 5.99, top 6.78
  Catchment (15mi): #9 of 16 (P46.7) — peer avg 6.02, top 6.78
  UK Category Cohort: #9 of 17 (P50.0) — peer avg 6.02, top 6.78
...
Based on publicly observable data for Stratford Manor Hotel, your current operational gaps are putting an estimated **26–75 covers per week** at risk — representing approximately **£3,080–£18,000 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£1,540–£9,000/mo); Fix the digital shopfront — you're losing walk-ins (£1,540–£9,000/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~320–500 | Derived from 1,179 Google reviews (high-traffic venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 1,179 Google (4★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4 rating across 1,179 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Stratford Manor Hotel operates as a credible hotel dining venue with a 4.0/5 Google rating across 1179 reviews — solid but not yet commanding.
...
- **Evidence:** `experience=8.83, conversion=2.5`
...
- **Review momentum.** At 1179 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: hotel, gym, wedding_venue, sports_activity_location, lodging, event_venue, health, service. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: hotel, gym, wedding_venue, sports_activity_location, lodging, event_venue, health, service*
...
Online visibility (3.8) hasn't kept pace with guest experience quality (8.8). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 1,179 reviews — statistically robust rating. Individual reviews have negligible impact.
...
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 9.6/10 (Strong) |
| Review Volume | 1179 reviews (High) | Visibility 3.8/10 (Weak) |
...
Stratford Manor Hotel is classified as **Hotel** (confidence: low). Google's raw category is "Hotel / Accommodation" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | hotel, gym, wedding_venue, sports_activity_location, lodging, event_venue, health, service | Primary |

**Resolved category:** Hotel (confidence: low)

### Peer Justification

- **Premier Inn** (6.8): Hotel restaurant — different occasion type, may not compete for walk-in trade; 2.9 miles away *(marginal comparator)*
- **Hotel Indigo And The Woodsman** (6.6): Hotel restaurant — different occasion type, may not compete for walk-in trade; 3.1 miles away *(marginal comparator)*
- **Alveston Manor Hotel** (6.5): Hotel restaurant — different occasion type, may not compete for walk-in trade; 2.9 miles away *(marginal comparator)*
- **Crowne Plaza** (6.5): Hotel restaurant — different occasion type, may not compete for walk-in trade; 2.8 miles away *(marginal comparator)*
- **Premier Inn** (6.4): Hotel restaurant — different occasion type, may not compete for walk-in trade; 2.8 miles away *(marginal comparator)*

## Competitive Market Intelligence

**Local market:** 7 direct competitors identified.

Below the median (P29). Customers have higher-rated alternatives nearby (peer avg 6.0, top 6.8).

**Where you lead:** Trust (+1.9), Experience (+0.6)
...
You are below the median of your peer set. At 6.2 vs peer average 6.0, competitors are outperforming you. The top performer scores 6.8. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Trust: 9.6 (+1.9 above peer avg 7.7)
- Experience: 8.8 (+0.6 above peer avg 8.2)

**Closest competitors:**

- Premier Inn (6.8) — leads you by 0.6
- Hotel Indigo And The Woodsman (6.6) — leads you by 0.4
- Alveston Manor Hotel (6.5) — leads you by 0.3
- Crowne Plaza (6.5) — leads you by 0.3
- Premier Inn (6.4) — leads you by 0.2
...
**Position:** #9 of 16 (Percentile 46.7)

You are below the median of your peer set. At 6.2 vs peer average 6.0, competitors are outperforming you. The top performer scores 6.8. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Trust: 9.6 (+2.0 above peer avg 7.6)

**Closest competitors:**

- Premier Inn (6.8) — leads you by 0.6
- Ragley Hall Catering (6.8) — leads you by 0.6
- Studley Castle (6.7) — leads you by 0.5
- Hotel Indigo And The Woodsman (6.6) — leads you by 0.4
- Alveston Manor Hotel (6.5) — leads you by 0.3
...
You sit above the median but below the top tier. Your 6.2 compares to a peer average of 6.0. The gap to the top (6.8) is 0.6 points — closeable with focused improvement on your weakest dimension.
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.8 | — | 8.2 | +0.6 | Above peers |
| Visibility | 3.8 | — | 3.9 | -0.0 | Needs work |
| Trust | 9.6 | — | 7.7 | +1.9 | Clear strength |
...
**Assessment: Strong.** This is a genuine competitive strength at 8.8.
 Slightly above peer average (8.2).
...
**Management note:** At 1179 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 9.6.
 You lead peers by 1.9 points (peer avg 7.7).
...
| Inspection Recency | 8.4/10 | ✅ Adequate | Last inspected 2026-01-23 (3 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2026-01-23 (3 months ago). Full confidence. No action needed. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.4 on trust, +0.1 on overall (6.2 → 6.3).
...
**Ranked #6 of 8 locally — peers are ahead** [ESCALATED]

At percentile 28.6, customers in this area have higher-rated alternatives. This isn't a crisis but it means you're competing on convenience rather than reputation.
...
### Action 4: Ranked #6 of 8 locally — peers are ahead
**Status:** Stale (4 months) | **Priority:** Medium
...
| Google review count | 1179 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.0★ (1179 reviews) | observed | ✓ |
...
| Last Inspection | 2026-01-23 | FSA | observed |
| Google Rating | 4.0/5 | Google Places API | observed |
| Google Reviews | 1179 | Google Places API | observed |
...
| Postcode | CV37 0PY | FSA | observed |
| Companies House | — | Not checked | not_assessed |
