# Costa — Monthly Intelligence Report
...
**Overall score: 6.2/10** (baseline month — no prior comparison)
 | Strongest: Trust (9.2) | Weakest: Visibility (3.4)

**Competitive position:** Local Peers (5mi): #1 of 5 (P100.0) — peer avg 5.63, top 6.19
  Catchment (15mi): #9 of 36 (P77.1) — peer avg 5.65, top 6.78
  UK Category Cohort: #13 of 53 (P76.9) — peer avg 5.78, top 6.92
...
Based on publicly observable data for Costa, your current operational gaps are putting an estimated **7–22 covers per week** at risk — representing approximately **£840–£5,280 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£420–£2,640/mo); Fix the digital shopfront — you're losing walk-ins (£420–£2,640/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~140–220 | Derived from 283 Google reviews (mid venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 283 Google (4.3★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.3 rating across 283 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Costa operates as a credible cafe venue with a 4.3/5 Google rating across 283 reviews — solid but not yet commanding.
...
- **Review momentum.** At 283 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
- **Volume:** 283 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 283 reviews (Moderate) | Visibility 3.4/10 (Weak) |
...
Costa is classified as **Cafe / Coffee Shop** (confidence: high). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 2 signal sources.
...
- **Henley Ice Cream Limited** (6.2): Dining with comparable price band; 0.2 miles away
- **Cafe 86B** (5.8): Dining with comparable price band; 0.0 miles away
- **JNB Cafe** (5.6): Dining with comparable price band; 5.0 miles away
- **The Cowshed Cafe** (5.0): Dining with similar price band; 1.9 miles away
...
**Where you lead:** Trust (+2.1), Conversion (+0.5)
...
You are in the top quintile of this peer set. Your overall score of 6.2 exceeds the peer average of 5.6 by 0.6 points. The competitive risk here is complacency — the nearest competitor scores 6.2.

**Dimension gaps vs peers:**

- Trust: 9.2 (+2.1 above peer avg 7.1)
- Conversion: 3.5 (+0.5 above peer avg 3.0)

**Closest competitors:**

- Henley Ice Cream Limited (6.2) — you lead by 0.1
- Cafe 86B (5.8) — you lead by 0.4
- JNB Cafe (5.6) — you lead by 0.7
- The Cowshed Cafe (5.0) — you lead by 1.3
...
**Position:** #9 of 36 (Percentile 77.1)

You sit above the median but below the top tier. Your 6.2 compares to a peer average of 5.7. The gap to the top (6.8) is 0.5 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 9.2 (+2.0 above peer avg 7.2)
...
- Dec X Canteen (6.7) — leads you by 0.4
...
**Position:** #13 of 53 (Percentile 76.9)
...
| Visibility | 3.4 | — | 3.3 | +0.0 | Needs work |
| Trust | 9.2 | — | 7.1 | +2.1 | Clear strength |
...
**Management note:** At 283 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 9.2.
 You lead peers by 2.1 points (peer avg 7.1).
...
**Biggest drag:** Inspection Recency. Last inspected 2026-01-19 (3 months ago). Full confidence. No action needed. 
...
| Google review count | 283 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.3★ (283 reviews) | observed | ✓ |
...
| Google Reviews | 283 | Google Places API | observed |
