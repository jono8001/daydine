# The Embankment — Monthly Intelligence Report
...
**Overall score: 5.0/10** (baseline month — no prior comparison)
 | Strongest: Experience (7.1) | Weakest: Conversion (2.5)

**Competitive position:** Local Peers (5mi): #8 of 9 (P12.5) — peer avg 6.15, top 6.78
  Catchment (15mi): #13 of 15 (P14.3) — peer avg 6.16, top 6.78
  UK Category Cohort: #15 of 17 (P12.5) — peer avg 6.09, top 6.78
...
Based on publicly observable data for The Embankment, your current operational gaps are putting an estimated **26–75 covers per week** at risk — representing approximately **£3,080–£18,500 per month** in lost or leaked revenue. The main drivers are: Close the hygiene gap — 4 to 5 (£0–£500/mo (defensive)); Get your menu online — 77% of diners check before visiting (£1,540–£9,000/mo); Fix the digital shopfront — you're losing walk-ins (£1,540–£9,000/mo). Taking action on **Close the hygiene gap — 4 to 5** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~320–500 | Derived from 820 Google reviews (high-traffic venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 820 Google (4.3★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.3 rating across 820 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Embankment operates as a credible hotel dining venue with a 4.3/5 Google rating across 820 reviews — solid but not yet commanding.
...
- **Evidence:** `experience=7.1, conversion=2.5`
...
- **Review momentum.** At 820 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: hotel, lodging. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: hotel, lodging*
...
- **Volume:** 820 reviews — strong base. Rating is stable but a sustained negative pattern could shift it.
...
| Review Volume | 820 reviews (High) | Visibility 3.7/10 (Weak) |
...
The Embankment is classified as **Hotel** (confidence: low). Google's raw category is "Hotel / Accommodation" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | hotel, lodging | Primary |

**Resolved category:** Hotel (confidence: low)

### Peer Justification

- **Premier Inn** (6.8): Hotel restaurant — different occasion type, may not compete for walk-in trade; 0.3 miles away *(marginal comparator)*
- **Hotel Indigo And The Woodsman** (6.6): Hotel restaurant — different occasion type, may not compete for walk-in trade; 0.3 miles away *(marginal comparator)*
- **Alveston Manor Hotel** (6.5): Hotel restaurant — different occasion type, may not compete for walk-in trade; 0.2 miles away *(marginal comparator)*
- **Crowne Plaza** (6.5): Hotel restaurant — different occasion type, may not compete for walk-in trade; 0.2 miles away *(marginal comparator)*
- **Premier Inn** (6.4): Hotel restaurant — different occasion type, may not compete for walk-in trade; 1.1 miles away *(marginal comparator)*

## Competitive Market Intelligence

**Local market:** 8 direct competitors identified.

Below the median (P12). Customers have higher-rated alternatives nearby (peer avg 6.2, top 6.8).

**Where peers beat you:** Experience (-1.3), Trust (-1.1)
...
**Position:** #8 of 9 (Percentile 12.5)

You are below the median of your peer set. At 5.0 vs peer average 6.2, competitors are outperforming you. The top performer scores 6.8. Customers in this area have demonstrably better-rated alternatives.
...
- Premier Inn (6.8) — leads you by 1.8
- Hotel Indigo And The Woodsman (6.6) — leads you by 1.6
- Alveston Manor Hotel (6.5) — leads you by 1.5
- Crowne Plaza (6.5) — leads you by 1.5
- Premier Inn (6.4) — leads you by 1.4
...
- **Wins on:** Trust (+2.4): FSA 5/5 vs your 4/5; Experience (+1.8): higher composite experience score from rating + compliance signals
...
- **Also wins on:** Trust (+1.6): FSA 5/5 vs your 4/5
- **Why it matters:** They lead on both Experience and Trust — a combined advantage that is harder to close than a single-dimension gap.
...
- Trust: 7.0 (-0.9 below peer avg 7.9)
- Experience: 7.1 (-1.6 below peer avg 8.7)

**Closest competitors:**

- Premier Inn (6.8) — leads you by 1.8
- Ragley Hall Catering (6.8) — leads you by 1.8
- Studley Castle (6.7) — leads you by 1.7
- Hotel Indigo And The Woodsman (6.6) — leads you by 1.6
- Alveston Manor Hotel (6.5) — leads you by 1.5
...
You are below the median of your peer set. At 5.0 vs peer average 6.1, competitors are outperforming you. The top performer scores 6.8. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Trust: 7.0 (-0.8 below peer avg 7.8)
- Experience: 7.1 (-1.6 below peer avg 8.7)
...
| Visibility | 3.7 | — | 3.9 | -0.1 | Needs work |
...
**Management note:** At 820 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 4.0/10 | ⚠️ Significant drag | Last inspected 2025-03-07 (13 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-03-07 (13 months ago). Score starting to decay. Note it but don't escalate. 

**Peer context:** Premier Inn's trust lead (+2.6) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
|--:|---------------|--------|--------|------|
| 6 | Ranked #8 of 9 locally — peers are ahead | Stale (5 months) | 01 May 2026 | Medium (£200–£1,000) |
...
| Google review count | 820 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.3★ (820 reviews) | observed | ✓ |
...
| Last Inspection | 2025-03-07 | FSA | observed |
| Google Rating | 4.3/5 | Google Places API | observed |
| Google Reviews | 820 | Google Places API | observed |
...
| Postcode | CV37 7LS | FSA | observed |
| Companies House | — | Not checked | not_assessed |
