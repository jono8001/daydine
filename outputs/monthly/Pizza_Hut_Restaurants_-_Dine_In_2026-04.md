# Pizza Hut Restaurants - Dine In — Monthly Intelligence Report
...
**Overall score: 6.0/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.4) | Weakest: Conversion (2.5)

**Competitive position:** Local Peers (5mi): #4 of 10 (P66.7) — peer avg 5.73, top 6.41
  Catchment (15mi): #6 of 12 (P54.5) — peer avg 5.79, top 6.41
  UK Category Cohort: #6 of 13 (P58.3) — peer avg 5.8, top 6.41
...
Based on publicly observable data for Pizza Hut Restaurants - Dine In, your current operational gaps are putting an estimated **26–75 covers per week** at risk — representing approximately **£3,080–£18,500 per month** in lost or leaked revenue. The main drivers are: Publish opening hours — you're invisible to 'open now' searches (£1,540–£9,000/mo); Renew formal trust proof before it becomes a visible drag (£0–£500/mo (defensive)); Get your menu online — 77% of diners check before visiting (£1,540–£9,000/mo). Taking action on **Publish opening hours — you're invisible to 'open now' searches** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~320–500 | Derived from 1,831 Google reviews (high-traffic venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 1,831 Google (4.5★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.5 rating across 1,831 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Pizza Hut Restaurants - Dine In is a well-established Italian dining venue with a strong public reputation — 4.5/5 across 1,831 Google reviews. That volume means the reputation is earned, not manufactured.
...
- **Review momentum.** At 1831 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: pizza_restaurant, vegan_restaurant, vegetarian_restaurant, family_restaurant, fast_food_restaurant, meal_takeaway, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: pizza_restaurant, vegan_restaurant, vegetarian_restaurant, family_restaurant, fast_food_restaurant, meal_takeaway, restaurant*
...
- **Volume:** 1,831 reviews — statistically robust rating. Individual reviews have negligible impact.
...
### What's Trending in Your Category (Pizzerias, UK, 2026)
...
**Opportunity gap:** Category trend — sourdough: Sourdough and long-ferment bases commanding a premium with strong positive review sentiment. No guest mentions detected in current reviews. Worth exploring if this aligns with your offering.
...
| Review Volume | 1831 reviews (High) | Visibility 4.0/10 (Weak) |
...
Pizza Hut Restaurants - Dine In is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Italian Restaurant" but the resolved category triangulates across 3 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | pizza_restaurant, vegan_restaurant, vegetarian_restaurant, family_restaurant, fast_food_restaurant, meal_takeaway, restaurant | Primary |
| Price Level | ££ (2/4) — Casual dining | Supportive |
| Name | "Pizza Hut Restaurants - Dine In" contains "restaurant" | Supportive |

**Resolved category:** Restaurant (General) (confidence: medium)

### Peer Justification

- **The Phoenix** (6.4): Takeaway-focused — different service model; 0.6 miles away *(weak comparator)*
- **Soma** (6.2): Dining with comparable price band; 0.7 miles away
- **Carluccio's** (6.1): Dining with similar price band; 0.7 miles away
- **Impasto Micro-Pizzeria** (5.8): Dining with comparable price band; 0.6 miles away
- **Corte Campana** (5.7): Dining with comparable price band; 0.7 miles away

## Competitive Market Intelligence

**Local market:** 9 direct competitors identified.

Above the median (P67) but not leading. Peer average is 5.7; the top performer scores 6.4. The gap to the top is closeable.
...
**Position:** #4 of 10 (Percentile 66.7)

You sit above the median but below the top tier. Your 6.0 compares to a peer average of 5.7. The gap to the top (6.4) is 0.4 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Experience: 9.4 (+0.6 above peer avg 8.8)
- Visibility: 4.0 (+0.6 above peer avg 3.4)

**Closest competitors:**

- The Phoenix (6.4) — leads you by 0.4
- Soma (6.2) — leads you by 0.1
- Carluccio's (6.1) — leads you by 0.0
- Impasto Micro-Pizzeria (5.8) — you lead by 0.3
- Corte Campana (5.7) — you lead by 0.3
...
- **Defend:** Defend your 1831-review advantage vs their 272 (discovery moat).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

**Soma** (signal-backed)

- **Wins on:** Trust (+0.9): same FSA rating but likely stronger sub-scores or more recent inspection
...
- **Defend:** Defend your 1831-review advantage vs their 120 (discovery moat).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*
...
**Position:** #6 of 12 (Percentile 54.5)

You sit above the median but below the top tier. Your 6.0 compares to a peer average of 5.8. The gap to the top (6.4) is 0.4 points — closeable with focused improvement on your weakest dimension.
...
- The Phoenix (6.4) — leads you by 0.4
- Soma (6.2) — leads you by 0.1
- The Still House Café (6.1) — leads you by 0.1
- Bumbles (6.1) — leads you by 0.0
- Carluccio's (6.1) — leads you by 0.0

### UK Category Cohort (12 peers in Italian Restaurant)

**Position:** #6 of 13 (Percentile 58.3)

You sit above the median but below the top tier. Your 6.0 compares to a peer average of 5.8. The gap to the top (6.4) is 0.4 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Visibility: 4.0 (+0.6 above peer avg 3.3)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.4 | — | 8.8 | +0.6 | Above peers |
| Visibility | 4.0 | — | 3.4 | +0.6 | Above peers |
| Trust | 7.6 | — | 7.5 | +0.1 | In line |
...
**Assessment: Critical.** At 4.0, this represents a material operational gap.
...
**Management note:** At 1831 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 1.8/10 | ⚠️ Significant drag | Last inspected 2024-04-04 (24 months ago). Maximum decay applied. Reinspectio... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-04-04 (24 months ago). Maximum decay applied. Reinspection strongly recommended. The system discounts older inspections because they carry less certainty.

**What you can do:**

1. **Request voluntary reinspection** (free, 4–8 weeks) — would recover ~2.0 trust points and overtake 5 peers. Only request reinspection if confident of maintaining 5/5. A drop to 4 would be worse than the staleness drag.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +2.0 on trust, +0.5 on overall (6.0 → 6.5).
...
| Google review count | 1831 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.5★ (1831 reviews) | observed | ✓ |
...
| Last Inspection | 2024-04-04 | FSA | observed |
| Google Rating | 4.5/5 | Google Places API | observed |
| Google Reviews | 1831 | Google Places API | observed |
