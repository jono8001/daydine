# Nel's At The Pavilion — Monthly Intelligence Report
...
**Competitive position:** Local Peers (5mi): #5 of 10 (P55.6) — peer avg 6.03, top 6.78
  Catchment (15mi): #7 of 43 (P85.7) — peer avg 5.8, top 6.92
  UK Category Cohort: #8 of 53 (P86.5) — peer avg 5.77, top 6.92
...
Based on publicly observable data for Nel's At The Pavilion, your current operational gaps are putting an estimated **11–35 covers per week** at risk — representing approximately **£1,320–£8,400 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£660–£4,200/mo); Fix the digital shopfront — you're losing walk-ins (£660–£4,200/mo); Protect the 4.7/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~220–350 | Derived from 453 Google reviews (large venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 453 Google (4.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.7 rating across 453 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Nel's At The Pavilion operates as a credible cafe venue with a 4.7/5 Google rating across 453 reviews — solid but not yet commanding.
...
With 453 reviews at 4.7/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 453 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Online visibility (3.5) hasn't kept pace with guest experience quality (9.7). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 453 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 453 reviews (Moderate) | Visibility 3.5/10 (Weak) |
...
Nel's At The Pavilion is classified as **Cafe / Coffee Shop** (confidence: high). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 2 signal sources.
...
- **South Costa** (6.8): Dining with comparable price band; 0.9 miles away
- **Building 523 Costa And Kitchen** (6.8): Dining with comparable price band; 0.9 miles away
- **Dec X Canteen** (6.7): Dining with comparable price band; 0.9 miles away
- **Gilks' Garage Cafe** (6.7): Dining with similar price band; 3.3 miles away
- **Harbury Library Cafe** (5.8): Dining with comparable price band; 3.1 miles away

## Competitive Market Intelligence

**Local market:** 9 direct competitors identified.

Above the median (P56) but not leading. Peer average is 6.0; the top performer scores 6.8. The gap to the top is closeable.

**Where you lead:** Trust (+1.8), Experience (+0.8), Conversion (+0.5)

*Commercial implication: you capture an adequate share of a 10-venue market, but the gap to the top (6.8) represents demand you could win. Closing the gap typically requires 1–2 targeted dimension improvements (indicative).*
...
| Harbury Library Cafe | 5.8 | 5.0★ | 26 |
...
You sit above the median but below the top tier. Your 6.6 compares to a peer average of 6.0. The gap to the top (6.8) is 0.2 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 9.4 (+1.8 above peer avg 7.6)
- Experience: 9.7 (+0.8 above peer avg 8.9)
- Conversion: 3.5 (+0.5 above peer avg 3.0)

**Closest competitors:**

- South Costa (6.8) — leads you by 0.2
- Building 523 Costa And Kitchen (6.8) — leads you by 0.2
- Dec X Canteen (6.7) — leads you by 0.0
- Gilks' Garage Cafe (6.7) — leads you by 0.0
- Harbury Library Cafe (5.8) — you lead by 0.8
...
**Position:** #7 of 43 (Percentile 85.7)

You are in the top quintile of this peer set. Your overall score of 6.6 exceeds the peer average of 5.8 by 0.8 points. The competitive risk here is complacency — the nearest competitor scores 6.9.
...
**Position:** #8 of 53 (Percentile 86.5)
...
- Puddleduck Cafe Ltd (6.9) — leads you by 0.3
- South Costa (6.8) — leads you by 0.2
- Nanas Caff (6.8) — leads you by 0.2
- Building 523 Costa And Kitchen (6.8) — leads you by 0.2
- Dec X Canteen (6.7) — leads you by 0.0
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.7 | — | 8.9 | +0.8 | Above peers |
| Visibility | 3.5 | — | 3.5 | +0.0 | Needs work |
| Trust | 9.4 | — | 7.6 | +1.8 | Clear strength |
...
**Assessment: Strong.** This is a genuine competitive strength at 9.7.
 Slightly above peer average (8.9).
...
**Management note:** At 453 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 9.4.
 You lead peers by 1.8 points (peer avg 7.6).
...
| Inspection Recency | 9.1/10 | ✅ Strong | Last inspected 2026-02-26 (1 months ago). Full confidence. No action needed.  |
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.2 on trust, +0.1 on overall (6.6 → 6.7).
...
| Google review count | 453 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.7★ (453 reviews) | observed | ✓ |
...
| Last Inspection | 2026-02-26 | FSA | observed |
| Google Rating | 4.7/5 | Google Places API | observed |
| Google Reviews | 453 | Google Places API | observed |
...
| Postcode | CV35 0AD | FSA | observed |
| Companies House | — | Not checked | not_assessed |
