# Earlswood Lunch Club — Monthly Intelligence Report
...
**Overall score: 5.8/10** (baseline month — no prior comparison)
 | Strongest: Experience (8.1) | Weakest: Visibility (2.6)

**Competitive position:** UK Category Cohort: #2 of 3 (P50.0) — peer avg 5.45, top 5.98
...
Based on publicly observable data for Earlswood Lunch Club, your current operational gaps are putting an estimated **1–6 covers per week** at risk — representing approximately **£140–£1,340 per month** in lost or leaked revenue. The main drivers are: Publish opening hours — you're invisible to 'open now' searches (£70–£670/mo); Get your menu online — 77% of diners check before visiting (£70–£670/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Publish opening hours — you're invisible to 'open now' searches** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~40–80 | Derived from 32 Google reviews (micro venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 32 Google (4.3★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.3 rating across 32 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Earlswood Lunch Club is a catering venue with an adequate public reputation (4.3/5, 32 reviews) that has room to build stronger proof.
...
- **Review momentum.** At 32 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: community_center, service, event_venue. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: community_center, service, event_venue*
...
Online visibility (2.6) hasn't kept pace with guest experience quality (8.1). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Unrealised review authority.** At 32 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** Only 32 reviews — rating is volatile. A single 1-star review moves the average measurably.
...
| Review Volume | 32 reviews (Low) | Visibility 2.6/10 (Weak) |

## Category & Peer Validation

### Why This Venue Is In This Cohort

Earlswood Lunch Club is classified as **Community Center** (confidence: low). Google's raw category is "Catering" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | community_center, service, event_venue | Primary |

**Resolved category:** Community Center (confidence: low)
...
You sit above the median but below the top tier. Your 5.8 compares to a peer average of 5.5. The gap to the top (6.0) is 0.2 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 7.8 (+1.0 above peer avg 6.8)
- Experience: 8.1 (-0.6 below peer avg 8.8)

**Closest competitors:**

- Kitty's Kitchen Catering Ltd (6.0) — leads you by 0.2
- CAMEO Lunch Club (4.9) — you lead by 0.9
...
**Management note:** At 32 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 3.1/10 | ⚠️ Significant drag | Last inspected 2024-11-20 (17 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-11-20 (17 months ago). Score starting to decay. Note it but don't escalate. 
...
| Google review count | 32 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.3★ (32 reviews) | observed | ✓ |
...
| Last Inspection | 2024-11-20 | FSA | observed |
| Google Rating | 4.3/5 | Google Places API | observed |
| Google Reviews | 32 | Google Places API | observed |
