# Elders Who Lunch (Hartley Locums) — Monthly Intelligence Report
...
**Overall score: 5.4/10** (baseline month — no prior comparison)
 | Strongest: Experience (8.7) | Weakest: Visibility (1.2)

**Competitive position:** Catchment (15mi): #5 of 5 (P0.0) — peer avg 6.23, top 7.07
  UK Category Cohort: #9 of 10 (P11.1) — peer avg 6.21, top 7.85
...
Based on publicly observable data for Elders Who Lunch (Hartley Locums), your current operational gaps are putting an estimated **3–12 covers per week** at risk — representing approximately **£380–£2,880 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£190–£1,440/mo); Build review volume — you lack statistical credibility (discovery protection); Fix the digital shopfront — you're losing walk-ins (£190–£1,440/mo). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~40–80 | Derived from 9 Google reviews (micro venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 9 Google (4.8★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.8 rating across 9 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Elders Who Lunch (Hartley Locums) is a other venue with an adequate public reputation (4.8/5, 9 reviews) that has room to build stronger proof.
...
Only 9 Google reviews. A single bad review moves your average visibly. Encourage satisfied customers to leave reviews.
...
- **Review momentum.** At 9 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Only 3 photos vs peer average of ~10. Low photo count suppresses click-through.

**Commercial consequence:** Venues with 10+ photos get ~35% more click-throughs (Google data).

*Signals: Photo count: 3; Peer average: ~10 photos*

### Proposition Clarity [PARTIAL]

Insufficient review data to cross-reference proposition. Google types show: service. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: service*
...
Online visibility (1.2) hasn't kept pace with guest experience quality (8.7). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Unrealised review authority.** At 9 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** Only 9 reviews — insufficient for reliable assessment. Priority: build review count.
...
| Review Volume | 9 reviews (Low) | Visibility 1.2/10 (Weak) |
...
Elders Who Lunch (Hartley Locums) is classified as **Service** (confidence: low). Google's raw category is "Other" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | service | Primary |

**Resolved category:** Service (confidence: low)
...
You are below the median of your peer set. At 5.4 vs peer average 6.2, competitors are outperforming you. The top performer scores 7.1. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Conversion: 2.5 (-0.5 below peer avg 3.0)
- Visibility: 1.2 (-2.2 below peer avg 3.4)

**Closest competitors:**

- Ashorne Hill Management College (7.1) — leads you by 1.7
- The Pavillion (6.3) — leads you by 0.9
- Lexi's Loving Spoonful (6.0) — leads you by 0.7
- Good Breakfast (5.5) — leads you by 0.1

### UK Category Cohort (9 peers in Other)

**Position:** #9 of 10 (Percentile 11.1)

You are below the median of your peer set. At 5.4 vs peer average 6.2, competitors are outperforming you. The top performer scores 7.8. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Visibility: 1.2 (-2.0 below peer avg 3.1)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.7 | — | — | — | Strong |
| Visibility | 1.2 | — | — | — | Needs work |
| Trust | 7.9 | — | — | — | In line |
...
**Assessment: Critical.** At 1.2, this represents a material operational gap.
...
**Management note:** At 9 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 5.2/10 | ⚠️ Room to improve | Last inspected 2025-06-30 (9 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-06-30 (9 months ago). Full confidence. No action needed. 
...
| Google review count | 9 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.8★ (9 reviews) | observed | ✓ |
...
| Last Inspection | 2025-06-30 | FSA | observed |
| Google Rating | 4.8/5 | Google Places API | observed |
| Google Reviews | 9 | Google Places API | observed |
| Google Photos | 3 | Google Places API | observed |
...
| Postcode | CV47 8LS | FSA | observed |
| Companies House | — | Not checked | not_assessed |
