# JNB Cafe — Monthly Intelligence Report
...
**Competitive position:** Local Peers (5mi): #9 of 19 (P55.6) — peer avg 5.5, top 6.64
  Catchment (15mi): #26 of 42 (P39.0) — peer avg 5.7, top 6.78
  UK Category Cohort: #36 of 53 (P32.7) — peer avg 5.79, top 6.92
...
Based on publicly observable data for JNB Cafe, your current operational gaps are putting an estimated **11–33 covers per week** at risk — representing approximately **£1,340–£8,420 per month** in lost or leaked revenue. The main drivers are: Renew formal trust proof before it becomes a visible drag (£0–£500/mo (defensive)); Get your menu online — 77% of diners check before visiting (£670–£3,960/mo); Fix the digital shopfront — you're losing walk-ins (£670–£3,960/mo). Taking action on **Renew formal trust proof before it becomes a visible drag** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~140–220 | Derived from 194 Google reviews (mid venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 194 Google (4.6★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.6 rating across 194 Google reviews is the reputation bedrock and is factored into scoring separately.
...
JNB Cafe operates as a credible cafe venue with a 4.6/5 Google rating across 194 reviews — solid but not yet commanding.
...
Last inspected 2.9 years ago. A stale inspection date erodes trust scoring and signals to customers that compliance isn't actively managed. Request a voluntary re-inspection once you're confident of a strong result.
...
- **Review momentum.** At 194 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: gym, sports_school, sports_complex, sports_activity_location, health. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: gym, sports_school, sports_complex, sports_activity_location, health*
...
- **Unrealised review authority.** At 194 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** 194 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 7.3/10 (Adequate) |
| Review Volume | 194 reviews (Moderate) | Visibility 3.2/10 (Weak) |
...
JNB Cafe is classified as **Gym** (confidence: low). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | gym, sports_school, sports_complex, sports_activity_location, health | Primary |
| Name | "JNB Cafe" contains "cafe" | Supportive |

**Resolved category:** Gym (confidence: low)

### Peer Justification

- **Shakespaw Cat Cafe** (6.6): Dining with comparable price band; 2.7 miles away
- **No 37 Cafe** (6.3): Dining with comparable price band; 2.8 miles away
- **Costa** (6.3): Dining with comparable price band; 2.1 miles away
- **Costa** (6.2): Dining with comparable price band; 5.0 miles away
- **Henley Ice Cream Limited** (6.2): Dining with comparable price band; 4.8 miles away

## Competitive Market Intelligence

**Local market:** 18 direct competitors identified.

Above the median (P56) but not leading. Peer average is 5.5; the top performer scores 6.6. The gap to the top is closeable.

*Commercial implication: you capture an adequate share of a 19-venue market, but the gap to the top (6.6) represents demand you could win. Closing the gap typically requires 1–2 targeted dimension improvements (indicative).*

**Density alert:** 18 competitors within range. Differentiation is critical — competing on fundamentals alone is insufficient in a dense market.
...
18 direct competitors within 5mi. Differentiation critical.
...
### Local Competitive Set (18 peers within 5 miles)

**Position:** #9 of 19 (Percentile 55.6)

You sit above the median but below the top tier. Your 5.6 compares to a peer average of 5.5. The gap to the top (6.6) is 1.1 points — closeable with focused improvement on your weakest dimension.

**Closest competitors:**

- Shakespaw Cat Cafe (6.6) — leads you by 1.1
- No 37 Cafe (6.3) — leads you by 0.8
- Costa (6.3) — leads you by 0.8
- Costa (6.2) — leads you by 0.7
- Henley Ice Cream Limited (6.2) — leads you by 0.6
...
### Extended Catchment (41 peers within 15 miles)

**Position:** #26 of 42 (Percentile 39.0)

You are below the median of your peer set. At 5.6 vs peer average 5.7, competitors are outperforming you. The top performer scores 6.8. Customers in this area have demonstrably better-rated alternatives.

**Closest competitors:**

- South Costa (6.8) — leads you by 1.2
- Building 523 Costa And Kitchen (6.8) — leads you by 1.2
- Dec X Canteen (6.7) — leads you by 1.1
- Gilks' Garage Cafe (6.7) — leads you by 1.1
- Shakespaw Cat Cafe (6.6) — leads you by 1.1

### UK Category Cohort (52 peers in Cafe / Coffee Shop)

**Position:** #36 of 53 (Percentile 32.7)

You are below the median of your peer set. At 5.6 vs peer average 5.8, competitors are outperforming you. The top performer scores 6.9. Customers in this area have demonstrably better-rated alternatives.

**Closest competitors:**

- Puddleduck Cafe Ltd (6.9) — leads you by 1.4
- South Costa (6.8) — leads you by 1.2
- Nanas Caff (6.8) — leads you by 1.2
- Building 523 Costa And Kitchen (6.8) — leads you by 1.2
- Dec X Canteen (6.7) — leads you by 1.1
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.5 | — | 8.4 | +0.1 | Strong |
| Visibility | 3.2 | — | 3.4 | -0.1 | Needs work |
| Trust | 7.3 | — | 7.2 | +0.1 | In line |
...
**Assessment: Critical.** At 3.2, this represents a material operational gap.
...
**Management note:** At 194 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 0.9/10 | ⚠️ Significant drag | Last inspected 2023-05-26 (35 months ago). Maximum decay applied. Reinspectio... |
...
**Biggest drag:** Inspection Recency. Last inspected 2023-05-26 (35 months ago). Maximum decay applied. Reinspection strongly recommended. The system discounts older inspections because they carry less certainty.

**Peer context:** Shakespaw Cat Cafe's trust lead (+2.3) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.

**What you can do:**

1. **Request voluntary reinspection** (free, 4–8 weeks) — would recover ~2.3 trust points and overtake 4 peers. Only request reinspection if confident of maintaining 5/5. A drop to 4 would be worse than the staleness drag.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +2.3 on trust, +0.6 on overall (5.6 → 6.1).
...
🔴 **FSA inspection recency:** Last inspected 34 months ago — re-inspection likely overdue.
...
| Google review count | 194 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.6★ (194 reviews) | observed | ✓ |
...
| Last Inspection | 2023-05-26 | FSA | observed |
| Google Rating | 4.6/5 | Google Places API | observed |
| Google Reviews | 194 | Google Places API | observed |
...
| Postcode | CV37 0ER | FSA | observed |
| Companies House | — | Not checked | not_assessed |
