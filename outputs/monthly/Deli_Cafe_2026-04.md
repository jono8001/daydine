# Deli Cafe — Monthly Intelligence Report
...
**Overall score: 6.8/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.5) | Weakest: Visibility (3.5)

**Competitive position:** Local Peers (5mi): #1 of 6 (P100.0) — peer avg 6.29, top 6.52
  Catchment (15mi): #1 of 7 (P100.0) — peer avg 6.24, top 6.52
  UK Category Cohort: #1 of 7 (P100.0) — peer avg 6.24, top 6.52
...
Based on publicly observable data for Deli Cafe, your current operational gaps are putting an estimated **6–23 covers per week** at risk — representing approximately **£380–£2,760 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£190–£1,380/mo); Fix the digital shopfront — you're losing walk-ins (£190–£1,380/mo); Protect the 4.6/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~290–460 | Derived from 510 Google reviews (large venue indicator), price level £ |
| Average spend per head | ~£12 | UK hospitality benchmark for price level £ |
| Covers at risk per week | 6–23 | Conversion score 5.0/10 → 2%–5% leakage |
| Weekly revenue at risk | £100–£690 | Recoverable with priority action fixes |
| Monthly revenue at risk | £380–£2,760 | Aggregate across top 3 priorities |
| Annual projection | £4,560–£33,120 | If current gaps persist 12 months |
...
| Aggregate signals | Rating and volume from all platforms | 510 Google (4.6★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.6 rating across 510 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Deli Cafe is a well-established British dining venue with a strong public reputation — 4.6/5 across 510 Google reviews. That volume means the reputation is earned, not manufactured.
...
- **Evidence:** `has_menu_online=false`
  ...
  **Commercial consequence** (directional):
  Value at stake: £190–£2,210/month | Cost to fix: Low (< 1 hour, no spend) | Payback: < 1 month
...
With 510 reviews at 4.6/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 510 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: cafe, sandwich_shop, coffee_shop, breakfast_restaurant, tea_house, british_restaurant, meal_takeaway, food_store, restaurant, store. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: cafe, sandwich_shop, coffee_shop, breakfast_restaurant, tea_house, british_restaurant, meal_takeaway, food_store, restaurant, store*
...
- **Volume:** 510 reviews — strong base. Rating is stable but a sustained negative pattern could shift it.
...
| Review Volume | 510 reviews (High) | Visibility 3.5/10 (Weak) |
...
Deli Cafe is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "British Restaurant" but the resolved category triangulates across 3 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | cafe, sandwich_shop, coffee_shop, breakfast_restaurant, tea_house, british_restaurant, meal_takeaway, food_store, restaurant, store | Primary |
| Price Level | £ (1/4) — Budget | Supportive |
| Name | "Deli Cafe" contains "cafe" | Supportive |

**Resolved category:** Restaurant (General) (confidence: medium)

### Peer Justification

- **Lambs** (6.5): Dining with comparable price band; 0.2 miles away
- **Barnabys** (6.4): Takeaway-focused — different service model; 0.2 miles away *(weak comparator)*
- **Loxleys Restaurant And Wine Bar** (6.3): Pub Dining with comparable price band; 0.2 miles away
- **The Kings Head** (6.2): Pub Dining with comparable price band; 4.8 miles away
- **Prospero Lounge** (6.0): Pub Dining with comparable price band; 0.2 miles away
...
**Where you lead:** Conversion (+1.2), Trust (+0.9)
...
You are in the top quintile of this peer set. Your overall score of 6.8 exceeds the peer average of 6.3 by 0.5 points. The competitive risk here is complacency — the nearest competitor scores 6.5.

**Dimension gaps vs peers:**

- Conversion: 5.0 (+1.2 above peer avg 3.8)
- Trust: 9.5 (+0.9 above peer avg 8.6)

**Closest competitors:**

- Lambs (6.5) — you lead by 0.3
- Barnabys (6.4) — you lead by 0.4
- Loxleys Restaurant And Wine Bar (6.3) — you lead by 0.5
- The Kings Head (6.2) — you lead by 0.6
- Prospero Lounge (6.0) — you lead by 0.8
...
- **Defend:** Defend your conversion readiness (+1.5) — you are easier to book/find and your trust advantage (+0.8).
...
- **Why it matters:** You are closely matched — small improvements on either side shift the balance.
- **Copy / test:** No clear action to copy — maintain current standards.
- **Defend:** Defend your experience lead (+0.7) — drives repeats and word-of-mouth and your trust advantage (+0.5).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*
...
- **Why it matters:** You are closely matched — small improvements on either side shift the balance.
- **Copy / test:** No clear action to copy — maintain current standards.
- **Defend:** Defend your conversion readiness (+1.5) — you are easier to book/find and your experience lead (+0.9) — drives repeats and word-of-mouth.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*
...
You are in the top quintile of this peer set. Your overall score of 6.8 exceeds the peer average of 6.2 by 0.6 points. The competitive risk here is complacency — the nearest competitor scores 6.5.

**Dimension gaps vs peers:**

- Conversion: 5.0 (+1.2 above peer avg 3.8)
- Trust: 9.5 (+0.9 above peer avg 8.6)
- Experience: 9.5 (+0.5 above peer avg 9.0)
...
- Loxleys Restaurant And Wine Bar (6.3) — you lead by 0.5
- The Kings Head (6.2) — you lead by 0.6
- The George Hotel (6.0) — you lead by 0.8
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.5 | — | 9.1 | +0.4 | Above peers |
| Visibility | 3.5 | — | 3.9 | -0.3 | Below peers |
| Trust | 9.5 | — | 8.6 | +0.9 | Above peers |
...
**Management note:** At 510 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.2 on trust, +0.0 on overall (6.8 → 6.9).
...
| Google review count | 510 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.6★ (510 reviews) | observed | ✓ |
...
| Google Reviews | 510 | Google Places API | observed |
