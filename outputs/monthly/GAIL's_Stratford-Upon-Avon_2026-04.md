# GAIL's Stratford-Upon-Avon — Monthly Intelligence Report
...
**Overall score: 5.8/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.2) | Weakest: Conversion (2.5)

**Competitive position:** Local Peers (5mi): #4 of 5 (P25.0) — peer avg 5.84, top 6.43
  Catchment (15mi): #6 of 11 (P50.0) — peer avg 5.73, top 6.43
  UK Category Cohort: #6 of 11 (P50.0) — peer avg 5.73, top 6.43
...
| Aggregate signals | Rating and volume from all platforms | 139 Google (4.3★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.3 rating across 139 Google reviews is the reputation bedrock and is factored into scoring separately.
...
GAIL's Stratford-Upon-Avon operates as a credible quick-service food venue with a 4.3/5 Google rating across 139 reviews — solid but not yet commanding.
...
- **Evidence:** `experience=9.18, conversion=2.5`
...
- **Review momentum.** At 139 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: bakery, sandwich_shop, pastry_shop, coffee_shop, cafe, dessert_shop, confectionery, food_store, restaurant, store. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: bakery, sandwich_shop, pastry_shop, coffee_shop, cafe, dessert_shop, confectionery, food_store, restaurant, store*
...
Online visibility (3.1) hasn't kept pace with guest experience quality (9.2). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Unrealised review authority.** At 139 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** 139 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 8.2/10 (Strong) |
| Review Volume | 139 reviews (Moderate) | Visibility 3.1/10 (Weak) |
...
GAIL's Stratford-Upon-Avon is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Fast Food / Quick Service" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | bakery, sandwich_shop, pastry_shop, coffee_shop, cafe, dessert_shop, confectionery, food_store, restaurant, store | Primary |
...
- **Starbucks** (6.3): Dining with comparable price band; 0.0 miles away
...
Below the median (P25). Customers have higher-rated alternatives nearby (peer avg 5.8, top 6.4).

**Where you lead:** Experience (+1.0)
**Where peers beat you:** Conversion (-2.1)
...
You are below the median of your peer set. At 5.8 vs peer average 5.8, competitors are outperforming you. The top performer scores 6.4. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Experience: 9.2 (+1.0 above peer avg 8.1)
- Conversion: 2.5 (-2.1 below peer avg 4.6)

**Closest competitors:**

- The Kingfisher FishBar (6.4) — leads you by 0.6
- Starbucks (6.3) — leads you by 0.5
- The Food Of Love (6.2) — leads you by 0.4
- Subway (4.5) — you lead by 1.3
...
- **Wins on:** Trust (+1.7): same FSA rating but likely stronger sub-scores or more recent inspection; Conversion (+1.0): more complete operational signals (hours, menu, delivery/takeaway, booking)
...
**Position:** #6 of 11 (Percentile 50.0)

You sit above the median but below the top tier. Your 5.8 compares to a peer average of 5.7. The gap to the top (6.4) is 0.6 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Experience: 9.2 (+1.0 above peer avg 8.2)
- Trust: 8.2 (+0.5 above peer avg 7.7)
- Conversion: 2.5 (-1.8 below peer avg 4.2)

**Closest competitors:**

- The Kingfisher FishBar (6.4) — leads you by 0.6
- Starbucks Drive Thru (6.4) — leads you by 0.6
- Starbucks (6.3) — leads you by 0.5
- Bruno's Bakery (6.3) — leads you by 0.5
- The Food Of Love (6.2) — leads you by 0.4
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.2 | — | 8.1 | +1.0 | Above peers |
| Visibility | 3.1 | — | 3.4 | -0.3 | Below peers |
| Trust | 8.2 | — | 8.0 | +0.3 | Above peers |
| Conversion | 2.5 | — | 4.6 | -2.1 | Significant gap |
| **Overall** | **5.8** | **—** | | | |
...
**Assessment: Strong.** This is a genuine competitive strength at 9.2.
 You lead peers by 1.0 points (peer avg 8.1).
...
**Management note:** At 139 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Critical.** At 2.5, this represents a material operational gap.
 You trail peers by 2.1 points (peer avg 4.6).
...
| Inspection Recency | 2.9/10 | ⚠️ Significant drag | Last inspected 2024-10-22 (18 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-10-22 (18 months ago). Score starting to decay. Note it but don't escalate. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.8 on trust, +0.4 on overall (5.8 → 6.2).
...
You trail peers by 2.1 points on conversion. This isn't a label problem — it means customers are getting a measurably better experience on this dimension from your competitors.
...
### Action 5: Ranked #4 of 5 locally — peers are ahead
**Status:** Stale (4 months) | **Priority:** Medium
...
| Google review count | 139 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.3★ (139 reviews) | observed | ✓ |
...
| Last Inspection | 2024-10-22 | FSA | observed |
| Google Rating | 4.3/5 | Google Places API | observed |
| Google Reviews | 139 | Google Places API | observed |
