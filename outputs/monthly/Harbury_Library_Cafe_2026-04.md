# Harbury Library Cafe — Monthly Intelligence Report
...
- Ranked #7 of 9 locally — peers are ahead
...
**Competitive position:** Local Peers (5mi): #7 of 9 (P25.0) — peer avg 6.17, top 6.78
  Catchment (15mi): #17 of 37 (P55.6) — peer avg 5.79, top 6.92
  UK Category Cohort: #27 of 53 (P50.0) — peer avg 5.78, top 6.92
...
Based on publicly observable data for Harbury Library Cafe, your current operational gaps are putting an estimated **3–12 covers per week** at risk — representing approximately **£380–£2,880 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£190–£1,440/mo); Fix the digital shopfront — you're losing walk-ins (£190–£1,440/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~40–80 | Derived from 26 Google reviews (micro venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 26 Google (5★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 5 rating across 26 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Harbury Library Cafe is a cafe venue with an adequate public reputation (5.0/5, 26 reviews) that has room to build stronger proof.
...
- **Evidence:** `experience=8.96, conversion=2.5`
...
- **Review momentum.** At 26 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: cafe, library, art_gallery, event_venue, service. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: cafe, library, art_gallery, event_venue, service*
...
Online visibility (2.6) hasn't kept pace with guest experience quality (9.0). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **The 5.0/5 rating feels dominant but isn't.** In this market, peer venues achieve similar ratings. Your percentile position (P25.0) shows the rating is table stakes, not a differentiator.
...
- **Unrealised review authority.** At 26 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** Only 26 reviews — rating is volatile. A single 1-star review moves the average measurably.
...
|--------|-------------|---------------------|
| Customer Rating | 5.0/5 Google (Strong) | Experience 9.0/10 (Strong) — Aligned |
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 8.5/10 (Strong) |
| Review Volume | 26 reviews (Low) | Visibility 2.6/10 (Weak) |
...
Harbury Library Cafe is classified as **Cafe / Coffee Shop** (confidence: high). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | cafe, library, art_gallery, event_venue, service | Primary |
| Name | "Harbury Library Cafe" contains "cafe" | Supportive |

**Resolved category:** Cafe / Coffee Shop (confidence: high)

### Peer Justification

- **South Costa** (6.8): Dining with comparable price band; 3.2 miles away
- **Building 523 Costa And Kitchen** (6.8): Dining with comparable price band; 3.2 miles away
- **Dec X Canteen** (6.7): Dining with comparable price band; 3.2 miles away
- **Nel's At The Pavilion** (6.6): Dining with comparable price band; 3.1 miles away
- **Southam Gateway Coffee Shop Ltd** (6.1): Dining with comparable price band; 3.1 miles away

## Competitive Market Intelligence

**Local market:** 8 direct competitors identified.

Below the median (P25). Customers have higher-rated alternatives nearby (peer avg 6.2, top 6.8).

**Where you lead:** Trust (+0.6)
**Where peers beat you:** Visibility (-0.9), Conversion (-0.6)
...
You are below the median of your peer set. At 5.8 vs peer average 6.2, competitors are outperforming you. The top performer scores 6.8. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Trust: 8.5 (+0.6 above peer avg 7.9)
- Conversion: 2.5 (-0.6 below peer avg 3.1)
- Visibility: 2.6 (-0.9 below peer avg 3.5)

**Closest competitors:**

- South Costa (6.8) — leads you by 0.9
- Building 523 Costa And Kitchen (6.8) — leads you by 0.9
- Dec X Canteen (6.7) — leads you by 0.8
- Nel's At The Pavilion (6.6) — leads you by 0.8
- Southam Gateway Coffee Shop Ltd (6.1) — leads you by 0.2
...
- **Wins on:** Conversion (+1.0): more complete operational signals (hours, menu, delivery/takeaway, booking); Experience (+0.7): higher composite experience score from rating + compliance signals
...
- **Copy / test:** Build review volume — they have 600 to your 26. Read their recent positive reviews (4.7/5) for operational clues.
- **Defend:** Defend your trust advantage (+0.5).
...
You sit above the median but below the top tier. Your 5.8 compares to a peer average of 5.8. The gap to the top (6.9) is 1.1 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 8.5 (+0.9 above peer avg 7.6)
- Conversion: 2.5 (-0.5 below peer avg 3.0)
- Visibility: 2.6 (-0.7 below peer avg 3.3)
...
- Building 523 Costa And Kitchen (6.8) — leads you by 0.9
- Dec X Canteen (6.7) — leads you by 0.8
- Gilks' Garage Cafe (6.7) — leads you by 0.8

### UK Category Cohort (52 peers in Cafe / Coffee Shop)

**Position:** #27 of 53 (Percentile 50.0)

You sit above the median but below the top tier. Your 5.8 compares to a peer average of 5.8. The gap to the top (6.9) is 1.1 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 8.5 (+1.0 above peer avg 7.5)
...
- Puddleduck Cafe Ltd (6.9) — leads you by 1.1
- South Costa (6.8) — leads you by 0.9
- Nanas Caff (6.8) — leads you by 0.9
- Building 523 Costa And Kitchen (6.8) — leads you by 0.9
- Dec X Canteen (6.7) — leads you by 0.8
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.0 | — | 9.0 | -0.0 | Strong |
| Visibility | 2.6 | — | 3.5 | -0.9 | Below peers |
| Trust | 8.5 | — | 7.9 | +0.6 | Above peers |
| Conversion | 2.5 | — | 3.1 | -0.6 | Below peers |
| **Overall** | **5.8** | **—** | | | |

*Prestige (editorial recognition): 1.5/10 (peer avg 1.3) — tracked but not a headline operational lever for most independents.*
...
**Management note:** At 26 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 7.5/10 | ✅ Adequate | Last inspected 2025-12-05 (4 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-12-05 (4 months ago). Full confidence. No action needed. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.6 on trust, +0.1 on overall (5.8 → 6.0).
...
Your 5/5 Google rating feels dominant but you sit below the local median (P25.0). Peer venues achieve similar or better ratings — in this market, 4.5 is table stakes, not a differentiator. Don't mistake the number for an advantage.

**Ranked #7 of 9 locally — peers are ahead** [ESCALATED]
...
### Action 5: Ranked #7 of 9 locally — peers are ahead
**Status:** Stale (4 months) | **Priority:** Medium
...
| Google review count | 26 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 5.0★ (26 reviews) | observed | ✓ |
...
| Last Inspection | 2025-12-05 | FSA | observed |
| Google Rating | 5.0/5 | Google Places API | observed |
| Google Reviews | 26 | Google Places API | observed |
...
| Postcode | CV33 9HW | FSA | observed |
| Companies House | — | Not checked | not_assessed |
