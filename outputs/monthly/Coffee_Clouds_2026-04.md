# Coffee Clouds — Monthly Intelligence Report
...
**Overall score: 6.0/10** (baseline month — no prior comparison)
 | Strongest: Experience (8.5) | Weakest: Visibility (3.4)

**Competitive position:** Local Peers (5mi): #5 of 18 (P76.5) — peer avg 5.47, top 6.64
  Catchment (15mi): #21 of 46 (P55.6) — peer avg 5.72, top 6.78
  UK Category Cohort: #26 of 53 (P51.9) — peer avg 5.78, top 6.92
...
Based on publicly observable data for Coffee Clouds, your current operational gaps are putting an estimated **7–22 covers per week** at risk — representing approximately **£840–£5,280 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£420–£2,640/mo); Fix the digital shopfront — you're losing walk-ins (£420–£2,640/mo); Protect the 4.6/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~140–220 | Derived from 311 Google reviews (mid venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 311 Google (4.6★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.6 rating across 311 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Coffee Clouds operates as a credible cafe venue with a 4.6/5 Google rating across 311 reviews — solid but not yet commanding.
...
With 311 reviews at 4.6/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 311 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: cafe, restaurant, food_store, store. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: cafe, restaurant, food_store, store*
...
Online visibility (3.4) hasn't kept pace with guest experience quality (8.5). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 311 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 311 reviews (Moderate) | Visibility 3.4/10 (Weak) |
...
Coffee Clouds is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | cafe, restaurant, food_store, store | Primary |
...
- **Touchdown Cafe** (5.8): Dining with comparable price band; 3.7 miles away

## Competitive Market Intelligence

**Local market:** 17 direct competitors identified.

Above the median (P76) but not leading. Peer average is 5.5; the top performer scores 6.6. The gap to the top is closeable.

**Where you lead:** Trust (+1.2), Conversion (+0.6)
...
**Position:** #5 of 18 (Percentile 76.5)

You sit above the median but below the top tier. Your 6.0 compares to a peer average of 5.5. The gap to the top (6.6) is 0.7 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 8.3 (+1.2 above peer avg 7.1)
- Conversion: 3.5 (+0.6 above peer avg 2.9)

**Closest competitors:**

- Shakespaw Cat Cafe (6.6) — leads you by 0.7
- No 37 Cafe (6.3) — leads you by 0.4
- Costa (6.3) — leads you by 0.3
- Espresso Barn (6.3) — leads you by 0.3
- Touchdown Cafe (5.8) — you lead by 0.2
...
- **Copy / test:** Review inspection documentation and sub-score gaps. Read their recent positive reviews (4.3/5) for operational clues.
...
- **Wins on:** Experience (+0.9): higher composite experience score from rating + compliance signals; Trust (+0.7): same FSA rating but likely stronger sub-scores or more recent inspection
...
**Position:** #21 of 46 (Percentile 55.6)

You sit above the median but below the top tier. Your 6.0 compares to a peer average of 5.7. The gap to the top (6.8) is 0.8 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 8.3 (+0.9 above peer avg 7.4)
- Conversion: 3.5 (+0.6 above peer avg 2.9)

**Closest competitors:**

- South Costa (6.8) — leads you by 0.8
- Building 523 Costa And Kitchen (6.8) — leads you by 0.8
- Dec X Canteen (6.7) — leads you by 0.7
- Gilks' Garage Cafe (6.7) — leads you by 0.7
- Shakespaw Cat Cafe (6.6) — leads you by 0.7

### UK Category Cohort (52 peers in Cafe / Coffee Shop)

**Position:** #26 of 53 (Percentile 51.9)

You sit above the median but below the top tier. Your 6.0 compares to a peer average of 5.8. The gap to the top (6.9) is 0.9 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 8.3 (+0.8 above peer avg 7.5)
- Conversion: 3.5 (+0.6 above peer avg 2.9)

**Closest competitors:**

- Puddleduck Cafe Ltd (6.9) — leads you by 0.9
- South Costa (6.8) — leads you by 0.8
- Nanas Caff (6.8) — leads you by 0.8
- Building 523 Costa And Kitchen (6.8) — leads you by 0.8
- Dec X Canteen (6.7) — leads you by 0.7
...
**Management note:** At 311 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 8.3.
 You lead peers by 1.2 points (peer avg 7.1).
...
| Inspection Recency | 6.8/10 | ⚠️ Room to improve | Last inspected 2025-10-21 (6 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-10-21 (6 months ago). Full confidence. No action needed. 

**Peer context:** Shakespaw Cat Cafe's trust lead (+1.3) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.8 on trust, +0.2 on overall (6.0 → 6.2).
...
### Action 3: Protect the 4.6/5 rating — it took years to build
**Status:** Stale (4 months) | **Priority:** High
...
| Google review count | 311 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.6★ (311 reviews) | observed | ✓ |
...
| Last Inspection | 2025-10-21 | FSA | observed |
| Google Rating | 4.6/5 | Google Places API | observed |
| Google Reviews | 311 | Google Places API | observed |
...
| Postcode | CV37 6GJ | FSA | observed |
| Companies House | — | Not checked | not_assessed |
