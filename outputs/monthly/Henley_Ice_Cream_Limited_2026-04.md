# Henley Ice Cream Limited — Monthly Intelligence Report
...
**Competitive position:** Local Peers (5mi): #2 of 5 (P75.0) — peer avg 5.65, top 6.25
  Catchment (15mi): #10 of 36 (P74.3) — peer avg 5.65, top 6.78
  UK Category Cohort: #15 of 53 (P73.1) — peer avg 5.78, top 6.92
...
Based on publicly observable data for Henley Ice Cream Limited, your current operational gaps are putting an estimated **21–65 covers per week** at risk — representing approximately **£1,340–£7,800 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£670–£3,900/mo); Fix the digital shopfront — you're losing walk-ins (£670–£3,900/mo); Protect the 4.7/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~420–650 | Derived from 1,160 Google reviews (high-traffic venue indicator), price level £ |
...
| Weekly revenue at risk | £340–£1,950 | Recoverable with priority action fixes |
| Monthly revenue at risk | £1,340–£7,800 | Aggregate across top 3 priorities |
| Annual projection | £16,080–£93,600 | If current gaps persist 12 months |
...
| Aggregate signals | Rating and volume from all platforms | 1,160 Google (4.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.7 rating across 1,160 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Henley Ice Cream Limited is a well-established cafe venue with a strong public reputation — 4.7/5 across 1,160 Google reviews. That volume means the reputation is earned, not manufactured.
...
With 1160 reviews at 4.7/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 1160 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: ice_cream_shop, tea_house, dessert_shop, confectionery, cafe, food_store, store. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: ice_cream_shop, tea_house, dessert_shop, confectionery, cafe, food_store, store*
...
- **Volume:** 1,160 reviews — statistically robust rating. Individual reviews have negligible impact.
...
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 7.4/10 (Adequate) |
| Review Volume | 1160 reviews (High) | Visibility 3.8/10 (Weak) |
...
Henley Ice Cream Limited is classified as **Cafe / Coffee Shop** (confidence: high). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | ice_cream_shop, tea_house, dessert_shop, confectionery, cafe, food_store, store | Primary |
...
- **Costa** (6.2): Dining with comparable price band; 0.2 miles away
- **Cafe 86B** (5.8): Dining with comparable price band; 0.1 miles away
- **JNB Cafe** (5.6): Dining with comparable price band; 4.8 miles away
- **The Cowshed Cafe** (5.0): Dining with comparable price band; 1.8 miles away

## Competitive Market Intelligence

**Local market:** 4 direct competitors identified.

Above the median (P75) but not leading. Peer average is 5.7; the top performer scores 6.2. The gap to the top is closeable.

**Where you lead:** Experience (+1.0), Visibility (+0.6), Conversion (+0.5)

*Commercial implication: you capture an adequate share of a 5-venue market, but the gap to the top (6.2) represents demand you could win. Closing the gap typically requires 1–2 targeted dimension improvements (indicative).*
...
You sit above the median but below the top tier. Your 6.2 compares to a peer average of 5.7. The gap to the top (6.2) is 0.1 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Experience: 9.7 (+1.0 above peer avg 8.6)
- Visibility: 3.8 (+0.6 above peer avg 3.2)
- Conversion: 3.5 (+0.5 above peer avg 3.0)

**Closest competitors:**

- Costa (6.2) — leads you by 0.1
- Cafe 86B (5.8) — you lead by 0.4
- JNB Cafe (5.6) — you lead by 0.6
- The Cowshed Cafe (5.0) — you lead by 1.2
...
### Extended Catchment (35 peers within 15 miles)

**Position:** #10 of 36 (Percentile 74.3)

You sit above the median but below the top tier. Your 6.2 compares to a peer average of 5.7. The gap to the top (6.8) is 0.6 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Experience: 9.7 (+1.0 above peer avg 8.7)
...
- Shakespaw Cat Cafe (6.6) — leads you by 0.4
- Nel's At The Pavilion (6.6) — leads you by 0.4

### UK Category Cohort (52 peers in Cafe / Coffee Shop)

**Position:** #15 of 53 (Percentile 73.1)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.7 | — | 8.6 | +1.0 | Above peers |
| Visibility | 3.8 | — | 3.2 | +0.6 | Above peers |
| Trust | 7.4 | — | 7.6 | -0.1 | In line |
...
**Assessment: Strong.** This is a genuine competitive strength at 9.7.
 You lead peers by 1.0 points (peer avg 8.6).
...
**Assessment: Critical.** At 3.8, this represents a material operational gap.
 Slightly above peer average (3.2).
...
**Management note:** At 1160 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 3.2/10 | ⚠️ Significant drag | Last inspected 2024-11-29 (17 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-11-29 (17 months ago). Score starting to decay. Note it but don't escalate. 

**Peer context:** Costa's trust lead (+1.8) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.7 on trust, +0.4 on overall (6.2 → 6.6).
...
| Google review count | 1160 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.7★ (1160 reviews) | observed | ✓ |
...
| Last Inspection | 2024-11-29 | FSA | observed |
| Google Rating | 4.7/5 | Google Places API | observed |
| Google Reviews | 1160 | Google Places API | observed |
