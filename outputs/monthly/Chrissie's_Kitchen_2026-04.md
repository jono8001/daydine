# Chrissie's Kitchen — Monthly Intelligence Report
...
**Overall score: 5.9/10** (baseline month — no prior comparison)
 | Strongest: Experience (10.0) | Weakest: Conversion (1.5)

**Competitive position:** UK Category Cohort: #4 of 6 (P40.0) — peer avg 5.92, top 6.51
...
Based on publicly observable data for Chrissie's Kitchen, your current operational gaps are putting an estimated **6–21 covers per week** at risk — representing approximately **£760–£5,540 per month** in lost or leaked revenue. The main drivers are: Publish opening hours — you're invisible to 'open now' searches (£380–£2,520/mo); Renew formal trust proof before it becomes a visible drag (£0–£500/mo (defensive)); Get your menu online — 77% of diners check before visiting (£380–£2,520/mo). Taking action on **Publish opening hours — you're invisible to 'open now' searches** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~80–140 | Derived from 79 Google reviews (small venue indicator), price level ££ |
| Average spend per head | ~£22 | UK hospitality benchmark for price level ££ |
| Covers at risk per week | 6–21 | Conversion score 1.5/10 → 8%–15% leakage |
...
| Aggregate signals | Rating and volume from all platforms | 79 Google (5★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 5 rating across 79 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Chrissie's Kitchen is a takeaway venue with an adequate public reputation (5.0/5, 79 reviews) that has room to build stronger proof.
...
- **Review momentum.** At 79 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
**2 of 7** demand capture dimensions are clear. **2** have friction. **3** are missing.

*First audit — all dimensions baselined for next month's comparison.*

*Conversion dimension score: 1.5/10 — this audit explains what is behind that number.*
...
Insufficient review data to cross-reference proposition. Google types show: catering_service, event_venue, food_delivery, service. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: catering_service, event_venue, food_delivery, service*
...
- **Unrealised review authority.** At 79 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** Only 79 reviews — rating is volatile. A single 1-star review moves the average measurably.
...
| Review Volume | 79 reviews (Low) | Visibility 2.9/10 (Weak) |
| Booking/Ordering | What customers can find | Conversion 1.5/10 (Gaps) |

## Category & Peer Validation

### Why This Venue Is In This Cohort

Chrissie's Kitchen is classified as **Catering Service** (confidence: low). Google's raw category is "Takeaway" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | catering_service, event_venue, food_delivery, service | Primary |

**Resolved category:** Catering Service (confidence: low)
...
You are below the median of your peer set. At 5.9 vs peer average 5.9, competitors are outperforming you. The top performer scores 6.5. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Experience: 10.0 (+1.1 above peer avg 8.9)
- Conversion: 1.5 (-2.9 below peer avg 4.4)

**Closest competitors:**

- The Pickled Crab Deli (6.5) — leads you by 0.6
- Pickled & Tipsy's Cafe (6.2) — leads you by 0.3
- The Bishops Fryer (6.1) — leads you by 0.2
- The Margin (5.5) — you lead by 0.4
- The Water Margin @ The Hollybush (5.2) — you lead by 0.8

## Dimension Scorecard

| Dimension | Score | Δ | Peer Avg | Gap | Read |
|-----------|------:|--:|---------:|----:|------|
| Experience | 10.0 | — | — | — | Strong |
| Visibility | 2.9 | — | — | — | Needs work |
| Trust | 7.9 | — | — | — | In line |
| Conversion | 1.5 | — | — | — | Needs work |
| **Overall** | **5.9** | **—** | | | |
...
**Management note:** At 79 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 1.7/10 | ⚠️ Significant drag | Last inspected 2024-02-26 (26 months ago). Maximum decay applied. Reinspectio... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-02-26 (26 months ago). Maximum decay applied. Reinspection strongly recommended. The system discounts older inspections because they carry less certainty.

**What you can do:**

1. **Request voluntary reinspection** (free, 4–8 weeks) — would recover ~2.1 trust points. Only request reinspection if confident of maintaining 5/5. A drop to 4 would be worse than the staleness drag.
...
| Google review count | 79 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 5.0★ (79 reviews) | observed | ✓ |
...
| Last Inspection | 2024-02-26 | FSA | observed |
| Google Rating | 5.0/5 | Google Places API | observed |
| Google Reviews | 79 | Google Places API | observed |
