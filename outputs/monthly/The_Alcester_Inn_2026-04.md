# The Alcester Inn — Monthly Intelligence Report
...
**Overall score: 5.9/10** (baseline month — no prior comparison)
 | Strongest: Trust (9.7) | Weakest: Conversion (2.5)

**Competitive position:** Local Peers (5mi): #3 of 5 (P50.0) — peer avg 5.62, top 6.73
  Catchment (15mi): #10 of 15 (P35.7) — peer avg 5.99, top 7.34
  UK Category Cohort: #11 of 19 (P44.4) — peer avg 5.91, top 7.34
...
Based on publicly observable data for The Alcester Inn, your current operational gaps are putting an estimated **18–52 covers per week** at risk — representing approximately **£2,120–£12,600 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£1,060–£6,300/mo); Fix the digital shopfront — you're losing walk-ins (£1,060–£6,300/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~220–350 | Derived from 513 Google reviews (large venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 513 Google (4.1★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.1 rating across 513 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Alcester Inn operates as a credible pub dining venue with a 4.1/5 Google rating across 513 reviews — solid but not yet commanding.
...
- **Evidence:** `experience=7.91, conversion=2.5`
...
- **Review momentum.** At 513 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: inn, hotel, live_music_venue, lodging, bar, event_venue, restaurant, service. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: inn, hotel, live_music_venue, lodging, bar, event_venue, restaurant, service*
...
Online visibility (3.5) hasn't kept pace with guest experience quality (7.9). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 513 reviews — strong base. Rating is stable but a sustained negative pattern could shift it.
...
| Review Volume | 513 reviews (High) | Visibility 3.5/10 (Weak) |
...
The Alcester Inn is classified as **Inn** (confidence: low). Google's raw category is "Pub / Bar" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | inn, hotel, live_music_venue, lodging, bar, event_venue, restaurant, service | Primary |

**Resolved category:** Inn (confidence: low)

### Peer Justification

- **Arrow Mill** (6.7): Hotel restaurant — different occasion type, may not compete for walk-in trade; 1.4 miles away *(marginal comparator)*
- **Cafe Des Fleurs** (6.2): Pub Dining with comparable price band; 0.4 miles away
- **The Cottage Of Content** (5.2): Pub Dining with comparable price band; 4.3 miles away
- **The Roebuck Inn Alcester** (4.4): Dining with comparable price band; 0.5 miles away

## Competitive Market Intelligence

**Local market:** 4 direct competitors identified.

Above the median (P50) but not leading. Peer average is 5.6; the top performer scores 6.7. The gap to the top is closeable.

**Where you lead:** Trust (+1.8)
**Where peers beat you:** Conversion (-1.0), Experience (-0.7)
...
You sit above the median but below the top tier. Your 5.9 compares to a peer average of 5.6. The gap to the top (6.7) is 0.9 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 9.7 (+1.8 above peer avg 7.8)
- Experience: 7.9 (-0.7 below peer avg 8.7)
- Conversion: 2.5 (-1.0 below peer avg 3.5)

**Closest competitors:**

- Arrow Mill (6.7) — leads you by 0.9
- Cafe Des Fleurs (6.2) — leads you by 0.4
- The Cottage Of Content (5.2) — you lead by 0.7
- The Roebuck Inn Alcester (4.4) — you lead by 1.5
...
- **Why it matters:** They lead on both Experience and Conversion — a combined advantage that is harder to close than a single-dimension gap.
- **Copy / test:** Read their recent positive reviews (4.5/5) for operational clues. Audit your Google profile vs theirs: hours, menu, booking, delivery.
...
- **Also wins on:** Conversion (+1.0): more complete operational signals (hours, menu, delivery/takeaway, booking)
- **Why it matters:** They lead on both Experience and Conversion — a combined advantage that is harder to close than a single-dimension gap.
- **Copy / test:** Read their recent positive reviews (4.4/5) for operational clues. Audit your Google profile vs theirs: hours, menu, booking, delivery.
- **Defend:** No clear defensive advantage — you are closely matched across dimensions.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

### Extended Catchment (14 peers within 15 miles)

**Position:** #10 of 15 (Percentile 35.7)

You are below the median of your peer set. At 5.9 vs peer average 6.0, competitors are outperforming you. The top performer scores 7.3. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Trust: 9.7 (+1.6 above peer avg 8.1)
- Conversion: 2.5 (-0.7 below peer avg 3.2)
- Experience: 7.9 (-1.1 below peer avg 9.0)

**Closest competitors:**

- Vintner Wine Bar (7.3) — leads you by 1.5
- Arrow Mill (6.7) — leads you by 0.9
- The Fox Inn (6.5) — leads you by 0.6
- The Red Lion (6.4) — leads you by 0.5
- The Townhouse Also Trading As JR Hotel And Restaurants LTD (6.3) — leads you by 0.5

### UK Category Cohort (18 peers in Pub / Bar)

**Position:** #11 of 19 (Percentile 44.4)

You are below the median of your peer set. At 5.9 vs peer average 5.9, competitors are outperforming you. The top performer scores 7.3. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Trust: 9.7 (+1.7 above peer avg 7.9)
- Conversion: 2.5 (-0.8 below peer avg 3.3)
- Experience: 7.9 (-0.9 below peer avg 8.8)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 7.9 | — | 8.7 | -0.7 | Below peers |
| Visibility | 3.5 | — | 3.6 | -0.1 | Needs work |
| Trust | 9.7 | — | 7.8 | +1.8 | Clear strength |
| Conversion | 2.5 | — | 3.5 | -1.0 | Below peers |
| **Overall** | **5.9** | **—** | | | |
...
**Management note:** At 513 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 9.7.
 You lead peers by 1.8 points (peer avg 7.8).
...
**Assessment: Critical.** At 2.5, this represents a material operational gap.
 You trail peers by 1.0 points (peer avg 3.5).
...
| Inspection Recency | 8.6/10 | ✅ Adequate | Last inspected 2026-02-02 (2 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2026-02-02 (2 months ago). Full confidence. No action needed. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.3 on trust, +0.1 on overall (5.9 → 6.0).
...
| Google review count | 513 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.1★ (513 reviews) | observed | ✓ |
...
| Last Inspection | 2026-02-02 | FSA | observed |
| Google Rating | 4.1/5 | Google Places API | observed |
| Google Reviews | 513 | Google Places API | observed |
