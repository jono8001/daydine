# Costa Coffee — Monthly Intelligence Report
...
**Overall score: 5.6/10** (baseline month — no prior comparison)
 | Strongest: Trust (8.8) | Weakest: Visibility (1.5)

**Competitive position:** Local Peers (5mi): #9 of 20 (P57.9) — peer avg 5.53, top 6.64
  Catchment (15mi): #31 of 47 (P34.8) — peer avg 5.74, top 6.78
...
Based on publicly observable data for Costa Coffee, your current operational gaps are putting an estimated **2–8 covers per week** at risk — representing approximately **£310–£2,880 per month** in lost or leaked revenue. The main drivers are: Identify and fix the recurring guest complaint (£70–£960/mo); Get your menu online — 77% of diners check before visiting (£120–£960/mo); Fix the digital shopfront — you're losing walk-ins (£120–£960/mo). Taking action on **Identify and fix the recurring guest complaint** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~40–80 | Derived from 35 Google reviews (micro venue indicator), price level ££ |
| Average spend per head | ~£22 | UK hospitality benchmark for price level ££ |
| Covers at risk per week | 2–8 | Conversion score 3.5/10 → 5%–10% leakage |
| Weekly revenue at risk | £80–£720 | Recoverable with priority action fixes |
| Monthly revenue at risk | £310–£2,880 | Aggregate across top 3 priorities |
| Annual projection | £3,720–£34,560 | If current gaps persist 12 months |
...
| Aggregate signals | Rating and volume from all platforms | 35 Google (3.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 3.7 rating across 35 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Costa Coffee operates in the cafe category with a public rating of 3.7/5 that is currently limiting discovery.
...
- **Evidence:** `experience=8.48, conversion=3.5`
...
- **Review momentum.** At 35 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Online visibility (1.5) hasn't kept pace with guest experience quality (8.5). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** Only 35 reviews — rating is volatile. A single 1-star review moves the average measurably.
...
|--------|-------------|---------------------|
| Customer Rating | 3.7/5 Google (Weak) | Experience 8.5/10 (Strong) — Gap |
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 8.8/10 (Strong) |
| Review Volume | 35 reviews (Low) | Visibility 1.5/10 (Weak) |
...
Costa Coffee is classified as **Cafe / Coffee Shop** (confidence: high). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 2 signal sources.
...
- **Shakespaw Cat Cafe** (6.6): Dining with similar price band; 1.0 miles away
- **No 37 Cafe** (6.3): Dining with similar price band; 0.9 miles away
- **Costa** (6.3): Dining with similar price band; 1.6 miles away
- **Espresso Barn** (6.3): Dining with comparable price band; 4.3 miles away
- **Ettington Garden Cafe** (6.2): Dining with comparable price band; 4.8 miles away

## Competitive Market Intelligence

**Local market:** 19 direct competitors identified.

Above the median (P58) but not leading. Peer average is 5.5; the top performer scores 6.6. The gap to the top is closeable.

**Where you lead:** Trust (+1.5), Conversion (+0.7)
**Where peers beat you:** Visibility (-1.9)

*Commercial implication: you capture an adequate share of a 20-venue market, but the gap to the top (6.6) represents demand you could win. Closing the gap typically requires 1–2 targeted dimension improvements (indicative).*

**Density alert:** 19 competitors within range. Differentiation is critical — competing on fundamentals alone is insufficient in a dense market.
...
19 direct competitors within 5mi. Differentiation critical.
...
### Local Competitive Set (19 peers within 5 miles)

**Position:** #9 of 20 (Percentile 57.9)
...
- Trust: 8.8 (+1.5 above peer avg 7.3)
- Conversion: 3.5 (+0.7 above peer avg 2.8)
- Visibility: 1.5 (-1.9 below peer avg 3.4)
...
- Ettington Garden Cafe (6.2) — leads you by 0.6
...
- **Also wins on:** Experience (+1.0): Google 4.6/5 vs your 3.7/5
...
- **Copy / test:** Build review volume — they have 952 to your 35. Read their recent positive reviews (4.6/5) for operational clues.
...
- **Also wins on:** Trust (+0.7): same FSA rating but likely stronger sub-scores or more recent inspection
...
- **Copy / test:** Build review volume — they have 430 to your 35. Review inspection documentation and sub-score gaps.
- **Defend:** No clear defensive advantage — you are closely matched across dimensions.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*
...
- **Why it matters:** They lead on both Visibility and Trust — a combined advantage that is harder to close than a single-dimension gap.
- **Copy / test:** Build review volume — they have 541 to your 35. Review inspection documentation and sub-score gaps.
- **Defend:** No clear defensive advantage — you are closely matched across dimensions.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

### Extended Catchment (46 peers within 15 miles)

**Position:** #31 of 47 (Percentile 34.8)
...
- Trust: 8.8 (+1.4 above peer avg 7.4)
- Conversion: 3.5 (+0.6 above peer avg 2.9)
- Visibility: 1.5 (-1.8 below peer avg 3.2)
...
- Conversion: 3.5 (+0.6 above peer avg 2.9)
- Visibility: 1.5 (-1.7 below peer avg 3.2)
...
| Visibility | 1.5 | — | 3.4 | -1.9 | Significant gap |
| Trust | 8.8 | — | 7.3 | +1.5 | Clear strength |
...
**Assessment: Critical.** At 1.5, this represents a material operational gap.
 You trail peers by 1.9 points (peer avg 3.4).
...
**Management note:** At 35 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 8.8.
 You lead peers by 1.5 points (peer avg 7.3).
...
| Inspection Recency | 6.6/10 | ⚠️ Room to improve | Last inspected 2025-10-13 (6 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-10-13 (6 months ago). Full confidence. No action needed. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.8 on trust, +0.2 on overall (5.6 → 5.8).
...
| Google review count | 35 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 3.7★ (35 reviews) | observed | ✓ |
...
| Last Inspection | 2025-10-13 | FSA | observed |
| Google Rating | 3.7/5 | Google Places API | observed |
| Google Reviews | 35 | Google Places API | observed |
...
| Postcode | CV37 8LU | FSA | observed |
| Companies House | — | Not checked | not_assessed |
