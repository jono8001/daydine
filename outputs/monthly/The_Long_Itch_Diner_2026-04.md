# The Long Itch Diner — Monthly Intelligence Report
...
**Overall score: 5.7/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.3) | Weakest: Visibility (3.7)

**Competitive position:** Catchment (15mi): #6 of 8 (P28.6) — peer avg 5.86, top 6.43
  UK Category Cohort: #7 of 11 (P40.0) — peer avg 5.74, top 6.43
...
Based on publicly observable data for The Long Itch Diner, your current operational gaps are putting an estimated **8–32 covers per week** at risk — representing approximately **£540–£4,400 per month** in lost or leaked revenue. The main drivers are: Close the hygiene gap — 4 to 5 (£0–£500/mo (defensive)); Get your menu online — 77% of diners check before visiting (£270–£1,950/mo); Fix the digital shopfront — you're losing walk-ins (£270–£1,950/mo). Taking action on **Close the hygiene gap — 4 to 5** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~420–650 | Derived from 849 Google reviews (high-traffic venue indicator), price level £ |
| Average spend per head | ~£12 | UK hospitality benchmark for price level £ |
| Covers at risk per week | 8–32 | Conversion score 5.0/10 → 2%–5% leakage |
| Weekly revenue at risk | £140–£1,100 | Recoverable with priority action fixes |
| Monthly revenue at risk | £540–£4,400 | Aggregate across top 3 priorities |
| Annual projection | £6,480–£52,800 | If current gaps persist 12 months |
...
| Aggregate signals | Rating and volume from all platforms | 849 Google (4.4★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.4 rating across 849 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Long Itch Diner operates as a credible quick-service food venue with a 4.4/5 Google rating across 849 reviews — solid but not yet commanding.
...
- **Evidence:** `experience=9.3, conversion=5.0`
...
- **Review momentum.** At 849 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: cafe, sandwich_shop, breakfast_restaurant, diner, fast_food_restaurant, meal_takeaway, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: cafe, sandwich_shop, breakfast_restaurant, diner, fast_food_restaurant, meal_takeaway, restaurant*
...
- **Volume:** 849 reviews — strong base. Rating is stable but a sustained negative pattern could shift it.
...
| Hygiene Rating | FSA 4/5 (Acceptable) | Trust 5.7/10 (Weak) |
| Review Volume | 849 reviews (High) | Visibility 3.7/10 (Weak) |
...
The Long Itch Diner is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Fast Food / Quick Service" but the resolved category triangulates across 3 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | cafe, sandwich_shop, breakfast_restaurant, diner, fast_food_restaurant, meal_takeaway, restaurant | Primary |
| Price Level | £ (1/4) — Budget | Supportive |
| Name | "The Long Itch Diner" contains "restaurant" | Supportive |
...
You are below the median of your peer set. At 5.7 vs peer average 5.9, competitors are outperforming you. The top performer scores 6.4. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Experience: 9.3 (+1.1 above peer avg 8.2)
- Conversion: 5.0 (+0.9 above peer avg 4.1)
- Trust: 5.7 (-2.6 below peer avg 8.2)

**Closest competitors:**

- The Kingfisher FishBar (6.4) — leads you by 0.7
- Starbucks Drive Thru (6.4) — leads you by 0.7
- Starbucks (6.3) — leads you by 0.6
- The Food Of Love (6.2) — leads you by 0.5
- GAIL's Stratford-Upon-Avon (5.8) — leads you by 0.1

### UK Category Cohort (10 peers in Fast Food / Quick Service)

**Position:** #7 of 11 (Percentile 40.0)

You are below the median of your peer set. At 5.7 vs peer average 5.7, competitors are outperforming you. The top performer scores 6.4. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Experience: 9.3 (+1.1 above peer avg 8.2)
- Conversion: 5.0 (+1.0 above peer avg 4.0)
- Trust: 5.7 (-2.3 below peer avg 8.0)
...
- Starbucks Drive Thru (6.4) — leads you by 0.7
- Starbucks (6.3) — leads you by 0.6
- Bruno's Bakery (6.3) — leads you by 0.6
- The Food Of Love (6.2) — leads you by 0.5
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.3 | — | — | — | Strong |
| Visibility | 3.7 | — | — | — | Needs work |
| Trust | 5.7 | — | — | — | In line |
| Conversion | 5.0 | — | — | — | In line |
| **Overall** | **5.7** | **—** | | | |
...
**Management note:** At 849 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 2.9/10 | ⚠️ Significant drag | Last inspected 2024-10-14 (18 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-10-14 (18 months ago). Score starting to decay. Note it but don't escalate. 
...
| Google review count | 849 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.4★ (849 reviews) | observed | ✓ |
...
| Last Inspection | 2024-10-14 | FSA | observed |
| Google Rating | 4.4/5 | Google Places API | observed |
| Google Reviews | 849 | Google Places API | observed |
...
| Postcode | CV47 9QZ | FSA | observed |
| Companies House | — | Not checked | not_assessed |
