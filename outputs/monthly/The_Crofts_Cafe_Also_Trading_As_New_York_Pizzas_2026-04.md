# The Crofts Cafe Also Trading As New York Pizzas — Monthly Intelligence Report
...
**Overall score: 6.5/10** (baseline month — no prior comparison)
 | Strongest: Trust (8.0) | Weakest: Experience (7.5)

**Competitive position:** Local Peers (5mi): #1 of 6 (P100.0) — peer avg 5.75, top 6.16
  Catchment (15mi): #1 of 9 (P100.0) — peer avg 5.77, top 6.3
  UK Category Cohort: #1 of 9 (P100.0) — peer avg 5.77, top 6.3
...
The Crofts Cafe Also Trading As New York Pizzas operates in the american / grill category with a public rating of None/5 that is currently limiting discovery.
...
- **Prestige positioning.** Your fundamentals are strong enough to support a credible awards submission. This is the clearest growth lever for a venue already operating well.
...
GBP profile is only 2/10 complete. Significant gaps: Has rating, Has reviews (>0), Has photos (>0), Has opening hours, Has price level, Review count >= 10, Review count >= 100, Has website.

**Commercial consequence:** Incomplete GBP profile suppresses Google Maps visibility and customer action.

*Signals: GBP completeness: 2/10; Missing: Has rating, Has reviews (>0), Has photos (>0), Has opening hours, Has price level, Review count >= 10, Review count >= 100, Has website*

### Photo Mix & Quality [MISSING]

Zero photos. A faceless listing loses to every competitor with a single photo.

**Commercial consequence:** No visual proof of experience — maximum conversion friction at discovery.

*Signals: Photo count: 0; Peer average: ~10 photos*

### Proposition Clarity [PARTIAL]

Insufficient review data to cross-reference proposition. Google types show: american_restaurant, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: american_restaurant, restaurant*
...
|--------|-------------|---------------------|
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 8.0/10 (Adequate) |

## Category & Peer Validation

### Why This Venue Is In This Cohort

The Crofts Cafe Also Trading As New York Pizzas is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "American / Grill" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | american_restaurant, restaurant | Primary |
| Name | "The Crofts Cafe Also Trading As New York Pizzas" contains "cafe" | Supportive |

**Resolved category:** Restaurant (General) (confidence: medium)

### Peer Justification

- **Beleza Rodizio** (6.2): Dining with comparable price band; 0.3 miles away
- **McDonald's** (6.0): Dining with comparable price band; 0.2 miles away
- **McDonald's** (5.8): Dining with comparable price band; 0.4 miles away
- **WINGERS STRATFORD** (5.5): Dining with comparable price band; 0.6 miles away
- **Libertine Burger** (5.4): Dining with comparable price band; 0.3 miles away
...
**Where peers beat you:** Experience (-1.2)
...
You are in the top quintile of this peer set. Your overall score of 6.5 exceeds the peer average of 5.8 by 0.8 points. The competitive risk here is complacency — the nearest competitor scores 6.2.
...
- Beleza Rodizio (6.2) — you lead by 0.4
- McDonald's (6.0) — you lead by 0.5
- McDonald's (5.8) — you lead by 0.7
- WINGERS STRATFORD (5.5) — you lead by 1.1
- Libertine Burger (5.4) — you lead by 1.1
...
- **Why it matters:** A large experience gap (+2.3) — guests rate their visit higher — this drives reviews, repeats, and word-of-mouth. This is a structural disadvantage, not a rounding error.
...
- **Wins on:** Experience (see pattern above)
- **Why it matters:** A large experience gap (+2.4) — guests rate their visit higher — this drives reviews, repeats, and word-of-mouth. This is a structural disadvantage, not a rounding error.
...
- **Wins on:** Trust (+1.5): same FSA rating but likely stronger sub-scores or more recent inspection
...
You are in the top quintile of this peer set. Your overall score of 6.5 exceeds the peer average of 5.8 by 0.8 points. The competitive risk here is complacency — the nearest competitor scores 6.3.

**Dimension gaps vs peers:**

- Experience: 7.5 (-0.9 below peer avg 8.4)

**Closest competitors:**

- Miller And Carter (6.3) — you lead by 0.2
- Beleza Rodizio (6.2) — you lead by 0.4
- McDonald's (6.0) — you lead by 0.5
- KFC - Southbound (5.8) — you lead by 0.7
- McDonald's (5.8) — you lead by 0.7
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 7.5 | — | 8.7 | -1.2 | Below peers |
| Visibility | — | — | — | — | No data |
| Trust | 8.0 | — | 7.9 | +0.1 | In line |
| Conversion | — | — | — | — | No data |
| **Overall** | **6.5** | **—** | | | |
...
**Assessment: Adequate.** At 7.5, this is functional but not distinctive.
 You trail peers by 1.2 points (peer avg 8.7).
...
**Assessment: Adequate.** At 8.0, this is functional but not distinctive.
...
| Inspection Recency | 5.3/10 | ⚠️ Room to improve | Last inspected 2025-07-10 (9 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-07-10 (9 months ago). Full confidence. No action needed. 

**Peer context:** Beleza Rodizio's trust lead (+1.6) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.2 on trust, +0.3 on overall (6.5 → 6.8).
...
| Last Inspection | 2025-07-10 | FSA | observed |
...
| Postcode | CV37 6PH | FSA | observed |
| Companies House | — | Not checked | not_assessed |
