# Cardamom — Monthly Intelligence Report
...
**Overall score: 6.6/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.5) | Weakest: Visibility (3.4)

**Competitive position:** Local Peers (5mi): #1 of 4 (P100.0) — peer avg 5.39, top 6.08
  Catchment (15mi): #2 of 14 (P92.3) — peer avg 5.58, top 6.59
  UK Category Cohort: #2 of 17 (P93.8) — peer avg 5.56, top 6.59
...
Based on publicly observable data for Cardamom, your current operational gaps are putting an estimated **3–11 covers per week** at risk — representing approximately **£340–£2,640 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£170–£1,320/mo); Fix the digital shopfront — you're losing walk-ins (£170–£1,320/mo); Protect the 4.6/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~140–220 | Derived from 344 Google reviews (mid venue indicator), price level ££ |
| Average spend per head | ~£22 | UK hospitality benchmark for price level ££ |
| Covers at risk per week | 3–11 | Conversion score 5.0/10 → 2%–5% leakage |
| Weekly revenue at risk | £80–£660 | Recoverable with priority action fixes |
| Monthly revenue at risk | £340–£2,640 | Aggregate across top 3 priorities |
| Annual projection | £4,080–£31,680 | If current gaps persist 12 months |
...
| Aggregate signals | Rating and volume from all platforms | 344 Google (4.6★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.6 rating across 344 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Cardamom operates as a credible Indian dining venue with a 4.6/5 Google rating across 344 reviews — solid but not yet commanding.
...
Within the local Indian dining market (3 peers), this venue leads the field. The identity is that of a category leader — the venue others are compared against.
...
- **Evidence:** `experience=9.53, conversion=5.0`
...
With 344 reviews at 4.6/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 344 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: indian_restaurant, fine_dining_restaurant, diner, meal_takeaway, restaurant, service. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: indian_restaurant, fine_dining_restaurant, diner, meal_takeaway, restaurant, service*
...
Online visibility (3.4) hasn't kept pace with guest experience quality (9.5). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 344 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 344 reviews (Moderate) | Visibility 3.4/10 (Weak) |
...
Cardamom is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Indian Restaurant" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | indian_restaurant, fine_dining_restaurant, diner, meal_takeaway, restaurant, service | Primary |
...
- **The Spice Room** (6.1): Takeaway-focused — different service model; 0.1 miles away *(weak comparator)*
- **Peppers** (5.5): Dining with similar price band; 4.2 miles away
- **Mouchak** (4.6): Dining with comparable price band; 3.5 miles away

## Competitive Market Intelligence

**Local market:** 3 direct competitors identified.

You are in the top quintile (P100). The competitive risk is complacency — the nearest competitor scores 6.1.

**Where you lead:** Conversion (+1.7), Trust (+1.4), Experience (+1.4), Visibility (+0.6)
...
**Position:** #1 of 4 (Percentile 100.0)

You are in the top quintile of this peer set. Your overall score of 6.6 exceeds the peer average of 5.4 by 1.2 points. The competitive risk here is complacency — the nearest competitor scores 6.1.

**Dimension gaps vs peers:**

- Conversion: 5.0 (+1.7 above peer avg 3.3)
- Trust: 8.5 (+1.4 above peer avg 7.1)
- Experience: 9.5 (+1.4 above peer avg 8.1)
- Visibility: 3.4 (+0.6 above peer avg 2.8)

**Closest competitors:**

- The Spice Room (6.1) — you lead by 0.5
- Peppers (5.5) — you lead by 1.1
- Mouchak (4.6) — you lead by 1.9
...
- **Wins on:** Visibility (+1.6): you have 344 reviews vs their 73 — but they score higher on other visibility signals; Conversion (+1.0): more complete operational signals (hours, menu, delivery/takeaway, booking)
...
- **Copy / test:** Improve profile completeness (photos, GBP attributes). Audit your Google profile vs theirs: hours, menu, booking, delivery.
...
- Trust: 8.5 (+1.6 above peer avg 6.9)
- Conversion: 5.0 (+1.2 above peer avg 3.8)
- Experience: 9.5 (+1.1 above peer avg 8.4)

**Closest competitors:**

- Simla Takeaway (6.6) — leads you by 0.0
...
**Position:** #2 of 17 (Percentile 93.8)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.5 | — | 8.1 | +1.4 | Above peers |
| Visibility | 3.4 | — | 2.8 | +0.6 | Above peers |
| Trust | 8.5 | — | 7.1 | +1.4 | Above peers |
| Conversion | 5.0 | — | 3.3 | +1.7 | Clear strength |
| **Overall** | **6.6** | **—** | | | |
...
**Assessment: Strong.** This is a genuine competitive strength at 9.5.
 You lead peers by 1.4 points (peer avg 8.1).
...
**Management note:** At 344 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 8.5.
 You lead peers by 1.4 points (peer avg 7.1).
...
**Assessment: Weak.** At 5.0, this dimension is actively limiting your overall position.
 You lead peers by 1.7 points (peer avg 3.3).
...
| Inspection Recency | 7.6/10 | ✅ Adequate | Last inspected 2025-12-09 (4 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-12-09 (4 months ago). Full confidence. No action needed. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.6 on trust, +0.1 on overall (6.6 → 6.7).
...
| Google review count | 344 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.6★ (344 reviews) | observed | ✓ |
...
| Last Inspection | 2025-12-09 | FSA | observed |
| Google Rating | 4.6/5 | Google Places API | observed |
| Google Reviews | 344 | Google Places API | observed |
