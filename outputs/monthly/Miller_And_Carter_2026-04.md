# Miller And Carter — Monthly Intelligence Report
...
**Competitive position:** Catchment (15mi): #2 of 9 (P87.5) — peer avg 5.8, top 6.52
  UK Category Cohort: #2 of 9 (P87.5) — peer avg 5.8, top 6.52
...
Based on publicly observable data for Miller And Carter, your current operational gaps are putting an estimated **16–50 covers per week** at risk — representing approximately **£1,920–£12,500 per month** in lost or leaked revenue. The main drivers are: Renew formal trust proof before it becomes a visible drag (£0–£500/mo (defensive)); Get your menu online — 77% of diners check before visiting (£960–£6,000/mo); Fix the digital shopfront — you're losing walk-ins (£960–£6,000/mo). Taking action on **Renew formal trust proof before it becomes a visible drag** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~320–500 | Derived from 8,975 Google reviews (high-traffic venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 8,975 Google (4.8★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.8 rating across 8,975 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Miller And Carter is a well-established american / grill venue with a strong public reputation — 4.8/5 across 8,975 Google reviews. That volume means the reputation is earned, not manufactured.
...
- **Review momentum.** At 8975 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: steak_house, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: steak_house, restaurant*
...
Online visibility (4.0) hasn't kept pace with guest experience quality (9.8). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 8,975 reviews — statistically robust rating. Individual reviews have negligible impact.
...
| Review Volume | 8975 reviews (High) | Visibility 4.0/10 (Weak) |
...
Miller And Carter is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "American / Grill" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | steak_house, restaurant | Primary |
...
You are in the top quintile of this peer set. Your overall score of 6.3 exceeds the peer average of 5.8 by 0.5 points. The competitive risk here is complacency — the nearest competitor scores 6.5.

**Dimension gaps vs peers:**

- Experience: 9.8 (+1.7 above peer avg 8.1)
- Visibility: 4.0 (+0.6 above peer avg 3.4)
- Trust: 7.6 (-0.6 below peer avg 8.2)

**Closest competitors:**

- The Crofts Cafe Also Trading As New York Pizzas (6.5) — leads you by 0.2
- Beleza Rodizio (6.2) — you lead by 0.1
- McDonald's (6.0) — you lead by 0.3
- KFC - Southbound (5.8) — you lead by 0.5
- McDonald's (5.8) — you lead by 0.5
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.8 | — | — | — | Strong |
| Visibility | 4.0 | — | — | — | Needs work |
| Trust | 7.6 | — | — | — | In line |
...
**Management note:** At 8975 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 1.9/10 | ⚠️ Significant drag | Last inspected 2024-04-08 (24 months ago). Maximum decay applied. Reinspectio... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-04-08 (24 months ago). Maximum decay applied. Reinspection strongly recommended. The system discounts older inspections because they carry less certainty.
...
| Google review count | 8975 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.8★ (8975 reviews) | observed | ✓ |
...
| Last Inspection | 2024-04-08 | FSA | observed |
| Google Rating | 4.8/5 | Google Places API | observed |
| Google Reviews | 8975 | Google Places API | observed |
