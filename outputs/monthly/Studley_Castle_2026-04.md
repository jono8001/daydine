# Studley Castle — Monthly Intelligence Report
...
**Overall score: 6.7/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.4) | Weakest: Visibility (4.0)

**Competitive position:** Local Peers (5mi): #1 of 3 (P100.0) — peer avg 6.24, top 6.39
  Catchment (15mi): #3 of 15 (P85.7) — peer avg 6.03, top 6.78
  UK Category Cohort: #3 of 17 (P87.5) — peer avg 5.99, top 6.78
...
Based on publicly observable data for Studley Castle, your current operational gaps are putting an estimated **10–35 covers per week** at risk — representing approximately **£1,160–£8,400 per month** in lost or leaked revenue. The main drivers are: Publish opening hours — you're invisible to 'open now' searches (£580–£4,200/mo); Get your menu online — 77% of diners check before visiting (£580–£4,200/mo); Protect the 4.5/5 rating — it took years to build (discovery protection). Taking action on **Publish opening hours — you're invisible to 'open now' searches** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~320–500 | Derived from 1,698 Google reviews (high-traffic venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 1,698 Google (4.5★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.5 rating across 1,698 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Studley Castle is a well-established hotel dining venue with a strong public reputation — 4.5/5 across 1,698 Google reviews. That volume means the reputation is earned, not manufactured.
...
Within the local hotel dining market (2 peers), this venue leads the field. The identity is that of a category leader — the venue others are compared against.
...
With 1698 reviews at 4.5/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 1698 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
- **Volume:** 1,698 reviews — statistically robust rating. Individual reviews have negligible impact.
...
| Review Volume | 1698 reviews (High) | Visibility 4.0/10 (Weak) |

## Category & Peer Validation

### Why This Venue Is In This Cohort

Studley Castle is classified as **Hotel** (confidence: low). Google's raw category is "Hotel / Accommodation" but the resolved category triangulates across 1 signal sources.
...
- **The Stables** (6.4): Hotel restaurant — different occasion type, may not compete for walk-in trade; 4.0 miles away *(marginal comparator)*
- **Kings Court Hotel** (6.1): Dining with comparable price band; 2.9 miles away
...
**Where you lead:** Visibility (+2.1)
**Where peers beat you:** Trust (-0.7)
...
You are in the top quintile of this peer set. Your overall score of 6.7 exceeds the peer average of 6.2 by 0.4 points. The competitive risk here is complacency — the nearest competitor scores 6.4.

**Dimension gaps vs peers:**

- Visibility: 4.0 (+2.1 above peer avg 1.9)
- Trust: 7.6 (-0.7 below peer avg 8.3)

**Closest competitors:**

- The Stables (6.4) — you lead by 0.3
- Kings Court Hotel (6.1) — you lead by 0.6
...
- **Defend:** Defend your 1698-review advantage vs their 98 (discovery moat) and your experience lead (+0.9) — drives repeats and word-of-mouth.
...
You are in the top quintile of this peer set. Your overall score of 6.7 exceeds the peer average of 6.0 by 0.6 points. The competitive risk here is complacency — the nearest competitor scores 6.8.
...
- Premier Inn (6.8) — leads you by 0.1
- Ragley Hall Catering (6.8) — leads you by 0.1
- Hotel Indigo And The Woodsman (6.6) — you lead by 0.1
- Alveston Manor Hotel (6.5) — you lead by 0.2
- Crowne Plaza (6.5) — you lead by 0.2

### UK Category Cohort (16 peers in Hotel / Accommodation)

**Position:** #3 of 17 (Percentile 87.5)

You are in the top quintile of this peer set. Your overall score of 6.7 exceeds the peer average of 6.0 by 0.7 points. The competitive risk here is complacency — the nearest competitor scores 6.8.
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.4 | — | 9.2 | +0.2 | Strong |
| Visibility | 4.0 | — | 1.9 | +2.1 | Clear strength |
| Trust | 7.6 | — | 8.3 | -0.7 | Below peers |
| Conversion | — | — | — | — | No data |
| **Overall** | **6.7** | **—** | | | |
...
**Assessment: Critical.** At 4.0, this represents a material operational gap.
 You lead peers by 2.1 points (peer avg 1.9).
...
**Management note:** At 1698 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Adequate.** At 7.6, this is functional but not distinctive.
 Slightly below peer average (8.3).
...
| Inspection Recency | 1.9/10 | ⚠️ Significant drag | Last inspected 2024-04-29 (24 months ago). Meaningful score drag. Consider pr... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-04-29 (24 months ago). Meaningful score drag. Consider proactive action. The system discounts older inspections because they carry less certainty.
...
| Google review count | 1698 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.5★ (1698 reviews) | observed | ✓ |
...
| Last Inspection | 2024-04-29 | FSA | observed |
| Google Rating | 4.5/5 | Google Places API | observed |
| Google Reviews | 1698 | Google Places API | observed |
