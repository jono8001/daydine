# Avon Spice — Monthly Intelligence Report
...
3. **Protect the 4.5/5 rating — it took years to build** [PROTECT] — Sustain discovery advantage
...
**Overall score: 6.4/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.4) | Weakest: Visibility (3.4)

**Competitive position:** Local Peers (5mi): #2 of 7 (P83.3) — peer avg 5.89, top 6.59
  Catchment (15mi): #3 of 16 (P86.7) — peer avg 5.57, top 6.59
  UK Category Cohort: #3 of 17 (P87.5) — peer avg 5.56, top 6.59
...
Based on publicly observable data for Avon Spice, your current operational gaps are putting an estimated **9–29 covers per week** at risk — representing approximately **£580–£3,480 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£290–£1,740/mo); Fix the digital shopfront — you're losing walk-ins (£290–£1,740/mo); Protect the 4.5/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~180–290 | Derived from 312 Google reviews (mid venue indicator), price level £ |
...
| Weekly revenue at risk | £140–£870 | Recoverable with priority action fixes |
| Monthly revenue at risk | £580–£3,480 | Aggregate across top 3 priorities |
| Annual projection | £6,960–£41,760 | If current gaps persist 12 months |
...
| Aggregate signals | Rating and volume from all platforms | 312 Google (4.5★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.5 rating across 312 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Avon Spice operates as a credible Indian dining venue with a 4.5/5 Google rating across 312 reviews — solid but not yet commanding.
...
### Priority 3: Protect the 4.5/5 rating — it took years to build [PROTECT | ESCALATED]

With 312 reviews at 4.5/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 312 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Online visibility (3.4) hasn't kept pace with guest experience quality (9.4). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 312 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 312 reviews (Moderate) | Visibility 3.4/10 (Weak) |
...
Avon Spice is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Indian Restaurant" but the resolved category triangulates across 2 signal sources.
...
- **Simla Takeaway** (6.6): Takeaway-focused — different service model; 0.0 miles away *(weak comparator)*
...
You are in the top quintile (P83). The competitive risk is complacency — the nearest competitor scores 6.6.

**Where you lead:** Trust (+1.2), Experience (+0.9)
...
You are in the top quintile of this peer set. Your overall score of 6.4 exceeds the peer average of 5.9 by 0.5 points. The competitive risk here is complacency — the nearest competitor scores 6.6.

**Dimension gaps vs peers:**

- Trust: 9.0 (+1.2 above peer avg 7.7)
- Experience: 9.4 (+0.9 above peer avg 8.5)
- Conversion: 3.5 (-0.5 below peer avg 4.0)

**Closest competitors:**

- Simla Takeaway (6.6) — leads you by 0.2
- Shah's (6.3) — you lead by 0.1
- Hussains (6.2) — you lead by 0.2
- Kolshi Restaurant (6.1) — you lead by 0.4
- Thespians Indian Restaurant (5.4) — you lead by 1.0
...
- **Also wins on:** Visibility (+1.7): you have 312 reviews vs their 73 — but they score higher on other visibility signals
...
- **Defend:** Defend your trust advantage (+0.8) and your experience lead (+0.6) — drives repeats and word-of-mouth.
...
- **Defend:** Defend your trust advantage (+0.8).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*
...
**Position:** #3 of 16 (Percentile 86.7)

You are in the top quintile of this peer set. Your overall score of 6.4 exceeds the peer average of 5.6 by 0.8 points. The competitive risk here is complacency — the nearest competitor scores 6.6.

**Dimension gaps vs peers:**

- Trust: 9.0 (+2.1 above peer avg 6.9)
- Experience: 9.4 (+1.0 above peer avg 8.4)

**Closest competitors:**

- Simla Takeaway (6.6) — leads you by 0.2
- Cardamom (6.6) — leads you by 0.2
- Shah's (6.3) — you lead by 0.1
- Hussains (6.2) — you lead by 0.2
- The Spice Room (6.1) — you lead by 0.3

### UK Category Cohort (16 peers in Indian Restaurant)

**Position:** #3 of 17 (Percentile 87.5)

You are in the top quintile of this peer set. Your overall score of 6.4 exceeds the peer average of 5.6 by 0.9 points. The competitive risk here is complacency — the nearest competitor scores 6.6.
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.4 | — | 8.5 | +0.9 | Above peers |
| Visibility | 3.4 | — | 3.8 | -0.4 | Below peers |
| Trust | 9.0 | — | 7.7 | +1.2 | Above peers |
...
**Assessment: Strong.** This is a genuine competitive strength at 9.4.
 Slightly above peer average (8.5).
...
**Assessment: Critical.** At 3.4, this represents a material operational gap.
 Slightly below peer average (3.8).
...
**Management note:** At 312 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 9.0.
 You lead peers by 1.2 points (peer avg 7.7).
...
| Inspection Recency | 9.3/10 | ✅ Strong | Last inspected 2026-03-10 (1 months ago). Full confidence. No action needed.  |
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.2 on trust, +0.0 on overall (6.4 → 6.5).
...
| Google review count | 312 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.5★ (312 reviews) | observed | ✓ |
...
| Last Inspection | 2026-03-10 | FSA | observed |
| Google Rating | 4.5/5 | Google Places API | observed |
| Google Reviews | 312 | Google Places API | observed |
...
| Postcode | CV37 6LF | FSA | observed |
| Companies House | — | Not checked | not_assessed |
