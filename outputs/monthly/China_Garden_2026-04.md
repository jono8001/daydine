...
Based on publicly observable data for China Garden, your current operational gaps are putting an estimated **3–30 covers per week** at risk — representing approximately **£450–£8,600 per month** in lost or leaked revenue. The main drivers are: Close the hygiene gap — 2 to 5 (£0–£500/mo (defensive)); Identify and fix the recurring guest complaint (£270–£4,500/mo); Get your menu online — 77% of diners check before visiting (£180–£3,600/mo). Taking action on **Close the hygiene gap — 2 to 5** could begin recovering this within weeks at low cost (< £200).
