# China Garden — Monthly Intelligence Report
...
**Overall score: 4.2/10** (baseline month — no prior comparison)
 | Strongest: Experience (5.9) | Weakest: Visibility (3.1)

**Competitive position:** Catchment (15mi): #3 of 3 (P0.0) — peer avg 5.43, top 6.36
  UK Category Cohort: #3 of 3 (P0.0) — peer avg 5.43, top 6.36
...
Based on publicly observable data for China Garden, your current operational gaps are putting an estimated **4–14 covers per week** at risk — representing approximately **£380–£3,860 per month** in lost or leaked revenue. The main drivers are: Close the hygiene gap — 2 to 5 (£0–£500/mo (defensive)); Identify and fix the recurring guest complaint (£140–£1,680/mo); Get your menu online — 77% of diners check before visiting (£240–£1,680/mo). Taking action on **Close the hygiene gap — 2 to 5** could begin recovering this within weeks at low cost (< £200).
...
| Weekly revenue at risk | £100–£960 | Recoverable with priority action fixes |
| Monthly revenue at risk | £380–£3,860 | Aggregate across top 3 priorities |
| Annual projection | £4,560–£46,320 | If current gaps persist 12 months |
...
| Aggregate signals | Rating and volume from all platforms | 148 Google (3.3★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 3.3 rating across 148 Google reviews is the reputation bedrock and is factored into scoring separately.
...
China Garden operates in the Chinese dining category with a public rating of 3.3/5 that is currently limiting discovery.
...
Insufficient review data to cross-reference proposition. Google types show: restaurant, chinese_restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: restaurant, chinese_restaurant*
...
|--------|-------------|---------------------|
| Customer Rating | 3.3/5 Google (Weak) | Experience 5.9/10 (Weak) — Aligned |
| Hygiene Rating | FSA 2/5 (Concern) | Trust 5.2/10 (Weak) |
...
China Garden is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Chinese Restaurant" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | restaurant, chinese_restaurant | Primary |
...
You are below the median of your peer set. At 4.2 vs peer average 5.4, competitors are outperforming you. The top performer scores 6.4. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Conversion: 3.5 (-0.8 below peer avg 4.2)
- Experience: 5.9 (-1.7 below peer avg 7.6)
- Trust: 5.2 (-1.8 below peer avg 6.9)

**Closest competitors:**

- Sans Oriental Restaurant (6.4) — leads you by 2.1
- New Summer Palace Restaurant (4.5) — leads you by 0.3
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 5.9 | — | — | — | In line |
| Visibility | 3.1 | — | — | — | Needs work |
| Trust | 5.2 | — | — | — | In line |
| Conversion | 3.5 | — | — | — | Needs work |
| **Overall** | **4.2** | **—** | | | |
...
**Management note:** At 3.3/5 Google, customers are telling you something specific. Read the 3 most recent negative reviews and identify the recurring theme. That theme is your highest-ROI operational fix.
...
**Assessment: Weak.** At 5.2, this dimension is actively limiting your overall position.
...
| Google Business Profile | 3.3★ (148 reviews) | observed | ✓ |
...
| Postcode | CV37 6NL | FSA | observed |
| Companies House | — | Not checked | not_assessed |
