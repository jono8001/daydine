# Impasto Micro-Pizzeria — Monthly Intelligence Report
...
**Competitive position:** Local Peers (5mi): #5 of 10 (P55.6) — peer avg 5.76, top 6.41
  Catchment (15mi): #7 of 12 (P45.5) — peer avg 5.82, top 6.41
  UK Category Cohort: #8 of 13 (P41.7) — peer avg 5.82, top 6.41
...
- **Your 5.0/5 Google rating.** This is your primary commercial asset. Protect it through consistent delivery.
...
- **Review momentum.** At 121 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
10 photos present — matching peer average. However, we cannot verify from external data whether photos match the experience guests praise. Reviews highlight **food quality** — if your photos don't showcase this, there is a proposition mismatch in the listing.
...
*Signals: Photo count: 10; Peer average: ~10 photos; Top review theme: Food Quality*

### Proposition Clarity [CLEAR]

Google types (pizza_restaurant, restaurant) are broadly consistent with what guests praise (Food Quality).

**Commercial consequence:** No major proposition mismatch detected.

*Signals: Google types: pizza_restaurant, restaurant; Top review themes: Food Quality*
...
Online visibility (3.1) hasn't kept pace with guest experience quality (9.0). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
| Review Volume | 121 reviews (Moderate) | Visibility 3.1/10 (Weak) |
...
Impasto Micro-Pizzeria is classified as **Restaurant (General)** (confidence: high). Google's raw category is "Italian Restaurant" but the resolved category triangulates across 2 signal sources.
...
| Review Language | "restaurant" (2x), "bar" (2x) | Supportive |

**Resolved category:** Restaurant (General) (confidence: high)

### Peer Justification

- **The Phoenix** (6.4): Takeaway-focused — different service model; 0.0 miles away *(weak comparator)*
...
Above the median (P56) but not leading. Peer average is 5.8; the top performer scores 6.4. The gap to the top is closeable.
...
You sit above the median but below the top tier. Your 5.8 compares to a peer average of 5.8. The gap to the top (6.4) is 0.6 points — closeable with focused improvement on your weakest dimension.

**Closest competitors:**

- The Phoenix (6.4) — leads you by 0.6
- Soma (6.2) — leads you by 0.4
- Carluccio's (6.1) — leads you by 0.3
- Pizza Hut Restaurants - Dine In (6.0) — leads you by 0.3
- Corte Campana (5.7) — you lead by 0.1

### Competitor Strategy

**Soma** (signal-backed)

- **Wins on:** Experience (+0.7): higher composite experience score from rating + compliance signals; Trust (+0.7): same FSA rating but likely stronger sub-scores or more recent inspection
...
- **Wins on:** Conversion (+1.0): more complete operational signals (hours, menu, delivery/takeaway, booking); Trust (+0.6): same FSA rating but likely stronger sub-scores or more recent inspection
...
- **Wins on:** Visibility (+0.9): 1831 Google reviews vs your 121 — they have volume advantage
- **Why it matters:** Their visibility lead means they are easier to find online — this controls top-of-funnel discovery.
- **Copy / test:** Build review volume — they have 1831 to your 121.
- **Defend:** No clear defensive advantage — you are closely matched across dimensions.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*
...
- The Phoenix (6.4) — leads you by 0.6
- Soma (6.2) — leads you by 0.4
- The Still House Café (6.1) — leads you by 0.3
- Bumbles (6.1) — leads you by 0.3
- Carluccio's (6.1) — leads you by 0.3

### UK Category Cohort (12 peers in Italian Restaurant)

**Position:** #8 of 13 (Percentile 41.7)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.0 | — | 8.8 | +0.1 | Strong |
| Visibility | 3.1 | — | 3.5 | -0.4 | Below peers |
| Trust | 7.8 | — | 7.4 | +0.3 | Above peers |
...
**Management note:** At 121 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Adequate.** At 7.8, this is functional but not distinctive.
 Slightly above peer average (7.4).
...
| Inspection Recency | 3.1/10 | ⚠️ Significant drag | Last inspected 2024-11-18 (17 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-11-18 (17 months ago). Score starting to decay. Note it but don't escalate. 
...
**Status:** Overdue (9 months) | **Priority:** High
...
**Status:** Overdue (9 months) | **Priority:** Medium
...
**Target date:** 01 May 2026 | **Cost:** Medium (£200–£1,000) | **Expected upside:** Reduce value for money complaints, protect rating
...
| Google review count | 121 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Last Inspection | 2024-11-18 | FSA | observed |
| Google Rating | 5.0/5 | Google Places API | observed |
| Google Reviews | 121 | Google Places API | observed |
...
**Review 1** | Unknown | Undated | 5★ | positive
> Fantastic tasting pizza! My permanently underwhelmed teenage nephews said it was the best pizza they  ever had!Price per person£10–20Food: 5Service: 5Atmosphere: 5Recommended dishesPizza Margherita, Vodka Pie, Sardenara, Pepperoni Pizza, Cheese BallsNoise levelModerate noiseSeating typeIndoor dining area, Bar area, Outdoor patio / terrace, Booth seating

**Review 2** | Unknown | Undated | 5★ | positive | Food Quality
> Took our teenage nephews here to play the games consoles and have a pizza as a means to occupy the afternoon.
So glad we did as wow this was the best pizza! Genuinely fabulous. We had the phoenix pie and all of us were very happy with it. One of the best pizzas I've ever had. Both nephews said repeatedly was the best pizza they've ever had.
We also had potato tots, Mac and cheese bites as well as chicken strips. OMG the strips were delicious.
Everything really good.
Highly recommend.Food: 5Service: 5Atmosphere: 5
