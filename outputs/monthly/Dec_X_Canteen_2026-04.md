# Dec X Canteen — Monthly Intelligence Report
...
**Overall score: 6.7/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.7) | Weakest: Visibility (3.6)

**Competitive position:** Local Peers (5mi): #3 of 9 (P75.0) — peer avg 6.06, top 6.78
  Catchment (15mi): #4 of 42 (P92.7) — peer avg 5.79, top 6.92
  UK Category Cohort: #5 of 53 (P92.3) — peer avg 5.77, top 6.92
...
Based on publicly observable data for Dec X Canteen, your current operational gaps are putting an estimated **7–25 covers per week** at risk — representing approximately **£800–£5,880 per month** in lost or leaked revenue. The main drivers are: Publish opening hours — you're invisible to 'open now' searches (£400–£2,940/mo); Get your menu online — 77% of diners check before visiting (£400–£2,940/mo); Protect the 4.7/5 rating — it took years to build (discovery protection). Taking action on **Publish opening hours — you're invisible to 'open now' searches** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~220–350 | Derived from 600 Google reviews (large venue indicator), price level ££ |
| Average spend per head | ~£22 | UK hospitality benchmark for price level ££ |
| Covers at risk per week | 7–25 | Default 3–7% leakage (no conversion score) |
| Weekly revenue at risk | £200–£1,470 | Recoverable with priority action fixes |
| Monthly revenue at risk | £800–£5,880 | Aggregate across top 3 priorities |
| Annual projection | £9,600–£70,560 | If current gaps persist 12 months |
...
| Aggregate signals | Rating and volume from all platforms | 600 Google (4.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.7 rating across 600 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Dec X Canteen is a well-established cafe venue with a strong public reputation — 4.7/5 across 600 Google reviews. That volume means the reputation is earned, not manufactured.
...
With 600 reviews at 4.7/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 600 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: corporate_office. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: corporate_office*
...
Online visibility (3.6) hasn't kept pace with guest experience quality (9.7). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 600 reviews — strong base. Rating is stable but a sustained negative pattern could shift it.
...
| Review Volume | 600 reviews (High) | Visibility 3.6/10 (Weak) |

## Category & Peer Validation

### Why This Venue Is In This Cohort

Dec X Canteen is classified as **Corporate Office** (confidence: low). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | corporate_office | Primary |

**Resolved category:** Corporate Office (confidence: low)

### Peer Justification

- **South Costa** (6.8): Dining with comparable price band; 0.0 miles away
- **Building 523 Costa And Kitchen** (6.8): Dining with comparable price band; 0.0 miles away
- **Gilks' Garage Cafe** (6.7): Dining with comparable price band; 2.8 miles away
- **Nel's At The Pavilion** (6.6): Dining with comparable price band; 0.9 miles away
- **Harbury Library Cafe** (5.8): Dining with comparable price band; 3.2 miles away

## Competitive Market Intelligence

**Local market:** 8 direct competitors identified.

Above the median (P75) but not leading. Peer average is 6.1; the top performer scores 6.8. The gap to the top is closeable.
...
You sit above the median but below the top tier. Your 6.7 compares to a peer average of 6.1. The gap to the top (6.8) is 0.1 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Experience: 9.7 (+0.8 above peer avg 8.8)

**Closest competitors:**

- South Costa (6.8) — leads you by 0.1
- Building 523 Costa And Kitchen (6.8) — leads you by 0.1
- Gilks' Garage Cafe (6.7) — you lead by 0.0
...
- **Wins on:** Trust (+1.6): same FSA rating but likely stronger sub-scores or more recent inspection
- **Why it matters:** A large trust gap (+1.6) — their compliance record is stronger — this creates a ceiling you hit and they don't. This is a structural disadvantage, not a rounding error.
...
**Position:** #4 of 42 (Percentile 92.7)
...
- Puddleduck Cafe Ltd (6.9) — leads you by 0.2
- South Costa (6.8) — leads you by 0.1
- Building 523 Costa And Kitchen (6.8) — leads you by 0.1
- Gilks' Garage Cafe (6.7) — you lead by 0.0
...
**Position:** #5 of 53 (Percentile 92.3)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.7 | — | 8.8 | +0.8 | Above peers |
| Visibility | 3.6 | — | 3.5 | +0.1 | Needs work |
...
**Management note:** At 600 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 2.0/10 | ⚠️ Significant drag | Last inspected 2024-05-13 (23 months ago). Meaningful score drag. Consider pr... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-05-13 (23 months ago). Meaningful score drag. Consider proactive action. The system discounts older inspections because they carry less certainty.

**Peer context:** South Costa's trust lead (+1.8) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +2.0 on trust, +0.5 on overall (6.7 → 7.2).
...
| Google review count | 600 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.7★ (600 reviews) | observed | ✓ |
...
| Last Inspection | 2024-05-13 | FSA | observed |
| Google Rating | 4.7/5 | Google Places API | observed |
| Google Reviews | 600 | Google Places API | observed |
...
| Postcode | CV35 0RR | FSA | observed |
| Companies House | — | Not checked | not_assessed |
