...
- Ranked #5 of 5 locally — peers are ahead

**Do not prioritise:** Establish basic web presence — you don't exist online beyond Google

**Overall score: 4.4/10** (baseline month — no prior comparison)
 | Strongest: Trust (6.1) | Weakest: Trust (6.1)

**Competitive position:** Local Peers (5mi): #5 of 5 (P0.0) — peer avg 6.0, top 6.73
  Catchment (15mi): #15 of 15 (P0.0) — peer avg 6.09, top 7.34
  UK Category Cohort: #19 of 19 (P0.0) — peer avg 6.0, top 7.34
...
The Roebuck Inn Alcester operates in the pub dining category with a public rating of None/5 that is currently limiting discovery.
...
- **FSA rating.** At 4/5 vs peer average, this is your widest competitive gap. Request a re-inspection once the specific inspector concerns have been addressed.
...
**0 of 7** demand capture dimensions are clear. **3** have friction. **4** are missing.
...
|--------|-------------|---------------------|
| Hygiene Rating | FSA 4/5 (Acceptable) | Trust 6.1/10 (Adequate) |

## Category & Peer Validation

### Why This Venue Is In This Cohort

The Roebuck Inn Alcester is classified as **Premise** (confidence: low). Google's raw category is "Pub / Bar" but the resolved category triangulates across 1 signal sources.
...
- **Cafe Des Fleurs** (6.2): Pub Dining with comparable price band; 0.7 miles away
- **The Alcester Inn** (5.9): Hotel restaurant — different occasion type, may not compete for walk-in trade; 0.5 miles away *(marginal comparator)*
- **The Cottage Of Content** (5.2): Pub Dining with comparable price band; 4.7 miles away

## Competitive Market Intelligence

**Local market:** 4 direct competitors identified.

Below the median (P0). Customers have higher-rated alternatives nearby (peer avg 6.0, top 6.7).

**Where peers beat you:** Trust (-2.6)
...
You are below the median of your peer set. At 4.4 vs peer average 6.0, competitors are outperforming you. The top performer scores 6.7. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Trust: 6.1 (-2.6 below peer avg 8.7)

**Closest competitors:**

- Arrow Mill (6.7) — leads you by 2.4
- Cafe Des Fleurs (6.2) — leads you by 1.9
- The Alcester Inn (5.9) — leads you by 1.5
- The Cottage Of Content (5.2) — leads you by 0.8
...
- **Why it matters:** A large trust gap (+3.6) — their compliance record is stronger — this creates a ceiling you hit and they don't. This is a structural disadvantage, not a rounding error.
...
**The Alcester Inn** (signal-backed)
...
You are below the median of your peer set. At 4.4 vs peer average 6.1, competitors are outperforming you. The top performer scores 7.3. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Trust: 6.1 (-2.2 below peer avg 8.3)

**Closest competitors:**

- Vintner Wine Bar (7.3) — leads you by 3.0
- Arrow Mill (6.7) — leads you by 2.4
- The Fox Inn (6.5) — leads you by 2.1
- The Red Lion (6.4) — leads you by 2.0
- The Townhouse Also Trading As JR Hotel And Restaurants LTD (6.3) — leads you by 2.0

### UK Category Cohort (18 peers in Pub / Bar)

**Position:** #19 of 19 (Percentile 0.0)

You are below the median of your peer set. At 4.4 vs peer average 6.0, competitors are outperforming you. The top performer scores 7.3. Customers in this area have demonstrably better-rated alternatives.
...
| Experience | — | — | — | — | No data |
| Visibility | — | — | — | — | No data |
| Trust | 6.1 | — | 8.7 | -2.6 | Significant gap |
| Conversion | — | — | — | — | No data |
| **Overall** | **4.4** | **—** | | | |
...
**Assessment: Adequate.** At 6.1, this is functional but not distinctive.
 You trail peers by 2.6 points (peer avg 8.7).
...
| Inspection Recency | 3.1/10 | ⚠️ Significant drag | Last inspected 2024-11-19 (17 months ago). Score starting to decay. Note it b... |

**Biggest drag:** Inspection Recency. Last inspected 2024-11-19 (17 months ago). Score starting to decay. Note it but don't escalate. 

**Peer context:** Arrow Mill's trust lead (+3.6) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
