# Kitty's Kitchen Catering Ltd — Monthly Intelligence Report
...
**Competitive position:** UK Category Cohort: #1 of 3 (P100.0) — peer avg 5.35, top 5.78
...
Based on publicly observable data for Kitty's Kitchen Catering Ltd, your current operational gaps are putting an estimated **6–21 covers per week** at risk — representing approximately **£760–£5,540 per month** in lost or leaked revenue. The main drivers are: Renew formal trust proof before it becomes a visible drag (£0–£500/mo (defensive)); Get your menu online — 77% of diners check before visiting (£380–£2,520/mo); Fix the digital shopfront — you're losing walk-ins (£380–£2,520/mo). Taking action on **Renew formal trust proof before it becomes a visible drag** could begin recovering this within weeks at low cost (< £200).
...
| Aggregate signals | Rating and volume from all platforms | 121 Google (4.6★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.6 rating across 121 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Kitty's Kitchen Catering Ltd operates as a credible catering venue with a 4.6/5 Google rating across 121 reviews — solid but not yet commanding.
...
Insufficient review data to cross-reference proposition. Google types show: association_or_organization. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: association_or_organization*
...
Online visibility (3.1) hasn't kept pace with guest experience quality (9.5). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 121 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
Kitty's Kitchen Catering Ltd is classified as **Association Or Organization** (confidence: low). Google's raw category is "Catering" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | association_or_organization | Primary |

**Resolved category:** Association Or Organization (confidence: low)
...
### UK Category Cohort (2 peers in Catering)

**Position:** #1 of 3 (Percentile 100.0)

You are in the top quintile of this peer set. Your overall score of 6.0 exceeds the peer average of 5.3 by 0.6 points. The competitive risk here is complacency — the nearest competitor scores 5.8.

**Dimension gaps vs peers:**

- Experience: 9.5 (+1.4 above peer avg 8.1)
- Trust: 7.9 (+1.2 above peer avg 6.7)
- Visibility: 3.1 (+0.8 above peer avg 2.3)

**Closest competitors:**

- Earlswood Lunch Club (5.8) — you lead by 0.2
- CAMEO Lunch Club (4.9) — you lead by 1.1

## Dimension Scorecard

| Dimension | Score | Δ | Peer Avg | Gap | Read |
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.5 | — | — | — | Strong |
...
| Google Business Profile | 4.6★ (121 reviews) | observed | ✓ |
...
| Category | Catering | name_match | derived |
| Postcode | CV37 7AY | FSA | observed |
| Companies House | — | Not checked | not_assessed |
