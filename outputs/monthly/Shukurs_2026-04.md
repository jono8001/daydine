# Shukurs — Monthly Intelligence Report
...
**Overall score: 5.6/10** (baseline month — no prior comparison)
 | Strongest: Experience (8.6) | Weakest: Conversion (3.5)

**Competitive position:** Local Peers (5mi): #3 of 3 (P0.0) — peer avg 6.17, top 6.29
  Catchment (15mi): #7 of 13 (P50.0) — peer avg 5.52, top 6.59
  UK Category Cohort: #9 of 17 (P50.0) — peer avg 5.62, top 6.59
...
Based on publicly observable data for Shukurs, your current operational gaps are putting an estimated **11–35 covers per week** at risk — representing approximately **£1,320–£8,900 per month** in lost or leaked revenue. The main drivers are: Close the hygiene gap — 4 to 5 (£0–£500/mo (defensive)); Get your menu online — 77% of diners check before visiting (£660–£4,200/mo); Fix the digital shopfront — you're losing walk-ins (£660–£4,200/mo). Taking action on **Close the hygiene gap — 4 to 5** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~220–350 | Derived from 526 Google reviews (large venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 526 Google (4.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.7 rating across 526 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Shukurs is a well-established Indian dining venue with a strong public reputation — 4.7/5 across 526 Google reviews. That volume means the reputation is earned, not manufactured.
...
- **Review momentum.** At 526 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: bangladeshi_restaurant, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: bangladeshi_restaurant, restaurant*
...
Online visibility (3.6) hasn't kept pace with guest experience quality (8.6). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 526 reviews — strong base. Rating is stable but a sustained negative pattern could shift it.
...
| Hygiene Rating | FSA 4/5 (Acceptable) | Trust 6.5/10 (Adequate) |
| Review Volume | 526 reviews (High) | Visibility 3.6/10 (Weak) |
...
Shukurs is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Indian Restaurant" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | bangladeshi_restaurant, restaurant | Primary |
...
- **Shah's** (6.3): Dining with similar price band; 4.7 miles away
- **Kolshi Restaurant** (6.1): Dining with comparable price band; 4.5 miles away

## Competitive Market Intelligence

**Local market:** 2 direct competitors identified.

Below the median (P0). Customers have higher-rated alternatives nearby (peer avg 6.2, top 6.3).

**Where you lead:** Conversion (+0.5)
**Where peers beat you:** Trust (-2.0), Experience (-0.6)
...
You are below the median of your peer set. At 5.6 vs peer average 6.2, competitors are outperforming you. The top performer scores 6.3. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Conversion: 3.5 (+0.5 above peer avg 3.0)
- Experience: 8.6 (-0.6 below peer avg 9.2)
- Trust: 6.5 (-2.0 below peer avg 8.4)

**Closest competitors:**

- Shah's (6.3) — leads you by 0.7
- Kolshi Restaurant (6.1) — leads you by 0.5
...
**Kolshi Restaurant** (signal-backed)
...
**Shah's** (signal-backed)

- **Also wins on:** Experience (+1.0): same Google rating (4.7/5) but higher experience score — likely stronger FSA food hygiene sub-scores
...
- **Wins on:** Conversion (+2.5): more complete operational signals (hours, menu, delivery/takeaway, booking); Trust (+1.6): FSA 5/5 vs your 4/5
...
**Position:** #7 of 13 (Percentile 50.0)

You sit above the median but below the top tier. Your 5.6 compares to a peer average of 5.5. The gap to the top (6.6) is 1.0 points — closeable with focused improvement on your weakest dimension.

**Closest competitors:**

- Simla Takeaway (6.6) — leads you by 1.0
- Avon Spice (6.4) — leads you by 0.8
- Shah's (6.3) — leads you by 0.7
- Hussains (6.2) — leads you by 0.6
- Kolshi Restaurant (6.1) — leads you by 0.5

### UK Category Cohort (16 peers in Indian Restaurant)

**Position:** #9 of 17 (Percentile 50.0)

You sit above the median but below the top tier. Your 5.6 compares to a peer average of 5.6. The gap to the top (6.6) is 1.0 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 6.5 (-0.6 below peer avg 7.1)

**Closest competitors:**

- Simla Takeaway (6.6) — leads you by 1.0
- Cardamom (6.6) — leads you by 1.0
- Avon Spice (6.4) — leads you by 0.8
- Shah's (6.3) — leads you by 0.7
- Hussains (6.2) — leads you by 0.6
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.6 | — | 9.2 | -0.6 | Below peers |
| Visibility | 3.6 | — | 3.5 | +0.0 | Needs work |
| Trust | 6.5 | — | 8.4 | -2.0 | Significant gap |
| Conversion | 3.5 | — | 3.0 | +0.5 | Above peers |
| **Overall** | **5.6** | **—** | | | |
...
**Assessment: Strong.** This is a genuine competitive strength at 8.6.
 Slightly below peer average (9.2).
...
**Management note:** At 526 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Adequate.** At 6.5, this is functional but not distinctive.
 You trail peers by 2.0 points (peer avg 8.4).
...
| Inspection Recency | 4.1/10 | ⚠️ Significant drag | Last inspected 2025-03-17 (13 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-03-17 (13 months ago). Score starting to decay. Note it but don't escalate. 

**Peer context:** Shah's's trust lead (+2.3) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
| 8 | Ranked #3 of 3 locally — peers are ahead | Stale (5 months) | 01 May 2026 | Medium (£200–£1,000) |
...
| Google review count | 526 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.7★ (526 reviews) | observed | ✓ |
...
| Last Inspection | 2025-03-17 | FSA | observed |
| Google Rating | 4.7/5 | Google Places API | observed |
| Google Reviews | 526 | Google Places API | observed |
...
| Postcode | CV35 0HP | FSA | observed |
| Companies House | — | Not checked | not_assessed |
