# Feel Good Crystals — Monthly Intelligence Report
...
**Competitive position:** Local Peers (5mi): #1 of 3 (P100.0) — peer avg 6.12, top 6.15
  Catchment (15mi): #4 of 14 (P76.9) — peer avg 5.96, top 6.66
  UK Category Cohort: #14 of 53 (P75.0) — peer avg 5.78, top 6.92
...
| Aggregate signals | Rating and volume from all platforms | 105 Google (4.9★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.9 rating across 105 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Feel Good Crystals operates as a credible cafe venue with a 4.9/5 Google rating across 105 reviews — solid but not yet commanding.
...
Within the local cafe market (2 peers), this venue leads the field. The identity is that of a category leader — the venue others are compared against.
...
- **Review momentum.** At 105 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: home_goods_store, coffee_shop, cafe, jewelry_store, food_store, store. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: home_goods_store, coffee_shop, cafe, jewelry_store, food_store, store*
...
Online visibility (3.0) hasn't kept pace with guest experience quality (9.9). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Unrealised review authority.** At 105 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** 105 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 105 reviews (Moderate) | Visibility 3.0/10 (Weak) |
...
Feel Good Crystals is classified as **Cafe / Coffee Shop** (confidence: high). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | home_goods_store, coffee_shop, cafe, jewelry_store, food_store, store | Primary |

**Resolved category:** Cafe / Coffee Shop (confidence: high)

### Peer Justification

- **Cotswold Distillery Cafe** (6.2): Dining with comparable price band; 3.0 miles away
- **The Straw Kitchen** (6.1): Dining with comparable price band; 2.3 miles away
...
**Where you lead:** Trust (+1.0)
**Where peers beat you:** Visibility (-0.6), Conversion (-0.5)
...
**Position:** #1 of 3 (Percentile 100.0)

You are in the top quintile of this peer set. Your overall score of 6.2 exceeds the peer average of 6.1 by 0.1 points. The competitive risk here is complacency — the nearest competitor scores 6.2.

**Dimension gaps vs peers:**

- Trust: 8.4 (+1.0 above peer avg 7.4)
- Conversion: 2.5 (-0.5 below peer avg 3.0)
- Visibility: 3.0 (-0.6 below peer avg 3.6)

**Closest competitors:**

- Cotswold Distillery Cafe (6.2) — you lead by 0.0
...
- **Wins on:** Visibility (+0.8): 1239 Google reviews vs your 105 — they have volume advantage
- **Why it matters:** Their visibility lead means they are easier to find online — this controls top-of-funnel discovery.
- **Copy / test:** Build review volume — they have 1239 to your 105.
...
- **Defend:** Defend your trust advantage (+1.3).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

**Gilks' Garage Cafe** (signal-backed)
...
You sit above the median but below the top tier. Your 6.2 compares to a peer average of 6.0. The gap to the top (6.7) is 0.5 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Experience: 9.9 (+0.8 above peer avg 9.1)
- Conversion: 2.5 (-0.5 below peer avg 3.0)

**Closest competitors:**

- Gilks' Garage Cafe (6.7) — leads you by 0.5
- Cotswold Cafe (6.4) — leads you by 0.2
- Espresso Barn (6.3) — leads you by 0.1
- Ettington Garden Cafe (6.2) — you lead by 0.0
- Cotswold Distillery Cafe (6.2) — you lead by 0.0

### UK Category Cohort (52 peers in Cafe / Coffee Shop)

**Position:** #14 of 53 (Percentile 75.0)

You sit above the median but below the top tier. Your 6.2 compares to a peer average of 5.8. The gap to the top (6.9) is 0.7 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Experience: 9.9 (+1.0 above peer avg 8.8)
- Trust: 8.4 (+0.9 above peer avg 7.5)

**Closest competitors:**

- Puddleduck Cafe Ltd (6.9) — leads you by 0.7
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.9 | — | 9.9 | +0.0 | Strong |
| Visibility | 3.0 | — | 3.6 | -0.6 | Below peers |
| Trust | 8.4 | — | 7.4 | +1.0 | Above peers |
...
**Management note:** At 105 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 8.4.
 You lead peers by 1.0 points (peer avg 7.4).
...
| Inspection Recency | 3.7/10 | ⚠️ Significant drag | Last inspected 2025-01-29 (14 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-01-29 (14 months ago). Score starting to decay. Note it but don't escalate. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.6 on trust, +0.4 on overall (6.2 → 6.6).
...
| Google review count | 105 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.9★ (105 reviews) | observed | ✓ |
...
| Last Inspection | 2025-01-29 | FSA | observed |
| Google Rating | 4.9/5 | Google Places API | observed |
| Google Reviews | 105 | Google Places API | observed |
...
| Postcode | CV36 5LE | FSA | observed |
| Companies House | — | Not checked | not_assessed |
