# The Pavilion Coffee Shop And Community Space — Monthly Intelligence Report
...
- Ranked #3 of 4 locally — peers are ahead
...
**Overall score: 5.5/10** (baseline month — no prior comparison)
 | Strongest: Trust (8.7) | Weakest: Visibility (1.3)

**Competitive position:** Local Peers (5mi): #3 of 4 (P33.3) — peer avg 5.6, top 6.32
  Catchment (15mi): #30 of 43 (P31.0) — peer avg 5.75, top 6.78
  UK Category Cohort: #38 of 53 (P28.8) — peer avg 5.79, top 6.92
...
Based on publicly observable data for The Pavilion Coffee Shop And Community Space, your current operational gaps are putting an estimated **3–12 covers per week** at risk — representing approximately **£380–£2,880 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£190–£1,440/mo); Fix the digital shopfront — you're losing walk-ins (£190–£1,440/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~40–80 | Derived from 20 Google reviews (micro venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 20 Google (4.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.7 rating across 20 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Pavilion Coffee Shop And Community Space is a cafe venue with an adequate public reputation (4.7/5, 20 reviews) that has room to build stronger proof.
...
- **Evidence:** `experience=8.61, conversion=2.5`
...
- **Review momentum.** At 20 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
**0 of 7** demand capture dimensions are clear. **5** have friction. **2** are missing.
...
Only 2 photos vs peer average of ~10. Low photo count suppresses click-through.

**Commercial consequence:** Venues with 10+ photos get ~35% more click-throughs (Google data).

*Signals: Photo count: 2; Peer average: ~10 photos*
...
Online visibility (1.3) hasn't kept pace with guest experience quality (8.6). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **The 4.7/5 rating feels dominant but isn't.** In this market, peer venues achieve similar ratings. Your percentile position (P33.3) shows the rating is table stakes, not a differentiator.
...
- **Unrealised review authority.** At 20 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** Only 20 reviews — rating is volatile. A single 1-star review moves the average measurably.
...
| Review Volume | 20 reviews (Low) | Visibility 1.3/10 (Weak) |
...
The Pavilion Coffee Shop And Community Space is classified as **Cafe / Coffee Shop** (confidence: high). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 2 signal sources.
...
| Name | "The Pavilion Coffee Shop And Community Space" contains "cafe" | Supportive |

**Resolved category:** Cafe / Coffee Shop (confidence: high)

### Peer Justification

- **Espresso Barn** (6.3): Dining with comparable price band; 1.5 miles away
- **Costa Coffee** (5.6): Dining with comparable price band; 4.8 miles away
- **Hudson's** (4.9): Dining with comparable price band; 4.3 miles away

## Competitive Market Intelligence

**Local market:** 3 direct competitors identified.

Below the median (P33). Customers have higher-rated alternatives nearby (peer avg 5.6, top 6.3).

**Where you lead:** Trust (+0.8)
**Where peers beat you:** Visibility (-1.4)

*Commercial implication: in a 4-venue market, a below-median position means demand is flowing to competitors. Each percentile point gained recaptures a share of local search traffic. Estimated fair share: ~25% of local demand — you are likely underindexed (directional).*
...
| Costa Coffee | 5.6 | 3.7★ | 35 |
| Hudson's | 4.9 | 4.4★ | 132 |
...
### Local Competitive Set (3 peers within 5 miles)

**Position:** #3 of 4 (Percentile 33.3)

You are below the median of your peer set. At 5.5 vs peer average 5.6, competitors are outperforming you. The top performer scores 6.3. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Trust: 8.7 (+0.8 above peer avg 7.9)
- Visibility: 1.3 (-1.4 below peer avg 2.7)

**Closest competitors:**

- Espresso Barn (6.3) — leads you by 0.8
- Costa Coffee (5.6) — leads you by 0.0
- Hudson's (4.9) — you lead by 0.6
...
**Espresso Barn** (signal-backed)

- **Also wins on:** Experience (+0.8): higher composite experience score from rating + compliance signals
...
- **Copy / test:** Build review volume — they have 501 to your 20. Read their recent positive reviews (4.5/5) for operational clues.
- **Defend:** No clear defensive advantage — you are closely matched across dimensions.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

**Hudson's** (signal-backed)

- **Wins on:** Visibility (see pattern above)
- **Why it matters:** A large visibility gap (+1.8) — they are easier to find online — this controls top-of-funnel discovery. This is a structural disadvantage, not a rounding error.
- **Copy / test:** Build review volume — they have 132 to your 20.
- **Defend:** Defend your trust advantage (+2.9).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

### Extended Catchment (42 peers within 15 miles)

**Position:** #30 of 43 (Percentile 31.0)

You are below the median of your peer set. At 5.5 vs peer average 5.8, competitors are outperforming you. The top performer scores 6.8. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Trust: 8.7 (+1.2 above peer avg 7.4)
- Visibility: 1.3 (-2.0 below peer avg 3.3)
...
**Position:** #38 of 53 (Percentile 28.8)

You are below the median of your peer set. At 5.5 vs peer average 5.8, competitors are outperforming you. The top performer scores 6.9. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Trust: 8.7 (+1.2 above peer avg 7.5)
- Visibility: 1.3 (-1.9 below peer avg 3.2)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.6 | — | 8.7 | -0.1 | Strong |
| Visibility | 1.3 | — | 2.7 | -1.4 | Below peers |
| Trust | 8.7 | — | 7.9 | +0.8 | Above peers |
| Conversion | 2.5 | — | 2.8 | -0.3 | Below peers |
| **Overall** | **5.5** | **—** | | | |
...
**Assessment: Critical.** At 1.3, this represents a material operational gap.
 You trail peers by 1.4 points (peer avg 2.7).
...
**Management note:** At 20 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 8.7.
 Slightly above peer average (7.9).
...
| Inspection Recency | 6.6/10 | ⚠️ Room to improve | Last inspected 2025-10-10 (6 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-10-10 (6 months ago). Full confidence. No action needed. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.8 on trust, +0.2 on overall (5.5 → 5.7).
...
Your 4.7/5 Google rating feels dominant but you sit below the local median (P33.3). Peer venues achieve similar or better ratings — in this market, 4.5 is table stakes, not a differentiator. Don't mistake the number for an advantage.

**Ranked #3 of 4 locally — peers are ahead** [ESCALATED]
...
### Action 5: Ranked #3 of 4 locally — peers are ahead
**Status:** Stale (4 months) | **Priority:** Medium
...
| Google review count | 20 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.7★ (20 reviews) | observed | ✓ |
...
| Last Inspection | 2025-10-10 | FSA | observed |
| Google Rating | 4.7/5 | Google Places API | observed |
| Google Reviews | 20 | Google Places API | observed |
| Google Photos | 2 | Google Places API | observed |
...
| Postcode | CV37 8YE | FSA | observed |
| Companies House | — | Not checked | not_assessed |
