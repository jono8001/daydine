# LeBuns — Monthly Intelligence Report
...
**Overall score: 6.1/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.1) | Weakest: Visibility (3.4)

**Competitive position:** Local Peers (5mi): #1 of 2 (P100.0) — peer avg 5.66, top 5.66
  Catchment (15mi): #7 of 15 (P57.1) — peer avg 5.93, top 7.34
  UK Category Cohort: #9 of 19 (P55.6) — peer avg 5.9, top 7.34
...
| Aggregate signals | Rating and volume from all platforms | 294 Google (4.2★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.2 rating across 294 Google reviews is the reputation bedrock and is factored into scoring separately.
...
LeBuns operates as a credible pub dining venue with a 4.2/5 Google rating across 294 reviews — solid but not yet commanding.
...
Insufficient review data to cross-reference proposition. Google types show: pub, hotel, live_music_venue, wine_bar, lodging, bar, event_venue. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: pub, hotel, live_music_venue, wine_bar, lodging, bar, event_venue*
...
Online visibility (3.4) hasn't kept pace with guest experience quality (9.1). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
LeBuns is classified as **Pub / Bar** (confidence: medium). Google's raw category is "Pub / Bar" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | pub, hotel, live_music_venue, wine_bar, lodging, bar, event_venue | Primary |
...
- **The Yew Tree** (5.7): Pub Dining with similar price band; 4.5 miles away

## Competitive Market Intelligence

**Local market:** 1 direct competitors identified.

You are in the top quintile (P100). The competitive risk is complacency — the nearest competitor scores 5.7.
...
You are in the top quintile of this peer set. Your overall score of 6.1 exceeds the peer average of 5.7 by 0.5 points. The competitive risk here is complacency — the nearest competitor scores 5.7.

**Dimension gaps vs peers:**

- Trust: 8.9 (+2.0 above peer avg 6.8)

**Closest competitors:**

- The Yew Tree (5.7) — you lead by 0.5
...
You sit above the median but below the top tier. Your 6.1 compares to a peer average of 5.9. The gap to the top (7.3) is 1.2 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 8.9 (+1.1 above peer avg 7.8)

**Closest competitors:**

- Vintner Wine Bar (7.3) — leads you by 1.2
- The Fox Inn (6.5) — leads you by 0.3
- The Red Lion (6.4) — leads you by 0.3
- The Townhouse Also Trading As JR Hotel And Restaurants LTD (6.3) — leads you by 0.2
- The Bull's Head (6.3) — leads you by 0.2
...
- Trust: 8.9 (+0.9 above peer avg 8.0)

**Closest competitors:**

- Vintner Wine Bar (7.3) — leads you by 1.2
- Arrow Mill (6.7) — leads you by 0.6
- The Fox Inn (6.5) — leads you by 0.3
- The Red Lion (6.4) — leads you by 0.3
- The Townhouse Also Trading As JR Hotel And Restaurants LTD (6.3) — leads you by 0.2
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.1 | — | 8.6 | +0.5 | Above peers |
| Visibility | 3.4 | — | 3.5 | -0.1 | Needs work |
| Trust | 8.9 | — | 6.8 | +2.0 | Clear strength |
...
**Assessment: Strong.** This is a genuine competitive strength at 8.9.
 You lead peers by 2.0 points (peer avg 6.8).
...
**Biggest drag:** Inspection Recency. Last inspected 2025-11-05 (5 months ago). Full confidence. No action needed. 

**Peer context:** The Yew Tree's trust lead (+2.0) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.8 on trust, +0.2 on overall (6.1 → 6.3).
...
| Google Business Profile | 4.2★ (294 reviews) | observed | ✓ |
...
| Postcode | CV35 0JS | FSA | observed |
| Companies House | — | Not checked | not_assessed |
