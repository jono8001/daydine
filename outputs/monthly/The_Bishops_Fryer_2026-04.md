# The Bishops Fryer — Monthly Intelligence Report
...
**Overall score: 6.1/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.2) | Weakest: Visibility (2.9)

**Competitive position:** Local Peers (5mi): #3 of 3 (P0.0) — peer avg 6.37, top 6.51
  Catchment (15mi): #3 of 5 (P50.0) — peer avg 5.87, top 6.51
  UK Category Cohort: #3 of 6 (P60.0) — peer avg 5.88, top 6.51
...
| Aggregate signals | Rating and volume from all platforms | 253 Google (4.3★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.3 rating across 253 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Bishops Fryer operates as a credible takeaway venue with a 4.3/5 Google rating across 253 reviews — solid but not yet commanding.
...
- **Review momentum.** At 253 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Online visibility (2.9) hasn't kept pace with guest experience quality (9.2). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 253 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 253 reviews (Moderate) | Visibility 2.9/10 (Weak) |
...
The Bishops Fryer is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Takeaway" but the resolved category triangulates across 2 signal sources.
...
- **The Pickled Crab Deli** (6.5): Takeaway-focused — different service model; 3.0 miles away *(weak comparator)*
- **Pickled & Tipsy's Cafe** (6.2): Takeaway-focused — different service model; 3.1 miles away *(weak comparator)*
...
You are below the median of your peer set. At 6.1 vs peer average 6.4, competitors are outperforming you. The top performer scores 6.5. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Conversion: 5.0 (+0.5 above peer avg 4.5)

**Closest competitors:**

- The Pickled Crab Deli (6.5) — leads you by 0.4
- Pickled & Tipsy's Cafe (6.2) — leads you by 0.1
...
You sit above the median but below the top tier. Your 6.1 compares to a peer average of 5.9. The gap to the top (6.5) is 0.4 points — closeable with focused improvement on your weakest dimension.
...
- The Pickled Crab Deli (6.5) — leads you by 0.4
- Pickled & Tipsy's Cafe (6.2) — leads you by 0.1
- The Margin (5.5) — you lead by 0.6
- The Water Margin @ The Hollybush (5.2) — you lead by 0.9
...
- The Pickled Crab Deli (6.5) — leads you by 0.4
- Pickled & Tipsy's Cafe (6.2) — leads you by 0.1
- Chrissie's Kitchen (5.9) — you lead by 0.2
- The Margin (5.5) — you lead by 0.6
- The Water Margin @ The Hollybush (5.2) — you lead by 0.9
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.2 | — | 9.6 | -0.4 | Below peers |
| Visibility | 2.9 | — | 2.9 | -0.0 | Needs work |
| Trust | 8.2 | — | 8.4 | -0.2 | Strong |
| Conversion | 5.0 | — | 4.5 | +0.5 | Above peers |
| **Overall** | **6.1** | **—** | | | |
...
**Assessment: Strong.** This is a genuine competitive strength at 9.2.
 Slightly below peer average (9.6).
...
**Management note:** At 253 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Weak.** At 5.0, this dimension is actively limiting your overall position.
 Slightly above peer average (4.5).
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.8 on trust, +0.5 on overall (6.1 → 6.6).
...
### Action 4: Ranked #3 of 3 locally — peers are ahead
**Status:** Stale (4 months) | **Priority:** Medium
...
| Google review count | 253 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.3★ (253 reviews) | observed | ✓ |
...
| Google Reviews | 253 | Google Places API | observed |
...
| Postcode | CV47 2RN | FSA | observed |
| Companies House | — | Not checked | not_assessed |
