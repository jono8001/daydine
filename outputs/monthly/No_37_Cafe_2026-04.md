# No 37 Cafe — Monthly Intelligence Report
...
**Overall score: 6.3/10** (baseline month — no prior comparison)
 | Strongest: Trust (9.5) | Weakest: Visibility (3.5)

**Competitive position:** Local Peers (5mi): #2 of 18 (P94.1) — peer avg 5.44, top 6.64
  Catchment (15mi): #8 of 46 (P84.4) — peer avg 5.71, top 6.78
  UK Category Cohort: #10 of 53 (P82.7) — peer avg 5.77, top 6.92
...
Based on publicly observable data for No 37 Cafe, your current operational gaps are putting an estimated **11–35 covers per week** at risk — representing approximately **£1,320–£8,400 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£660–£4,200/mo); Fix the digital shopfront — you're losing walk-ins (£660–£4,200/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~220–350 | Derived from 430 Google reviews (large venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 430 Google (4.3★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.3 rating across 430 Google reviews is the reputation bedrock and is factored into scoring separately.
...
No 37 Cafe operates as a credible cafe venue with a 4.3/5 Google rating across 430 reviews — solid but not yet commanding.
...
- **Review momentum.** At 430 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Online visibility (3.5) hasn't kept pace with guest experience quality (9.2). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 430 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 430 reviews (Moderate) | Visibility 3.5/10 (Weak) |
...
No 37 Cafe is classified as **Cafe / Coffee Shop** (confidence: high). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 3 signal sources.
...
| Name | "No 37 Cafe" contains "cafe" | Supportive |
...
You are in the top quintile (P94). The competitive risk is complacency — the nearest competitor scores 6.6.

**Where you lead:** Trust (+2.5), Experience (+0.9), Conversion (+0.6)
...
**Position:** #2 of 18 (Percentile 94.1)
...
- Trust: 9.5 (+2.5 above peer avg 7.1)
- Experience: 9.2 (+0.9 above peer avg 8.3)
- Conversion: 3.5 (+0.6 above peer avg 2.9)

**Closest competitors:**

- Shakespaw Cat Cafe (6.6) — leads you by 0.3
- Costa (6.3) — you lead by 0.0
- Espresso Barn (6.3) — you lead by 0.0
- Coffee Clouds (6.0) — you lead by 0.4
- Touchdown Cafe (5.8) — you lead by 0.6
...
**Position:** #8 of 46 (Percentile 84.4)

You are in the top quintile of this peer set. Your overall score of 6.3 exceeds the peer average of 5.7 by 0.6 points. The competitive risk here is complacency — the nearest competitor scores 6.8.

**Dimension gaps vs peers:**

- Trust: 9.5 (+2.1 above peer avg 7.4)
- Conversion: 3.5 (+0.6 above peer avg 2.9)

**Closest competitors:**

- South Costa (6.8) — leads you by 0.4
- Building 523 Costa And Kitchen (6.8) — leads you by 0.4
...
**Position:** #10 of 53 (Percentile 82.7)

You are in the top quintile of this peer set. Your overall score of 6.3 exceeds the peer average of 5.8 by 0.6 points. The competitive risk here is complacency — the nearest competitor scores 6.9.

**Dimension gaps vs peers:**

- Trust: 9.5 (+2.0 above peer avg 7.5)
- Conversion: 3.5 (+0.6 above peer avg 2.9)
...
- South Costa (6.8) — leads you by 0.4
- Nanas Caff (6.8) — leads you by 0.4
- Building 523 Costa And Kitchen (6.8) — leads you by 0.4
- Dec X Canteen (6.7) — leads you by 0.3
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.2 | — | 8.3 | +0.9 | Above peers |
| Visibility | 3.5 | — | 3.4 | +0.1 | Needs work |
| Trust | 9.5 | — | 7.1 | +2.5 | Clear strength |
...
**Management note:** At 430 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 9.5.
 You lead peers by 2.5 points (peer avg 7.1).
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.1 on trust, +0.0 on overall (6.3 → 6.4).
...
| Google review count | 430 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.3★ (430 reviews) | observed | ✓ |
...
| Google Reviews | 430 | Google Places API | observed |
