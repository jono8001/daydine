# Kings Court Hotel — Monthly Intelligence Report
...
**Overall score: 6.1/10** (baseline month — no prior comparison)
 | Strongest: Experience (10.0) | Weakest: Visibility (0.8)

**Competitive position:** Local Peers (5mi): #3 of 4 (P33.3) — peer avg 6.49, top 6.76
  Catchment (15mi): #11 of 15 (P28.6) — peer avg 6.08, top 6.78
  UK Category Cohort: #11 of 17 (P37.5) — peer avg 6.03, top 6.78
...
Based on publicly observable data for Kings Court Hotel, your current operational gaps are putting an estimated **1–6 covers per week** at risk — representing approximately **£140–£1,340 per month** in lost or leaked revenue. The main drivers are: Publish opening hours — you're invisible to 'open now' searches (£70–£670/mo); Get your menu online — 77% of diners check before visiting (£70–£670/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Publish opening hours — you're invisible to 'open now' searches** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~40–80 | Derived from 0 Google reviews (micro venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 0 Google (None★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate None rating across 0 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Kings Court Hotel operates in the hotel dining category with a public rating of None/5 that is currently limiting discovery.
...
- **Review momentum.** At 0 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
GBP profile is only 3/10 complete. Significant gaps: Has rating, Has reviews (>0), Has opening hours, Has price level, Review count >= 10, Review count >= 100, Has website.

**Commercial consequence:** Incomplete GBP profile suppresses Google Maps visibility and customer action.

*Signals: GBP completeness: 3/10; Missing: Has rating, Has reviews (>0), Has opening hours, Has price level, Review count >= 10, Review count >= 100, Has website*

### Photo Mix & Quality [PARTIAL]

Only 5 photos vs peer average of ~10. Low photo count suppresses click-through.

**Commercial consequence:** Venues with 10+ photos get ~35% more click-throughs (Google data).

*Signals: Photo count: 5; Peer average: ~10 photos*

### Proposition Clarity [PARTIAL]

Insufficient review data to cross-reference proposition. Google types show: premise, street_address. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: premise, street_address*
...
Online visibility (0.8) hasn't kept pace with guest experience quality (10.0). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** Only 0 reviews — insufficient for reliable assessment. Priority: build review count.
...
Kings Court Hotel is classified as **Premise** (confidence: low). Google's raw category is "Hotel / Accommodation" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | premise, street_address | Primary |

**Resolved category:** Premise (confidence: low)

### Peer Justification

- **Ragley Hall Catering** (6.8): Dining with comparable price band; 2.4 miles away
- **Studley Castle** (6.7): Hotel restaurant — different occasion type, may not compete for walk-in trade; 2.9 miles away *(marginal comparator)*
- **Billesley Manor Hotel** (6.0): Hotel restaurant — different occasion type, may not compete for walk-in trade; 4.3 miles away *(marginal comparator)*

## Competitive Market Intelligence

**Local market:** 3 direct competitors identified.

Below the median (P33). Customers have higher-rated alternatives nearby (peer avg 6.5, top 6.8).

**Where you lead:** Experience (+1.0)
**Where peers beat you:** Visibility (-3.1)
...
|---|---|---|---|
| Ragley Hall Catering | 6.8 | 4.6★ | 1,395 |
| Studley Castle | 6.7 | 4.5★ | 1,698 |
| Billesley Manor Hotel | 6.0 | 4.2★ | 1,208 |
...
You are below the median of your peer set. At 6.1 vs peer average 6.5, competitors are outperforming you. The top performer scores 6.8. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Experience: 10.0 (+1.0 above peer avg 9.0)
- Visibility: 0.8 (-3.1 below peer avg 3.9)

**Closest competitors:**

- Ragley Hall Catering (6.8) — leads you by 0.7
- Studley Castle (6.7) — leads you by 0.6
- Billesley Manor Hotel (6.0) — you lead by 0.0
...
**Billesley Manor Hotel** (partial)

- **Wins on:** Visibility (see pattern above)
- **Why it matters:** A large visibility gap (+3.1) — they are easier to find online — this controls top-of-funnel discovery. This is a structural disadvantage, not a rounding error.
- **Copy / test:** Build review volume — they have 1208 to your 0.
- **Defend:** Defend your experience lead (+2.0) — drives repeats and word-of-mouth.
- *Based on Google rating/reviews, FSA record, 3 dimension scores*

**Hotel Indigo And The Woodsman** (partial)

- **Wins on:** Visibility (see pattern above)
- **Why it matters:** A large visibility gap (+3.0) — they are easier to find online — this controls top-of-funnel discovery. This is a structural disadvantage, not a rounding error.
- **Copy / test:** Build review volume — they have 826 to your 0.
...
- **Wins on:** Visibility (see pattern above)
- **Why it matters:** A large visibility gap (+3.2) — they are easier to find online — this controls top-of-funnel discovery. This is a structural disadvantage, not a rounding error.
- **Copy / test:** Build review volume — they have 1938 to your 0.
- **Defend:** Defend your experience lead (+1.3) — drives repeats and word-of-mouth.
- *Based on Google rating/reviews, FSA record, 3 dimension scores*

### Extended Catchment (14 peers within 15 miles)

**Position:** #11 of 15 (Percentile 28.6)

You are below the median of your peer set. At 6.1 vs peer average 6.1, competitors are outperforming you. The top performer scores 6.8. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Experience: 10.0 (+1.5 above peer avg 8.5)
- Visibility: 0.8 (-3.0 below peer avg 3.8)

**Closest competitors:**

- Premier Inn (6.8) — leads you by 0.7
- Ragley Hall Catering (6.8) — leads you by 0.7
- Studley Castle (6.7) — leads you by 0.6
- Hotel Indigo And The Woodsman (6.6) — leads you by 0.5
- Alveston Manor Hotel (6.5) — leads you by 0.4

### UK Category Cohort (16 peers in Hotel / Accommodation)

**Position:** #11 of 17 (Percentile 37.5)

You are below the median of your peer set. At 6.1 vs peer average 6.0, competitors are outperforming you. The top performer scores 6.8. Customers in this area have demonstrably better-rated alternatives.
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 10.0 | — | 9.0 | +1.0 | Above peers |
| Visibility | 0.8 | — | 3.9 | -3.1 | Significant gap |
| Trust | 8.1 | — | 7.8 | +0.3 | Above peers |
| Conversion | — | — | — | — | No data |
| **Overall** | **6.1** | **—** | | | |

*Prestige (editorial recognition): 0.0/10 (peer avg 1.0) — tracked but not a headline operational lever for most independents.*
...
**Assessment: Strong.** This is a genuine competitive strength at 10.0.
 You lead peers by 1.0 points (peer avg 9.0).
...
**Assessment: Critical.** At 0.8, this represents a material operational gap.
 You trail peers by 3.1 points (peer avg 3.9).
...
**Management note:** At 0 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 4.0/10 | ⚠️ Significant drag | Last inspected 2025-03-06 (13 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-03-06 (13 months ago). Score starting to decay. Note it but don't escalate. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.5 on trust, +0.4 on overall (6.1 → 6.5).
...
### Action 4: Ranked #3 of 4 locally — peers are ahead
**Status:** Stale (5 months) | **Priority:** Medium
...
| Google Business Profile | Not available | not_assessed | — |
...
| Last Inspection | 2025-03-06 | FSA | observed |
| Google Photos | 5 | Google Places API | observed |
| Website | No | Google inference | inferred |
| Facebook | No | Google inference | inferred |
| Instagram | No | Google inference | inferred |
| Category | Hotel / Accommodation | name_match | derived |
| Postcode | B49 5QQ | FSA | observed |
| Companies House | — | Not checked | not_assessed |
