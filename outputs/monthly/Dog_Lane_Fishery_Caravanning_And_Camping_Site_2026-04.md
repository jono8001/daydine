# Dog Lane Fishery Caravanning And Camping Site — Monthly Intelligence Report
...
**Competitive position:** Catchment (15mi): #2 of 2 (P0.0) — peer avg 6.19, top 6.19
  UK Category Cohort: #14 of 17 (P18.8) — peer avg 6.07, top 6.78
...
Based on publicly observable data for Dog Lane Fishery Caravanning And Camping Site, your current operational gaps are putting an estimated **11–33 covers per week** at risk — representing approximately **£1,340–£8,420 per month** in lost or leaked revenue. The main drivers are: Renew formal trust proof before it becomes a visible drag (£0–£500/mo (defensive)); Get your menu online — 77% of diners check before visiting (£670–£3,960/mo); Fix the digital shopfront — you're losing walk-ins (£670–£3,960/mo). Taking action on **Renew formal trust proof before it becomes a visible drag** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~140–220 | Derived from 303 Google reviews (mid venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 303 Google (4.6★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.6 rating across 303 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Dog Lane Fishery Caravanning And Camping Site operates as a credible hotel dining venue with a 4.6/5 Google rating across 303 reviews — solid but not yet commanding.
...
Last inspected 11.1 years ago. A stale inspection date erodes trust scoring and signals to customers that compliance isn't actively managed. Request a voluntary re-inspection once you're confident of a strong result.
...
- **Review momentum.** At 303 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: fishing_pond, campground, lodging. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: fishing_pond, campground, lodging*
...
- **Volume:** 303 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 6.6/10 (Adequate) |
| Review Volume | 303 reviews (Moderate) | Visibility 3.4/10 (Weak) |
...
Dog Lane Fishery Caravanning And Camping Site is classified as **Fishing Pond** (confidence: low). Google's raw category is "Hotel / Accommodation" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | fishing_pond, campground, lodging | Primary |

**Resolved category:** Fishing Pond (confidence: low)
...
### Extended Catchment (1 peers within 15 miles)

**Position:** #2 of 2 (Percentile 0.0)

You are below the median of your peer set. At 5.4 vs peer average 6.2, competitors are outperforming you. The top performer scores 6.2. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Trust: 6.6 (-3.0 below peer avg 9.6)

**Closest competitors:**

- Stratford Manor Hotel (6.2) — leads you by 0.8

### UK Category Cohort (16 peers in Hotel / Accommodation)

**Position:** #14 of 17 (Percentile 18.8)

You are below the median of your peer set. At 5.4 vs peer average 6.1, competitors are outperforming you. The top performer scores 6.8. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Trust: 6.6 (-1.2 below peer avg 7.8)

**Closest competitors:**

- Premier Inn (6.8) — leads you by 1.4
- Ragley Hall Catering (6.8) — leads you by 1.3
- Studley Castle (6.7) — leads you by 1.3
- Hotel Indigo And The Woodsman (6.6) — leads you by 1.1
- Alveston Manor Hotel (6.5) — leads you by 1.1

## Dimension Scorecard

| Dimension | Score | Δ | Peer Avg | Gap | Read |
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.5 | — | — | — | Strong |
| Visibility | 3.4 | — | — | — | Needs work |
| Trust | 6.6 | — | — | — | In line |
...
**Management note:** At 303 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Adequate.** At 6.6, this is functional but not distinctive.
...
| Inspection Recency | 0.0/10 | ⚠️ Significant drag | Last inspected 2015-03-10 (135 months ago). Maximum decay applied. Reinspecti... |
...
**Biggest drag:** Inspection Recency. Last inspected 2015-03-10 (135 months ago). Maximum decay applied. Reinspection strongly recommended. The system discounts older inspections because they carry less certainty.

**What you can do:**

1. **Request voluntary reinspection** (free, 4–8 weeks) — would recover ~2.5 trust points. Only request reinspection if confident of maintaining 5/5. A drop to 4 would be worse than the staleness drag.
...
🔴 **FSA inspection recency:** Last inspected 134 months ago — re-inspection likely overdue.
...
| Google review count | 303 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.6★ (303 reviews) | observed | ✓ |
...
| Last Inspection | 2015-03-10 | FSA | observed |
| Google Rating | 4.6/5 | Google Places API | observed |
| Google Reviews | 303 | Google Places API | observed |
