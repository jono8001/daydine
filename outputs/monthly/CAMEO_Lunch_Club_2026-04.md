# CAMEO Lunch Club — Monthly Intelligence Report
...
**Overall score: 4.9/10** (baseline month — no prior comparison)
 | Strongest: Experience (8.0) | Weakest: Visibility (1.9)

**Competitive position:** UK Category Cohort: #3 of 3 (P0.0) — peer avg 5.88, top 5.98
...
Based on publicly observable data for CAMEO Lunch Club, your current operational gaps are putting an estimated **1–6 covers per week** at risk — representing approximately **£140–£1,840 per month** in lost or leaked revenue. The main drivers are: Close the hygiene gap — 3 to 5 (£0–£500/mo (defensive)); Publish opening hours — you're invisible to 'open now' searches (£70–£670/mo); Get your menu online — 77% of diners check before visiting (£70–£670/mo). Taking action on **Close the hygiene gap — 3 to 5** could begin recovering this within weeks at low cost (< £200).
...
| Aggregate signals | Rating and volume from all platforms | 20 Google (4.2★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.2 rating across 20 Google reviews is the reputation bedrock and is factored into scoring separately.
...
CAMEO Lunch Club is a catering venue with an adequate public reputation (4.2/5, 20 reviews) that has room to build stronger proof.
...
**Trust deficit.** Guests enjoy the venue but formal trust signals (compliance record, inspection recency) lag behind. This creates a hidden ceiling — one poor inspection makes a private gap public.

### Secondary Drag

Online visibility (1.9) hasn't kept pace with guest experience quality (8.0). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
| Review Volume | 20 reviews (Low) | Visibility 1.9/10 (Weak) |
...
CAMEO Lunch Club is classified as **Event Venue** (confidence: low). Google's raw category is "Catering" but the resolved category triangulates across 1 signal sources.
...
You are below the median of your peer set. At 4.9 vs peer average 5.9, competitors are outperforming you. The top performer scores 6.0. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Experience: 8.0 (-0.8 below peer avg 8.8)
- Visibility: 1.9 (-1.0 below peer avg 2.9)
- Trust: 5.6 (-2.3 below peer avg 7.9)

**Closest competitors:**

- Kitty's Kitchen Catering Ltd (6.0) — leads you by 1.1
- Earlswood Lunch Club (5.8) — leads you by 0.9
...
**Assessment: Critical.** At 1.9, this represents a material operational gap.
...
| Inspection Recency | 5.7/10 | ⚠️ Room to improve | Last inspected 2025-08-05 (8 months ago). Full confidence. No action needed.  |
...
| Google Business Profile | 4.2★ (20 reviews) | observed | ✓ |
...
| Last Inspection | 2025-08-05 | FSA | observed |
