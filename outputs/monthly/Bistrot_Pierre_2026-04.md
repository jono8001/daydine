# Bistrot Pierre — Monthly Intelligence Report
...
**Overall score: 6.1/10** (baseline month — no prior comparison)
 | Strongest: Trust (9.3) | Weakest: Conversion (3.5)

**Competitive position:** Local Peers (5mi): #2 of 2 (P0.0) — peer avg 6.12, top 6.12
  Catchment (15mi): #2 of 2 (P0.0) — peer avg 6.12, top 6.12
  UK Category Cohort: #2 of 2 (P0.0) — peer avg 6.12, top 6.12
...
Based on publicly observable data for Bistrot Pierre, your current operational gaps are putting an estimated **16–50 covers per week** at risk — representing approximately **£1,920–£12,000 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£960–£6,000/mo); Fix the digital shopfront — you're losing walk-ins (£960–£6,000/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~320–500 | Derived from 970 Google reviews (high-traffic venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 970 Google (4.1★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.1 rating across 970 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Bistrot Pierre operates as a credible French dining venue with a 4.1/5 Google rating across 970 reviews — solid but not yet commanding.
...
- **Evidence:** `experience=8.2, conversion=3.5`
...
- **Review momentum.** At 970 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: french_restaurant, bistro, pub, breakfast_restaurant, restaurant, bar. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: french_restaurant, bistro, pub, breakfast_restaurant, restaurant, bar*
...
Online visibility (3.8) hasn't kept pace with guest experience quality (8.2). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 970 reviews — strong base. Rating is stable but a sustained negative pattern could shift it.
...
|--------|-------------|---------------------|
| Customer Rating | 4.1/5 Google (Good) | Experience 8.2/10 (Strong) — Gap |
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 9.3/10 (Strong) |
| Review Volume | 970 reviews (High) | Visibility 3.8/10 (Weak) |
...
Bistrot Pierre is classified as **Pub / Bar** (confidence: medium). Google's raw category is "French Restaurant" but the resolved category triangulates across 3 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | french_restaurant, bistro, pub, breakfast_restaurant, restaurant, bar | Primary |
| Price Level | ££ (2/4) — Casual dining | Supportive |
| Name | "Bistrot Pierre" contains "bistro" | Supportive |

**Resolved category:** Pub / Bar (confidence: medium)

### Peer Justification

- **The Opposition** (6.1): Dining with similar price band; 0.2 miles away
...
- Trust: 9.3 (+0.9 above peer avg 8.4)
- Experience: 8.2 (-0.5 below peer avg 8.7)

**Closest competitors:**

- The Opposition (6.1) — leads you by 0.1

### Competitor Strategy

**The Opposition** (signal-backed)

- **Wins on:** Experience (+0.5): Google 4.8/5 vs your 4.1/5
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.2 | — | 8.7 | -0.5 | Below peers |
| Visibility | 3.8 | — | 3.6 | +0.2 | Needs work |
| Trust | 9.3 | — | 8.4 | +0.9 | Above peers |
...
**Management note:** At 970 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Biggest drag:** Inspection Recency. Last inspected 2026-01-13 (3 months ago). Full confidence. No action needed. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.5 on trust, +0.1 on overall (6.1 → 6.2).
...
| Google review count | 970 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.1★ (970 reviews) | observed | ✓ |
...
| Google Reviews | 970 | Google Places API | observed |
...
| Category | French Restaurant | google_types | derived |
| Postcode | CV37 7LT | FSA | observed |
| Companies House | — | Not checked | not_assessed |
