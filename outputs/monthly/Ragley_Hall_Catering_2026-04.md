# Ragley Hall Catering — Monthly Intelligence Report
...
**Overall score: 6.8/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.5) | Weakest: Visibility (3.9)

**Competitive position:** Local Peers (5mi): #1 of 3 (P100.0) — peer avg 6.07, top 6.09
  Catchment (15mi): #2 of 15 (P92.9) — peer avg 6.03, top 6.78
  UK Category Cohort: #2 of 17 (P93.8) — peer avg 5.98, top 6.78
...
Based on publicly observable data for Ragley Hall Catering, your current operational gaps are putting an estimated **10–35 covers per week** at risk — representing approximately **£1,160–£8,400 per month** in lost or leaked revenue. The main drivers are: Publish opening hours — you're invisible to 'open now' searches (£580–£4,200/mo); Get your menu online — 77% of diners check before visiting (£580–£4,200/mo); Protect the 4.6/5 rating — it took years to build (discovery protection). Taking action on **Publish opening hours — you're invisible to 'open now' searches** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~320–500 | Derived from 1,395 Google reviews (high-traffic venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 1,395 Google (4.6★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.6 rating across 1,395 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Ragley Hall Catering is a well-established hotel dining venue with a strong public reputation — 4.6/5 across 1,395 Google reviews. That volume means the reputation is earned, not manufactured.
...
With 1395 reviews at 4.6/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 1395 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: event_venue, wedding_venue, tourist_attraction, garden, park, live_music_venue, service. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: event_venue, wedding_venue, tourist_attraction, garden, park, live_music_venue, service*
...
Online visibility (3.9) hasn't kept pace with guest experience quality (9.5). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 1,395 reviews — statistically robust rating. Individual reviews have negligible impact.
...
| Review Volume | 1395 reviews (High) | Visibility 3.9/10 (Weak) |

## Category & Peer Validation

### Why This Venue Is In This Cohort

Ragley Hall Catering is classified as **Event Venue** (confidence: low). Google's raw category is "Hotel / Accommodation" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | event_venue, wedding_venue, tourist_attraction, garden, park, live_music_venue, service | Primary |

**Resolved category:** Event Venue (confidence: low)

### Peer Justification

- **Kings Court Hotel** (6.1): Dining with comparable price band; 2.4 miles away
- **Billesley Manor Hotel** (6.0): Hotel restaurant — different occasion type, may not compete for walk-in trade; 4.6 miles away *(marginal comparator)*
...
**Where you lead:** Visibility (+1.6), Experience (+0.5)
...
You are in the top quintile of this peer set. Your overall score of 6.8 exceeds the peer average of 6.1 by 0.7 points. The competitive risk here is complacency — the nearest competitor scores 6.1.

**Dimension gaps vs peers:**

- Visibility: 3.9 (+1.6 above peer avg 2.3)
- Experience: 9.5 (+0.5 above peer avg 9.0)

**Closest competitors:**

- Kings Court Hotel (6.1) — you lead by 0.7
- Billesley Manor Hotel (6.0) — you lead by 0.7
...
- Experience: 9.5 (+1.0 above peer avg 8.5)

**Closest competitors:**

- Premier Inn (6.8) — leads you by 0.0
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.5 | — | 9.0 | +0.5 | Above peers |
| Visibility | 3.9 | — | 2.3 | +1.6 | Clear strength |
| Trust | 7.8 | — | 8.0 | -0.1 | In line |
| Conversion | — | — | — | — | No data |
| **Overall** | **6.8** | **—** | | | |
...
**Assessment: Critical.** At 3.9, this represents a material operational gap.
 You lead peers by 1.6 points (peer avg 2.3).
...
**Management note:** At 1395 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Biggest drag:** Inspection Recency. Last inspected 2025-06-03 (10 months ago). Full confidence. No action needed. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.3 on trust, +0.3 on overall (6.8 → 7.1).
...
| Google review count | 1395 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.6★ (1395 reviews) | observed | ✓ |
...
| Google Reviews | 1395 | Google Places API | observed |
