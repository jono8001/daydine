...
Based on publicly observable data for Ragley Hall Catering, your current operational gaps are putting an estimated **3–30 covers per week** at risk — representing approximately **£360–£7,200 per month** in lost or leaked revenue. The main drivers are: Publish opening hours — you're invisible to 'open now' searches (£180–£3,600/mo); Get your menu online — 77% of diners check before visiting (£180–£3,600/mo); Protect the 4.6/5 rating — it took years to build (discovery protection). Taking action on **Publish opening hours — you're invisible to 'open now' searches** could begin recovering this within weeks at low cost (< £200).
