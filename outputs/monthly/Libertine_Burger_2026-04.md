# Libertine Burger — Monthly Intelligence Report
...
**Competitive position:** Local Peers (5mi): #6 of 6 (P0.0) — peer avg 5.98, top 6.52
  Catchment (15mi): #8 of 9 (P12.5) — peer avg 5.91, top 6.52
  UK Category Cohort: #8 of 9 (P12.5) — peer avg 5.91, top 6.52
...
Based on publicly observable data for Libertine Burger, your current operational gaps are putting an estimated **11–33 covers per week** at risk — representing approximately **£1,340–£7,920 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£670–£3,960/mo); Fix the digital shopfront — you're losing walk-ins (£670–£3,960/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~140–220 | Derived from 184 Google reviews (mid venue indicator), price level ££ |
...
| Weekly revenue at risk | £340–£1,980 | Recoverable with priority action fixes |
| Monthly revenue at risk | £1,340–£7,920 | Aggregate across top 3 priorities |
| Annual projection | £16,080–£95,040 | If current gaps persist 12 months |
...
| Aggregate signals | Rating and volume from all platforms | 184 Google (4.4★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.4 rating across 184 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Libertine Burger operates as a credible american / grill venue with a 4.4/5 Google rating across 184 reviews — solid but not yet commanding.
...
- **Review momentum.** At 184 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: hamburger_restaurant, american_restaurant, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: hamburger_restaurant, american_restaurant, restaurant*
...
Online visibility (3.2) hasn't kept pace with guest experience quality (8.3). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Unrealised review authority.** At 184 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** 184 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 184 reviews (Moderate) | Visibility 3.2/10 (Weak) |
...
Libertine Burger is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "American / Grill" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | hamburger_restaurant, american_restaurant, restaurant | Primary |
...
- **Beleza Rodizio** (6.2): Dining with comparable price band; 0.0 miles away
- **McDonald's** (6.0): Dining with comparable price band; 0.4 miles away
- **McDonald's** (5.8): Dining with comparable price band; 0.2 miles away
- **WINGERS STRATFORD** (5.5): Dining with comparable price band; 0.7 miles away

## Competitive Market Intelligence

**Local market:** 5 direct competitors identified.

Below the median (P0). Customers have higher-rated alternatives nearby (peer avg 6.0, top 6.5).
...
You are below the median of your peer set. At 5.4 vs peer average 6.0, competitors are outperforming you. The top performer scores 6.5. Customers in this area have demonstrably better-rated alternatives.
...
- Beleza Rodizio (6.2) — leads you by 0.8
- McDonald's (6.0) — leads you by 0.6
- McDonald's (5.8) — leads you by 0.4
- WINGERS STRATFORD (5.5) — leads you by 0.1
...
- **Also wins on:** Visibility (+0.7): 1562 Google reviews vs your 184 — they have volume advantage
...
- **Copy / test:** Audit your Google profile vs theirs: hours, menu, booking, delivery. Build review volume — they have 1562 to your 184.
...
**WINGERS STRATFORD** (signal-backed)

- **Wins on:** Experience (+1.0): same Google rating (4.4/5) but higher experience score — likely stronger FSA food hygiene sub-scores
...
- **Defend:** Defend your trust advantage (+0.6) and your 184-review advantage vs their 40 (discovery moat).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

**KFC - Southbound** (signal-backed)

- **Also wins on:** Trust (+1.6): same FSA rating but likely stronger sub-scores or more recent inspection
...
- **Defend:** Defend your experience lead (+1.3) — drives repeats and word-of-mouth.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*
...
You are below the median of your peer set. At 5.4 vs peer average 5.9, competitors are outperforming you. The top performer scores 6.5. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Trust: 7.6 (-0.6 below peer avg 8.2)
- Conversion: 2.5 (-0.9 below peer avg 3.4)

**Closest competitors:**

- The Crofts Cafe Also Trading As New York Pizzas (6.5) — leads you by 1.1
- Miller And Carter (6.3) — leads you by 0.9
- Beleza Rodizio (6.2) — leads you by 0.8
- McDonald's (6.0) — leads you by 0.6
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.3 | — | 8.6 | -0.3 | Below peers |
| Visibility | 3.2 | — | 3.6 | -0.4 | Below peers |
| Trust | 7.6 | — | 8.0 | -0.4 | Below peers |
...
**Assessment: Critical.** At 3.2, this represents a material operational gap.
 Slightly below peer average (3.6).
...
**Management note:** At 184 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 3.9/10 | ⚠️ Significant drag | Last inspected 2025-02-21 (14 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-02-21 (14 months ago). Score starting to decay. Note it but don't escalate. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.5 on trust, +0.4 on overall (5.4 → 5.8).
...
### Action 4: Ranked #6 of 6 locally — peers are ahead
**Status:** Stale (5 months) | **Priority:** Medium
...
| Google review count | 184 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.4★ (184 reviews) | observed | ✓ |
...
| Last Inspection | 2025-02-21 | FSA | observed |
| Google Rating | 4.4/5 | Google Places API | observed |
| Google Reviews | 184 | Google Places API | observed |
...
| Postcode | CV37 6JP | FSA | observed |
| Companies House | — | Not checked | not_assessed |
