# Red Hot Mamma Pizzeria — Monthly Intelligence Report
...
**Overall score: 6.3/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.8) | Weakest: Conversion (2.5)

**Competitive position:** Local Peers (5mi): #2 of 8 (P85.7) — peer avg 5.7, top 6.91
  Catchment (15mi): #4 of 14 (P76.9) — peer avg 5.63, top 6.91
  UK Category Cohort: #5 of 15 (P71.4) — peer avg 5.69, top 6.91
...
Based on publicly observable data for Red Hot Mamma Pizzeria, your current operational gaps are putting an estimated **26–75 covers per week** at risk — representing approximately **£3,080–£18,000 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£1,540–£9,000/mo); Fix the digital shopfront — you're losing walk-ins (£1,540–£9,000/mo); Protect the 4.8/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~320–500 | Derived from 912 Google reviews (high-traffic venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 912 Google (4.8★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.8 rating across 912 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Red Hot Mamma Pizzeria is a well-established restaurant venue with a strong public reputation — 4.8/5 across 912 Google reviews. That volume means the reputation is earned, not manufactured.
...
Within the local restaurant market (7 peers), this venue leads the field. The identity is that of a category leader — the venue others are compared against.
...
- **Evidence:** `experience=9.77, conversion=2.5`
...
With 912 reviews at 4.8/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 912 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Online visibility (3.7) hasn't kept pace with guest experience quality (9.8). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 912 reviews — strong base. Rating is stable but a sustained negative pattern could shift it.
...
|--------|-------------|---------------------|
| Customer Rating | 4.8/5 Google (Strong) | Experience 9.8/10 (Strong) — Aligned |
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 8.4/10 (Strong) |
| Review Volume | 912 reviews (High) | Visibility 3.7/10 (Weak) |
...
Red Hot Mamma Pizzeria is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Restaurant (General)" but the resolved category triangulates across 1 signal sources.
...
- **11/17 Salt Beef Bar** (6.9): Dining with comparable price band; 0.1 miles away
- **Bannatyne Health Club And Spa Wildmoor** (5.8): Dining with comparable price band; 1.9 miles away
- **Fast Flavour** (5.8): Dining with comparable price band; 0.1 miles away
- **NO4 Bar And Restaurant** (5.7): Dining with comparable price band; 0.2 miles away
- **Lily's** (5.6): Dining with comparable price band; 0.2 miles away

## Competitive Market Intelligence

**Local market:** 7 direct competitors identified.

You are in the top quintile (P86). The competitive risk is complacency — the nearest competitor scores 6.9.

**Where you lead:** Experience (+1.2), Visibility (+0.8), Trust (+0.5)
...
| Bannatyne Health Club And Spa Wildmoor | 5.8 | 4.3★ | 530 |
...
**Position:** #2 of 8 (Percentile 85.7)

You are in the top quintile of this peer set. Your overall score of 6.3 exceeds the peer average of 5.7 by 0.6 points. The competitive risk here is complacency — the nearest competitor scores 6.9.

**Dimension gaps vs peers:**

- Experience: 9.8 (+1.2 above peer avg 8.6)
- Visibility: 3.7 (+0.8 above peer avg 3.0)
- Trust: 8.4 (+0.5 above peer avg 7.9)

**Closest competitors:**

- 11/17 Salt Beef Bar (6.9) — leads you by 0.6
- Bannatyne Health Club And Spa Wildmoor (5.8) — you lead by 0.5
- Fast Flavour (5.8) — you lead by 0.5
- NO4 Bar And Restaurant (5.7) — you lead by 0.6
- Lily's (5.6) — you lead by 0.7
...
- **Defend:** Defend your 912-review advantage vs their 72 (discovery moat).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

**The Bluebell** (signal-backed)
...
**Position:** #4 of 14 (Percentile 76.9)

You sit above the median but below the top tier. Your 6.3 compares to a peer average of 5.6. The gap to the top (6.9) is 0.6 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Experience: 9.8 (+1.3 above peer avg 8.4)
- Visibility: 3.7 (+0.9 above peer avg 2.8)
- Trust: 8.4 (+0.6 above peer avg 7.9)

**Closest competitors:**

- 11/17 Salt Beef Bar (6.9) — leads you by 0.6
- Lithos Restaurant (6.5) — leads you by 0.2
- The Bluebell (6.4) — leads you by 0.1
- The Bridge (6.0) — you lead by 0.4
- Bannatyne Health Club And Spa Wildmoor (5.8) — you lead by 0.5

### UK Category Cohort (14 peers in Restaurant (General))

**Position:** #5 of 15 (Percentile 71.4)

You sit above the median but below the top tier. Your 6.3 compares to a peer average of 5.7. The gap to the top (6.9) is 0.6 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Experience: 9.8 (+1.2 above peer avg 8.6)
- Visibility: 3.7 (+1.0 above peer avg 2.8)

**Closest competitors:**

- 11/17 Salt Beef Bar (6.9) — leads you by 0.6
- Lithos Restaurant (6.5) — leads you by 0.2
- Oxheart (6.5) — leads you by 0.2
- The Bluebell (6.4) — leads you by 0.1
- The Bridge (6.0) — you lead by 0.4
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.8 | — | 8.6 | +1.2 | Above peers |
| Visibility | 3.7 | — | 3.0 | +0.8 | Above peers |
| Trust | 8.4 | — | 7.9 | +0.5 | Above peers |
...
**Assessment: Strong.** This is a genuine competitive strength at 9.8.
 You lead peers by 1.2 points (peer avg 8.6).
...
**Management note:** At 912 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 5.3/10 | ⚠️ Room to improve | Last inspected 2025-07-08 (9 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-07-08 (9 months ago). Full confidence. No action needed. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.2 on trust, +0.3 on overall (6.3 → 6.6).
...
### Action 3: Protect the 4.8/5 rating — it took years to build
**Status:** Stale (5 months) | **Priority:** High
...
| Google review count | 912 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.8★ (912 reviews) | observed | ✓ |
...
| Last Inspection | 2025-07-08 | FSA | observed |
| Google Rating | 4.8/5 | Google Places API | observed |
| Google Reviews | 912 | Google Places API | observed |
