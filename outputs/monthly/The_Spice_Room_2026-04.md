# The Spice Room — Monthly Intelligence Report
...
**Overall score: 6.1/10** (baseline month — no prior comparison)
 | Strongest: Trust (8.7) | Weakest: Visibility (3.1)

**Competitive position:** Local Peers (5mi): #2 of 4 (P66.7) — peer avg 5.55, top 6.57
  Catchment (15mi): #6 of 14 (P61.5) — peer avg 5.61, top 6.59
  UK Category Cohort: #6 of 17 (P68.8) — peer avg 5.59, top 6.59
...
| Aggregate signals | Rating and volume from all platforms | 127 Google (4.6★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.6 rating across 127 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Spice Room operates as a credible Indian dining venue with a 4.6/5 Google rating across 127 reviews — solid but not yet commanding.
...
- **Evidence:** `experience=8.49, conversion=4.0`
...
- **Review momentum.** At 127 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: meal_takeaway, indian_restaurant, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: meal_takeaway, indian_restaurant, restaurant*
...
Online visibility (3.1) hasn't kept pace with guest experience quality (8.5). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Unrealised review authority.** At 127 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** 127 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 127 reviews (Moderate) | Visibility 3.1/10 (Weak) |
...
The Spice Room is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Indian Restaurant" but the resolved category triangulates across 1 signal sources.
...
- **Cardamom** (6.6): Takeaway-focused — different service model; 0.1 miles away *(weak comparator)*
- **Peppers** (5.5): Dining with comparable price band; 4.2 miles away
...
Above the median (P67) but not leading. Peer average is 5.5; the top performer scores 6.6. The gap to the top is closeable.

**Where you lead:** Trust (+1.6)

*Commercial implication: you capture an adequate share of a 4-venue market, but the gap to the top (6.6) represents demand you could win. Closing the gap typically requires 1–2 targeted dimension improvements (indicative).*
...
You sit above the median but below the top tier. Your 6.1 compares to a peer average of 5.5. The gap to the top (6.6) is 0.5 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 8.7 (+1.6 above peer avg 7.1)

**Closest competitors:**

- Cardamom (6.6) — leads you by 0.5
- Peppers (5.5) — you lead by 0.6
- Mouchak (4.6) — you lead by 1.4
...
- **Defend:** Defend your conversion readiness (+0.5) — you are easier to book/find.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*
...
- **Defend:** Defend your trust advantage (+0.5) and your conversion readiness (+0.5) — you are easier to book/find.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.5 | — | 8.5 | +0.0 | Strong |
| Visibility | 3.1 | — | 3.0 | +0.1 | Needs work |
| Trust | 8.7 | — | 7.1 | +1.6 | Clear strength |
| Conversion | 4.0 | — | 3.7 | +0.3 | Above peers |
| **Overall** | **6.1** | **—** | | | |
...
**Management note:** At 127 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 8.7.
 You lead peers by 1.6 points (peer avg 7.1).
...
**Assessment: Weak.** At 4.0, this dimension is actively limiting your overall position.
 Slightly above peer average (3.7).
...
| Inspection Recency | 4.7/10 | ⚠️ Significant drag | Last inspected 2025-05-14 (11 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-05-14 (11 months ago). Full confidence. No action needed. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.3 on trust, +0.3 on overall (6.1 → 6.4).
...
| Google review count | 127 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.6★ (127 reviews) | observed | ✓ |
...
| Last Inspection | 2025-05-14 | FSA | observed |
| Google Rating | 4.6/5 | Google Places API | observed |
| Google Reviews | 127 | Google Places API | observed |
