# The Margin — Monthly Intelligence Report
...
**Overall score: 5.5/10** (baseline month — no prior comparison)
 | Strongest: Experience (8.1) | Weakest: Visibility (2.9)

**Competitive position:** Local Peers (5mi): #3 of 3 (P0.0) — peer avg 6.37, top 6.51
  Catchment (15mi): #4 of 5 (P25.0) — peer avg 6.01, top 6.51
  UK Category Cohort: #5 of 6 (P20.0) — peer avg 6.0, top 6.51
...
| Aggregate signals | Rating and volume from all platforms | 73 Google (4.3★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.3 rating across 73 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Margin is a takeaway venue with an adequate public reputation (4.3/5, 73 reviews) that has room to build stronger proof.
...
- **Evidence:** `experience=8.14, conversion=4.0`
...
Insufficient review data to cross-reference proposition. Google types show: meal_takeaway, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: meal_takeaway, restaurant*
...
Online visibility (2.9) hasn't kept pace with guest experience quality (8.1). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** Only 73 reviews — rating is volatile. A single 1-star review moves the average measurably.
...
|--------|-------------|---------------------|
| Customer Rating | 4.3/5 Google (Good) | Experience 8.1/10 (Strong) — Gap |
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 7.7/10 (Adequate) |
| Review Volume | 73 reviews (Low) | Visibility 2.9/10 (Weak) |
...
The Margin is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Takeaway" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | meal_takeaway, restaurant | Primary |

**Resolved category:** Restaurant (General) (confidence: medium)

### Peer Justification

- **The Pickled Crab Deli** (6.5): Takeaway-focused — different service model; 2.5 miles away *(weak comparator)*
- **Pickled & Tipsy's Cafe** (6.2): Takeaway-focused — different service model; 2.5 miles away *(weak comparator)*

## Competitive Market Intelligence

**Local market:** 2 direct competitors identified.

Below the median (P0). Customers have higher-rated alternatives nearby (peer avg 6.4, top 6.5).

**Where peers beat you:** Experience (-1.4), Trust (-0.7), Conversion (-0.5)
...
| Pickled & Tipsy's Cafe | 6.2 | 4.7★ | 23 |
...
You are below the median of your peer set. At 5.5 vs peer average 6.4, competitors are outperforming you. The top performer scores 6.5. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Conversion: 4.0 (-0.5 below peer avg 4.5)
- Trust: 7.7 (-0.7 below peer avg 8.4)
- Experience: 8.1 (-1.4 below peer avg 9.6)

**Closest competitors:**

- The Pickled Crab Deli (6.5) — leads you by 1.0
- Pickled & Tipsy's Cafe (6.2) — leads you by 0.7
...
- **Copy / test:** Read their recent positive reviews (4.6/5) for operational clues. Audit your Google profile vs theirs: hours, menu, booking, delivery.
...
**Pickled & Tipsy's Cafe** (signal-backed)
...
- **Also wins on:** Conversion (+1.0): more complete operational signals (hours, menu, delivery/takeaway, booking)
- **Why it matters:** They lead on both Experience and Conversion — a combined advantage that is harder to close than a single-dimension gap.
- **Copy / test:** Read their recent positive reviews (4.3/5) for operational clues. Audit your Google profile vs theirs: hours, menu, booking, delivery.
- **Defend:** No clear defensive advantage — you are closely matched across dimensions.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*
...
- Conversion: 4.0 (-0.5 below peer avg 4.5)
- Experience: 8.1 (-1.0 below peer avg 9.1)

**Closest competitors:**

- The Pickled Crab Deli (6.5) — leads you by 1.0
- Pickled & Tipsy's Cafe (6.2) — leads you by 0.7
- The Bishops Fryer (6.1) — leads you by 0.6
- The Water Margin @ The Hollybush (5.2) — you lead by 0.4
...
- Experience: 8.1 (-1.2 below peer avg 9.3)
...
- Pickled & Tipsy's Cafe (6.2) — leads you by 0.7
- The Bishops Fryer (6.1) — leads you by 0.6
- Chrissie's Kitchen (5.9) — leads you by 0.4
- The Water Margin @ The Hollybush (5.2) — you lead by 0.4
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.1 | — | 9.6 | -1.4 | Below peers |
| Visibility | 2.9 | — | 2.9 | +0.0 | Needs work |
| Trust | 7.7 | — | 8.4 | -0.7 | Below peers |
| Conversion | 4.0 | — | 4.5 | -0.5 | Below peers |
| **Overall** | **5.5** | **—** | | | |
...
**Assessment: Strong.** This is a genuine competitive strength at 8.1.
 You trail peers by 1.4 points (peer avg 9.6).
...
**Assessment: Weak.** At 4.0, this dimension is actively limiting your overall position.
 Slightly below peer average (4.5).
...
| Inspection Recency | 4.2/10 | ⚠️ Significant drag | Last inspected 2025-03-27 (13 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-03-27 (13 months ago). Score starting to decay. Note it but don't escalate. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.4 on trust, +0.4 on overall (5.5 → 5.9).
...
| Google Business Profile | 4.3★ (73 reviews) | observed | ✓ |
...
| Last Inspection | 2025-03-27 | FSA | observed |
...
| Postcode | CV47 9PZ | FSA | observed |
| Companies House | — | Not checked | not_assessed |
