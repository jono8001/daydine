# Revs Automobilia — Monthly Intelligence Report
...
**Competitive position:** Local Peers (5mi): #3 of 5 (P50.0) — peer avg 6.0, top 6.44
  Catchment (15mi): #19 of 37 (P50.0) — peer avg 5.83, top 6.78
  UK Category Cohort: #28 of 53 (P48.1) — peer avg 5.78, top 6.92
...
| Aggregate signals | Rating and volume from all platforms | 118 Google (4.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.7 rating across 118 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Revs Automobilia operates as a credible cafe venue with a 4.7/5 Google rating across 118 reviews — solid but not yet commanding.
...
- **Review momentum.** At 118 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
- **The 4.7/5 rating feels dominant but isn't.** In this market, peer venues achieve similar ratings. Your percentile position (P50.0) shows the rating is table stakes, not a differentiator.
...
- **Unrealised review authority.** At 118 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** 118 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 118 reviews (Moderate) | Visibility 3.1/10 (Weak) |
...
Revs Automobilia is classified as **Cafe / Coffee Shop** (confidence: high). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 1 signal sources.
...
- **Cotswold Cafe** (6.4): Dining with comparable price band; 1.8 miles away
- **Cotswold Distillery Cafe** (6.2): Dining with comparable price band; 4.3 miles away
- **Ferment And Flour (Bastardos)** (5.8): Dining with comparable price band; 2.0 miles away
- **Blue Bean Coffee Shop** (5.7): Dining with comparable price band; 2.0 miles away

## Competitive Market Intelligence

**Local market:** 4 direct competitors identified.

Above the median (P50) but not leading. Peer average is 6.0; the top performer scores 6.4. The gap to the top is closeable.

**Where peers beat you:** Experience (-0.7), Conversion (-0.5)
...
**Position:** #3 of 5 (Percentile 50.0)

You sit above the median but below the top tier. Your 5.8 compares to a peer average of 6.0. The gap to the top (6.4) is 0.6 points — closeable with focused improvement on your weakest dimension.
...
- Cotswold Cafe (6.4) — leads you by 0.6
- Cotswold Distillery Cafe (6.2) — leads you by 0.3
- Ferment And Flour (Bastardos) (5.8) — you lead by 0.1
- Blue Bean Coffee Shop (5.7) — you lead by 0.2

### Competitor Strategy

**Cotswold Distillery Cafe** (signal-backed)

- **Wins on:** Experience (+1.3): Google 4.9/5 vs your 4.7/5; Visibility (+0.8): 1239 Google reviews vs your 118 — they have volume advantage
...
- **Copy / test:** Read their recent positive reviews (4.9/5) for operational clues. Build review volume — they have 1239 to your 118.
...
- **Defend:** Defend your 118-review advantage vs their 18 (discovery moat).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*
...
**Position:** #19 of 37 (Percentile 50.0)

You sit above the median but below the top tier. Your 5.8 compares to a peer average of 5.8. The gap to the top (6.8) is 0.9 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 8.5 (+0.7 above peer avg 7.7)
...
**Position:** #28 of 53 (Percentile 48.1)
...
| Visibility | 3.1 | — | 3.2 | -0.2 | Needs work |
| Trust | 8.5 | — | 8.1 | +0.4 | Above peers |
...
**Management note:** At 118 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 8.5.
 Slightly above peer average (8.1).
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.2 on trust, +0.3 on overall (5.8 → 6.1).
...
| Google review count | 118 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.7★ (118 reviews) | observed | ✓ |
...
| Google Reviews | 118 | Google Places API | observed |
...
| Postcode | GL56 9RE | FSA | observed |
| Companies House | — | Not checked | not_assessed |
