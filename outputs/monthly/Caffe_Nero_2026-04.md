# Caffe Nero — Monthly Intelligence Report
...
**Competitive position:** UK Category Cohort: #41 of 53 (P23.1) — peer avg 5.79, top 6.92
...
Based on publicly observable data for Caffe Nero, your current operational gaps are putting an estimated **7–22 covers per week** at risk — representing approximately **£840–£5,780 per month** in lost or leaked revenue. The main drivers are: Renew formal trust proof before it becomes a visible drag (£0–£500/mo (defensive)); Get your menu online — 77% of diners check before visiting (£420–£2,640/mo); Fix the digital shopfront — you're losing walk-ins (£420–£2,640/mo). Taking action on **Renew formal trust proof before it becomes a visible drag** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~140–220 | Derived from 392 Google reviews (mid venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 392 Google (4.2★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.2 rating across 392 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Caffe Nero operates as a credible cafe venue with a 4.2/5 Google rating across 392 reviews — solid but not yet commanding.
...
Last inspected 2.5 years ago. A stale inspection date erodes trust scoring and signals to customers that compliance isn't actively managed. Request a voluntary re-inspection once you're confident of a strong result.
...
- **Review momentum.** At 392 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
- **Volume:** 392 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 392 reviews (Moderate) | Visibility 3.5/10 (Weak) |
...
Caffe Nero is classified as **Cafe / Coffee Shop** (confidence: high). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 2 signal sources.
...
**Position:** #41 of 53 (Percentile 23.1)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.0 | — | — | — | Strong |
| Visibility | 3.5 | — | — | — | Needs work |
| Trust | 7.4 | — | — | — | In line |
...
**Management note:** At 392 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 1.2/10 | ⚠️ Significant drag | Last inspected 2023-10-18 (30 months ago). Maximum decay applied. Reinspectio... |
...
**Biggest drag:** Inspection Recency. Last inspected 2023-10-18 (30 months ago). Maximum decay applied. Reinspection strongly recommended. The system discounts older inspections because they carry less certainty.

**What you can do:**

1. **Request voluntary reinspection** (free, 4–8 weeks) — would recover ~2.2 trust points. Only request reinspection if confident of maintaining 5/5. A drop to 4 would be worse than the staleness drag.
...
🔴 **FSA inspection recency:** Last inspected 30 months ago — re-inspection likely overdue.
...
| Google review count | 392 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.2★ (392 reviews) | observed | ✓ |
...
| Last Inspection | 2023-10-18 | FSA | observed |
| Google Rating | 4.2/5 | Google Places API | observed |
| Google Reviews | 392 | Google Places API | observed |
...
| Postcode | CV37 6AN | FSA | observed |
| Companies House | — | Not checked | not_assessed |
