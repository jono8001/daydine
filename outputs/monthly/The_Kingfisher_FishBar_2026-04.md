# The Kingfisher FishBar — Monthly Intelligence Report
...
**Competitive position:** Local Peers (5mi): #1 of 5 (P100.0) — peer avg 5.69, top 6.29
  Catchment (15mi): #1 of 11 (P100.0) — peer avg 5.67, top 6.36
  UK Category Cohort: #1 of 11 (P100.0) — peer avg 5.67, top 6.36
...
Based on publicly observable data for The Kingfisher FishBar, your current operational gaps are putting an estimated **4–14 covers per week** at risk — representing approximately **£240–£1,740 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£120–£870/mo); Fix the digital shopfront — you're losing walk-ins (£120–£870/mo); Protect the 4.5/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~180–290 | Derived from 386 Google reviews (mid venue indicator), price level £ |
...
| Aggregate signals | Rating and volume from all platforms | 386 Google (4.5★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.5 rating across 386 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Kingfisher FishBar operates as a credible quick-service food venue with a 4.5/5 Google rating across 386 reviews — solid but not yet commanding.
...
Within the local quick-service food market (4 peers), this venue leads the field. The identity is that of a category leader — the venue others are compared against.
...
- **Evidence:** `experience=9.42, conversion=5.0`
...
With 386 reviews at 4.5/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 386 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: fast_food_restaurant, meal_takeaway, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: fast_food_restaurant, meal_takeaway, restaurant*
...
- **Volume:** 386 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 8.0/10 (Strong) |
| Review Volume | 386 reviews (Moderate) | Visibility 3.5/10 (Weak) |
...
The Kingfisher FishBar is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Fast Food / Quick Service" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | fast_food_restaurant, meal_takeaway, restaurant | Primary |
...
- **Starbucks** (6.3): Dining with comparable price band; 0.1 miles away
- **The Food Of Love** (6.2): Takeaway-focused — different service model; 0.2 miles away *(weak comparator)*
- **GAIL's Stratford-Upon-Avon** (5.8): Dining with comparable price band; 0.1 miles away
...
**Where you lead:** Experience (+1.3), Conversion (+1.0)
...
**Position:** #1 of 5 (Percentile 100.0)

You are in the top quintile of this peer set. Your overall score of 6.4 exceeds the peer average of 5.7 by 0.7 points. The competitive risk here is complacency — the nearest competitor scores 6.3.

**Dimension gaps vs peers:**

- Experience: 9.4 (+1.3 above peer avg 8.1)
...
- **Defend:** Defend your conversion readiness (+1.5) — you are easier to book/find and your experience lead (+0.8) — drives repeats and word-of-mouth.
...
**Position:** #1 of 11 (Percentile 100.0)

You are in the top quintile of this peer set. Your overall score of 6.4 exceeds the peer average of 5.7 by 0.8 points. The competitive risk here is complacency — the nearest competitor scores 6.4.
...
- Starbucks Drive Thru (6.4) — you lead by 0.1
- Starbucks (6.3) — you lead by 0.1
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.4 | — | 8.1 | +1.3 | Above peers |
| Visibility | 3.5 | — | 3.3 | +0.1 | Needs work |
| Trust | 8.0 | — | 8.0 | +0.0 | Strong |
...
**Assessment: Strong.** This is a genuine competitive strength at 9.4.
 You lead peers by 1.3 points (peer avg 8.1).
...
**Management note:** At 386 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 3.7/10 | ⚠️ Significant drag | Last inspected 2025-01-28 (15 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-01-28 (15 months ago). Score starting to decay. Note it but don't escalate. 

**Peer context:** Starbucks's trust lead (+1.9) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.6 on trust, +0.4 on overall (6.4 → 6.8).
...
| Google review count | 386 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.5★ (386 reviews) | observed | ✓ |
...
| Last Inspection | 2025-01-28 | FSA | observed |
| Google Rating | 4.5/5 | Google Places API | observed |
| Google Reviews | 386 | Google Places API | observed |
