# Bumbles — Monthly Intelligence Report
...
**Competitive position:** Catchment (15mi): #3 of 11 (P80.0) — peer avg 5.76, top 6.41
  UK Category Cohort: #4 of 13 (P75.0) — peer avg 5.8, top 6.41
...
Based on publicly observable data for Bumbles, your current operational gaps are putting an estimated **11–33 covers per week** at risk — representing approximately **£1,340–£7,920 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£670–£3,960/mo); Fix the digital shopfront — you're losing walk-ins (£670–£3,960/mo); Protect the 4.8/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~140–220 | Derived from 275 Google reviews (mid venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 275 Google (4.8★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.8 rating across 275 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Bumbles operates as a credible Italian dining venue with a 4.8/5 Google rating across 275 reviews — solid but not yet commanding.
...
With 275 reviews at 4.8/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 275 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: coffee_shop, pizza_restaurant, gift_shop, hamburger_restaurant, chicken_restaurant, american_restaurant, cafe, restaurant, food_store, store. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: coffee_shop, pizza_restaurant, gift_shop, hamburger_restaurant, chicken_restaurant, american_restaurant, cafe, restaurant, food_store, store*
...
Online visibility (3.4) hasn't kept pace with guest experience quality (9.8). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 275 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 275 reviews (Moderate) | Visibility 3.4/10 (Weak) |
...
Bumbles is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Italian Restaurant" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | coffee_shop, pizza_restaurant, gift_shop, hamburger_restaurant, chicken_restaurant, american_restaurant, cafe, restaurant, food_store, store | Primary |
...
- Carluccio's (6.1) — you lead by 0.0
...
**Position:** #4 of 13 (Percentile 75.0)

You sit above the median but below the top tier. Your 6.1 compares to a peer average of 5.8. The gap to the top (6.4) is 0.3 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Experience: 9.8 (+0.8 above peer avg 8.9)

**Closest competitors:**

- The Phoenix (6.4) — leads you by 0.3
- Soma (6.2) — leads you by 0.1
- The Still House Café (6.1) — leads you by 0.0
- Carluccio's (6.1) — you lead by 0.0
- Pizza Hut Restaurants - Dine In (6.0) — you lead by 0.0
...
**Management note:** At 275 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Google review count | 275 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.8★ (275 reviews) | observed | ✓ |
...
| Google Reviews | 275 | Google Places API | observed |
