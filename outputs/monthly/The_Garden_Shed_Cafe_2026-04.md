# The Garden Shed Cafe — Monthly Intelligence Report
...
**Overall score: 5.5/10** (baseline month — no prior comparison)
 | Strongest: Experience (7.5) | Weakest: Conversion (3.5)

**Competitive position:** Local Peers (5mi): #15 of 20 (P26.3) — peer avg 5.83, top 6.78
  Catchment (15mi): #38 of 49 (P22.9) — peer avg 5.77, top 6.92
  UK Category Cohort: #42 of 53 (P21.2) — peer avg 5.79, top 6.92
...
Based on publicly observable data for The Garden Shed Cafe, your current operational gaps are putting an estimated **11–35 covers per week** at risk — representing approximately **£1,320–£8,900 per month** in lost or leaked revenue. The main drivers are: Close the hygiene gap — 4 to 5 (£0–£500/mo (defensive)); Get your menu online — 77% of diners check before visiting (£660–£4,200/mo); Fix the digital shopfront — you're losing walk-ins (£660–£4,200/mo). Taking action on **Close the hygiene gap — 4 to 5** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~220–350 | Derived from 494 Google reviews (large venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 494 Google (4.6★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.6 rating across 494 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Garden Shed Cafe operates as a credible cafe venue with a 4.6/5 Google rating across 494 reviews — solid but not yet commanding.
...
- **Evidence:** `experience=7.45, conversion=3.5`
...
- **Review momentum.** At 494 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: cafe. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: cafe*
...
- **The 4.6/5 rating feels dominant but isn't.** In this market, peer venues achieve similar ratings. Your percentile position (P26.3) shows the rating is table stakes, not a differentiator.
...
- **Volume:** 494 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Hygiene Rating | FSA 4/5 (Acceptable) | Trust 7.4/10 (Adequate) |
| Review Volume | 494 reviews (Moderate) | Visibility 3.5/10 (Weak) |
...
The Garden Shed Cafe is classified as **Cafe / Coffee Shop** (confidence: high). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 3 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | cafe | Primary |
| Price Level | ££ (2/4) — Casual dining | Supportive |
| Name | "The Garden Shed Cafe" contains "cafe" | Supportive |

**Resolved category:** Cafe / Coffee Shop (confidence: high)

### Peer Justification

- **South Costa** (6.8): Dining with comparable price band; 4.5 miles away
- **Building 523 Costa And Kitchen** (6.8): Dining with comparable price band; 4.5 miles away
- **Dec X Canteen** (6.7): Dining with comparable price band; 4.5 miles away
- **Gilks' Garage Cafe** (6.7): Dining with similar price band; 4.7 miles away
- **Shakespaw Cat Cafe** (6.6): Dining with similar price band; 4.9 miles away

## Competitive Market Intelligence

**Local market:** 19 direct competitors identified.

Below the median (P26). Customers have higher-rated alternatives nearby (peer avg 5.8, top 6.8).

**Where you lead:** Conversion (+0.6)
**Where peers beat you:** Experience (-1.3)

*Commercial implication: in a 20-venue market, a below-median position means demand is flowing to competitors. Each percentile point gained recaptures a share of local search traffic. Estimated fair share: ~5% of local demand — you are likely underindexed (directional).*
...
**Position:** #15 of 20 (Percentile 26.3)
...
- Experience: 7.5 (-1.3 below peer avg 8.8)

**Closest competitors:**

- South Costa (6.8) — leads you by 1.3
- Building 523 Costa And Kitchen (6.8) — leads you by 1.3
- Dec X Canteen (6.7) — leads you by 1.2
- Gilks' Garage Cafe (6.7) — leads you by 1.2
- Shakespaw Cat Cafe (6.6) — leads you by 1.2
...
- **Also wins on:** Trust (+0.6): FSA 5/5 vs your 4/5
...
**Dec X Canteen** (partial)

- **Wins on:** Experience (see pattern above)
- **Why it matters:** A large experience gap (+2.2) — guests rate their visit higher — this drives reviews, repeats, and word-of-mouth. This is a structural disadvantage, not a rounding error.
...
**Position:** #38 of 49 (Percentile 22.9)
...
- Conversion: 3.5 (+0.6 above peer avg 2.9)
- Experience: 7.5 (-1.4 below peer avg 8.9)
...
**Position:** #42 of 53 (Percentile 21.2)
...
- Puddleduck Cafe Ltd (6.9) — leads you by 1.5
- South Costa (6.8) — leads you by 1.3
- Nanas Caff (6.8) — leads you by 1.3
- Building 523 Costa And Kitchen (6.8) — leads you by 1.3
- Dec X Canteen (6.7) — leads you by 1.2
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 7.5 | — | 8.8 | -1.3 | Below peers |
| Visibility | 3.5 | — | 3.4 | +0.1 | Needs work |
| Trust | 7.4 | — | 7.6 | -0.2 | In line |
| Conversion | 3.5 | — | 2.9 | +0.6 | Above peers |
| **Overall** | **5.5** | **—** | | | |

*Prestige (editorial recognition): 1.5/10 (peer avg 0.9) — tracked but not a headline operational lever for most independents.*
...
**Assessment: Adequate.** At 7.5, this is functional but not distinctive.
 You trail peers by 1.3 points (peer avg 8.8).
...
**Management note:** At 494 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Adequate.** At 7.4, this is functional but not distinctive.
 In line with peers (avg 7.6).
...
| Inspection Recency | 5.7/10 | ⚠️ Room to improve | Last inspected 2025-08-08 (8 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-08-08 (8 months ago). Full confidence. No action needed. 

**Peer context:** South Costa's trust lead (+2.1) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
Your 4.6/5 Google rating feels dominant but you sit below the local median (P26.3). Peer venues achieve similar or better ratings — in this market, 4.5 is table stakes, not a differentiator. Don't mistake the number for an advantage.
...
| 7 | Ranked #15 of 20 locally — peers are ahead | Stale (5 months) | 01 May 2026 | Medium (£200–£1,000) |
...
| Google review count | 494 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.6★ (494 reviews) | observed | ✓ |
...
| Last Inspection | 2025-08-08 | FSA | observed |
| Google Rating | 4.6/5 | Google Places API | observed |
| Google Reviews | 494 | Google Places API | observed |
...
| Postcode | CV35 9NZ | FSA | observed |
| Companies House | — | Not checked | not_assessed |
