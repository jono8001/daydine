# Annie's Cafe & Event Catering — Monthly Intelligence Report
...
**Competitive position:** UK Category Cohort: #25 of 53 (P53.8) — peer avg 5.78, top 6.92
...
| Aggregate signals | Rating and volume from all platforms | 94 Google (4.5★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.5 rating across 94 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Annie's Cafe & Event Catering is a cafe venue with an adequate public reputation (4.5/5, 94 reviews) that has room to build stronger proof.
...
- **Review momentum.** At 94 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Online visibility (3.0) hasn't kept pace with guest experience quality (9.4). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Unrealised review authority.** At 94 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** Only 94 reviews — rating is volatile. A single 1-star review moves the average measurably.
...
| Review Volume | 94 reviews (Low) | Visibility 3.0/10 (Weak) |
...
Annie's Cafe & Event Catering is classified as **Sports Club** (confidence: low). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 2 signal sources.
...
| Name | "Annie's Cafe & Event Catering" contains "cafe" | Supportive |
...
**Position:** #25 of 53 (Percentile 53.8)
...
- Trust: 8.2 (+0.7 above peer avg 7.5)
...
**Management note:** At 94 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 2.7/10 | ⚠️ Significant drag | Last inspected 2024-09-11 (19 months ago). Meaningful score drag. Consider pr... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-09-11 (19 months ago). Meaningful score drag. Consider proactive action. The system discounts older inspections because they carry less certainty.

**What you can do:**

1. **Request voluntary reinspection** (free, 4–8 weeks) — would recover ~1.8 trust points. Only request reinspection if confident of maintaining 5/5. A drop to 4 would be worse than the staleness drag.
...
| Google review count | 94 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.5★ (94 reviews) | observed | ✓ |
...
| Last Inspection | 2024-09-11 | FSA | observed |
| Google Rating | 4.5/5 | Google Places API | observed |
| Google Reviews | 94 | Google Places API | observed |
