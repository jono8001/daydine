# Bruno's Bakery — Monthly Intelligence Report
...
**Overall score: 6.3/10** (baseline month — no prior comparison)
 | Strongest: Trust (8.7) | Weakest: Visibility (3.4)

**Competitive position:** Catchment (15mi): #2 of 7 (P83.3) — peer avg 5.77, top 6.43
...
Based on publicly observable data for Bruno's Bakery, your current operational gaps are putting an estimated **4–14 covers per week** at risk — representing approximately **£240–£1,740 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£120–£870/mo); Fix the digital shopfront — you're losing walk-ins (£120–£870/mo); Protect the 4.6/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~180–290 | Derived from 290 Google reviews (mid venue indicator), price level £ |
...
| Aggregate signals | Rating and volume from all platforms | 290 Google (4.6★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.6 rating across 290 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Bruno's Bakery operates as a credible quick-service food venue with a 4.6/5 Google rating across 290 reviews — solid but not yet commanding.
...
With 290 reviews at 4.6/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 290 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: bakery, cake_shop, catering_service, deli, breakfast_restaurant, sandwich_shop, food_delivery, coffee_shop, cafe, food_store, manufacturer, wholesaler, restaurant, service, store. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: bakery, cake_shop, catering_service, deli, breakfast_restaurant, sandwich_shop, food_delivery, coffee_shop, cafe, food_store, manufacturer, wholesaler, restaurant, service, store*
...
- **Volume:** 290 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 290 reviews (Moderate) | Visibility 3.4/10 (Weak) |
...
Bruno's Bakery is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Fast Food / Quick Service" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | bakery, cake_shop, catering_service, deli, breakfast_restaurant, sandwich_shop, food_delivery, coffee_shop, cafe, food_store, manufacturer, wholesaler, restaurant, service, store | Primary |
...
You are in the top quintile of this peer set. Your overall score of 6.3 exceeds the peer average of 5.8 by 0.5 points. The competitive risk here is complacency — the nearest competitor scores 6.4.
...
- Trust: 8.7 (+1.0 above peer avg 7.7)
...
**Management note:** At 290 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 8.2/10 | ✅ Adequate | Last inspected 2026-01-15 (3 months ago). Full confidence. No action needed.  |
...
| Google review count | 290 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.6★ (290 reviews) | observed | ✓ |
...
| Last Inspection | 2026-01-15 | FSA | observed |
| Google Rating | 4.6/5 | Google Places API | observed |
| Google Reviews | 290 | Google Places API | observed |
