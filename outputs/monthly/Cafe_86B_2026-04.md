# Cafe 86B — Monthly Intelligence Report
...
**Overall score: 5.8/10** (baseline month — no prior comparison)
 | Strongest: Experience (8.8) | Weakest: Conversion (2.5)

**Competitive position:** Local Peers (5mi): #3 of 5 (P50.0) — peer avg 5.74, top 6.25
  Catchment (15mi): #17 of 36 (P54.3) — peer avg 5.66, top 6.78
  UK Category Cohort: #29 of 53 (P46.2) — peer avg 5.79, top 6.92
...
Based on publicly observable data for Cafe 86B, your current operational gaps are putting an estimated **3–12 covers per week** at risk — representing approximately **£380–£2,880 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£190–£1,440/mo); Fix the digital shopfront — you're losing walk-ins (£190–£1,440/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~40–80 | Derived from 42 Google reviews (micro venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 42 Google (4.9★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.9 rating across 42 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Cafe 86B is a cafe venue with an adequate public reputation (4.9/5, 42 reviews) that has room to build stronger proof.
...
- **Evidence:** `experience=8.84, conversion=2.5`
...
- **Review momentum.** At 42 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Online visibility (2.7) hasn't kept pace with guest experience quality (8.8). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **The 4.9/5 rating feels dominant but isn't.** In this market, peer venues achieve similar ratings. Your percentile position (P50.0) shows the rating is table stakes, not a differentiator.
...
- **Unrealised review authority.** At 42 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** Only 42 reviews — rating is volatile. A single 1-star review moves the average measurably.
...
| Review Volume | 42 reviews (Low) | Visibility 2.7/10 (Weak) |
...
Cafe 86B is classified as **Cafe / Coffee Shop** (confidence: high). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 2 signal sources.
...
| Name | "Cafe 86B" contains "cafe" | Supportive |

**Resolved category:** Cafe / Coffee Shop (confidence: high)

### Peer Justification

- **Costa** (6.2): Dining with comparable price band; 0.0 miles away
- **Henley Ice Cream Limited** (6.2): Dining with comparable price band; 0.1 miles away
- **JNB Cafe** (5.6): Dining with comparable price band; 5.0 miles away
- **The Cowshed Cafe** (5.0): Dining with comparable price band; 1.9 miles away

## Competitive Market Intelligence

**Local market:** 4 direct competitors identified.

Above the median (P50) but not leading. Peer average is 5.7; the top performer scores 6.2. The gap to the top is closeable.

**Where you lead:** Trust (+1.0)
**Where peers beat you:** Conversion (-0.8), Visibility (-0.7)
...
You sit above the median but below the top tier. Your 5.8 compares to a peer average of 5.7. The gap to the top (6.2) is 0.4 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 8.4 (+1.0 above peer avg 7.3)
- Visibility: 2.7 (-0.7 below peer avg 3.5)
- Conversion: 2.5 (-0.8 below peer avg 3.2)

**Closest competitors:**

- Costa (6.2) — leads you by 0.4
- Henley Ice Cream Limited (6.2) — leads you by 0.4
- JNB Cafe (5.6) — you lead by 0.3
- The Cowshed Cafe (5.0) — you lead by 0.9
...
- **Copy / test:** Build review volume — they have 1160 to your 42. Audit your Google profile vs theirs: hours, menu, booking, delivery.
- **Defend:** Defend your trust advantage (+0.9).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

**JNB Cafe** (signal-backed)
...
- **Copy / test:** Build review volume — they have 194 to your 42.
- **Defend:** Defend your trust advantage (+1.0).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

### Extended Catchment (35 peers within 15 miles)

**Position:** #17 of 36 (Percentile 54.3)

You sit above the median but below the top tier. Your 5.8 compares to a peer average of 5.7. The gap to the top (6.8) is 1.0 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 8.4 (+1.1 above peer avg 7.3)
...
**Position:** #29 of 53 (Percentile 46.2)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.8 | — | 8.8 | +0.0 | Strong |
| Visibility | 2.7 | — | 3.5 | -0.7 | Below peers |
| Trust | 8.4 | — | 7.3 | +1.0 | Above peers |
| Conversion | 2.5 | — | 3.2 | -0.8 | Below peers |
| **Overall** | **5.8** | **—** | | | |
...
**Management note:** At 42 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 8.4.
 You lead peers by 1.0 points (peer avg 7.3).
...
| Inspection Recency | 5.0/10 | ⚠️ Significant drag | Last inspected 2025-06-11 (10 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-06-11 (10 months ago). Full confidence. No action needed. 
...
| Google review count | 42 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.9★ (42 reviews) | observed | ✓ |
...
| Last Inspection | 2025-06-11 | FSA | observed |
| Google Rating | 4.9/5 | Google Places API | observed |
| Google Reviews | 42 | Google Places API | observed |
