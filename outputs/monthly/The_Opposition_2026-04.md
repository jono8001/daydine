...
**Overall score: 6.1/10** (baseline month — no prior comparison)
 | Strongest: Experience (8.7) | Weakest: Conversion (3.5)

**Competitive position:** Local Peers (5mi): #1 of 2 (P100.0) — peer avg 6.06, top 6.06
  Catchment (15mi): #1 of 2 (P100.0) — peer avg 6.06, top 6.06
  UK Category Cohort: #1 of 2 (P100.0) — peer avg 6.06, top 6.06
...
Based on publicly observable data for The Opposition, your current operational gaps are putting an estimated **11–35 covers per week** at risk — representing approximately **£1,320–£8,400 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£660–£4,200/mo); Fix the digital shopfront — you're losing walk-ins (£660–£4,200/mo); Protect the 4.8/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~220–350 | Derived from 533 Google reviews (large venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 533 Google (4.8★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.8 rating across 533 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Opposition is a well-established French dining venue with a strong public reputation — 4.8/5 across 533 Google reviews. That volume means the reputation is earned, not manufactured.
...
Within the local French dining market (1 peers), this venue leads the field. The identity is that of a category leader — the venue others are compared against.
...
- **Evidence:** `experience=8.72, conversion=3.5`
...
With 533 reviews at 4.8/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 533 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: bistro, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: bistro, restaurant*
...
Online visibility (3.6) hasn't kept pace with guest experience quality (8.7). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 533 reviews — strong base. Rating is stable but a sustained negative pattern could shift it.
...
| Review Volume | 533 reviews (High) | Visibility 3.6/10 (Weak) |
...
The Opposition is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "French Restaurant" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | bistro, restaurant | Primary |
...
- **Bistrot Pierre** (6.1): Pub Dining with similar price band; 0.2 miles away
...
**Where you lead:** Experience (+0.5)
**Where peers beat you:** Trust (-0.9)

### Competitive Position

| Competitor | Score | Google Rating | Reviews |
|---|---|---|---|
| Bistrot Pierre | 6.1 | 4.1★ | 970 |
...
You are in the top quintile of this peer set. Your overall score of 6.1 exceeds the peer average of 6.1 by 0.1 points. The competitive risk here is complacency — the nearest competitor scores 6.1.

**Dimension gaps vs peers:**

- Experience: 8.7 (+0.5 above peer avg 8.2)
- Trust: 8.4 (-0.9 below peer avg 9.3)

**Closest competitors:**

- Bistrot Pierre (6.1) — you lead by 0.1

### Competitor Strategy

**Bistrot Pierre** (signal-backed)
...
- **Defend:** Defend your experience lead (+0.5) — drives repeats and word-of-mouth.
...
| Visibility | 3.6 | — | 3.8 | -0.2 | Needs work |
| Trust | 8.4 | — | 9.3 | -0.9 | Below peers |
...
**Management note:** At 533 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 5.2/10 | ⚠️ Room to improve | Last inspected 2025-07-03 (9 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-07-03 (9 months ago). Full confidence. No action needed. 
...
| Google review count | 533 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.8★ (533 reviews) | observed | ✓ |
...
| Last Inspection | 2025-07-03 | FSA | observed |
| Google Rating | 4.8/5 | Google Places API | observed |
| Google Reviews | 533 | Google Places API | observed |
