# Beleza Rodizio — Monthly Intelligence Report
...
3. **Protect the 4.9/5 rating — it took years to build** [PROTECT] — Sustain discovery advantage
...
**Competitive position:** Local Peers (5mi): #2 of 6 (P80.0) — peer avg 5.83, top 6.52
  Catchment (15mi): #3 of 9 (P75.0) — peer avg 5.81, top 6.52
  UK Category Cohort: #3 of 9 (P75.0) — peer avg 5.81, top 6.52
...
Based on publicly observable data for Beleza Rodizio, your current operational gaps are putting an estimated **26–75 covers per week** at risk — representing approximately **£3,080–£18,000 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£1,540–£9,000/mo); Fix the digital shopfront — you're losing walk-ins (£1,540–£9,000/mo); Protect the 4.9/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~320–500 | Derived from 950 Google reviews (high-traffic venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 950 Google (4.9★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.9 rating across 950 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Beleza Rodizio is a well-established american / grill venue with a strong public reputation — 4.9/5 across 950 Google reviews. That volume means the reputation is earned, not manufactured.
...
Within the local american / grill market (5 peers), this venue leads the field. The identity is that of a category leader — the venue others are compared against.
...
### Priority 3: Protect the 4.9/5 rating — it took years to build [PROTECT | ESCALATED]

With 950 reviews at 4.9/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 950 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: brazilian_restaurant, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: brazilian_restaurant, restaurant*
...
- **Volume:** 950 reviews — strong base. Rating is stable but a sustained negative pattern could shift it.
...
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 7.7/10 (Adequate) |
| Review Volume | 950 reviews (High) | Visibility 3.8/10 (Weak) |
...
Beleza Rodizio is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "American / Grill" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | brazilian_restaurant, restaurant | Primary |

**Resolved category:** Restaurant (General) (confidence: medium)

### Peer Justification

- **The Crofts Cafe Also Trading As New York Pizzas** (6.5): Dining with comparable price band; 0.3 miles away
- **McDonald's** (6.0): Dining with comparable price band; 0.4 miles away
- **McDonald's** (5.8): Dining with comparable price band; 0.1 miles away
- **WINGERS STRATFORD** (5.5): Dining with comparable price band; 0.8 miles away
- **Libertine Burger** (5.4): Dining with comparable price band; 0.0 miles away

## Competitive Market Intelligence

**Local market:** 5 direct competitors identified.

You are in the top quintile (P80). The competitive risk is complacency — the nearest competitor scores 6.5.

**Where you lead:** Experience (+1.6)
**Where peers beat you:** Conversion (-0.5)
...
You are in the top quintile of this peer set. Your overall score of 6.2 exceeds the peer average of 5.8 by 0.3 points. The competitive risk here is complacency — the nearest competitor scores 6.5.

**Dimension gaps vs peers:**

- Experience: 9.9 (+1.6 above peer avg 8.2)
- Conversion: 2.5 (-0.5 below peer avg 3.0)

**Closest competitors:**

- The Crofts Cafe Also Trading As New York Pizzas (6.5) — leads you by 0.4
- McDonald's (6.0) — you lead by 0.2
- McDonald's (5.8) — you lead by 0.4
- WINGERS STRATFORD (5.5) — you lead by 0.7
- Libertine Burger (5.4) — you lead by 0.8
...
- **Defend:** Defend your experience lead (+2.4) — drives repeats and word-of-mouth.
- *Based on FSA record, 2 dimension scores*

**McDonald's** (signal-backed)

- **Wins on:** Trust (+1.8): same FSA rating but likely stronger sub-scores or more recent inspection; Conversion (+1.0): more complete operational signals (hours, menu, delivery/takeaway, booking)
...
**Position:** #3 of 9 (Percentile 75.0)

You sit above the median but below the top tier. Your 6.2 compares to a peer average of 5.8. The gap to the top (6.5) is 0.4 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Experience: 9.9 (+1.8 above peer avg 8.1)
- Conversion: 2.5 (-0.9 below peer avg 3.4)

**Closest competitors:**

- The Crofts Cafe Also Trading As New York Pizzas (6.5) — leads you by 0.4
- Miller And Carter (6.3) — leads you by 0.1
- McDonald's (6.0) — you lead by 0.2
- KFC - Southbound (5.8) — you lead by 0.3
- McDonald's (5.8) — you lead by 0.4
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.9 | — | 8.2 | +1.6 | Clear strength |
| Visibility | 3.8 | — | 3.5 | +0.3 | Above peers |
| Trust | 7.7 | — | 7.9 | -0.3 | Below peers |
...
**Assessment: Strong.** This is a genuine competitive strength at 9.9.
 You lead peers by 1.6 points (peer avg 8.2).
...
**Management note:** At 950 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 2.7/10 | ⚠️ Significant drag | Last inspected 2024-09-18 (19 months ago). Meaningful score drag. Consider pr... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-09-18 (19 months ago). Meaningful score drag. Consider proactive action. The system discounts older inspections because they carry less certainty.

**Peer context:** The Crofts Cafe Also Trading As New York Pizzas's trust lead (+1.8) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.

**What you can do:**

1. **Request voluntary reinspection** (free, 4–8 weeks) — would recover ~1.8 trust points and overtake 1 peers. Only request reinspection if confident of maintaining 5/5. A drop to 4 would be worse than the staleness drag.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.8 on trust, +0.5 on overall (6.2 → 6.6).
...
### Action 3: Protect the 4.9/5 rating — it took years to build
**Status:** Stale (5 months) | **Priority:** High
...
| Google review count | 950 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.9★ (950 reviews) | observed | ✓ |
...
| Last Inspection | 2024-09-18 | FSA | observed |
| Google Rating | 4.9/5 | Google Places API | observed |
| Google Reviews | 950 | Google Places API | observed |
