# The Bridge — Monthly Intelligence Report
...
**Competitive position:** Catchment (15mi): #5 of 14 (P69.2) — peer avg 5.66, top 6.91
  UK Category Cohort: #6 of 15 (P64.3) — peer avg 5.72, top 6.91
...
Based on publicly observable data for The Bridge, your current operational gaps are putting an estimated **7–22 covers per week** at risk — representing approximately **£840–£5,280 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£420–£2,640/mo); Fix the digital shopfront — you're losing walk-ins (£420–£2,640/mo); Protect the 4.5/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~140–220 | Derived from 315 Google reviews (mid venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 315 Google (4.5★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.5 rating across 315 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Bridge operates as a credible restaurant venue with a 4.5/5 Google rating across 315 reviews — solid but not yet commanding.
...
With 315 reviews at 4.5/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 315 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
- **Volume:** 315 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 315 reviews (Moderate) | Visibility 3.4/10 (Weak) |
...
The Bridge is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Restaurant (General)" but the resolved category triangulates across 2 signal sources.
...
**Position:** #5 of 14 (Percentile 69.2)

You sit above the median but below the top tier. Your 6.0 compares to a peer average of 5.7. The gap to the top (6.9) is 1.0 points — closeable with focused improvement on your weakest dimension.
...
- Trust: 7.1 (-0.9 below peer avg 8.0)

**Closest competitors:**

- 11/17 Salt Beef Bar (6.9) — leads you by 1.0
- Lithos Restaurant (6.5) — leads you by 0.6
- The Bluebell (6.4) — leads you by 0.4
- Red Hot Mamma Pizzeria (6.3) — leads you by 0.4
- Bannatyne Health Club And Spa Wildmoor (5.8) — you lead by 0.1
...
- Experience: 9.4 (+0.8 above peer avg 8.6)
- Visibility: 3.4 (+0.6 above peer avg 2.8)
- Trust: 7.1 (-1.0 below peer avg 8.1)

**Closest competitors:**

- 11/17 Salt Beef Bar (6.9) — leads you by 1.0
- Lithos Restaurant (6.5) — leads you by 0.6
- Oxheart (6.5) — leads you by 0.5
- The Bluebell (6.4) — leads you by 0.4
- Red Hot Mamma Pizzeria (6.3) — leads you by 0.4
...
**Management note:** At 315 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 1.9/10 | ⚠️ Significant drag | Last inspected 2024-04-23 (24 months ago). Meaningful score drag. Consider pr... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-04-23 (24 months ago). Meaningful score drag. Consider proactive action. The system discounts older inspections because they carry less certainty.
...
| Google review count | 315 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.5★ (315 reviews) | observed | ✓ |
...
| Last Inspection | 2024-04-23 | FSA | observed |
| Google Rating | 4.5/5 | Google Places API | observed |
| Google Reviews | 315 | Google Places API | observed |
