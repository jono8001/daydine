# Snitterfield Arms — Monthly Intelligence Report
...
- Ranked #5 of 8 locally — peers are ahead
...
**Competitive position:** Local Peers (5mi): #5 of 8 (P42.9) — peer avg 6.1, top 7.34
  Catchment (15mi): #8 of 19 (P61.1) — peer avg 5.9, top 7.34
  UK Category Cohort: #8 of 19 (P61.1) — peer avg 5.9, top 7.34
...
| Aggregate signals | Rating and volume from all platforms | 102 Google (4.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.7 rating across 102 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Snitterfield Arms operates as a credible pub dining venue with a 4.7/5 Google rating across 102 reviews — solid but not yet commanding.
...
- **Review momentum.** At 102 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Online visibility (3.0) hasn't kept pace with guest experience quality (9.7). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **The 4.7/5 rating feels dominant but isn't.** In this market, peer venues achieve similar ratings. Your percentile position (P42.9) shows the rating is table stakes, not a differentiator.
...
- **Unrealised review authority.** At 102 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** 102 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 102 reviews (Moderate) | Visibility 3.0/10 (Weak) |
...
Snitterfield Arms is classified as **Pub / Bar** (confidence: medium). Google's raw category is "Pub / Bar" but the resolved category triangulates across 1 signal sources.
...
- **Vintner Wine Bar** (7.3): Pub Dining with comparable price band; 3.3 miles away
- **The Red Lion** (6.4): Pub Dining with comparable price band; 3.1 miles away
- **The Townhouse Also Trading As JR Hotel And Restaurants LTD** (6.3): Hotel restaurant — different occasion type, may not compete for walk-in trade; 3.3 miles away *(marginal comparator)*
- **The Bull's Head** (6.3): Pub Dining with comparable price band; 4.3 miles away
- **The Coach House** (5.6): Pub Dining with comparable price band; 3.3 miles away

## Competitive Market Intelligence

**Local market:** 7 direct competitors identified.

Below the median (P43). Customers have higher-rated alternatives nearby (peer avg 6.1, top 7.3).

**Where you lead:** Trust (+0.7), Experience (+0.6)
**Where peers beat you:** Visibility (-1.3), Conversion (-0.6)
...
You are below the median of your peer set. At 6.2 vs peer average 6.1, competitors are outperforming you. The top performer scores 7.3. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Trust: 8.7 (+0.7 above peer avg 8.0)
- Experience: 9.7 (+0.6 above peer avg 9.0)
- Conversion: 2.5 (-0.6 below peer avg 3.1)
- Visibility: 3.0 (-1.3 below peer avg 4.3)
...
- The Bull's Head (6.3) — leads you by 0.1
- The Coach House (5.6) — you lead by 0.6
...
- **Also wins on:** Visibility (+0.6): 576 Google reviews vs your 102 — they have volume advantage
...
- **Copy / test:** Audit your Google profile vs theirs: hours, menu, booking, delivery. Build review volume — they have 576 to your 102.
- **Defend:** No clear defensive advantage — you are closely matched across dimensions.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

**The Bull's Head** (signal-backed)

- **Also wins on:** Visibility (+0.6): 691 Google reviews vs your 102 — they have volume advantage
- **Why it matters:** They lead on both Conversion and Visibility — a combined advantage that is harder to close than a single-dimension gap.
- **Copy / test:** Audit your Google profile vs theirs: hours, menu, booking, delivery. Build review volume — they have 691 to your 102.
- **Defend:** Defend your trust advantage (+0.5).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

### Extended Catchment (18 peers within 15 miles)

**Position:** #8 of 19 (Percentile 61.1)
...
- Experience: 9.7 (+0.9 above peer avg 8.7)
- Trust: 8.7 (+0.7 above peer avg 8.0)
- Conversion: 2.5 (-0.8 below peer avg 3.3)
- Visibility: 3.0 (-0.8 below peer avg 3.8)

**Closest competitors:**

- Vintner Wine Bar (7.3) — leads you by 1.1
- Arrow Mill (6.7) — leads you by 0.5
- The Fox Inn (6.5) — leads you by 0.3
- The Red Lion (6.4) — leads you by 0.2
- The Townhouse Also Trading As JR Hotel And Restaurants LTD (6.3) — leads you by 0.1
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.7 | — | 9.0 | +0.6 | Above peers |
| Visibility | 3.0 | — | 4.3 | -1.3 | Below peers |
| Trust | 8.7 | — | 8.0 | +0.7 | Above peers |
...
**Assessment: Strong.** This is a genuine competitive strength at 9.7.
 Slightly above peer average (9.0).
...
**Assessment: Critical.** At 3.0, this represents a material operational gap.
 You trail peers by 1.3 points (peer avg 4.3).
...
**Management note:** At 102 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.9 on trust, +0.2 on overall (6.2 → 6.4).
...
| Google review count | 102 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.7★ (102 reviews) | observed | ✓ |
...
| Google Reviews | 102 | Google Places API | observed |
...
| Postcode | CV37 0JH | FSA | observed |
| Companies House | — | Not checked | not_assessed |
