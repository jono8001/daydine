# Chapter 23 — Monthly Intelligence Report
...
**Competitive position:** Local Peers (5mi): #2 of 6 (P80.0) — peer avg 5.16, top 6.18
  Catchment (15mi): #9 of 33 (P75.0) — peer avg 5.53, top 6.64
  UK Category Cohort: #22 of 53 (P59.6) — peer avg 5.78, top 6.92
...
| Aggregate signals | Rating and volume from all platforms | 96 Google (4.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.7 rating across 96 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Chapter 23 is a cafe venue with an adequate public reputation (4.7/5, 96 reviews) that has room to build stronger proof.
...
- **Review momentum.** At 96 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
- **Unrealised review authority.** At 96 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** Only 96 reviews — rating is volatile. A single 1-star review moves the average measurably.
...
| Review Volume | 96 reviews (Low) | Visibility 3.0/10 (Weak) |
...
Chapter 23 is classified as **Cafe / Coffee Shop** (confidence: high). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 1 signal sources.
...
- **Lounge@26** (6.2): Dining with comparable price band; 0.0 miles away
- **Costa Coffee** (6.0): Dining with comparable price band; 0.7 miles away
- **George's Cafe** (5.8): Dining with comparable price band; 3.0 miles away
- **Coughton Court Cafe** (3.9): Dining with comparable price band; 2.1 miles away
- **Karen's Korner** (3.9): Dining with comparable price band; 3.3 miles away

## Competitive Market Intelligence

**Local market:** 5 direct competitors identified.

You are in the top quintile (P80). The competitive risk is complacency — the nearest competitor scores 6.2.

**Where you lead:** Trust (+2.6), Experience (+0.7)
...
You are in the top quintile of this peer set. Your overall score of 6.1 exceeds the peer average of 5.2 by 0.9 points. The competitive risk here is complacency — the nearest competitor scores 6.2.

**Dimension gaps vs peers:**

- Trust: 8.2 (+2.6 above peer avg 5.5)
- Experience: 9.7 (+0.7 above peer avg 8.9)

**Closest competitors:**

- Lounge@26 (6.2) — leads you by 0.1
- Costa Coffee (6.0) — you lead by 0.0
- George's Cafe (5.8) — you lead by 0.3
- Coughton Court Cafe (3.9) — you lead by 2.2
- Karen's Korner (3.9) — you lead by 2.2
...
- **Defend:** Defend your 96-review advantage vs their 9 (discovery moat).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

**George's Cafe** (signal-backed)

- **Wins on:** Conversion (see pattern above)
- **Why it matters:** Their conversion lead means they convert interest into visits more effectively — their digital shopfront is more complete.
- **Copy / test:** Audit your Google profile vs theirs: hours, menu, booking, delivery.
- **Defend:** Defend your experience lead (+1.0) — drives repeats and word-of-mouth and your trust advantage (+0.5).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

### Extended Catchment (32 peers within 15 miles)

**Position:** #9 of 33 (Percentile 75.0)

You sit above the median but below the top tier. Your 6.1 compares to a peer average of 5.5. The gap to the top (6.6) is 0.6 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Experience: 9.7 (+1.1 above peer avg 8.6)
- Trust: 8.2 (+1.0 above peer avg 7.2)

**Closest competitors:**

- Shakespaw Cat Cafe (6.6) — leads you by 0.6
- No 37 Cafe (6.3) — leads you by 0.3
- Costa (6.3) — leads you by 0.3
- Espresso Barn (6.3) — leads you by 0.2
- Costa (6.2) — leads you by 0.2

### UK Category Cohort (52 peers in Cafe / Coffee Shop)

**Position:** #22 of 53 (Percentile 59.6)
...
| Visibility | 3.0 | — | 2.6 | +0.4 | Above peers |
| Trust | 8.2 | — | 5.5 | +2.6 | Clear strength |
| Conversion | 2.5 | — | 2.6 | -0.1 | Needs work |
| **Overall** | **6.1** | **—** | | | |
...
**Management note:** At 96 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Biggest drag:** Inspection Recency. Last inspected 2025-04-03 (12 months ago). Score starting to decay. Note it but don't escalate. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.4 on trust, +0.4 on overall (6.1 → 6.4).
...
| Google review count | 96 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.7★ (96 reviews) | observed | ✓ |
...
| Google Reviews | 96 | Google Places API | observed |
