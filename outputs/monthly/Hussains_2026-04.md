# Hussains — Monthly Intelligence Report
...
**Overall score: 6.2/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.2) | Weakest: Visibility (3.4)

**Competitive position:** Local Peers (5mi): #4 of 7 (P50.0) — peer avg 5.93, top 6.59
  Catchment (15mi): #5 of 16 (P73.3) — peer avg 5.58, top 6.59
  UK Category Cohort: #5 of 17 (P75.0) — peer avg 5.58, top 6.59
...
Based on publicly observable data for Hussains, your current operational gaps are putting an estimated **3–11 covers per week** at risk — representing approximately **£340–£2,640 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£170–£1,320/mo); Fix the digital shopfront — you're losing walk-ins (£170–£1,320/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~140–220 | Derived from 331 Google reviews (mid venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 331 Google (4.3★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.3 rating across 331 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Hussains operates as a credible Indian dining venue with a 4.3/5 Google rating across 331 reviews — solid but not yet commanding.
...
Insufficient review data to cross-reference proposition. Google types show: indian_restaurant, asian_restaurant, bangladeshi_restaurant, fast_food_restaurant, fine_dining_restaurant, meal_takeaway, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: indian_restaurant, asian_restaurant, bangladeshi_restaurant, fast_food_restaurant, fine_dining_restaurant, meal_takeaway, restaurant*
...
Online visibility (3.4) hasn't kept pace with guest experience quality (9.2). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
Hussains is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Indian Restaurant" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | indian_restaurant, asian_restaurant, bangladeshi_restaurant, fast_food_restaurant, fine_dining_restaurant, meal_takeaway, restaurant | Primary |
...
- **Simla Takeaway** (6.6): Takeaway-focused — different service model; 0.2 miles away *(weak comparator)*
- **Avon Spice** (6.4): Dining with comparable price band; 0.2 miles away
- **Shah's** (6.3): Dining with similar price band; 4.7 miles away
- **Kolshi Restaurant** (6.1): Dining with comparable price band; 4.8 miles away
- **Thespians Indian Restaurant** (5.4): Dining with similar price band; 0.1 miles away

## Competitive Market Intelligence

**Local market:** 6 direct competitors identified.

Above the median (P50) but not leading. Peer average is 5.9; the top performer scores 6.6. The gap to the top is closeable.

**Where you lead:** Conversion (+1.2), Experience (+0.6)

*Commercial implication: you capture an adequate share of a 7-venue market, but the gap to the top (6.6) represents demand you could win. Closing the gap typically requires 1–2 targeted dimension improvements (indicative).*
...
You sit above the median but below the top tier. Your 6.2 compares to a peer average of 5.9. The gap to the top (6.6) is 0.4 points — closeable with focused improvement on your weakest dimension.
...
- Simla Takeaway (6.6) — leads you by 0.4
- Avon Spice (6.4) — leads you by 0.2
- Shah's (6.3) — leads you by 0.1
- Kolshi Restaurant (6.1) — you lead by 0.1
- Thespians Indian Restaurant (5.4) — you lead by 0.8

### Competitor Strategy

**Simla Takeaway** (signal-backed)

- **Wins on:** Visibility (+1.6): you have 331 reviews vs their 73 — but they score higher on other visibility signals; Conversion (+1.0): more complete operational signals (hours, menu, delivery/takeaway, booking)
...
**Position:** #5 of 16 (Percentile 73.3)

You sit above the median but below the top tier. Your 6.2 compares to a peer average of 5.6. The gap to the top (6.6) is 0.4 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Conversion: 5.0 (+1.2 above peer avg 3.8)
- Trust: 8.1 (+1.1 above peer avg 6.9)
- Experience: 9.2 (+0.8 above peer avg 8.4)

**Closest competitors:**

- Simla Takeaway (6.6) — leads you by 0.4
- Cardamom (6.6) — leads you by 0.4
- Avon Spice (6.4) — leads you by 0.2
- Shah's (6.3) — leads you by 0.1
- The Spice Room (6.1) — you lead by 0.1
...
| Visibility | 3.4 | — | 3.8 | -0.3 | Below peers |
| Trust | 8.1 | — | 7.9 | +0.2 | Strong |
...
| Google Business Profile | 4.3★ (331 reviews) | observed | ✓ |
...
| Postcode | CV37 6EP | FSA | observed |
| Companies House | — | Not checked | not_assessed |
