...
| Aggregate signals | Rating and volume from all platforms | 75 Google (4.9★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
...
Puddleduck Cafe Ltd is a cafe venue with an adequate public reputation (4.9/5, 75 reviews) that has room to build stronger proof.
...
Within the local cafe market (4 peers), this venue leads the field. The identity is that of a category leader — the venue others are compared against.
...
- **Review momentum.** At 75 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Online visibility (2.9) hasn't kept pace with guest experience quality (9.9). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Unrealised review authority.** At 75 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** Only 75 reviews — rating is volatile. A single 1-star review moves the average measurably.
...
| Review Volume | 75 reviews (Low) | Visibility 2.9/10 (Weak) |
...
Puddleduck Cafe Ltd is classified as **Cafe / Coffee Shop** (confidence: high). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 2 signal sources.
...
| Name | "Puddleduck Cafe Ltd" contains "cafe" | Supportive |

**Resolved category:** Cafe / Coffee Shop (confidence: high)

### Peer Justification

- **Southam Gateway Coffee Shop Ltd** (6.1): Dining with comparable price band; 2.8 miles away
- **Cafe 16** (6.1): Dining with comparable price band; 2.8 miles away
- **The Tea Shed** (5.7): Dining with comparable price band; 1.2 miles away
- **Bishops Bowls Lake Cafe** (4.8): Dining with comparable price band; 4.1 miles away
...
**Where you lead:** Trust (+1.5), Experience (+1.3)
...
You are in the top quintile of this peer set. Your overall score of 6.9 exceeds the peer average of 5.7 by 1.2 points. The competitive risk here is complacency — the nearest competitor scores 6.1.

**Dimension gaps vs peers:**

- Trust: 8.8 (+1.5 above peer avg 7.3)
- Experience: 9.9 (+1.3 above peer avg 8.6)

**Closest competitors:**

- Southam Gateway Coffee Shop Ltd (6.1) — you lead by 0.8
- Cafe 16 (6.1) — you lead by 0.8
- The Tea Shed (5.7) — you lead by 1.2
- Bishops Bowls Lake Cafe (4.8) — you lead by 2.1
...
- **Copy / test:** Build review volume — they have 600 to your 75.
...
- Trust: 8.8 (+0.9 above peer avg 7.8)
- Experience: 9.9 (+0.9 above peer avg 9.0)
...
**Position:** #1 of 53 (Percentile 100.0)

You are in the top quintile of this peer set. Your overall score of 6.9 exceeds the peer average of 5.8 by 1.2 points. The competitive risk here is complacency — the nearest competitor scores 6.8.
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.9 | — | 8.6 | +1.3 | Above peers |
| Visibility | 2.9 | — | 2.7 | +0.2 | Needs work |
...
**Assessment: Strong.** This is a genuine competitive strength at 9.9.
 You lead peers by 1.3 points (peer avg 8.6).
...
**Management note:** At 75 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Biggest drag:** Inspection Recency. Last inspected 2025-06-13 (10 months ago). Full confidence. No action needed. 
...
| Google review count | 75 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.9★ (75 reviews) | observed | ✓ |
...
| Last Inspection | 2025-06-13 | FSA | observed |
| Google Rating | 4.9/5 | Google Places API | observed |
| Google Reviews | 75 | Google Places API | observed |
...
| Postcode | CV47 1AJ | FSA | observed |
| Companies House | — | Not checked | not_assessed |
