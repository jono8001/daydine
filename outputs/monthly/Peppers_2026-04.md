# Peppers — Monthly Intelligence Report
...
**Overall score: 5.5/10** (baseline month — no prior comparison)
 | Strongest: Experience (8.3) | Weakest: Visibility (3.1)

**Competitive position:** Local Peers (5mi): #3 of 3 (P0.0) — peer avg 6.33, top 6.57
  Catchment (15mi): #9 of 13 (P33.3) — peer avg 5.83, top 6.59
  UK Category Cohort: #11 of 17 (P37.5) — peer avg 5.63, top 6.59
...
Based on publicly observable data for Peppers, your current operational gaps are putting an estimated **4–14 covers per week** at risk — representing approximately **£480–£3,360 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£240–£1,680/mo); Fix the digital shopfront — you're losing walk-ins (£240–£1,680/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~80–140 | Derived from 148 Google reviews (small venue indicator), price level ££ |
...
| Weekly revenue at risk | £120–£840 | Recoverable with priority action fixes |
| Monthly revenue at risk | £480–£3,360 | Aggregate across top 3 priorities |
| Annual projection | £5,760–£40,320 | If current gaps persist 12 months |
...
| Aggregate signals | Rating and volume from all platforms | 148 Google (4.4★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.4 rating across 148 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Peppers operates as a credible Indian dining venue with a 4.4/5 Google rating across 148 reviews — solid but not yet commanding.
...
- **Evidence:** `experience=8.26, conversion=3.5`
...
- **Review momentum.** At 148 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
- **Unrealised review authority.** At 148 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** 148 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 148 reviews (Moderate) | Visibility 3.1/10 (Weak) |
...
Peppers is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Indian Restaurant" but the resolved category triangulates across 2 signal sources.
...
- **Cardamom** (6.6): Takeaway-focused — different service model; 4.2 miles away *(weak comparator)*
- **The Spice Room** (6.1): Takeaway-focused — different service model; 4.2 miles away *(weak comparator)*
...
**Where peers beat you:** Trust (-1.3), Conversion (-1.0), Experience (-0.8)
...
You are below the median of your peer set. At 5.5 vs peer average 6.3, competitors are outperforming you. The top performer scores 6.6. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Experience: 8.3 (-0.8 below peer avg 9.0)
- Conversion: 3.5 (-1.0 below peer avg 4.5)
- Trust: 7.3 (-1.3 below peer avg 8.6)

**Closest competitors:**

- Cardamom (6.6) — leads you by 1.1
- The Spice Room (6.1) — leads you by 0.6
...
- **Copy / test:** Audit your Google profile vs theirs: hours, menu, booking, delivery. Read their recent positive reviews (4.6/5) for operational clues.
...
- **Wins on:** Trust (+1.4): same FSA rating but likely stronger sub-scores or more recent inspection; Conversion (+0.5): more complete operational signals (hours, menu, delivery/takeaway, booking)
...
- **Also wins on:** Visibility (+1.9): you have 148 reviews vs their 73 — but they score higher on other visibility signals
...
**Position:** #9 of 13 (Percentile 33.3)

You are below the median of your peer set. At 5.5 vs peer average 5.8, competitors are outperforming you. The top performer scores 6.6. Customers in this area have demonstrably better-rated alternatives.

**Closest competitors:**

- Simla Takeaway (6.6) — leads you by 1.1
- Cardamom (6.6) — leads you by 1.1
- Avon Spice (6.4) — leads you by 1.0
- Shah's (6.3) — leads you by 0.8
- Hussains (6.2) — leads you by 0.8

### UK Category Cohort (16 peers in Indian Restaurant)

**Position:** #11 of 17 (Percentile 37.5)

You are below the median of your peer set. At 5.5 vs peer average 5.6, competitors are outperforming you. The top performer scores 6.6. Customers in this area have demonstrably better-rated alternatives.
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.3 | — | 9.0 | -0.8 | Below peers |
| Visibility | 3.1 | — | 3.2 | -0.1 | Needs work |
| Trust | 7.3 | — | 8.6 | -1.3 | Below peers |
...
**Assessment: Strong.** This is a genuine competitive strength at 8.3.
 Slightly below peer average (9.0).
...
**Management note:** At 148 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Adequate.** At 7.3, this is functional but not distinctive.
 You trail peers by 1.3 points (peer avg 8.6).
...
| Inspection Recency | 2.7/10 | ⚠️ Significant drag | Last inspected 2024-09-10 (19 months ago). Meaningful score drag. Consider pr... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-09-10 (19 months ago). Meaningful score drag. Consider proactive action. The system discounts older inspections because they carry less certainty.

**Peer context:** Cardamom's trust lead (+1.4) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.

**What you can do:**

1. **Request voluntary reinspection** (free, 4–8 weeks) — would recover ~1.8 trust points and overtake 2 peers. Only request reinspection if confident of maintaining 5/5. A drop to 4 would be worse than the staleness drag.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.8 on trust, +0.5 on overall (5.5 → 5.9).
...
| Google review count | 148 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.4★ (148 reviews) | observed | ✓ |
...
| Last Inspection | 2024-09-10 | FSA | observed |
| Google Rating | 4.4/5 | Google Places API | observed |
| Google Reviews | 148 | Google Places API | observed |
