# Wildwood Kitchen — Monthly Intelligence Report
...
**Overall score: 5.6/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.2) | Weakest: Conversion (3.5)

**Competitive position:** Local Peers (5mi): #7 of 10 (P33.3) — peer avg 5.78, top 6.41
  Catchment (15mi): #9 of 12 (P27.3) — peer avg 5.83, top 6.41
  UK Category Cohort: #10 of 13 (P25.0) — peer avg 5.84, top 6.41
...
Based on publicly observable data for Wildwood Kitchen, your current operational gaps are putting an estimated **16–50 covers per week** at risk — representing approximately **£1,920–£12,500 per month** in lost or leaked revenue. The main drivers are: Close the hygiene gap — 4 to 5 (£0–£500/mo (defensive)); Get your menu online — 77% of diners check before visiting (£960–£6,000/mo); Fix the digital shopfront — you're losing walk-ins (£960–£6,000/mo). Taking action on **Close the hygiene gap — 4 to 5** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~320–500 | Derived from 1,055 Google reviews (high-traffic venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 1,055 Google (4.3★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.3 rating across 1,055 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Wildwood Kitchen operates as a credible Italian dining venue with a 4.3/5 Google rating across 1055 reviews — solid but not yet commanding.
...
- **Evidence:** `experience=9.18, conversion=3.5`
...
- **Review momentum.** At 1055 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: restaurant, italian_restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: restaurant, italian_restaurant*
...
Online visibility (3.8) hasn't kept pace with guest experience quality (9.2). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 1,055 reviews — statistically robust rating. Individual reviews have negligible impact.
...
|--------|-------------|---------------------|
| Customer Rating | 4.3/5 Google (Good) | Experience 9.2/10 (Strong) — Gap |
| Hygiene Rating | FSA 4/5 (Acceptable) | Trust 6.2/10 (Adequate) |
| Review Volume | 1055 reviews (High) | Visibility 3.8/10 (Weak) |
...
Wildwood Kitchen is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Italian Restaurant" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | restaurant, italian_restaurant | Primary |
...
- **Carluccio's** (6.1): Dining with similar price band; 0.1 miles away
...
Below the median (P33). Customers have higher-rated alternatives nearby (peer avg 5.8, top 6.4).

**Where you lead:** Conversion (+0.7)
**Where peers beat you:** Trust (-1.4)
...
You are below the median of your peer set. At 5.6 vs peer average 5.8, competitors are outperforming you. The top performer scores 6.4. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Conversion: 3.5 (+0.7 above peer avg 2.8)
- Trust: 6.2 (-1.4 below peer avg 7.6)

**Closest competitors:**

- The Phoenix (6.4) — leads you by 0.8
- Soma (6.2) — leads you by 0.6
- Carluccio's (6.1) — leads you by 0.5
- Pizza Hut Restaurants - Dine In (6.0) — leads you by 0.4
- Impasto Micro-Pizzeria (5.8) — leads you by 0.2
...
- **Why it matters:** A large trust gap (+2.2) — their compliance record is stronger — this creates a ceiling you hit and they don't. This is a structural disadvantage, not a rounding error.
...
**Impasto Micro-Pizzeria** (signal-backed)

- **Wins on:** Trust (see pattern above)
- **Why it matters:** A large trust gap (+1.5) — their compliance record is stronger — this creates a ceiling you hit and they don't. This is a structural disadvantage, not a rounding error.
- **Copy / test:** Target FSA re-inspection to match their 5/5 rating.
- **Defend:** Defend your conversion readiness (+1.0) — you are easier to book/find and your 1055-review advantage vs their 121 (discovery moat).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

### Extended Catchment (11 peers within 15 miles)

**Position:** #9 of 12 (Percentile 27.3)
...
- The Phoenix (6.4) — leads you by 0.8
- Soma (6.2) — leads you by 0.6
- The Still House Café (6.1) — leads you by 0.5
- Bumbles (6.1) — leads you by 0.5
- Carluccio's (6.1) — leads you by 0.5

### UK Category Cohort (12 peers in Italian Restaurant)

**Position:** #10 of 13 (Percentile 25.0)
...
- Conversion: 3.5 (+0.6 above peer avg 2.9)
- Trust: 6.2 (-1.5 below peer avg 7.7)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.2 | — | 8.8 | +0.3 | Above peers |
| Visibility | 3.8 | — | 3.4 | +0.4 | Above peers |
| Trust | 6.2 | — | 7.6 | -1.4 | Below peers |
...
**Management note:** At 1055 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Adequate.** At 6.2, this is functional but not distinctive.
 You trail peers by 1.4 points (peer avg 7.6).
...
| Inspection Recency | 3.2/10 | ⚠️ Significant drag | Last inspected 2024-11-26 (17 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-11-26 (17 months ago). Score starting to decay. Note it but don't escalate. 
...
You trail peers by 1.4 points on trust. This isn't a label problem — it means customers are getting a measurably better experience on this dimension from your competitors.
...
|--:|---------------|--------|--------|------|
| 6 | Ranked #7 of 10 locally — peers are ahead | Stale (5 months) | 01 May 2026 | Medium (£200–£1,000) |
...
| Google review count | 1055 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.3★ (1055 reviews) | observed | ✓ |
...
| Last Inspection | 2024-11-26 | FSA | observed |
| Google Rating | 4.3/5 | Google Places API | observed |
| Google Reviews | 1055 | Google Places API | observed |
