# The Bell Inn — Monthly Intelligence Report
...
**Overall score: 5.9/10** (baseline month — no prior comparison)
 | Strongest: Experience (8.5) | Weakest: Conversion (3.5)

**Competitive position:** Local Peers (5mi): #6 of 10 (P44.4) — peer avg 6.06, top 7.34
  Catchment (15mi): #10 of 16 (P40.0) — peer avg 5.99, top 7.34
  UK Category Cohort: #10 of 19 (P50.0) — peer avg 5.91, top 7.34
...
Based on publicly observable data for The Bell Inn, your current operational gaps are putting an estimated **16–50 covers per week** at risk — representing approximately **£1,920–£12,000 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£960–£6,000/mo); Fix the digital shopfront — you're losing walk-ins (£960–£6,000/mo); Protect the 4.6/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~320–500 | Derived from 1,157 Google reviews (high-traffic venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 1,157 Google (4.6★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.6 rating across 1,157 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Bell Inn is a well-established pub dining venue with a strong public reputation — 4.6/5 across 1,157 Google reviews. That volume means the reputation is earned, not manufactured.
...
- **Evidence:** `experience=8.49, conversion=3.5`
...
With 1157 reviews at 4.6/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 1157 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Online visibility (3.8) hasn't kept pace with guest experience quality (8.5). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **The 4.6/5 rating feels dominant but isn't.** In this market, peer venues achieve similar ratings. Your percentile position (P44.4) shows the rating is table stakes, not a differentiator.
...
- **Volume:** 1,157 reviews — statistically robust rating. Individual reviews have negligible impact.
...
| Review Volume | 1157 reviews (High) | Visibility 3.8/10 (Weak) |
...
The Bell Inn is classified as **Pub / Bar** (confidence: medium). Google's raw category is "Pub / Bar" but the resolved category triangulates across 2 signal sources.
...
- **Vintner Wine Bar** (7.3): Pub Dining with similar price band; 3.7 miles away
- **Arrow Mill** (6.7): Hotel restaurant — different occasion type, may not compete for walk-in trade; 4.7 miles away *(marginal comparator)*
- **The Red Lion** (6.4): Pub Dining with comparable price band; 3.8 miles away
- **The Townhouse Also Trading As JR Hotel And Restaurants LTD** (6.3): Hotel restaurant — different occasion type, may not compete for walk-in trade; 3.6 miles away *(marginal comparator)*
- **Cafe Des Fleurs** (6.2): Pub Dining with similar price band; 4.9 miles away

## Competitive Market Intelligence

**Local market:** 9 direct competitors identified.

Below the median (P44). Customers have higher-rated alternatives nearby (peer avg 6.1, top 7.3).
...
You are below the median of your peer set. At 5.9 vs peer average 6.1, competitors are outperforming you. The top performer scores 7.3. Customers in this area have demonstrably better-rated alternatives.

**Closest competitors:**

- Vintner Wine Bar (7.3) — leads you by 1.4
- Arrow Mill (6.7) — leads you by 0.8
- The Red Lion (6.4) — leads you by 0.5
- The Townhouse Also Trading As JR Hotel And Restaurants LTD (6.3) — leads you by 0.4
- Cafe Des Fleurs (6.2) — leads you by 0.3
...
- **Also wins on:** Experience (+1.2): Google 4.7/5 vs your 4.6/5
...
- **Wins on:** Experience (+0.9): higher composite experience score from rating + compliance signals
...
- **Defend:** Defend your 1157-review advantage vs their 206 (discovery moat).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

### Extended Catchment (15 peers within 15 miles)

**Position:** #10 of 16 (Percentile 40.0)
...
- Vintner Wine Bar (7.3) — leads you by 1.4
- Arrow Mill (6.7) — leads you by 0.8
- The Fox Inn (6.5) — leads you by 0.5
- The Red Lion (6.4) — leads you by 0.5
- The Townhouse Also Trading As JR Hotel And Restaurants LTD (6.3) — leads you by 0.4

### UK Category Cohort (18 peers in Pub / Bar)

**Position:** #10 of 19 (Percentile 50.0)

You sit above the median but below the top tier. Your 5.9 compares to a peer average of 5.9. The gap to the top (7.3) is 1.4 points — closeable with focused improvement on your weakest dimension.
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.5 | — | 8.8 | -0.4 | Below peers |
| Visibility | 3.8 | — | 4.2 | -0.4 | Below peers |
| Trust | 7.8 | — | 8.1 | -0.2 | In line |
| Conversion | 3.5 | — | 3.2 | +0.3 | Above peers |
| **Overall** | **5.9** | **—** | | | |
...
**Management note:** At 1157 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.3 on trust, +0.3 on overall (5.9 → 6.3).
...
Your 4.6/5 Google rating feels dominant but you sit below the local median (P44.4). Peer venues achieve similar or better ratings — in this market, 4.5 is table stakes, not a differentiator. Don't mistake the number for an advantage.
...
### Action 4: Protect the 4.6/5 rating — it took years to build
**Status:** Stale (5 months) | **Priority:** High
...
| Google review count | 1157 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.6★ (1157 reviews) | observed | ✓ |
...
| Google Reviews | 1157 | Google Places API | observed |
...
| Postcode | CV37 8EB | FSA | observed |
| Companies House | — | Not checked | not_assessed |
