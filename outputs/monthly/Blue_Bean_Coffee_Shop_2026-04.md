# Blue Bean Coffee Shop — Monthly Intelligence Report
...
**Overall score: 5.7/10** (baseline month — no prior comparison)
 | Strongest: Experience (8.6) | Weakest: Visibility (3.2)

**Competitive position:** Local Peers (5mi): #5 of 5 (P0.0) — peer avg 6.04, top 6.44
  Catchment (15mi): #25 of 39 (P36.8) — peer avg 5.81, top 6.78
  UK Category Cohort: #35 of 53 (P34.6) — peer avg 5.79, top 6.92
...
Based on publicly observable data for Blue Bean Coffee Shop, your current operational gaps are putting an estimated **7–22 covers per week** at risk — representing approximately **£840–£5,280 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£420–£2,640/mo); Fix the digital shopfront — you're losing walk-ins (£420–£2,640/mo); Protect the 4.7/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~140–220 | Derived from 200 Google reviews (mid venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 200 Google (4.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.7 rating across 200 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Blue Bean Coffee Shop operates as a credible cafe venue with a 4.7/5 Google rating across 200 reviews — solid but not yet commanding.
...
With 200 reviews at 4.7/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 200 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
- **Volume:** 200 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 200 reviews (Moderate) | Visibility 3.2/10 (Weak) |
...
Blue Bean Coffee Shop is classified as **Cafe / Coffee Shop** (confidence: high). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 3 signal sources.
...
| Name | "Blue Bean Coffee Shop" contains "cafe" | Supportive |

**Resolved category:** Cafe / Coffee Shop (confidence: high)

### Peer Justification

- **Cotswold Cafe** (6.4): Dining with comparable price band; 0.4 miles away
- **Cotswold Distillery Cafe** (6.2): Dining with comparable price band; 3.4 miles away
- **Revs Automobilia** (5.8): Dining with comparable price band; 2.0 miles away
- **Ferment And Flour (Bastardos)** (5.8): Dining with comparable price band; 0.1 miles away

## Competitive Market Intelligence

**Local market:** 4 direct competitors identified.

Below the median (P0). Customers have higher-rated alternatives nearby (peer avg 6.0, top 6.4).

**Where you lead:** Conversion (+0.8)
**Where peers beat you:** Trust (-1.3), Experience (-0.7)
...
You are below the median of your peer set. At 5.7 vs peer average 6.0, competitors are outperforming you. The top performer scores 6.4. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Conversion: 3.5 (+0.8 above peer avg 2.8)
- Experience: 8.6 (-0.7 below peer avg 9.3)
- Trust: 7.1 (-1.3 below peer avg 8.4)

**Closest competitors:**

- Cotswold Cafe (6.4) — leads you by 0.8
- Cotswold Distillery Cafe (6.2) — leads you by 0.5
- Revs Automobilia (5.8) — leads you by 0.2
- Ferment And Flour (Bastardos) (5.8) — leads you by 0.1
...
- **Wins on:** Experience (+1.3): Google 4.9/5 vs your 4.7/5; Visibility (+0.6): 1239 Google reviews vs your 200 — they have volume advantage
...
- **Copy / test:** Read their recent positive reviews (4.9/5) for operational clues. Build review volume — they have 1239 to your 200.
...
**Ferment And Flour (Bastardos)** (signal-backed)

- **Wins on:** Trust (see pattern above)
- **Why it matters:** A large trust gap (+1.7) — their compliance record is stronger — this creates a ceiling you hit and they don't. This is a structural disadvantage, not a rounding error.
- **Copy / test:** Review inspection documentation and sub-score gaps.
- **Defend:** Defend your conversion readiness (+1.0) — you are easier to book/find and your 200-review advantage vs their 18 (discovery moat).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

### Extended Catchment (38 peers within 15 miles)

**Position:** #25 of 39 (Percentile 36.8)

You are below the median of your peer set. At 5.7 vs peer average 5.8, competitors are outperforming you. The top performer scores 6.8. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Conversion: 3.5 (+0.6 above peer avg 2.9)
- Trust: 7.1 (-0.6 below peer avg 7.7)

**Closest competitors:**

- South Costa (6.8) — leads you by 1.1
- Building 523 Costa And Kitchen (6.8) — leads you by 1.1
- Dec X Canteen (6.7) — leads you by 1.0
- Gilks' Garage Cafe (6.7) — leads you by 1.0
- Shakespaw Cat Cafe (6.6) — leads you by 1.0

### UK Category Cohort (52 peers in Cafe / Coffee Shop)

**Position:** #35 of 53 (Percentile 34.6)

You are below the median of your peer set. At 5.7 vs peer average 5.8, competitors are outperforming you. The top performer scores 6.9. Customers in this area have demonstrably better-rated alternatives.
...
- South Costa (6.8) — leads you by 1.1
- Nanas Caff (6.8) — leads you by 1.1
- Building 523 Costa And Kitchen (6.8) — leads you by 1.1
- Dec X Canteen (6.7) — leads you by 1.0
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.6 | — | 9.3 | -0.7 | Below peers |
| Visibility | 3.2 | — | 3.2 | +0.1 | Needs work |
| Trust | 7.1 | — | 8.4 | -1.3 | Below peers |
| Conversion | 3.5 | — | 2.8 | +0.8 | Above peers |
| **Overall** | **5.7** | **—** | | | |

*Prestige (editorial recognition): 1.5/10 (peer avg 1.1) — tracked but not a headline operational lever for most independents.*
...
**Assessment: Strong.** This is a genuine competitive strength at 8.6.
 Slightly below peer average (9.3).
...
**Management note:** At 200 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 1.9/10 | ⚠️ Significant drag | Last inspected 2024-04-24 (24 months ago). Meaningful score drag. Consider pr... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-04-24 (24 months ago). Meaningful score drag. Consider proactive action. The system discounts older inspections because they carry less certainty.

**Peer context:** Cotswold Cafe's trust lead (+1.7) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +2.0 on trust, +0.5 on overall (5.7 → 6.2).
...
You trail peers by 1.3 points on trust. This isn't a label problem — it means customers are getting a measurably better experience on this dimension from your competitors.
...
| Google review count | 200 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.7★ (200 reviews) | observed | ✓ |
...
| Last Inspection | 2024-04-24 | FSA | observed |
| Google Rating | 4.7/5 | Google Places API | observed |
| Google Reviews | 200 | Google Places API | observed |
...
| Postcode | CV36 4AF | FSA | observed |
| Companies House | — | Not checked | not_assessed |
