# Kolshi Restaurant — Monthly Intelligence Report
...
3. **Protect the 4.8/5 rating — it took years to build** [PROTECT] — Sustain discovery advantage
...
**Overall score: 6.1/10** (baseline month — no prior comparison)
 | Strongest: Trust (8.7) | Weakest: Conversion (2.5)

**Competitive position:** Local Peers (5mi): #5 of 7 (P33.3) — peer avg 6.08, top 6.59
  Catchment (15mi): #7 of 16 (P60.0) — peer avg 5.59, top 6.59
  UK Category Cohort: #7 of 17 (P62.5) — peer avg 5.59, top 6.59
...
Based on publicly observable data for Kolshi Restaurant, your current operational gaps are putting an estimated **18–52 covers per week** at risk — representing approximately **£2,120–£12,600 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£1,060–£6,300/mo); Fix the digital shopfront — you're losing walk-ins (£1,060–£6,300/mo); Protect the 4.8/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~220–350 | Derived from 763 Google reviews (large venue indicator), price level ££ |
...
| Weekly revenue at risk | £530–£3,150 | Recoverable with priority action fixes |
| Monthly revenue at risk | £2,120–£12,600 | Aggregate across top 3 priorities |
| Annual projection | £25,440–£151,200 | If current gaps persist 12 months |
...
| Aggregate signals | Rating and volume from all platforms | 763 Google (4.8★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.8 rating across 763 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Kolshi Restaurant is a well-established Indian dining venue with a strong public reputation — 4.8/5 across 763 Google reviews. That volume means the reputation is earned, not manufactured.
...
### Priority 3: Protect the 4.8/5 rating — it took years to build [PROTECT | ESCALATED]

With 763 reviews at 4.8/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 763 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Online visibility (3.7) hasn't kept pace with guest experience quality (8.7). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **The 4.8/5 rating feels dominant but isn't.** In this market, peer venues achieve similar ratings. Your percentile position (P33.3) shows the rating is table stakes, not a differentiator.
...
- **Volume:** 763 reviews — strong base. Rating is stable but a sustained negative pattern could shift it.
...
|--------|-------------|---------------------|
| Customer Rating | 4.8/5 Google (Strong) | Experience 8.7/10 (Strong) — Aligned |
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 8.7/10 (Strong) |
| Review Volume | 763 reviews (High) | Visibility 3.7/10 (Weak) |
...
Kolshi Restaurant is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Indian Restaurant" but the resolved category triangulates across 2 signal sources.
...
| Name | "Kolshi Restaurant" contains "restaurant" | Supportive |

**Resolved category:** Restaurant (General) (confidence: medium)

### Peer Justification

- **Simla Takeaway** (6.6): Takeaway-focused — different service model; 5.0 miles away *(weak comparator)*
- **Avon Spice** (6.4): Dining with comparable price band; 5.0 miles away
- **Shah's** (6.3): Dining with comparable price band; 0.1 miles away
- **Hussains** (6.2): Takeaway-focused — different service model; 4.8 miles away *(weak comparator)*
- **Shukurs** (5.6): Dining with comparable price band; 4.5 miles away

## Competitive Market Intelligence

**Local market:** 6 direct competitors identified.

Below the median (P33). Customers have higher-rated alternatives nearby (peer avg 6.1, top 6.6).

**Where you lead:** Trust (+0.9)
**Where peers beat you:** Conversion (-1.7)
...
You are below the median of your peer set. At 6.1 vs peer average 6.1, competitors are outperforming you. The top performer scores 6.6. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Trust: 8.7 (+0.9 above peer avg 7.8)
- Conversion: 2.5 (-1.7 below peer avg 4.2)

**Closest competitors:**

- Simla Takeaway (6.6) — leads you by 0.5
- Avon Spice (6.4) — leads you by 0.4
- Shah's (6.3) — leads you by 0.2
- Hussains (6.2) — leads you by 0.1
- Shukurs (5.6) — you lead by 0.5
...
- **Also wins on:** Experience (+0.7): higher composite experience score from rating + compliance signals
...
- **Also wins on:** Experience (+0.9): higher composite experience score from rating + compliance signals
- **Why it matters:** They lead on both Conversion and Experience — a combined advantage that is harder to close than a single-dimension gap.
...
- **Defend:** Defend your trust advantage (+0.6).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*
...
**Position:** #7 of 16 (Percentile 60.0)

You sit above the median but below the top tier. Your 6.1 compares to a peer average of 5.6. The gap to the top (6.6) is 0.5 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 8.7 (+1.9 above peer avg 6.9)
- Conversion: 2.5 (-1.5 below peer avg 4.0)

**Closest competitors:**

- Simla Takeaway (6.6) — leads you by 0.5
- Cardamom (6.6) — leads you by 0.5
- Avon Spice (6.4) — leads you by 0.4
- Shah's (6.3) — leads you by 0.2
- Hussains (6.2) — leads you by 0.1
...
**Position:** #7 of 17 (Percentile 62.5)

You sit above the median but below the top tier. Your 6.1 compares to a peer average of 5.6. The gap to the top (6.6) is 0.5 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 8.7 (+1.8 above peer avg 6.9)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.7 | — | 8.9 | -0.2 | Strong |
| Visibility | 3.7 | — | 3.7 | -0.1 | Needs work |
| Trust | 8.7 | — | 7.8 | +0.9 | Above peers |
| Conversion | 2.5 | — | 4.2 | -1.7 | Significant gap |
| **Overall** | **6.1** | **—** | | | |
...
**Assessment: Critical.** At 3.7, this represents a material operational gap.
...
**Management note:** At 763 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Critical.** At 2.5, this represents a material operational gap.
 You trail peers by 1.7 points (peer avg 4.2).
...
| Inspection Recency | 6.4/10 | ⚠️ Room to improve | Last inspected 2025-09-30 (6 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-09-30 (6 months ago). Full confidence. No action needed. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.9 on trust, +0.2 on overall (6.1 → 6.3).
...
Your 4.8/5 Google rating feels dominant but you sit below the local median (P33.3). Peer venues achieve similar or better ratings — in this market, 4.5 is table stakes, not a differentiator. Don't mistake the number for an advantage.

**Harder to book/find than competitors — friction losing customers** [ESCALATED]

You trail peers by 1.7 points on conversion. This isn't a label problem — it means customers are getting a measurably better experience on this dimension from your competitors.
...
### Action 4: Protect the 4.8/5 rating — it took years to build
**Status:** Stale (5 months) | **Priority:** High
...
**Target date:** 08 April 2026 | **Cost:** Low (< £200) | **Expected upside:** Close the 1.7-point gap
**Owner:** management
**Next milestone:** Review the 3 competitor profiles listed in this report. Note what they do on Google that you don't. Pick one gap to close this week
**Success measure:** Overall score percentile improved vs local peers (verifiable via next scoring run)
**Barrier diagnosis (Access barrier):** This likely requires system access (e.g. Google Business Profile admin) that may have been lost or never set up. If the original account holder has left, Google's ownership recovery process takes 7–14 days.
...
|--:|---------------|--------|--------|------|
| 6 | Ranked #5 of 7 locally — peers are ahead | Stale (5 months) | 01 May 2026 | Medium (£200–£1,000) |
...
| Google review count | 763 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.8★ (763 reviews) | observed | ✓ |
...
| Last Inspection | 2025-09-30 | FSA | observed |
| Google Rating | 4.8/5 | Google Places API | observed |
| Google Reviews | 763 | Google Places API | observed |
...
| Postcode | CV35 9ND | FSA | observed |
| Companies House | — | Not checked | not_assessed |
