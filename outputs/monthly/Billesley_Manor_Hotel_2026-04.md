# Billesley Manor Hotel — Monthly Intelligence Report
...
**Overall score: 6.0/10** (baseline month — no prior comparison)
 | Strongest: Experience (8.0) | Weakest: Visibility (3.8)

**Competitive position:** Local Peers (5mi): #8 of 10 (P22.2) — peer avg 6.09, top 6.78
  Catchment (15mi): #12 of 15 (P21.4) — peer avg 6.08, top 6.78
  UK Category Cohort: #12 of 17 (P31.2) — peer avg 6.03, top 6.78
...
Based on publicly observable data for Billesley Manor Hotel, your current operational gaps are putting an estimated **10–35 covers per week** at risk — representing approximately **£1,160–£8,400 per month** in lost or leaked revenue. The main drivers are: Publish opening hours — you're invisible to 'open now' searches (£580–£4,200/mo); Get your menu online — 77% of diners check before visiting (£580–£4,200/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Publish opening hours — you're invisible to 'open now' searches** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~320–500 | Derived from 1,208 Google reviews (high-traffic venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 1,208 Google (4.2★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.2 rating across 1,208 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Billesley Manor Hotel operates as a credible hotel dining venue with a 4.2/5 Google rating across 1208 reviews — solid but not yet commanding.
...
- **Review momentum.** At 1208 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Online visibility (3.8) hasn't kept pace with guest experience quality (8.0). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 1,208 reviews — statistically robust rating. Individual reviews have negligible impact.
...
| Review Volume | 1208 reviews (High) | Visibility 3.8/10 (Weak) |

## Category & Peer Validation

### Why This Venue Is In This Cohort

Billesley Manor Hotel is classified as **Hotel** (confidence: low). Google's raw category is "Hotel / Accommodation" but the resolved category triangulates across 1 signal sources.
...
- **Premier Inn** (6.8): Hotel restaurant — different occasion type, may not compete for walk-in trade; 3.7 miles away *(marginal comparator)*
- **Ragley Hall Catering** (6.8): Dining with comparable price band; 4.6 miles away
- **Hotel Indigo And The Woodsman** (6.6): Hotel restaurant — different occasion type, may not compete for walk-in trade; 3.6 miles away *(marginal comparator)*
- **Alveston Manor Hotel** (6.5): Hotel restaurant — different occasion type, may not compete for walk-in trade; 4.0 miles away *(marginal comparator)*
- **Crowne Plaza** (6.5): Hotel restaurant — different occasion type, may not compete for walk-in trade; 3.8 miles away *(marginal comparator)*

## Competitive Market Intelligence

**Local market:** 9 direct competitors identified.

Below the median (P22). Customers have higher-rated alternatives nearby (peer avg 6.1, top 6.8).

**Where peers beat you:** Experience (-0.5)
...
You are below the median of your peer set. At 6.0 vs peer average 6.1, competitors are outperforming you. The top performer scores 6.8. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Experience: 8.0 (-0.5 below peer avg 8.6)
...
- Alveston Manor Hotel (6.5) — leads you by 0.5
- Crowne Plaza (6.5) — leads you by 0.4
...
- **Copy / test:** Read their recent positive reviews (3.9/5) for operational clues. Review inspection documentation and sub-score gaps.
...
- Experience: 8.0 (-0.6 below peer avg 8.6)
...
You are below the median of your peer set. At 6.0 vs peer average 6.0, competitors are outperforming you. The top performer scores 6.8. Customers in this area have demonstrably better-rated alternatives.
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.0 | — | 8.6 | -0.5 | Below peers |
| Visibility | 3.8 | — | 3.5 | +0.3 | Above peers |
| Trust | 7.9 | — | 7.8 | +0.1 | In line |
| Conversion | — | — | — | — | No data |
| **Overall** | **6.0** | **—** | | | |
...
**Management note:** At 1208 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 3.0/10 | ⚠️ Significant drag | Last inspected 2024-10-25 (18 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-10-25 (18 months ago). Score starting to decay. Note it but don't escalate. 

**Peer context:** Premier Inn's trust lead (+1.5) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.8 on trust, +0.4 on overall (6.0 → 6.5).
...
### Action 4: Ranked #8 of 10 locally — peers are ahead
**Status:** Stale (4 months) | **Priority:** Medium
...
| Google review count | 1208 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.2★ (1208 reviews) | observed | ✓ |
...
| Last Inspection | 2024-10-25 | FSA | observed |
| Google Rating | 4.2/5 | Google Places API | observed |
| Google Reviews | 1208 | Google Places API | observed |
