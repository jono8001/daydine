# Carluccio's — Monthly Intelligence Report
...
**Overall score: 6.1/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.1) | Weakest: Conversion (3.5)

**Competitive position:** Local Peers (5mi): #3 of 10 (P77.8) — peer avg 5.73, top 6.41
  Catchment (15mi): #5 of 12 (P63.6) — peer avg 5.79, top 6.41
  UK Category Cohort: #5 of 13 (P66.7) — peer avg 5.8, top 6.41
...
Based on publicly observable data for Carluccio's, your current operational gaps are putting an estimated **11–35 covers per week** at risk — representing approximately **£1,320–£8,400 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£660–£4,200/mo); Fix the digital shopfront — you're losing walk-ins (£660–£4,200/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~220–350 | Derived from 516 Google reviews (large venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 516 Google (4.2★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.2 rating across 516 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Carluccio's operates as a credible Italian dining venue with a 4.2/5 Google rating across 516 reviews — solid but not yet commanding.
...
- **Evidence:** `experience=9.07, conversion=3.5`
...
- **Review momentum.** At 516 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: italian_restaurant, breakfast_restaurant, coffee_shop, cafe, food_store, restaurant, store. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: italian_restaurant, breakfast_restaurant, coffee_shop, cafe, food_store, restaurant, store*
...
- **Volume:** 516 reviews — strong base. Rating is stable but a sustained negative pattern could shift it.
...
| Review Volume | 516 reviews (High) | Visibility 3.5/10 (Weak) |
...
Carluccio's is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Italian Restaurant" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | italian_restaurant, breakfast_restaurant, coffee_shop, cafe, food_store, restaurant, store | Primary |
...
- **Corte Campana** (5.7): Dining with comparable price band; 0.2 miles away

## Competitive Market Intelligence

**Local market:** 9 direct competitors identified.

Above the median (P78) but not leading. Peer average is 5.7; the top performer scores 6.4. The gap to the top is closeable.

**Where you lead:** Trust (+1.1), Conversion (+0.7)
...
**Position:** #3 of 10 (Percentile 77.8)

You sit above the median but below the top tier. Your 6.1 compares to a peer average of 5.7. The gap to the top (6.4) is 0.4 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 8.4 (+1.1 above peer avg 7.4)
...
- Pizza Hut Restaurants - Dine In (6.0) — you lead by 0.0
...
- **Wins on:** Conversion (+1.5): more complete operational signals (hours, menu, delivery/takeaway, booking); Experience (+0.6): Google 4.7/5 vs your 4.2/5
...
- **Wins on:** Experience (+0.6): Google 4.7/5 vs your 4.2/5
...
- **Defend:** Defend your conversion readiness (+1.0) — you are easier to book/find and your trust advantage (+0.8).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

### Extended Catchment (11 peers within 15 miles)

**Position:** #5 of 12 (Percentile 63.6)

You sit above the median but below the top tier. Your 6.1 compares to a peer average of 5.8. The gap to the top (6.4) is 0.4 points — closeable with focused improvement on your weakest dimension.
...
**Position:** #5 of 13 (Percentile 66.7)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.1 | — | 8.8 | +0.2 | Strong |
| Visibility | 3.5 | — | 3.5 | +0.1 | Needs work |
| Trust | 8.4 | — | 7.4 | +1.1 | Above peers |
...
**Management note:** At 516 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 5.2/10 | ⚠️ Room to improve | Last inspected 2025-07-02 (9 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-07-02 (9 months ago). Full confidence. No action needed. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.2 on trust, +0.3 on overall (6.1 → 6.4).
...
3 active items: **3 overdue** (6–11 months).
...
| Google review count | 516 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.2★ (516 reviews) | observed | ✓ |
...
| Last Inspection | 2025-07-02 | FSA | observed |
| Google Rating | 4.2/5 | Google Places API | observed |
| Google Reviews | 516 | Google Places API | observed |
...
| Postcode | CV37 6BA | FSA | observed |
| Companies House | — | Not checked | not_assessed |
