# Arden Tandoori — Monthly Intelligence Report
...
**Overall score: 5.8/10** (baseline month — no prior comparison)
 | Strongest: Experience (8.5) | Weakest: Visibility (3.2)

**Competitive position:** Local Peers (5mi): #1 of 2 (P100.0) — peer avg 5.1, top 5.1
  Catchment (15mi): #8 of 14 (P46.2) — peer avg 5.78, top 6.59
  UK Category Cohort: #8 of 17 (P56.2) — peer avg 5.6, top 6.59
...
Based on publicly observable data for Arden Tandoori, your current operational gaps are putting an estimated **7–22 covers per week** at risk — representing approximately **£840–£5,280 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£420–£2,640/mo); Fix the digital shopfront — you're losing walk-ins (£420–£2,640/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~140–220 | Derived from 199 Google reviews (mid venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 199 Google (4.6★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.6 rating across 199 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Arden Tandoori operates as a credible Indian dining venue with a 4.6/5 Google rating across 199 reviews — solid but not yet commanding.
...
Within the local Indian dining market (1 peers), this venue leads the field. The identity is that of a category leader — the venue others are compared against.
...
- **Review momentum.** At 199 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Online visibility (3.2) hasn't kept pace with guest experience quality (8.5). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Unrealised review authority.** At 199 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** 199 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 199 reviews (Moderate) | Visibility 3.2/10 (Weak) |
...
Arden Tandoori is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Indian Restaurant" but the resolved category triangulates across 2 signal sources.
...
- **Curry Republic** (5.1): Takeaway-focused — different service model; 0.2 miles away *(weak comparator)*

## Competitive Market Intelligence

**Local market:** 1 direct competitors identified.

You are in the top quintile (P100). The competitive risk is complacency — the nearest competitor scores 5.1.

**Where you lead:** Trust (+1.8), Experience (+1.2), Visibility (+0.6)
**Where peers beat you:** Conversion (-1.5)

### Competitive Position

| Competitor | Score | Google Rating | Reviews |
|---|---|---|---|
| Curry Republic | 5.1 | 4.5★ | 126 |
...
You are in the top quintile of this peer set. Your overall score of 5.8 exceeds the peer average of 5.1 by 0.7 points. The competitive risk here is complacency — the nearest competitor scores 5.1.

**Dimension gaps vs peers:**

- Trust: 7.7 (+1.8 above peer avg 5.9)
- Experience: 8.5 (+1.2 above peer avg 7.3)
- Visibility: 3.2 (+0.6 above peer avg 2.6)
- Conversion: 3.5 (-1.5 below peer avg 5.0)

**Closest competitors:**

- Curry Republic (5.1) — you lead by 0.7

### Competitor Strategy

**Shah's** (signal-backed)

- **Wins on:** Experience (+1.2): Google 4.7/5 vs your 4.6/5
...
- **Wins on:** Conversion (+1.5): more complete operational signals (hours, menu, delivery/takeaway, booking); Experience (+0.7): higher composite experience score from rating + compliance signals
...
You are below the median of your peer set. At 5.8 vs peer average 5.8, competitors are outperforming you. The top performer scores 6.6. Customers in this area have demonstrably better-rated alternatives.

**Closest competitors:**

- Simla Takeaway (6.6) — leads you by 0.8
- Cardamom (6.6) — leads you by 0.8
- Avon Spice (6.4) — leads you by 0.6
- Shah's (6.3) — leads you by 0.5
- Hussains (6.2) — leads you by 0.4

### UK Category Cohort (16 peers in Indian Restaurant)

**Position:** #8 of 17 (Percentile 56.2)

You sit above the median but below the top tier. Your 5.8 compares to a peer average of 5.6. The gap to the top (6.6) is 0.8 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 7.7 (+0.7 above peer avg 7.0)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.5 | — | 7.3 | +1.2 | Above peers |
| Visibility | 3.2 | — | 2.6 | +0.6 | Above peers |
| Trust | 7.7 | — | 5.9 | +1.8 | Clear strength |
...
**Assessment: Strong.** This is a genuine competitive strength at 8.5.
 You lead peers by 1.2 points (peer avg 7.3).
...
**Management note:** At 199 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Adequate.** At 7.7, this is functional but not distinctive.
 You lead peers by 1.8 points (peer avg 5.9).
...
| Inspection Recency | 4.2/10 | ⚠️ Significant drag | Last inspected 2025-03-31 (12 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-03-31 (12 months ago). Score starting to decay. Note it but don't escalate. 

**Peer context:** Curry Republic's trust lead (+1.8) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.4 on trust, +0.4 on overall (5.8 → 6.2).
...
| Google review count | 199 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.6★ (199 reviews) | observed | ✓ |
...
| Last Inspection | 2025-03-31 | FSA | observed |
| Google Rating | 4.6/5 | Google Places API | observed |
| Google Reviews | 199 | Google Places API | observed |
