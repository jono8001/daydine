# Hotel Indigo And The Woodsman — Monthly Intelligence Report
...
**Overall score: 6.6/10** (baseline month — no prior comparison)
 | Strongest: Experience (8.6) | Weakest: Visibility (3.7)

**Competitive position:** Local Peers (5mi): #2 of 9 (P87.5) — peer avg 5.96, top 6.78
  Catchment (15mi): #4 of 15 (P78.6) — peer avg 6.04, top 6.78
  UK Category Cohort: #4 of 17 (P81.2) — peer avg 6.0, top 6.78
...
Based on publicly observable data for Hotel Indigo And The Woodsman, your current operational gaps are putting an estimated **10–35 covers per week** at risk — representing approximately **£1,160–£8,400 per month** in lost or leaked revenue. The main drivers are: Publish opening hours — you're invisible to 'open now' searches (£580–£4,200/mo); Get your menu online — 77% of diners check before visiting (£580–£4,200/mo); Protect the 4.7/5 rating — it took years to build (discovery protection). Taking action on **Publish opening hours — you're invisible to 'open now' searches** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~320–500 | Derived from 826 Google reviews (high-traffic venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 826 Google (4.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.7 rating across 826 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Hotel Indigo And The Woodsman is a well-established hotel dining venue with a strong public reputation — 4.7/5 across 826 Google reviews. That volume means the reputation is earned, not manufactured.
...
With 826 reviews at 4.7/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 826 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: hotel, wedding_venue, event_venue, lodging, service. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: hotel, wedding_venue, event_venue, lodging, service*
...
Online visibility (3.7) hasn't kept pace with guest experience quality (8.6). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 826 reviews — strong base. Rating is stable but a sustained negative pattern could shift it.
...
| Review Volume | 826 reviews (High) | Visibility 3.7/10 (Weak) |
...
Hotel Indigo And The Woodsman is classified as **Hotel** (confidence: low). Google's raw category is "Hotel / Accommodation" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | hotel, wedding_venue, event_venue, lodging, service | Primary |
...
- **Alveston Manor Hotel** (6.5): Hotel restaurant — different occasion type, may not compete for walk-in trade; 0.5 miles away *(marginal comparator)*
- **Crowne Plaza** (6.5): Hotel restaurant — different occasion type, may not compete for walk-in trade; 0.4 miles away *(marginal comparator)*
- **Premier Inn** (6.4): Hotel restaurant — different occasion type, may not compete for walk-in trade; 0.9 miles away *(marginal comparator)*
- **Stratford Manor Hotel** (6.2): Hotel restaurant — different occasion type, may not compete for walk-in trade; 3.1 miles away *(marginal comparator)*

## Competitive Market Intelligence

**Local market:** 8 direct competitors identified.

You are in the top quintile (P88). The competitive risk is complacency — the nearest competitor scores 6.8.

**Where you lead:** Trust (+0.5)
...
**Position:** #2 of 9 (Percentile 87.5)

You are in the top quintile of this peer set. Your overall score of 6.6 exceeds the peer average of 6.0 by 0.6 points. The competitive risk here is complacency — the nearest competitor scores 6.8.
...
- Premier Inn (6.8) — leads you by 0.2
- Alveston Manor Hotel (6.5) — you lead by 0.0
- Crowne Plaza (6.5) — you lead by 0.1
- Premier Inn (6.4) — you lead by 0.1
- Stratford Manor Hotel (6.2) — you lead by 0.4
...
- **Wins on:** Experience (+0.6): higher composite experience score from rating + compliance signals
...
- Trust: 8.4 (+0.6 above peer avg 7.8)

**Closest competitors:**

- Premier Inn (6.8) — leads you by 0.2
- Ragley Hall Catering (6.8) — leads you by 0.2
- Studley Castle (6.7) — leads you by 0.1
- Alveston Manor Hotel (6.5) — you lead by 0.0
- Crowne Plaza (6.5) — you lead by 0.1

### UK Category Cohort (16 peers in Hotel / Accommodation)

**Position:** #4 of 17 (Percentile 81.2)

You are in the top quintile of this peer set. Your overall score of 6.6 exceeds the peer average of 6.0 by 0.6 points. The competitive risk here is complacency — the nearest competitor scores 6.8.

**Dimension gaps vs peers:**

- Trust: 8.4 (+0.7 above peer avg 7.7)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.6 | — | 8.2 | +0.4 | Above peers |
...
**Management note:** At 826 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Biggest drag:** Inspection Recency. Last inspected 2025-01-21 (15 months ago). Score starting to decay. Note it but don't escalate. 

**Peer context:** Premier Inn's trust lead (+1.2) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
| Google review count | 826 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.7★ (826 reviews) | observed | ✓ |
...
| Google Reviews | 826 | Google Places API | observed |
...
| Postcode | CV37 6HA | FSA | observed |
| Companies House | — | Not checked | not_assessed |
