# Chopstix South — Monthly Intelligence Report
...
**Overall score: 4.8/10** (baseline month — no prior comparison)
 | Strongest: Trust (7.9) | Weakest: Visibility (2.4)

**Competitive position:** Catchment (15mi): #2 of 2 (P0.0) — peer avg 5.22, top 5.22
  UK Category Cohort: #2 of 2 (P0.0) — peer avg 5.22, top 5.22
...
| Aggregate signals | Rating and volume from all platforms | 39 Google (3★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 3 rating across 39 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Chopstix South operates in the asian restaurant category with a public rating of 3.0/5 that is currently limiting discovery.
...
At 3/5 on Google, something specific is landing badly. Read the 5 most recent negative reviews, identify the common thread, and fix it at source. The rating won't move until the root cause does.
...
- **Review momentum.** At 39 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
**0 of 7** demand capture dimensions are clear. **6** have friction. **1** are missing.
...
Only 8 photos vs peer average of ~10. Low photo count suppresses click-through.

**Commercial consequence:** Venues with 10+ photos get ~35% more click-throughs (Google data).

*Signals: Photo count: 8; Peer average: ~10 photos*

### Proposition Clarity [PARTIAL]

Insufficient review data to cross-reference proposition. Google types show: noodle_shop, restaurant, service. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: noodle_shop, restaurant, service*
...
**Discovery suppression.** A 3.0/5 Google rating actively prevents customers from finding you. Google deprioritises sub-4.0 venues, and most customers filter by 4+ stars. Until this lifts, all other investment underperforms because fewer people see it.
...
- **Volume:** Only 39 reviews — rating is volatile. A single 1-star review moves the average measurably.
- **Rating position:** 3/5 actively suppresses discovery. Google deprioritises sub-3.5 venues.
...
|--------|-------------|---------------------|
| Customer Rating | 3.0/5 Google (Weak) | Experience 6.6/10 (Adequate) — Gap |
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 7.9/10 (Adequate) |
| Review Volume | 39 reviews (Low) | Visibility 2.4/10 (Weak) |
...
Chopstix South is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Asian Restaurant" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | noodle_shop, restaurant, service | Primary |
...
You are below the median of your peer set. At 4.8 vs peer average 5.2, competitors are outperforming you. The top performer scores 5.2. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Trust: 7.9 (+0.9 above peer avg 7.1)
- Visibility: 2.4 (-0.8 below peer avg 3.2)
- Experience: 6.6 (-1.5 below peer avg 8.1)

**Closest competitors:**

- Four Seasons Pho Limited (5.2) — leads you by 0.4
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 6.6 | — | — | — | In line |
| Visibility | 2.4 | — | — | — | Needs work |
| Trust | 7.9 | — | — | — | In line |
...
**Management note:** At 39 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 3.7/10 | ⚠️ Significant drag | Last inspected 2025-02-05 (14 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-02-05 (14 months ago). Score starting to decay. Note it but don't escalate. 
...
|-----------|---------|---------------------|--------|
| Google star rating | 3.0/5 | Drop below 3.0 = experience drift; rise = guest improvements landing | Google Maps |
| Google review count | 39 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 3.0★ (39 reviews) | observed | ✓ |
...
| Last Inspection | 2025-02-05 | FSA | observed |
| Google Rating | 3.0/5 | Google Places API | observed |
| Google Reviews | 39 | Google Places API | observed |
| Google Photos | 8 | Google Places API | observed |
