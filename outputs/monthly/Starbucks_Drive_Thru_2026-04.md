# Starbucks Drive Thru — Monthly Intelligence Report
...
**Overall score: 6.4/10** (baseline month — no prior comparison)
 | Strongest: Trust (9.8) | Weakest: Visibility (3.6)

**Competitive position:** Local Peers (5mi): #1 of 2 (P100.0) — peer avg 5.48, top 5.48
  Catchment (15mi): #2 of 10 (P88.9) — peer avg 5.61, top 6.43
  UK Category Cohort: #2 of 11 (P90.0) — peer avg 5.68, top 6.43
...
Based on publicly observable data for Starbucks Drive Thru, your current operational gaps are putting an estimated **4–18 covers per week** at risk — representing approximately **£920–£8,400 per month** in lost or leaked revenue. The main drivers are: Identify and fix the recurring guest complaint (£400–£4,200/mo); Get your menu online — 77% of diners check before visiting (£260–£2,100/mo); Fix the digital shopfront — you're losing walk-ins (£260–£2,100/mo). Taking action on **Identify and fix the recurring guest complaint** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~220–350 | Derived from 587 Google reviews (large venue indicator), price level ££ |
| Average spend per head | ~£22 | UK hospitality benchmark for price level ££ |
| Covers at risk per week | 4–18 | Conversion score 5.0/10 → 2%–5% leakage |
| Weekly revenue at risk | £230–£2,100 | Recoverable with priority action fixes |
| Monthly revenue at risk | £920–£8,400 | Aggregate across top 3 priorities |
| Annual projection | £11,040–£100,800 | If current gaps persist 12 months |
...
| Aggregate signals | Rating and volume from all platforms | 587 Google (3.4★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 3.4 rating across 587 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Starbucks Drive Thru operates in the quick-service food category with a public rating of 3.4/5 that is currently limiting discovery.
...
Within the local quick-service food market (1 peers), this venue leads the field. The identity is that of a category leader — the venue others are compared against.
...
At 3.4/5 on Google, something specific is landing badly. Read the 5 most recent negative reviews, identify the common thread, and fix it at source. The rating won't move until the root cause does.
...
- **Evidence:** `experience=8.13, conversion=5.0`
...
- **Review momentum.** At 587 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: coffee_shop, tea_store, coffee_stand, sandwich_shop, cafe, meal_takeaway, tea_house, food_store, restaurant, store. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: coffee_shop, tea_store, coffee_stand, sandwich_shop, cafe, meal_takeaway, tea_house, food_store, restaurant, store*
...
**Discovery suppression.** A 3.4/5 Google rating actively prevents customers from finding you. Google deprioritises sub-4.0 venues, and most customers filter by 4+ stars. Until this lifts, all other investment underperforms because fewer people see it.

### Secondary Drag

Online visibility (3.6) hasn't kept pace with guest experience quality (8.1). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 587 reviews — strong base. Rating is stable but a sustained negative pattern could shift it.
- **Rating position:** 3.4/5 actively suppresses discovery. Google deprioritises sub-3.5 venues.
...
|--------|-------------|---------------------|
| Customer Rating | 3.4/5 Google (Weak) | Experience 8.1/10 (Strong) — Gap |
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 9.8/10 (Strong) |
| Review Volume | 587 reviews (High) | Visibility 3.6/10 (Weak) |
...
Starbucks Drive Thru is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Fast Food / Quick Service" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | coffee_shop, tea_store, coffee_stand, sandwich_shop, cafe, meal_takeaway, tea_house, food_store, restaurant, store | Primary |
...
- **Burger King - Southbound** (5.5): Dining with comparable price band; 0.0 miles away

## Competitive Market Intelligence

**Local market:** 1 direct competitors identified.

You are in the top quintile (P100). The competitive risk is complacency — the nearest competitor scores 5.5.

**Where you lead:** Conversion (+2.5), Trust (+1.9)

### Competitive Position

| Competitor | Score | Google Rating | Reviews |
|---|---|---|---|
| Burger King - Southbound | 5.5 | 4.0★ | 10,079 |
...
You are in the top quintile of this peer set. Your overall score of 6.4 exceeds the peer average of 5.5 by 0.9 points. The competitive risk here is complacency — the nearest competitor scores 5.5.

**Dimension gaps vs peers:**

- Conversion: 5.0 (+2.5 above peer avg 2.5)
- Trust: 9.8 (+1.9 above peer avg 7.9)

**Closest competitors:**

- Burger King - Southbound (5.5) — you lead by 0.9
...
You are in the top quintile of this peer set. Your overall score of 6.4 exceeds the peer average of 5.6 by 0.8 points. The competitive risk here is complacency — the nearest competitor scores 6.4.

**Dimension gaps vs peers:**

- Trust: 9.8 (+2.4 above peer avg 7.4)
- Conversion: 5.0 (+1.1 above peer avg 3.9)

**Closest competitors:**

- The Kingfisher FishBar (6.4) — leads you by 0.1
- Starbucks (6.3) — you lead by 0.1
- The Food Of Love (6.2) — you lead by 0.2
- GAIL's Stratford-Upon-Avon (5.8) — you lead by 0.6
- The Long Itch Diner (5.7) — you lead by 0.7

### UK Category Cohort (10 peers in Fast Food / Quick Service)

**Position:** #2 of 11 (Percentile 90.0)

You are in the top quintile of this peer set. Your overall score of 6.4 exceeds the peer average of 5.7 by 0.7 points. The competitive risk here is complacency — the nearest competitor scores 6.4.

**Dimension gaps vs peers:**

- Trust: 9.8 (+2.2 above peer avg 7.5)
...
- The Kingfisher FishBar (6.4) — leads you by 0.1
- Starbucks (6.3) — you lead by 0.1
- Bruno's Bakery (6.3) — you lead by 0.1
- The Food Of Love (6.2) — you lead by 0.2
- GAIL's Stratford-Upon-Avon (5.8) — you lead by 0.6
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.1 | — | 7.8 | +0.3 | Above peers |
| Visibility | 3.6 | — | 4.0 | -0.4 | Below peers |
| Trust | 9.8 | — | 7.9 | +1.9 | Clear strength |
| Conversion | 5.0 | — | 2.5 | +2.5 | Clear strength |
| **Overall** | **6.4** | **—** | | | |
...
**Management note:** At 587 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 9.8.
 You lead peers by 1.9 points (peer avg 7.9).
...
**Assessment: Weak.** At 5.0, this dimension is actively limiting your overall position.
 You lead peers by 2.5 points (peer avg 2.5).
...
| Inspection Recency | 9.2/10 | ✅ Strong | Last inspected 2026-03-02 (1 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2026-03-02 (1 months ago). Full confidence. No action needed. 

**Peer context:** Burger King - Southbound's trust lead (+1.9) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.2 on trust, +0.1 on overall (6.4 → 6.4).
...
|-----------|---------|---------------------|--------|
| Google star rating | 3.4/5 | Drop below 3.4 = experience drift; rise = guest improvements landing | Google Maps |
| Google review count | 587 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 3.4★ (587 reviews) | observed | ✓ |
...
| Last Inspection | 2026-03-02 | FSA | observed |
| Google Rating | 3.4/5 | Google Places API | observed |
| Google Reviews | 587 | Google Places API | observed |
