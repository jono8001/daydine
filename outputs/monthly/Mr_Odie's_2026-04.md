# Mr Odie's — Monthly Intelligence Report
...
**Competitive position:** Local Peers (5mi): #7 of 18 (P64.7) — peer avg 5.48, top 6.64
  Catchment (15mi): #27 of 46 (P42.2) — peer avg 5.73, top 6.78
  UK Category Cohort: #32 of 53 (P40.4) — peer avg 5.79, top 6.92
...
| Aggregate signals | Rating and volume from all platforms | 89 Google (5★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 5 rating across 89 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Mr Odie's is a cafe venue with an adequate public reputation (5.0/5, 89 reviews) that has room to build stronger proof.
...
Online visibility (3.0) hasn't kept pace with guest experience quality (9.0). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
Mr Odie's is classified as **Cafe / Coffee Shop** (confidence: high). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 1 signal sources.
...
- **Shakespaw Cat Cafe** (6.6): Dining with comparable price band; 0.0 miles away
- **No 37 Cafe** (6.3): Dining with comparable price band; 0.1 miles away
...
- **Coffee Clouds** (6.0): Dining with comparable price band; 0.1 miles away

## Competitive Market Intelligence

**Local market:** 17 direct competitors identified.

Above the median (P65) but not leading. Peer average is 5.5; the top performer scores 6.6. The gap to the top is closeable.

**Where you lead:** Experience (+0.7), Trust (+0.6)
...
You sit above the median but below the top tier. Your 5.8 compares to a peer average of 5.5. The gap to the top (6.6) is 0.9 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Experience: 9.0 (+0.7 above peer avg 8.3)
- Trust: 7.8 (+0.6 above peer avg 7.2)
...
- Espresso Barn (6.3) — leads you by 0.6
- Coffee Clouds (6.0) — leads you by 0.2
...
**Coffee Clouds** (signal-backed)

- **Wins on:** Conversion (+1.0): more complete operational signals (hours, menu, delivery/takeaway, booking); Trust (+0.5): same FSA rating but likely stronger sub-scores or more recent inspection
...
**Position:** #27 of 46 (Percentile 42.2)

You are below the median of your peer set. At 5.8 vs peer average 5.7, competitors are outperforming you. The top performer scores 6.8. Customers in this area have demonstrably better-rated alternatives.
...
**Position:** #32 of 53 (Percentile 40.4)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.0 | — | 8.3 | +0.7 | Above peers |
| Visibility | 3.0 | — | 3.4 | -0.4 | Below peers |
| Trust | 7.8 | — | 7.2 | +0.6 | Above peers |
...
**Assessment: Adequate.** At 7.8, this is functional but not distinctive.
 Slightly above peer average (7.2).
...
| Inspection Recency | 4.7/10 | ⚠️ Significant drag | Last inspected 2025-05-16 (11 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-05-16 (11 months ago). Full confidence. No action needed. 

**Peer context:** Shakespaw Cat Cafe's trust lead (+1.8) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.3 on trust, +0.3 on overall (5.8 → 6.1).
...
| Google Business Profile | 5.0★ (89 reviews) | observed | ✓ |
...
| Last Inspection | 2025-05-16 | FSA | observed |
