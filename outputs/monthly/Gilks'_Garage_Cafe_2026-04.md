# Gilks' Garage Cafe — Monthly Intelligence Report
...
**Overall score: 6.7/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.8) | Weakest: Conversion (3.5)

**Competitive position:** Local Peers (5mi): #4 of 8 (P57.1) — peer avg 6.28, top 6.78
  Catchment (15mi): #5 of 41 (P90.0) — peer avg 5.78, top 6.92
  UK Category Cohort: #6 of 53 (P90.4) — peer avg 5.77, top 6.92
...
Based on publicly observable data for Gilks' Garage Cafe, your current operational gaps are putting an estimated **16–50 covers per week** at risk — representing approximately **£1,920–£12,000 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£960–£6,000/mo); Fix the digital shopfront — you're losing walk-ins (£960–£6,000/mo); Protect the 4.8/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~320–500 | Derived from 935 Google reviews (high-traffic venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 935 Google (4.8★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.8 rating across 935 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Gilks' Garage Cafe is a well-established cafe venue with a strong public reputation — 4.8/5 across 935 Google reviews. That volume means the reputation is earned, not manufactured.
...
- **Evidence:** `experience=9.77, conversion=3.5`
...
With 935 reviews at 4.8/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 935 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Online visibility (3.8) hasn't kept pace with guest experience quality (9.8). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 935 reviews — strong base. Rating is stable but a sustained negative pattern could shift it.
...
| Review Volume | 935 reviews (High) | Visibility 3.8/10 (Weak) |
...
Gilks' Garage Cafe is classified as **Cafe / Coffee Shop** (confidence: high). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 3 signal sources.
...
| Name | "Gilks' Garage Cafe" contains "cafe" | Supportive |

**Resolved category:** Cafe / Coffee Shop (confidence: high)

### Peer Justification

- **South Costa** (6.8): Dining with comparable price band; 2.8 miles away
- **Building 523 Costa And Kitchen** (6.8): Dining with comparable price band; 2.8 miles away
- **Dec X Canteen** (6.7): Dining with comparable price band; 2.8 miles away
- **Nel's At The Pavilion** (6.6): Dining with similar price band; 3.3 miles away
- **Ettington Garden Cafe** (6.2): Dining with comparable price band; 4.6 miles away

## Competitive Market Intelligence

**Local market:** 7 direct competitors identified.

Above the median (P57) but not leading. Peer average is 6.3; the top performer scores 6.8. The gap to the top is closeable.

**Where you lead:** Trust (+1.0), Experience (+0.7), Conversion (+0.5)

*Commercial implication: you capture an adequate share of a 8-venue market, but the gap to the top (6.8) represents demand you could win. Closing the gap typically requires 1–2 targeted dimension improvements (indicative).*
...
You sit above the median but below the top tier. Your 6.7 compares to a peer average of 6.3. The gap to the top (6.8) is 0.1 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 9.2 (+1.0 above peer avg 8.2)
- Experience: 9.8 (+0.7 above peer avg 9.1)
...
- Ettington Garden Cafe (6.2) — you lead by 0.5
...
- **Why it matters:** You are closely matched — small improvements on either side shift the balance.
- **Copy / test:** No clear action to copy — maintain current standards.
- **Defend:** Defend your trust advantage (+1.6).
- *Based on Google rating/reviews, FSA record, 3 dimension scores*

### Extended Catchment (40 peers within 15 miles)

**Position:** #5 of 41 (Percentile 90.0)

You are in the top quintile of this peer set. Your overall score of 6.7 exceeds the peer average of 5.8 by 0.9 points. The competitive risk here is complacency — the nearest competitor scores 6.9.

**Dimension gaps vs peers:**

- Trust: 9.2 (+1.6 above peer avg 7.6)
- Experience: 9.8 (+1.0 above peer avg 8.8)
- Conversion: 3.5 (+0.6 above peer avg 2.9)
- Visibility: 3.8 (+0.5 above peer avg 3.2)
...
- Building 523 Costa And Kitchen (6.8) — leads you by 0.1
- Dec X Canteen (6.7) — leads you by 0.0
- Shakespaw Cat Cafe (6.6) — you lead by 0.0

### UK Category Cohort (52 peers in Cafe / Coffee Shop)

**Position:** #6 of 53 (Percentile 90.4)

You are in the top quintile of this peer set. Your overall score of 6.7 exceeds the peer average of 5.8 by 0.9 points. The competitive risk here is complacency — the nearest competitor scores 6.9.

**Dimension gaps vs peers:**

- Trust: 9.2 (+1.7 above peer avg 7.5)
- Experience: 9.8 (+0.9 above peer avg 8.9)
- Conversion: 3.5 (+0.6 above peer avg 2.9)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.8 | — | 9.1 | +0.7 | Above peers |
| Visibility | 3.8 | — | 3.5 | +0.2 | Needs work |
| Trust | 9.2 | — | 8.2 | +1.0 | Above peers |
...
**Management note:** At 935 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 9.2.
 You lead peers by 1.0 points (peer avg 8.2).
...
| Inspection Recency | 6.8/10 | ⚠️ Room to improve | Last inspected 2025-10-23 (6 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-10-23 (6 months ago). Full confidence. No action needed. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.8 on trust, +0.2 on overall (6.7 → 6.9).
...
| Google review count | 935 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.8★ (935 reviews) | observed | ✓ |
...
| Last Inspection | 2025-10-23 | FSA | observed |
| Google Rating | 4.8/5 | Google Places API | observed |
| Google Reviews | 935 | Google Places API | observed |
...
| Postcode | CV35 0JZ | FSA | observed |
| Companies House | — | Not checked | not_assessed |
