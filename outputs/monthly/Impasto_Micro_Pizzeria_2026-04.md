...
**Competitive position:** Local Peers (5mi): #5 of 10 (P55.6) — peer avg 5.76, top 6.41
  ...
  UK Category Cohort: #8 of 13 (P41.7) — peer avg 5.83, top 6.41
...
### Priority 3: Lean into food quality — it's what guests are buying [EXPLOIT | NEW]
...
- Corte Campana (5.7) — you lead by 0.0

### Competitor Strategy

**Soma** (signal-backed)

- **Wins on:** Trust (+0.7): same FSA rating but likely stronger sub-scores or more recent inspection; Experience (+0.7): higher composite experience score from rating + compliance signals
...
- **Wins on:** Conversion (+1.0): more complete operational signals (hours, menu, delivery/takeaway, booking); Trust (+0.7): same FSA rating but likely stronger sub-scores or more recent inspection
...
**Review 1** | Google | Undated | 5★ | positive
...
**Review 2** | Google | Undated | 5★ | positive | Food Quality
