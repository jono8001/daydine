# NO4 Bar And Restaurant — Monthly Intelligence Report
...
**Competitive position:** Local Peers (5mi): #5 of 8 (P42.9) — peer avg 5.78, top 6.91
  Catchment (15mi): #8 of 14 (P46.2) — peer avg 5.67, top 6.91
  UK Category Cohort: #9 of 15 (P42.9) — peer avg 5.73, top 6.91
...
| Aggregate signals | Rating and volume from all platforms | 184 Google (4.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.7 rating across 184 Google reviews is the reputation bedrock and is factored into scoring separately.
...
NO4 Bar And Restaurant operates as a credible restaurant venue with a 4.7/5 Google rating across 184 reviews — solid but not yet commanding.
...
Online visibility (3.2) hasn't kept pace with guest experience quality (8.6). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
NO4 Bar And Restaurant is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Restaurant (General)" but the resolved category triangulates across 2 signal sources.
...
| Name | "NO4 Bar And Restaurant" contains "restaurant" | Supportive |

**Resolved category:** Restaurant (General) (confidence: medium)

### Peer Justification

- **11/17 Salt Beef Bar** (6.9): Dining with comparable price band; 0.2 miles away
- **Red Hot Mamma Pizzeria** (6.3): Dining with comparable price band; 0.2 miles away
- **Bannatyne Health Club And Spa Wildmoor** (5.8): Dining with comparable price band; 2.1 miles away
- **Fast Flavour** (5.8): Dining with comparable price band; 0.2 miles away
- **Lily's** (5.6): Dining with comparable price band; 0.4 miles away

## Competitive Market Intelligence

**Local market:** 7 direct competitors identified.

Below the median (P43). Customers have higher-rated alternatives nearby (peer avg 5.8, top 6.9).
...
- 11/17 Salt Beef Bar (6.9) — leads you by 1.2
- Red Hot Mamma Pizzeria (6.3) — leads you by 0.6
- Bannatyne Health Club And Spa Wildmoor (5.8) — leads you by 0.1
- Fast Flavour (5.8) — leads you by 0.1
- Lily's (5.6) — you lead by 0.1
...
- **Defend:** Defend your 184-review advantage vs their 27 (discovery moat).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*
...
You are below the median of your peer set. At 5.7 vs peer average 5.7, competitors are outperforming you. The top performer scores 6.9. Customers in this area have demonstrably better-rated alternatives.

**Closest competitors:**

- 11/17 Salt Beef Bar (6.9) — leads you by 1.2
- Lithos Restaurant (6.5) — leads you by 0.8
- The Bluebell (6.4) — leads you by 0.7
- Red Hot Mamma Pizzeria (6.3) — leads you by 0.6
- The Bridge (6.0) — leads you by 0.2

### UK Category Cohort (14 peers in Restaurant (General))

**Position:** #9 of 15 (Percentile 42.9)
...
| Visibility | 3.2 | — | 3.0 | +0.2 | Needs work |
| Trust | 7.9 | — | 8.0 | -0.1 | In line |
...
| Inspection Recency | 3.5/10 | ⚠️ Significant drag | Last inspected 2025-01-13 (15 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-01-13 (15 months ago). Score starting to decay. Note it but don't escalate. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.6 on trust, +0.4 on overall (5.7 → 6.1).
...
| Google Business Profile | 4.7★ (184 reviews) | observed | ✓ |
...
| Last Inspection | 2025-01-13 | FSA | observed |
...
| Postcode | CV37 6YY | FSA | observed |
| Companies House | — | Not checked | not_assessed |
