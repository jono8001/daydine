# Premier Inn — Monthly Intelligence Report
...
**Overall score: 6.8/10** (baseline month — no prior comparison)
 | Strongest: Trust (9.3) | Weakest: Visibility (3.7)

**Competitive position:** Local Peers (5mi): #1 of 9 (P100.0) — peer avg 5.93, top 6.56
  Catchment (15mi): #1 of 15 (P100.0) — peer avg 6.03, top 6.76
  UK Category Cohort: #1 of 17 (P100.0) — peer avg 5.98, top 6.76
...
Based on publicly observable data for Premier Inn, your current operational gaps are putting an estimated **10–35 covers per week** at risk — representing approximately **£1,160–£8,400 per month** in lost or leaked revenue. The main drivers are: Publish opening hours — you're invisible to 'open now' searches (£580–£4,200/mo); Get your menu online — 77% of diners check before visiting (£580–£4,200/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Publish opening hours — you're invisible to 'open now' searches** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~320–500 | Derived from 860 Google reviews (high-traffic venue indicator), price level ££ |
| Average spend per head | ~£22 | UK hospitality benchmark for price level ££ |
| Covers at risk per week | 10–35 | Default 3–7% leakage (no conversion score) |
| Weekly revenue at risk | £290–£2,100 | Recoverable with priority action fixes |
| Monthly revenue at risk | £1,160–£8,400 | Aggregate across top 3 priorities |
| Annual projection | £13,920–£100,800 | If current gaps persist 12 months |
...
| Aggregate signals | Rating and volume from all platforms | 860 Google (4.1★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.1 rating across 860 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Premier Inn operates as a credible hotel dining venue with a 4.1/5 Google rating across 860 reviews — solid but not yet commanding.
...
Within the local hotel dining market (8 peers), this venue leads the field. The identity is that of a category leader — the venue others are compared against.
...
- **Review momentum.** At 860 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: hotel, inn, bed_and_breakfast, lodging, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: hotel, inn, bed_and_breakfast, lodging, restaurant*
...
Online visibility (3.7) hasn't kept pace with guest experience quality (8.9). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 860 reviews — strong base. Rating is stable but a sustained negative pattern could shift it.
...
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 9.3/10 (Strong) |
| Review Volume | 860 reviews (High) | Visibility 3.7/10 (Weak) |

## Category & Peer Validation

### Why This Venue Is In This Cohort

Premier Inn is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Hotel / Accommodation" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | hotel, inn, bed_and_breakfast, lodging, restaurant | Primary |
...
- **Alveston Manor Hotel** (6.5): Hotel restaurant — different occasion type, may not compete for walk-in trade; 0.4 miles away *(marginal comparator)*
...
- **Premier Inn** (6.4): Hotel restaurant — different occasion type, may not compete for walk-in trade; 0.8 miles away *(marginal comparator)*
- **Stratford Manor Hotel** (6.2): Hotel restaurant — different occasion type, may not compete for walk-in trade; 2.9 miles away *(marginal comparator)*

## Competitive Market Intelligence

**Local market:** 8 direct competitors identified.

You are in the top quintile (P100). The competitive risk is complacency — the nearest competitor scores 6.6.

**Where you lead:** Trust (+1.5), Experience (+0.8)
...
You are in the top quintile of this peer set. Your overall score of 6.8 exceeds the peer average of 5.9 by 0.9 points. The competitive risk here is complacency — the nearest competitor scores 6.6.

**Dimension gaps vs peers:**

- Trust: 9.3 (+1.5 above peer avg 7.8)
- Experience: 8.9 (+0.8 above peer avg 8.2)

**Closest competitors:**

- Hotel Indigo And The Woodsman (6.6) — you lead by 0.2
- Alveston Manor Hotel (6.5) — you lead by 0.3
- Crowne Plaza (6.5) — you lead by 0.3
- Premier Inn (6.4) — you lead by 0.4
- Stratford Manor Hotel (6.2) — you lead by 0.6
...
- **Wins on:** Experience (+0.6): Google 4.6/5 vs your 4.1/5
...
- **Defend:** Defend your trust advantage (+1.5).
- *Based on Google rating/reviews, FSA record, 3 dimension scores*
...
You are in the top quintile of this peer set. Your overall score of 6.8 exceeds the peer average of 6.0 by 0.8 points. The competitive risk here is complacency — the nearest competitor scores 6.8.

**Dimension gaps vs peers:**

- Trust: 9.3 (+1.6 above peer avg 7.7)

**Closest competitors:**

- Ragley Hall Catering (6.8) — you lead by 0.0
- Studley Castle (6.7) — you lead by 0.1
- Hotel Indigo And The Woodsman (6.6) — you lead by 0.2
- Alveston Manor Hotel (6.5) — you lead by 0.3
- Crowne Plaza (6.5) — you lead by 0.3
...
- Trust: 9.3 (+1.7 above peer avg 7.6)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.9 | — | 8.2 | +0.8 | Above peers |
| Visibility | 3.7 | — | 3.9 | -0.1 | Needs work |
| Trust | 9.3 | — | 7.8 | +1.5 | Clear strength |
| Conversion | — | — | — | — | No data |
| **Overall** | **6.8** | **—** | | | |
...
**Management note:** At 860 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 9.3.
 You lead peers by 1.5 points (peer avg 7.8).
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.3 on trust, +0.1 on overall (6.8 → 6.8).
...
| Google review count | 860 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.1★ (860 reviews) | observed | ✓ |
...
| Google Reviews | 860 | Google Places API | observed |
...
| Postcode | CV37 6UQ | FSA | observed |
| Companies House | — | Not checked | not_assessed |
