# The George Hotel — Monthly Intelligence Report
...
**Overall score: 6.0/10** (baseline month — no prior comparison)
 | Strongest: Experience (8.4) | Weakest: Conversion (3.5)

**Competitive position:** Catchment (15mi): #6 of 7 (P16.7) — peer avg 6.38, top 6.83
  UK Category Cohort: #6 of 7 (P16.7) — peer avg 6.38, top 6.83
...
Based on publicly observable data for The George Hotel, your current operational gaps are putting an estimated **16–50 covers per week** at risk — representing approximately **£1,920–£12,000 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£960–£6,000/mo); Fix the digital shopfront — you're losing walk-ins (£960–£6,000/mo); Protect the 4.5/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~320–500 | Derived from 1,034 Google reviews (high-traffic venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 1,034 Google (4.5★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.5 rating across 1,034 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The George Hotel is a well-established British dining venue with a strong public reputation — 4.5/5 across 1,034 Google reviews. That volume means the reputation is earned, not manufactured.
...
With 1034 reviews at 4.5/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
Insufficient review data to cross-reference proposition. Google types show: pub, beer_garden, bed_and_breakfast, bar_and_grill, british_restaurant, restaurant, bar, lodging. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: pub, beer_garden, bed_and_breakfast, bar_and_grill, british_restaurant, restaurant, bar, lodging*
...
Online visibility (3.8) hasn't kept pace with guest experience quality (8.4). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
The George Hotel is classified as **Pub / Bar** (confidence: medium). Google's raw category is "British Restaurant" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | pub, beer_garden, bed_and_breakfast, bar_and_grill, british_restaurant, restaurant, bar, lodging | Primary |
...
- Experience: 8.4 (-0.8 below peer avg 9.2)
...
| Google Business Profile | 4.5★ (1034 reviews) | observed | ✓ |
...
| Postcode | CV36 4AJ | FSA | observed |
| Companies House | — | Not checked | not_assessed |
