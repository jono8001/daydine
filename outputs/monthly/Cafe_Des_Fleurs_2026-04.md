# Cafe Des Fleurs — Monthly Intelligence Report
...
**Overall score: 6.2/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.4) | Weakest: Visibility (3.2)

**Competitive position:** Local Peers (5mi): #2 of 6 (P80.0) — peer avg 5.61, top 6.73
  Catchment (15mi): #7 of 15 (P57.1) — peer avg 5.96, top 7.34
  UK Category Cohort: #7 of 19 (P66.7) — peer avg 5.89, top 7.34
...
Based on publicly observable data for Cafe Des Fleurs, your current operational gaps are putting an estimated **7–22 covers per week** at risk — representing approximately **£840–£5,280 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£420–£2,640/mo); Fix the digital shopfront — you're losing walk-ins (£420–£2,640/mo); Protect the 4.5/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~140–220 | Derived from 206 Google reviews (mid venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 206 Google (4.5★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.5 rating across 206 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Cafe Des Fleurs operates as a credible pub dining venue with a 4.5/5 Google rating across 206 reviews — solid but not yet commanding.
...
With 206 reviews at 4.5/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 206 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: cafe, brunch_restaurant, cocktail_bar, breakfast_restaurant, bar, food_store, store, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: cafe, brunch_restaurant, cocktail_bar, breakfast_restaurant, bar, food_store, store, restaurant*
...
Online visibility (3.2) hasn't kept pace with guest experience quality (9.4). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 206 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 8.3/10 (Strong) |
| Review Volume | 206 reviews (Moderate) | Visibility 3.2/10 (Weak) |
...
Cafe Des Fleurs is classified as **Cafe / Coffee Shop** (confidence: high). Google's raw category is "Pub / Bar" but the resolved category triangulates across 3 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | cafe, brunch_restaurant, cocktail_bar, breakfast_restaurant, bar, food_store, store, restaurant | Primary |
| Price Level | ££ (2/4) — Casual dining | Supportive |
| Name | "Cafe Des Fleurs" contains "cafe" | Supportive |

**Resolved category:** Cafe / Coffee Shop (confidence: high)

### Peer Justification

- **Arrow Mill** (6.7): Hotel restaurant — different occasion type, may not compete for walk-in trade; 1.0 miles away *(marginal comparator)*
- **The Bell Inn** (5.9): Pub Dining with similar price band; 4.9 miles away
- **The Alcester Inn** (5.9): Hotel restaurant — different occasion type, may not compete for walk-in trade; 0.4 miles away *(marginal comparator)*
- **The Cottage Of Content** (5.2): Pub Dining with similar price band; 4.0 miles away
- **The Roebuck Inn Alcester** (4.4): Dining with comparable price band; 0.7 miles away

## Competitive Market Intelligence

**Local market:** 5 direct competitors identified.

You are in the top quintile (P80). The competitive risk is complacency — the nearest competitor scores 6.7.

**Where you lead:** Experience (+1.2)
...
You are in the top quintile of this peer set. Your overall score of 6.2 exceeds the peer average of 5.6 by 0.6 points. The competitive risk here is complacency — the nearest competitor scores 6.7.
...
- Arrow Mill (6.7) — leads you by 0.5
- The Bell Inn (5.9) — you lead by 0.3
- The Alcester Inn (5.9) — you lead by 0.4
- The Cottage Of Content (5.2) — you lead by 1.1
- The Roebuck Inn Alcester (4.4) — you lead by 1.9
...
- **Also wins on:** Visibility (+0.8): 1988 Google reviews vs your 206 — they have volume advantage
...
- **Copy / test:** Review inspection documentation and sub-score gaps. Build review volume — they have 1988 to your 206.
...
- **Wins on:** Visibility (+0.6): 1157 Google reviews vs your 206 — they have volume advantage
- **Why it matters:** Their visibility lead means they are easier to find online — this controls top-of-funnel discovery.
- **Copy / test:** Build review volume — they have 1157 to your 206.
- **Defend:** Defend your experience lead (+0.9) — drives repeats and word-of-mouth.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*
...
**Position:** #7 of 15 (Percentile 57.1)

You sit above the median but below the top tier. Your 6.2 compares to a peer average of 6.0. The gap to the top (7.3) is 1.1 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Experience: 9.4 (+0.6 above peer avg 8.8)
- Visibility: 3.2 (-0.7 below peer avg 4.0)

**Closest competitors:**

- Vintner Wine Bar (7.3) — leads you by 1.1
- Arrow Mill (6.7) — leads you by 0.5
- The Fox Inn (6.5) — leads you by 0.2
- The Red Lion (6.4) — leads you by 0.2
- The Townhouse Also Trading As JR Hotel And Restaurants LTD (6.3) — leads you by 0.1

### UK Category Cohort (18 peers in Pub / Bar)

**Position:** #7 of 19 (Percentile 66.7)

You sit above the median but below the top tier. Your 6.2 compares to a peer average of 5.9. The gap to the top (7.3) is 1.1 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Experience: 9.4 (+0.7 above peer avg 8.8)
- Visibility: 3.2 (-0.6 below peer avg 3.8)
...
| Visibility | 3.2 | — | 3.7 | -0.5 | Below peers |
| Trust | 8.3 | — | 8.1 | +0.2 | Strong |
...
**Assessment: Critical.** At 3.2, this represents a material operational gap.
 Slightly below peer average (3.7).
...
**Management note:** At 206 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 6.8/10 | ⚠️ Room to improve | Last inspected 2025-10-20 (6 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-10-20 (6 months ago). Full confidence. No action needed. 

**Peer context:** Arrow Mill's trust lead (+1.4) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.8 on trust, +0.2 on overall (6.2 → 6.4).
...
| Google review count | 206 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.5★ (206 reviews) | observed | ✓ |
...
| Last Inspection | 2025-10-20 | FSA | observed |
| Google Rating | 4.5/5 | Google Places API | observed |
| Google Reviews | 206 | Google Places API | observed |
