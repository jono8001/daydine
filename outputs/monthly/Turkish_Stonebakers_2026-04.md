# Turkish Stonebakers — Monthly Intelligence Report
...
**Do not prioritise:** Protect the 4.8/5 rating — it took years to build

**Overall score: 5.3/10** (baseline month — no prior comparison)
 | Strongest: Experience (8.7) | Weakest: Conversion (2.5)

**Competitive position:** Local Peers (5mi): #2 of 2 (P0.0) — peer avg 5.72, top 5.72
  Catchment (15mi): #2 of 2 (P0.0) — peer avg 5.72, top 5.72
  UK Category Cohort: #2 of 2 (P0.0) — peer avg 5.72, top 5.72
...
| Aggregate signals | Rating and volume from all platforms | 294 Google (4.8★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.8 rating across 294 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Turkish Stonebakers operates as a credible mediterranean restaurant venue with a 4.8/5 Google rating across 294 reviews — solid but not yet commanding.
...
- **Review momentum.** At 294 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: turkish_restaurant, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: turkish_restaurant, restaurant*
...
Online visibility (3.4) hasn't kept pace with guest experience quality (8.7). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 294 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 294 reviews (Moderate) | Visibility 3.4/10 (Weak) |
...
Turkish Stonebakers is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Mediterranean Restaurant" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | turkish_restaurant, restaurant | Primary |

**Resolved category:** Restaurant (General) (confidence: medium)

### Peer Justification

- **Tzatziki34** (5.7): Dining with comparable price band; 4.9 miles away

## Competitive Market Intelligence

**Local market:** 1 direct competitors identified.

Below the median (P0). Customers have higher-rated alternatives nearby (peer avg 5.7, top 5.7).
...
You are below the median of your peer set. At 5.3 vs peer average 5.7, competitors are outperforming you. The top performer scores 5.7. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Experience: 8.7 (+0.8 above peer avg 7.9)
- Trust: 5.9 (-1.4 below peer avg 7.3)

**Closest competitors:**

- Tzatziki34 (5.7) — leads you by 0.4

### Competitor Strategy

**Tzatziki34** (partial)

- **Wins on:** Trust (+1.4): same FSA rating but likely stronger sub-scores or more recent inspection
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.7 | — | 7.9 | +0.8 | Above peers |
| Visibility | 3.4 | — | 3.4 | -0.0 | Needs work |
| Trust | 5.9 | — | 7.3 | -1.4 | Below peers |
...
**Management note:** At 294 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Weak.** At 5.9, this dimension is actively limiting your overall position.
 You trail peers by 1.4 points (peer avg 7.3).
...
| Inspection Recency | 2.2/10 | ⚠️ Significant drag | Last inspected 2024-06-18 (22 months ago). Meaningful score drag. Consider pr... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-06-18 (22 months ago). Meaningful score drag. Consider proactive action. The system discounts older inspections because they carry less certainty.

**Peer context:** Tzatziki34's trust lead (+1.4) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
**Protect the 4.8/5 rating — it took years to build**
...
- **Protect the 4.8/5 rating — it took years to build** — Sustain discovery advantage. Maintain current approach; no active effort required.
...
| Google review count | 294 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.8★ (294 reviews) | observed | ✓ |
...
| Last Inspection | 2024-06-18 | FSA | observed |
| Google Rating | 4.8/5 | Google Places API | observed |
| Google Reviews | 294 | Google Places API | observed |
...
| Postcode | CV35 9NE | FSA | observed |
| Companies House | — | Not checked | not_assessed |
