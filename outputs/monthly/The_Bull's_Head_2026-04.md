# The Bull's Head — Monthly Intelligence Report
...
**Competitive position:** Local Peers (5mi): #1 of 2 (P100.0) — peer avg 6.19, top 6.19
  Catchment (15mi): #6 of 16 (P66.7) — peer avg 5.97, top 7.34
  UK Category Cohort: #6 of 19 (P72.2) — peer avg 5.89, top 7.34
...
Based on publicly observable data for The Bull's Head, your current operational gaps are putting an estimated **11–35 covers per week** at risk — representing approximately **£1,320–£8,400 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£660–£4,200/mo); Fix the digital shopfront — you're losing walk-ins (£660–£4,200/mo); Protect the 4.6/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~220–350 | Derived from 691 Google reviews (large venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 691 Google (4.6★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.6 rating across 691 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Bull's Head is a well-established pub dining venue with a strong public reputation — 4.6/5 across 691 Google reviews. That volume means the reputation is earned, not manufactured.
...
With 691 reviews at 4.6/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 691 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Online visibility (3.6) hasn't kept pace with guest experience quality (9.5). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 691 reviews — strong base. Rating is stable but a sustained negative pattern could shift it.
...
| Review Volume | 691 reviews (High) | Visibility 3.6/10 (Weak) |
...
The Bull's Head is classified as **Pub / Bar** (confidence: medium). Google's raw category is "Pub / Bar" but the resolved category triangulates across 2 signal sources.
...
- **Snitterfield Arms** (6.2): Pub Dining with comparable price band; 4.3 miles away
...
**Where you lead:** Conversion (+1.0), Visibility (+0.6)
**Where peers beat you:** Trust (-0.5)

### Competitive Position

| Competitor | Score | Google Rating | Reviews |
|---|---|---|---|
| Snitterfield Arms | 6.2 | 4.7★ | 102 |
...
You are in the top quintile of this peer set. Your overall score of 6.3 exceeds the peer average of 6.2 by 0.1 points. The competitive risk here is complacency — the nearest competitor scores 6.2.

**Dimension gaps vs peers:**

- Conversion: 3.5 (+1.0 above peer avg 2.5)
- Visibility: 3.6 (+0.6 above peer avg 3.0)
- Trust: 8.2 (-0.5 below peer avg 8.7)
...
- **Defend:** Defend your conversion readiness (+1.0) — you are easier to book/find and your 691-review advantage vs their 102 (discovery moat).
...
**Position:** #6 of 16 (Percentile 66.7)

You sit above the median but below the top tier. Your 6.3 compares to a peer average of 6.0. The gap to the top (7.3) is 1.0 points — closeable with focused improvement on your weakest dimension.
...
- The Townhouse Also Trading As JR Hotel And Restaurants LTD (6.3) — leads you by 0.0

### UK Category Cohort (18 peers in Pub / Bar)

**Position:** #6 of 19 (Percentile 72.2)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.5 | — | 9.7 | -0.1 | Strong |
| Visibility | 3.6 | — | 3.0 | +0.6 | Above peers |
| Trust | 8.2 | — | 8.7 | -0.5 | Below peers |
...
**Management note:** At 691 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.4 on trust, +0.4 on overall (6.3 → 6.7).
...
| Google review count | 691 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.6★ (691 reviews) | observed | ✓ |
...
| Google Reviews | 691 | Google Places API | observed |
