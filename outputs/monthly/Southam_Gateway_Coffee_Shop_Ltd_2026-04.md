# Southam Gateway Coffee Shop Ltd — Monthly Intelligence Report
...
**Overall score: 6.1/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.7) | Weakest: Visibility (3.0)

**Competitive position:** Local Peers (5mi): #2 of 6 (P80.0) — peer avg 5.87, top 6.92
  Catchment (15mi): #11 of 28 (P63.0) — peer avg 5.8, top 6.92
  UK Category Cohort: #20 of 53 (P63.5) — peer avg 5.78, top 6.92
...
Based on publicly observable data for Southam Gateway Coffee Shop Ltd, your current operational gaps are putting an estimated **5–18 covers per week** at risk — representing approximately **£320–£2,160 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£160–£1,080/mo); Fix the digital shopfront — you're losing walk-ins (£160–£1,080/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~100–180 | Derived from 97 Google reviews (small venue indicator), price level £ |
...
| Aggregate signals | Rating and volume from all platforms | 97 Google (4.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.7 rating across 97 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Southam Gateway Coffee Shop Ltd is a cafe venue with an adequate public reputation (4.7/5, 97 reviews) that has room to build stronger proof.
...
- **Review momentum.** At 97 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
- **Unrealised review authority.** At 97 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** Only 97 reviews — rating is volatile. A single 1-star review moves the average measurably.
...
| Review Volume | 97 reviews (Low) | Visibility 3.0/10 (Weak) |
...
Southam Gateway Coffee Shop Ltd is classified as **Cafe / Coffee Shop** (confidence: high). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 3 signal sources.
...
| Name | "Southam Gateway Coffee Shop Ltd" contains "cafe" | Supportive |

**Resolved category:** Cafe / Coffee Shop (confidence: high)

### Peer Justification

- **Puddleduck Cafe Ltd** (6.9): Dining with comparable price band; 2.8 miles away
- **Cafe 16** (6.1): Dining with similar price band; 0.1 miles away
- **Harbury Library Cafe** (5.8): Dining with comparable price band; 3.1 miles away
- **The Tea Shed** (5.7): Dining with comparable price band; 3.0 miles away
- **Bishops Bowls Lake Cafe** (4.8): Dining with comparable price band; 2.5 miles away

## Competitive Market Intelligence

**Local market:** 5 direct competitors identified.

You are in the top quintile (P80). The competitive risk is complacency — the nearest competitor scores 6.9.

**Where you lead:** Experience (+0.9), Conversion (+0.7)
...
You are in the top quintile of this peer set. Your overall score of 6.1 exceeds the peer average of 5.9 by 0.2 points. The competitive risk here is complacency — the nearest competitor scores 6.9.
...
- Cafe 16 (6.1) — you lead by 0.0
- Harbury Library Cafe (5.8) — you lead by 0.2
- The Tea Shed (5.7) — you lead by 0.4
- Bishops Bowls Lake Cafe (4.8) — you lead by 1.3
...
**Harbury Library Cafe** (signal-backed)

- **Wins on:** Trust (see pattern above)
- **Why it matters:** Their trust lead means their compliance record is stronger — this creates a ceiling you hit and they don't.
- **Copy / test:** Review inspection documentation and sub-score gaps.
- **Defend:** Defend your conversion readiness (+1.0) — you are easier to book/find and your experience lead (+0.7) — drives repeats and word-of-mouth.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

### Extended Catchment (27 peers within 15 miles)

**Position:** #11 of 28 (Percentile 63.0)
...
**Position:** #20 of 53 (Percentile 63.5)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.7 | — | 8.7 | +0.9 | Above peers |
| Visibility | 3.0 | — | 2.7 | +0.3 | Above peers |
| Trust | 7.6 | — | 7.8 | -0.1 | In line |
...
**Management note:** At 97 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Peer context:** Puddleduck Cafe Ltd's trust lead (+1.1) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
| Google review count | 97 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.7★ (97 reviews) | observed | ✓ |
...
| Google Reviews | 97 | Google Places API | observed |
