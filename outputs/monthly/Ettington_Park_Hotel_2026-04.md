# Ettington Park Hotel — Monthly Intelligence Report
...
**Competitive position:** Catchment (15mi): #9 of 13 (P33.3) — peer avg 6.14, top 6.78
  UK Category Cohort: #10 of 17 (P43.8) — peer avg 6.02, top 6.78
...
Based on publicly observable data for Ettington Park Hotel, your current operational gaps are putting an estimated **26–75 covers per week** at risk — representing approximately **£3,080–£18,000 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£1,540–£9,000/mo); Fix the digital shopfront — you're losing walk-ins (£1,540–£9,000/mo); Protect the 4.7/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~320–500 | Derived from 1,021 Google reviews (high-traffic venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 1,021 Google (4.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.7 rating across 1,021 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Ettington Park Hotel is a well-established hotel dining venue with a strong public reputation — 4.7/5 across 1,021 Google reviews. That volume means the reputation is earned, not manufactured.
...
With 1021 reviews at 4.7/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 1021 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Online visibility (3.8) hasn't kept pace with guest experience quality (9.7). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 1,021 reviews — statistically robust rating. Individual reviews have negligible impact.
...
| Review Volume | 1021 reviews (High) | Visibility 3.8/10 (Weak) |
...
Ettington Park Hotel is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Hotel / Accommodation" but the resolved category triangulates across 1 signal sources.
...
You are below the median of your peer set. At 6.2 vs peer average 6.1, competitors are outperforming you. The top performer scores 6.8. Customers in this area have demonstrably better-rated alternatives.
...
**Position:** #10 of 17 (Percentile 43.8)
...
- Experience: 9.7 (+1.2 above peer avg 8.5)
...
**Management note:** At 1021 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 3.6/10 | ⚠️ Significant drag | Last inspected 2025-01-15 (15 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-01-15 (15 months ago). Score starting to decay. Note it but don't escalate. 
...
| Google review count | 1021 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.7★ (1021 reviews) | observed | ✓ |
...
| Last Inspection | 2025-01-15 | FSA | observed |
| Google Rating | 4.7/5 | Google Places API | observed |
| Google Reviews | 1021 | Google Places API | observed |
...
| Postcode | CV37 8BU | FSA | observed |
| Companies House | — | Not checked | not_assessed |
