# The Bluebell — Monthly Intelligence Report
...
**Overall score: 6.4/10** (baseline month — no prior comparison)
 | Strongest: Trust (9.5) | Weakest: Visibility (3.4)

**Competitive position:** Local Peers (5mi): #2 of 3 (P50.0) — peer avg 5.79, top 6.54
  Catchment (15mi): #3 of 14 (P84.6) — peer avg 5.62, top 6.91
  UK Category Cohort: #4 of 15 (P78.6) — peer avg 5.68, top 6.91
...
Based on publicly observable data for The Bluebell, your current operational gaps are putting an estimated **5–16 covers per week** at risk — representing approximately **£1,200–£6,400 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£600–£3,200/mo); Fix the digital shopfront — you're losing walk-ins (£600–£3,200/mo); Protect the 4.5/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~100–160 | Derived from 323 Google reviews (mid venue indicator), price level £££ |
| Average spend per head | ~£40 | UK hospitality benchmark for price level £££ |
| Covers at risk per week | 5–16 | Conversion score 3.5/10 → 5%–10% leakage |
| Weekly revenue at risk | £300–£1,600 | Recoverable with priority action fixes |
| Monthly revenue at risk | £1,200–£6,400 | Aggregate across top 3 priorities |
| Annual projection | £14,400–£76,800 | If current gaps persist 12 months |
...
| Aggregate signals | Rating and volume from all platforms | 323 Google (4.5★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.5 rating across 323 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Bluebell operates as a credible restaurant venue with a 4.5/5 Google rating across 323 reviews — solid but not yet commanding.
...
- **Evidence:** `has_menu_online=false`
  ...
  **Commercial consequence** (directional):
  Value at stake: £240–£2,560/month | Cost to fix: Low (< 1 hour, no spend) | Payback: < 1 month
...
With 323 reviews at 4.5/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 323 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.

### Ignore

- **Competitor mimicry.** Your competitive position is earned through your own strengths, not by copying what peers do. Avoid reactive changes driven by what competitors are promoting this month.
...
- **The 4.5/5 rating feels dominant but isn't.** In this market, peer venues achieve similar ratings. Your percentile position (P50.0) shows the rating is table stakes, not a differentiator.
...
- **Volume:** 323 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 323 reviews (Moderate) | Visibility 3.4/10 (Weak) |
...
The Bluebell is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Restaurant (General)" but the resolved category triangulates across 2 signal sources.
...
| Price Level | £££ (3/4) — Mid-range dining | Supportive |

**Resolved category:** Restaurant (General) (confidence: medium)

### Peer Justification

- **Lithos Restaurant** (6.5): Dining with comparable price band; 0.0 miles away
- **Gardener's Retreat** (5.0): Dining with comparable price band; 4.1 miles away

## Competitive Market Intelligence

**Local market:** 2 direct competitors identified.

Above the median (P50) but not leading. Peer average is 5.8; the top performer scores 6.5. The gap to the top is closeable.

**Where you lead:** Visibility (+1.2), Conversion (+1.0)

*Commercial implication: you capture an adequate share of a 3-venue market, but the gap to the top (6.5) represents demand you could win. Closing the gap typically requires 1–2 targeted dimension improvements (indicative).*

### Competitive Position

| Competitor | Score | Google Rating | Reviews |
|---|---|---|---|
| Lithos Restaurant | 6.5 | 5.0★ | 72 |
...
You sit above the median but below the top tier. Your 6.4 compares to a peer average of 5.8. The gap to the top (6.5) is 0.1 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Visibility: 3.4 (+1.2 above peer avg 2.2)
- Conversion: 3.5 (+1.0 above peer avg 2.5)

**Closest competitors:**

- Lithos Restaurant (6.5) — leads you by 0.1
- Gardener's Retreat (5.0) — you lead by 1.4
...
- **Copy / test:** Read their recent positive reviews (5.0/5) for operational clues.
...
- **Defend:** Defend your trust advantage (+1.1) and your conversion readiness (+1.0) — you are easier to book/find.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

### Extended Catchment (13 peers within 15 miles)

**Position:** #3 of 14 (Percentile 84.6)

You are in the top quintile of this peer set. Your overall score of 6.4 exceeds the peer average of 5.6 by 0.8 points. The competitive risk here is complacency — the nearest competitor scores 6.9.

**Dimension gaps vs peers:**

- Trust: 9.5 (+1.7 above peer avg 7.8)
- Conversion: 3.5 (+0.8 above peer avg 2.7)
- Visibility: 3.4 (+0.6 above peer avg 2.8)

**Closest competitors:**

- 11/17 Salt Beef Bar (6.9) — leads you by 0.5
- Lithos Restaurant (6.5) — leads you by 0.1
- Red Hot Mamma Pizzeria (6.3) — you lead by 0.1
- The Bridge (6.0) — you lead by 0.4
- Bannatyne Health Club And Spa Wildmoor (5.8) — you lead by 0.6

### UK Category Cohort (14 peers in Restaurant (General))

**Position:** #4 of 15 (Percentile 78.6)

You sit above the median but below the top tier. Your 6.4 compares to a peer average of 5.7. The gap to the top (6.9) is 0.5 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 9.5 (+1.5 above peer avg 8.0)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.4 | — | 8.6 | -0.2 | Strong |
| Visibility | 3.4 | — | 2.2 | +1.2 | Above peers |
| Trust | 9.5 | — | 9.2 | +0.3 | Above peers |
| Conversion | 3.5 | — | 2.5 | +1.0 | Above peers |
| **Overall** | **6.4** | **—** | | | |

*Prestige (editorial recognition): 3.0/10 (peer avg 0.8) — tracked but not a headline operational lever for most independents.*
...
**Assessment: Critical.** At 3.4, this represents a material operational gap.
 You lead peers by 1.2 points (peer avg 2.2).
...
**Management note:** At 323 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
*Score: 3.0/10 | Peer avg: 0.8*

Editorial recognition present. This supports premium positioning but is not an operational lever — protect it through quality consistency.
...
| Inspection Recency | 9.5/10 | ✅ Strong | Last inspected 2026-03-19 (1 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Structural Compliance. Room for improvement in premises/facilities.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.1 on trust, +0.0 on overall (6.4 → 6.4).
...
| Google review count | 323 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.5★ (323 reviews) | observed | ✓ |
...
| Last Inspection | 2026-03-19 | FSA | observed |
| Google Rating | 4.5/5 | Google Places API | observed |
| Google Reviews | 323 | Google Places API | observed |
| Google Photos | 10 | Google Places API | observed |
| Price Level | £££ (3/4) | Google Places API | observed |
