# Compton Verney Cafe — Monthly Intelligence Report
...
**Overall score: 4.8/10** (baseline month — no prior comparison)
 | Strongest: Trust (8.1) | Weakest: Visibility (0.9)

**Competitive position:** Local Peers (5mi): #2 of 2 (P0.0) — peer avg 4.88, top 4.88
  Catchment (15mi): #12 of 12 (P0.0) — peer avg 5.92, top 6.91
  UK Category Cohort: #14 of 15 (P7.1) — peer avg 5.8, top 6.91
...
Compton Verney Cafe operates in the restaurant category with a public rating of None/5 that is currently limiting discovery.
...
- **Evidence:** `experience=7.5, conversion=2.5`
...
GBP profile is only 4/10 complete. Significant gaps: Has rating, Has reviews (>0), Has price level, Review count >= 10, Review count >= 100, Has website.

**Commercial consequence:** Incomplete GBP profile suppresses Google Maps visibility and customer action.

*Signals: GBP completeness: 4/10; Missing: Has rating, Has reviews (>0), Has price level, Review count >= 10, Review count >= 100, Has website*

### Photo Mix & Quality [PARTIAL]

Only 6 photos vs peer average of ~10. Low photo count suppresses click-through.

**Commercial consequence:** Venues with 10+ photos get ~35% more click-throughs (Google data).

*Signals: Photo count: 6; Peer average: ~10 photos*
...
Online visibility (0.9) hasn't kept pace with guest experience quality (7.5). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
Compton Verney Cafe is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Restaurant (General)" but the resolved category triangulates across 2 signal sources.
...
| Name | "Compton Verney Cafe" contains "cafe" | Supportive |

**Resolved category:** Restaurant (General) (confidence: medium)

### Peer Justification

- **Gardener's Retreat** (4.9): Dining with comparable price band; 3.6 miles away

## Competitive Market Intelligence

**Local market:** 1 direct competitors identified.

Below the median (P0). Customers have higher-rated alternatives nearby (peer avg 4.9, top 4.9).

**Where you lead:** Trust (+1.1)
**Where peers beat you:** Visibility (-1.3)
...
You are below the median of your peer set. At 4.8 vs peer average 4.9, competitors are outperforming you. The top performer scores 4.9. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Trust: 8.1 (+1.1 above peer avg 7.0)
- Visibility: 0.9 (-1.3 below peer avg 2.2)

**Closest competitors:**

- Gardener's Retreat (4.9) — leads you by 0.0
...
- **Wins on:** Visibility (+1.3): 8 Google reviews vs your 0 — they have volume advantage
- **Why it matters:** Their visibility lead means they are easier to find online — this controls top-of-funnel discovery.
- **Copy / test:** Build review volume — they have 8 to your 0.
...
- **Also wins on:** Visibility (+2.1): 83 Google reviews vs your 0 — they have volume advantage
...
- **Copy / test:** Read their recent positive reviews (4.8/5) for operational clues. Build review volume — they have 83 to your 0.
...
- **Also wins on:** Visibility (+2.0): 72 Google reviews vs your 0 — they have volume advantage
- **Why it matters:** They lead on both Experience and Visibility — a combined advantage that is harder to close than a single-dimension gap.
- **Copy / test:** Read their recent positive reviews (5.0/5) for operational clues. Build review volume — they have 72 to your 0.
- **Defend:** No clear defensive advantage — you are closely matched across dimensions.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*
...
You are below the median of your peer set. At 4.8 vs peer average 5.9, competitors are outperforming you. The top performer scores 6.9. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Experience: 7.5 (-1.4 below peer avg 8.9)
- Visibility: 0.9 (-2.2 below peer avg 3.1)

**Closest competitors:**

- 11/17 Salt Beef Bar (6.9) — leads you by 2.1
- Lithos Restaurant (6.5) — leads you by 1.7
- The Bluebell (6.4) — leads you by 1.6
- Red Hot Mamma Pizzeria (6.3) — leads you by 1.5
...
- Experience: 7.5 (-1.2 below peer avg 8.7)
- Visibility: 0.9 (-2.1 below peer avg 3.0)

**Closest competitors:**

- 11/17 Salt Beef Bar (6.9) — leads you by 2.1
- Lithos Restaurant (6.5) — leads you by 1.7
- Oxheart (6.5) — leads you by 1.7
- The Bluebell (6.4) — leads you by 1.6
- Red Hot Mamma Pizzeria (6.3) — leads you by 1.5
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 7.5 | — | 7.7 | -0.2 | In line |
| Visibility | 0.9 | — | 2.2 | -1.3 | Below peers |
| Trust | 8.1 | — | 7.0 | +1.1 | Above peers |
...
**Assessment: Critical.** At 0.9, this represents a material operational gap.
 You trail peers by 1.3 points (peer avg 2.2).
...
**Assessment: Strong.** This is a genuine competitive strength at 8.1.
 You lead peers by 1.1 points (peer avg 7.0).
...
| Inspection Recency | 6.0/10 | ⚠️ Room to improve | Last inspected 2025-08-28 (7 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-08-28 (7 months ago). Full confidence. No action needed. 

**Peer context:** Gardener's Retreat's trust lead (+1.1) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.0 on trust, +0.2 on overall (4.8 → 5.1).
...
### Action 4: Ranked #2 of 2 locally — peers are ahead
**Status:** Stale (5 months) | **Priority:** Medium
...
| Last Inspection | 2025-08-28 | FSA | observed |
| Google Photos | 6 | Google Places API | observed |
...
| Postcode | CV35 9HZ | FSA | observed |
| Companies House | — | Not checked | not_assessed |
