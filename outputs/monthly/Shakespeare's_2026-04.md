# Shakespeare's — Monthly Intelligence Report
...
**Overall score: 5.7/10** (baseline month — no prior comparison)
 | Strongest: Experience (8.4) | Weakest: Conversion (2.5)

**Competitive position:** Catchment (15mi): #2 of 3 (P50.0) — peer avg 5.58, top 5.85
  UK Category Cohort: #7 of 10 (P33.3) — peer avg 6.17, top 7.85
...
Based on publicly observable data for Shakespeare's, your current operational gaps are putting an estimated **26–75 covers per week** at risk — representing approximately **£3,080–£18,500 per month** in lost or leaked revenue. The main drivers are: Close the hygiene gap — 4 to 5 (£0–£500/mo (defensive)); Get your menu online — 77% of diners check before visiting (£1,540–£9,000/mo); Fix the digital shopfront — you're losing walk-ins (£1,540–£9,000/mo). Taking action on **Close the hygiene gap — 4 to 5** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~320–500 | Derived from 1,375 Google reviews (high-traffic venue indicator), price level ££ |
...
- **Evidence:** `experience=8.38, conversion=2.5`
...
- **Review momentum.** At 1375 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: garden_center, hardware_store, garden, building_materials_store, supplier, general_contractor, service, store. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: garden_center, hardware_store, garden, building_materials_store, supplier, general_contractor, service, store*
...
Online visibility (3.9) hasn't kept pace with guest experience quality (8.4). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
Food Quality is frequently mentioned but registers as emerging concern, limited evidence. High mention volume combined with low sentiment suggests this is an area guests care about but feel let down by.
...
| Hygiene Rating | FSA 4/5 (Acceptable) | Trust 7.6/10 (Adequate) |
| Review Volume | 1375 reviews (High) | Visibility 3.9/10 (Weak) |
...
You sit above the median but below the top tier. Your 5.7 compares to a peer average of 5.6. The gap to the top (5.8) is 0.1 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Visibility: 3.9 (+2.1 above peer avg 1.8)
- Experience: 8.4 (-1.3 below peer avg 9.7)

**Closest competitors:**

- Stratford Adventure Golf (5.8) — leads you by 0.1
- Escape Arts (5.3) — you lead by 0.4

### UK Category Cohort (9 peers in Other)

**Position:** #7 of 10 (Percentile 33.3)

You are below the median of your peer set. At 5.7 vs peer average 6.2, competitors are outperforming you. The top performer scores 7.8. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Visibility: 3.9 (+1.1 above peer avg 2.8)
- Trust: 7.6 (-0.6 below peer avg 8.2)
- Experience: 8.4 (-0.8 below peer avg 9.2)

**Closest competitors:**

- Digby's Events (7.8) — leads you by 2.1
- Ashorne Hill Management College (7.1) — leads you by 1.3
- The Pavillion (6.3) — leads you by 0.6
- The Lime Tree Restaurant (6.3) — leads you by 0.5
- Lexi's Loving Spoonful (6.0) — leads you by 0.3
...
**Management note:** At 1375 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 8.8/10 | ✅ Adequate | Last inspected 2026-02-11 (2 months ago). Full confidence. No action needed.  |
...
**Status:** Overdue (11 months) | **Priority:** High
...
**Status:** Overdue (11 months) | **Priority:** Medium
...
**Status:** Overdue (11 months) | **Priority:** Standard
...
| Google review count | 1375 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Last Inspection | 2026-02-11 | FSA | observed |
| Google Rating | 4.5/5 | Google Places API | observed |
| Google Reviews | 1375 | Google Places API | observed |
...
**Review 1** | Unknown | Undated | 4★ | positive
...
**Review 2** | Unknown | Undated | 3★ | mixed | Food Quality
