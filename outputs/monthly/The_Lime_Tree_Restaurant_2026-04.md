# The Lime Tree Restaurant — Monthly Intelligence Report
...
**Competitive position:** Local Peers (5mi): #1 of 3 (P100.0) — peer avg 5.58, top 5.85
  Catchment (15mi): #3 of 7 (P66.7) — peer avg 6.01, top 7.07
  UK Category Cohort: #4 of 10 (P66.7) — peer avg 6.11, top 7.85
...
| Aggregate signals | Rating and volume from all platforms | 1,817 Google (4.4★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.4 rating across 1,817 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Lime Tree Restaurant operates as a credible other venue with a 4.4/5 Google rating across 1817 reviews — solid but not yet commanding.
...
Within the local other market (2 peers), this venue leads the field. The identity is that of a category leader — the venue others are compared against.
...
- **Review momentum.** At 1817 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: garden_center, store, service. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: garden_center, store, service*
...
Online visibility (4.0) hasn't kept pace with guest experience quality (9.3). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 1,817 reviews — statistically robust rating. Individual reviews have negligible impact.
...
| Review Volume | 1817 reviews (High) | Visibility 4.0/10 (Weak) |
...
The Lime Tree Restaurant is classified as **Garden Center** (confidence: low). Google's raw category is "Other" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | garden_center, store, service | Primary |
| Name | "The Lime Tree Restaurant" contains "restaurant" | Supportive |

**Resolved category:** Garden Center (confidence: low)

### Peer Justification

- **Stratford Adventure Golf** (5.8): Dining with comparable price band; 2.1 miles away
- **Escape Arts** (5.3): Dining with comparable price band; 2.1 miles away

## Competitive Market Intelligence

**Local market:** 2 direct competitors identified.

You are in the top quintile (P100). The competitive risk is complacency — the nearest competitor scores 5.8.

**Where you lead:** Visibility (+2.2), Trust (+1.7)
...
You are in the top quintile of this peer set. Your overall score of 6.3 exceeds the peer average of 5.6 by 0.7 points. The competitive risk here is complacency — the nearest competitor scores 5.8.

**Dimension gaps vs peers:**

- Visibility: 4.0 (+2.2 above peer avg 1.8)
- Trust: 9.3 (+1.7 above peer avg 7.5)

**Closest competitors:**

- Stratford Adventure Golf (5.8) — you lead by 0.4
- Escape Arts (5.3) — you lead by 0.9
...
- **Defend:** Defend your 1817-review advantage vs their 6 (discovery moat) and your trust advantage (+1.5).
...
You sit above the median but below the top tier. Your 6.3 compares to a peer average of 6.0. The gap to the top (7.1) is 0.8 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 9.3 (+1.2 above peer avg 8.1)
- Visibility: 4.0 (+1.1 above peer avg 2.9)

**Closest competitors:**

- Ashorne Hill Management College (7.1) — leads you by 0.8
- The Pavillion (6.3) — leads you by 0.0
- Lexi's Loving Spoonful (6.0) — you lead by 0.2
- Stratford Adventure Golf (5.8) — you lead by 0.4
- Good Breakfast (5.5) — you lead by 0.8

### UK Category Cohort (9 peers in Other)

**Position:** #4 of 10 (Percentile 66.7)

You sit above the median but below the top tier. Your 6.3 compares to a peer average of 6.1. The gap to the top (7.8) is 1.6 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 9.3 (+1.2 above peer avg 8.0)
- Visibility: 4.0 (+1.2 above peer avg 2.8)

**Closest competitors:**

- Digby's Events (7.8) — leads you by 1.6
- Ashorne Hill Management College (7.1) — leads you by 0.8
- The Pavillion (6.3) — leads you by 0.0
- Lexi's Loving Spoonful (6.0) — you lead by 0.2
- Stratford Adventure Golf (5.8) — you lead by 0.4
...
| Visibility | 4.0 | — | 1.8 | +2.2 | Clear strength |
| Trust | 9.3 | — | 7.5 | +1.7 | Clear strength |
...
**Assessment: Critical.** At 4.0, this represents a material operational gap.
 You lead peers by 2.2 points (peer avg 1.8).
...
**Management note:** At 1817 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 9.3.
 You lead peers by 1.7 points (peer avg 7.5).
...
| Inspection Recency | 8.5/10 | ✅ Adequate | Last inspected 2026-01-30 (2 months ago). Full confidence. No action needed.  |
...
**Peer context:** Stratford Adventure Golf's trust lead (+1.2) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.4 on trust, +0.1 on overall (6.3 → 6.4).
...
| Google review count | 1817 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.4★ (1817 reviews) | observed | ✓ |
...
| Last Inspection | 2026-01-30 | FSA | observed |
| Google Rating | 4.4/5 | Google Places API | observed |
| Google Reviews | 1817 | Google Places API | observed |
...
| Postcode | CV37 8LW | FSA | observed |
| Companies House | — | Not checked | not_assessed |
