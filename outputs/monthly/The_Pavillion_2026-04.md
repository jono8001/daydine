# The Pavillion — Monthly Intelligence Report
...
**Overall score: 6.3/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.4) | Weakest: Conversion (3.5)

**Competitive position:** Catchment (15mi): #2 of 8 (P85.7) — peer avg 5.91, top 7.07
  UK Category Cohort: #3 of 10 (P77.8) — peer avg 6.11, top 7.85
...
Based on publicly observable data for The Pavillion, your current operational gaps are putting an estimated **16–50 covers per week** at risk — representing approximately **£1,920–£12,000 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£960–£6,000/mo); Fix the digital shopfront — you're losing walk-ins (£960–£6,000/mo); Protect the 4.5/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~320–500 | Derived from 3,261 Google reviews (high-traffic venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 3,261 Google (4.5★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.5 rating across 3,261 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Pavillion is a well-established other venue with a strong public reputation — 4.5/5 across 3,261 Google reviews. That volume means the reputation is earned, not manufactured.
...
With 3261 reviews at 4.5/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 3261 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: tourist_attraction. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: tourist_attraction*
...
- **Volume:** 3,261 reviews — statistically robust rating. Individual reviews have negligible impact.
...
| Review Volume | 3261 reviews (High) | Visibility 4.0/10 (Weak) |
...
The Pavillion is classified as **Tourist Attraction** (confidence: low). Google's raw category is "Other" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | tourist_attraction | Primary |
| Price Level | ££ (2/4) — Casual dining | Supportive |

**Resolved category:** Tourist Attraction (confidence: low)
...
You are in the top quintile of this peer set. Your overall score of 6.3 exceeds the peer average of 5.9 by 0.4 points. The competitive risk here is complacency — the nearest competitor scores 7.1.
...
- The Lime Tree Restaurant (6.3) — you lead by 0.0
- Lexi's Loving Spoonful (6.0) — you lead by 0.3
- Stratford Adventure Golf (5.8) — you lead by 0.5
...
You sit above the median but below the top tier. Your 6.3 compares to a peer average of 6.1. The gap to the top (7.8) is 1.5 points — closeable with focused improvement on your weakest dimension.
...
- Digby's Events (7.8) — leads you by 1.5
- Ashorne Hill Management College (7.1) — leads you by 0.8
- The Lime Tree Restaurant (6.3) — you lead by 0.0
- Lexi's Loving Spoonful (6.0) — you lead by 0.3
- Stratford Adventure Golf (5.8) — you lead by 0.5
...
**Management note:** At 3261 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 2.2/10 | ⚠️ Significant drag | Last inspected 2024-06-19 (22 months ago). Meaningful score drag. Consider pr... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-06-19 (22 months ago). Meaningful score drag. Consider proactive action. The system discounts older inspections because they carry less certainty.

**What you can do:**

1. **Request voluntary reinspection** (free, 4–8 weeks) — would recover ~1.9 trust points. Only request reinspection if confident of maintaining 5/5. A drop to 4 would be worse than the staleness drag.
...
| Google review count | 3261 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.5★ (3261 reviews) | observed | ✓ |
...
| Last Inspection | 2024-06-19 | FSA | observed |
| Google Rating | 4.5/5 | Google Places API | observed |
| Google Reviews | 3261 | Google Places API | observed |
...
| Postcode | OX15 6HT | FSA | observed |
| Companies House | — | Not checked | not_assessed |
