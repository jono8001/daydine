# Pizza Junction Kineton Ltd — Monthly Intelligence Report
...
**Competitive position:** UK Category Cohort: #7 of 13 (P50.0) — peer avg 5.81, top 6.41
...
| Aggregate signals | Rating and volume from all platforms | 133 Google (4.8★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.8 rating across 133 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Pizza Junction Kineton Ltd operates as a credible Italian dining venue with a 4.8/5 Google rating across 133 reviews — solid but not yet commanding.
...
- **Review momentum.** At 133 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Online visibility (3.1) hasn't kept pace with guest experience quality (8.7). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Unrealised review authority.** At 133 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** 133 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 8.6/10 (Strong) |
| Review Volume | 133 reviews (Moderate) | Visibility 3.1/10 (Weak) |
...
Pizza Junction Kineton Ltd is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Italian Restaurant" but the resolved category triangulates across 1 signal sources.
...
You sit above the median but below the top tier. Your 5.9 compares to a peer average of 5.8. The gap to the top (6.4) is 0.5 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 8.6 (+1.1 above peer avg 7.5)

**Closest competitors:**

- The Phoenix (6.4) — leads you by 0.5
- Soma (6.2) — leads you by 0.2
- The Still House Café (6.1) — leads you by 0.2
- Bumbles (6.1) — leads you by 0.2
- Carluccio's (6.1) — leads you by 0.2
...
**Management note:** At 133 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 4.2/10 | ⚠️ Significant drag | Last inspected 2025-04-02 (12 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-04-02 (12 months ago). Score starting to decay. Note it but don't escalate. 
...
| Google review count | 133 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.8★ (133 reviews) | observed | ✓ |
...
| Last Inspection | 2025-04-02 | FSA | observed |
| Google Rating | 4.8/5 | Google Places API | observed |
| Google Reviews | 133 | Google Places API | observed |
...
| Postcode | CV35 0LN | FSA | observed |
| Companies House | — | Not checked | not_assessed |
