# The Sandwich Shop — Monthly Intelligence Report
...
**Overall score: 5.4/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.0) | Weakest: Visibility (2.2)

**Competitive position:** Catchment (15mi): #8 of 9 (P12.5) — peer avg 5.92, top 6.43
  UK Category Cohort: #9 of 11 (P20.0) — peer avg 5.77, top 6.43
...
| Aggregate signals | Rating and volume from all platforms | 8 Google (5★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 5 rating across 8 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Sandwich Shop is a quick-service food venue with an adequate public reputation (5.0/5, 8 reviews) that has room to build stronger proof.
...
Only 8 Google reviews. A single bad review moves your average visibly. Encourage satisfied customers to leave reviews.
...
Insufficient review data to cross-reference proposition. Google types show: cafe, coffee_shop, sandwich_shop, food_store, store, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: cafe, coffee_shop, sandwich_shop, food_store, store, restaurant*
...
- **Unrealised review authority.** At 8 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
The Sandwich Shop is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Fast Food / Quick Service" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | cafe, coffee_shop, sandwich_shop, food_store, store, restaurant | Primary |
...
You are below the median of your peer set. At 5.4 vs peer average 5.9, competitors are outperforming you. The top performer scores 6.4. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Experience: 9.0 (+0.7 above peer avg 8.3)
- Trust: 7.1 (-1.2 below peer avg 8.3)
- Visibility: 2.2 (-1.3 below peer avg 3.5)
- Conversion: 2.5 (-1.7 below peer avg 4.2)

**Closest competitors:**

- The Kingfisher FishBar (6.4) — leads you by 1.0
- Starbucks Drive Thru (6.4) — leads you by 0.9
- Starbucks (6.3) — leads you by 0.9
- Bruno's Bakery (6.3) — leads you by 0.9
- The Food Of Love (6.2) — leads you by 0.8

### UK Category Cohort (10 peers in Fast Food / Quick Service)

**Position:** #9 of 11 (Percentile 20.0)

You are below the median of your peer set. At 5.4 vs peer average 5.8, competitors are outperforming you. The top performer scores 6.4. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Experience: 9.0 (+0.7 above peer avg 8.2)
- Trust: 7.1 (-0.7 below peer avg 7.8)
- Visibility: 2.2 (-1.2 below peer avg 3.4)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.0 | — | — | — | Strong |
| Visibility | 2.2 | — | — | — | Needs work |
| Trust | 7.1 | — | — | — | In line |
...
| Inspection Recency | 2.0/10 | ⚠️ Significant drag | Last inspected 2024-05-14 (23 months ago). Meaningful score drag. Consider pr... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-05-14 (23 months ago). Meaningful score drag. Consider proactive action. The system discounts older inspections because they carry less certainty.
...
| Google Business Profile | 5.0★ (8 reviews) | observed | ✓ |
...
| Last Inspection | 2024-05-14 | FSA | observed |
