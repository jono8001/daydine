# The Still House Café — Monthly Intelligence Report
...
**Overall score: 6.1/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.7) | Weakest: Visibility (2.9)

**Competitive position:** Catchment (15mi): #3 of 11 (P80.0) — peer avg 5.76, top 6.41
  UK Category Cohort: #3 of 13 (P83.3) — peer avg 5.8, top 6.41
...
Based on publicly observable data for The Still House Café, your current operational gaps are putting an estimated **4–14 covers per week** at risk — representing approximately **£480–£3,860 per month** in lost or leaked revenue. The main drivers are: Renew formal trust proof before it becomes a visible drag (£0–£500/mo (defensive)); Get your menu online — 77% of diners check before visiting (£240–£1,680/mo); Fix the digital shopfront — you're losing walk-ins (£240–£1,680/mo). Taking action on **Renew formal trust proof before it becomes a visible drag** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~80–140 | Derived from 61 Google reviews (small venue indicator), price level ££ |
...
| Weekly revenue at risk | £120–£960 | Recoverable with priority action fixes |
| Monthly revenue at risk | £480–£3,860 | Aggregate across top 3 priorities |
| Annual projection | £5,760–£46,320 | If current gaps persist 12 months |
...
| Aggregate signals | Rating and volume from all platforms | 61 Google (4.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.7 rating across 61 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Still House Café is a Italian dining venue with an adequate public reputation (4.7/5, 61 reviews) that has room to build stronger proof.
...
- **Review momentum.** At 61 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: cafe, pizza_restaurant, coffee_shop, meal_takeaway, food_store, restaurant, store. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: cafe, pizza_restaurant, coffee_shop, meal_takeaway, food_store, restaurant, store*
...
- **Unrealised review authority.** At 61 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** Only 61 reviews — rating is volatile. A single 1-star review moves the average measurably.
...
| Review Volume | 61 reviews (Low) | Visibility 2.9/10 (Weak) |
...
The Still House Café is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Italian Restaurant" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | cafe, pizza_restaurant, coffee_shop, meal_takeaway, food_store, restaurant, store | Primary |
| Name | "The Still House Café" contains "cafe" | Supportive |
...
You are in the top quintile of this peer set. Your overall score of 6.1 exceeds the peer average of 5.8 by 0.4 points. The competitive risk here is complacency — the nearest competitor scores 6.4.

**Dimension gaps vs peers:**

- Conversion: 4.0 (+1.1 above peer avg 2.9)
...
**Position:** #3 of 13 (Percentile 83.3)

You are in the top quintile of this peer set. Your overall score of 6.1 exceeds the peer average of 5.8 by 0.3 points. The competitive risk here is complacency — the nearest competitor scores 6.4.

**Dimension gaps vs peers:**

- Conversion: 4.0 (+1.2 above peer avg 2.8)
- Experience: 9.7 (+0.7 above peer avg 8.9)
- Visibility: 2.9 (-0.6 below peer avg 3.4)

**Closest competitors:**

- The Phoenix (6.4) — leads you by 0.3
- Soma (6.2) — leads you by 0.0
- Bumbles (6.1) — you lead by 0.0
- Carluccio's (6.1) — you lead by 0.1
- Pizza Hut Restaurants - Dine In (6.0) — you lead by 0.1
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.7 | — | — | — | Strong |
| Visibility | 2.9 | — | — | — | Needs work |
| Trust | 7.6 | — | — | — | In line |
| Conversion | 4.0 | — | — | — | Needs work |
| **Overall** | **6.1** | **—** | | | |

*Prestige (editorial recognition): 1.5/10 — tracked but not a headline operational lever for most independents.*
...
**Management note:** At 61 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
1. **Request voluntary reinspection** (free, 4–8 weeks) — would recover ~2.0 trust points. Only request reinspection if confident of maintaining 5/5. A drop to 4 would be worse than the staleness drag.
...
| Google review count | 61 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.7★ (61 reviews) | observed | ✓ |
...
| Google Reviews | 61 | Google Places API | observed |
...
| Postcode | CV36 5EX | FSA | observed |
| Companies House | — | Not checked | not_assessed |
