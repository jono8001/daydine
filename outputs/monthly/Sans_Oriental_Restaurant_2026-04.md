# Sans Oriental Restaurant — Monthly Intelligence Report
...
**Overall score: 6.4/10** (baseline month — no prior comparison)
 | Strongest: Trust (9.0) | Weakest: Visibility (3.4)

**Competitive position:** Local Peers (5mi): #1 of 2 (P100.0) — peer avg 4.49, top 4.49
  Catchment (15mi): #1 of 3 (P100.0) — peer avg 4.36, top 4.49
  UK Category Cohort: #1 of 3 (P100.0) — peer avg 4.36, top 4.49
...
Based on publicly observable data for Sans Oriental Restaurant, your current operational gaps are putting an estimated **3–11 covers per week** at risk — representing approximately **£340–£2,640 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£170–£1,320/mo); Fix the digital shopfront — you're losing walk-ins (£170–£1,320/mo); Protect the 4.6/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~140–220 | Derived from 289 Google reviews (mid venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 289 Google (4.6★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.6 rating across 289 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Sans Oriental Restaurant operates as a credible Chinese dining venue with a 4.6/5 Google rating across 289 reviews — solid but not yet commanding.
...
Within the local Chinese dining market (1 peers), this venue leads the field. The identity is that of a category leader — the venue others are compared against.
...
- **Evidence:** `experience=8.49, conversion=5.0`
...
With 289 reviews at 4.6/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 289 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: chinese_restaurant, meal_takeaway, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: chinese_restaurant, meal_takeaway, restaurant*
...
- **Volume:** 289 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 289 reviews (Moderate) | Visibility 3.4/10 (Weak) |
...
Sans Oriental Restaurant is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Chinese Restaurant" but the resolved category triangulates across 3 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | chinese_restaurant, meal_takeaway, restaurant | Primary |
| Price Level | ££ (2/4) — Casual dining | Supportive |
| Name | "Sans Oriental Restaurant" contains "restaurant" | Supportive |

**Resolved category:** Restaurant (General) (confidence: medium)

### Peer Justification

- **New Summer Palace Restaurant** (4.5): Dining with similar price band; 4.3 miles away

## Competitive Market Intelligence

**Local market:** 1 direct competitors identified.

You are in the top quintile (P100). The competitive risk is complacency — the nearest competitor scores 4.5.

**Where you lead:** Trust (+4.0), Experience (+1.7), Conversion (+1.5)

### Competitive Position

| Competitor | Score | Google Rating | Reviews |
|---|---|---|---|
| New Summer Palace Restaurant | 4.5 | 4.0★ | 522 |
...
You are in the top quintile of this peer set. Your overall score of 6.4 exceeds the peer average of 4.5 by 1.9 points. The competitive risk here is complacency — the nearest competitor scores 4.5.

**Dimension gaps vs peers:**

- Trust: 9.0 (+4.0 above peer avg 4.9)
- Experience: 8.5 (+1.7 above peer avg 6.8)
- Conversion: 5.0 (+1.5 above peer avg 3.5)

**Closest competitors:**

- New Summer Palace Restaurant (4.5) — you lead by 1.9
...
**New Summer Palace Restaurant** (signal-backed)
...
- **Defend:** Defend your trust advantage (+4.0) and your experience lead (+1.7) — drives repeats and word-of-mouth.
...
- **Why it matters:** You are closely matched — small improvements on either side shift the balance.
- **Copy / test:** No clear action to copy — maintain current standards.
- **Defend:** Defend your trust advantage (+3.8) and your experience lead (+2.6) — drives repeats and word-of-mouth.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*
...
You are in the top quintile of this peer set. Your overall score of 6.4 exceeds the peer average of 4.4 by 2.0 points. The competitive risk here is complacency — the nearest competitor scores 4.5.

**Dimension gaps vs peers:**

- Trust: 9.0 (+3.9 above peer avg 5.0)
- Experience: 8.5 (+2.2 above peer avg 6.3)
- Conversion: 5.0 (+1.5 above peer avg 3.5)

**Closest competitors:**

- New Summer Palace Restaurant (4.5) — you lead by 1.9
- China Garden (4.2) — you lead by 2.1
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.5 | — | 6.8 | +1.7 | Clear strength |
| Visibility | 3.4 | — | 3.6 | -0.2 | Needs work |
| Trust | 9.0 | — | 4.9 | +4.0 | Clear strength |
...
**Assessment: Strong.** This is a genuine competitive strength at 8.5.
 You lead peers by 1.7 points (peer avg 6.8).
...
**Management note:** At 289 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 9.0.
 You lead peers by 4.0 points (peer avg 4.9).
...
**Peer context:** New Summer Palace Restaurant's trust lead (+4.0) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.2 on trust, +0.0 on overall (6.4 → 6.4).
...
| Google review count | 289 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.6★ (289 reviews) | observed | ✓ |
...
| Google Reviews | 289 | Google Places API | observed |
