# Burger King — Monthly Intelligence Report
...
**Overall score: 5.2/10** (baseline month — no prior comparison)
 | Strongest: Trust (7.7) | Weakest: Conversion (2.5)

**Competitive position:** Local Peers (5mi): #7 of 8 (P14.3) — peer avg 5.86, top 6.91
  Catchment (15mi): #10 of 14 (P30.8) — peer avg 5.72, top 6.91
  UK Category Cohort: #11 of 15 (P28.6) — peer avg 5.77, top 6.91
...
| Aggregate signals | Rating and volume from all platforms | 218 Google (3.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 3.7 rating across 218 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Burger King operates in the restaurant category with a public rating of 3.7/5 that is currently limiting discovery.
...
- **Review momentum.** At 218 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Online visibility (3.3) hasn't kept pace with guest experience quality (7.4). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 218 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
|--------|-------------|---------------------|
| Customer Rating | 3.7/5 Google (Weak) | Experience 7.4/10 (Adequate) — Gap |
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 7.7/10 (Adequate) |
| Review Volume | 218 reviews (Moderate) | Visibility 3.3/10 (Weak) |
...
Burger King is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Restaurant (General)" but the resolved category triangulates across 1 signal sources.
...
- **11/17 Salt Beef Bar** (6.9): Dining with comparable price band; 0.7 miles away
- **Red Hot Mamma Pizzeria** (6.3): Dining with comparable price band; 0.7 miles away
- **Bannatyne Health Club And Spa Wildmoor** (5.8): Dining with comparable price band; 1.7 miles away
- **Fast Flavour** (5.8): Dining with comparable price band; 0.7 miles away
- **NO4 Bar And Restaurant** (5.7): Dining with comparable price band; 0.7 miles away

## Competitive Market Intelligence

**Local market:** 7 direct competitors identified.

Below the median (P14). Customers have higher-rated alternatives nearby (peer avg 5.9, top 6.9).

**Where peers beat you:** Experience (-1.5)
...
You are below the median of your peer set. At 5.2 vs peer average 5.9, competitors are outperforming you. The top performer scores 6.9. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Experience: 7.4 (-1.5 below peer avg 8.9)

**Closest competitors:**

- 11/17 Salt Beef Bar (6.9) — leads you by 1.7
- Red Hot Mamma Pizzeria (6.3) — leads you by 1.1
- Bannatyne Health Club And Spa Wildmoor (5.8) — leads you by 0.6
- Fast Flavour (5.8) — leads you by 0.6
- NO4 Bar And Restaurant (5.7) — leads you by 0.5
...
- **Also wins on:** Trust (+1.1): same FSA rating but likely stronger sub-scores or more recent inspection
...
**Bannatyne Health Club And Spa Wildmoor** (signal-backed)

- **Wins on:** Experience (see pattern above)
- **Why it matters:** A large experience gap (+1.7) — guests rate their visit higher — this drives reviews, repeats, and word-of-mouth. This is a structural disadvantage, not a rounding error.
...
**Position:** #10 of 14 (Percentile 30.8)

You are below the median of your peer set. At 5.2 vs peer average 5.7, competitors are outperforming you. The top performer scores 6.9. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Experience: 7.4 (-1.2 below peer avg 8.6)

**Closest competitors:**

- 11/17 Salt Beef Bar (6.9) — leads you by 1.7
- Lithos Restaurant (6.5) — leads you by 1.4
- The Bluebell (6.4) — leads you by 1.2
- Red Hot Mamma Pizzeria (6.3) — leads you by 1.1
- The Bridge (6.0) — leads you by 0.8
...
- Experience: 7.4 (-1.3 below peer avg 8.7)

**Closest competitors:**

- 11/17 Salt Beef Bar (6.9) — leads you by 1.7
- Lithos Restaurant (6.5) — leads you by 1.4
- Oxheart (6.5) — leads you by 1.3
- The Bluebell (6.4) — leads you by 1.2
- Red Hot Mamma Pizzeria (6.3) — leads you by 1.1
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 7.4 | — | 8.9 | -1.5 | Significant gap |
| Visibility | 3.3 | — | 3.0 | +0.2 | Needs work |
| Trust | 7.7 | — | 8.0 | -0.3 | Below peers |
...
**Assessment: Adequate.** At 7.4, this is functional but not distinctive.
 You trail peers by 1.5 points (peer avg 8.9).
...
**Management note:** At 218 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 4.2/10 | ⚠️ Significant drag | Last inspected 2025-04-01 (12 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-04-01 (12 months ago). Score starting to decay. Note it but don't escalate. 

**Peer context:** 11/17 Salt Beef Bar's trust lead (+1.1) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.4 on trust, +0.4 on overall (5.2 → 5.5).
...
You trail peers by 1.5 points on experience. This isn't a label problem — it means customers are getting a measurably better experience on this dimension from your competitors.
...
| Google review count | 218 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 3.7★ (218 reviews) | observed | ✓ |
...
| Last Inspection | 2025-04-01 | FSA | observed |
| Google Rating | 3.7/5 | Google Places API | observed |
| Google Reviews | 218 | Google Places API | observed |
