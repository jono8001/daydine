# Plantarium — Monthly Intelligence Report
...
**Overall score: 6.0/10** (baseline month — no prior comparison)
 | Strongest: Experience (8.8) | Weakest: Conversion (3.5)
...
Based on publicly observable data for Plantarium, your current operational gaps are putting an estimated **11–35 covers per week** at risk — representing approximately **£1,320–£8,400 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£660–£4,200/mo); Fix the digital shopfront — you're losing walk-ins (£660–£4,200/mo); Protect the 4.9/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~220–350 | Derived from 575 Google reviews (large venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 575 Google (4.9★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.9 rating across 575 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Plantarium is a well-established vegan / vegetarian venue with a strong public reputation — 4.9/5 across 575 Google reviews. That volume means the reputation is earned, not manufactured.
...
- **Evidence:** `experience=8.84, conversion=3.5`
...
With 575 reviews at 4.9/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 575 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: vegan_restaurant, vegetarian_restaurant, cafe, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: vegan_restaurant, vegetarian_restaurant, cafe, restaurant*
...
Online visibility (3.6) hasn't kept pace with guest experience quality (8.8). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 575 reviews — strong base. Rating is stable but a sustained negative pattern could shift it.
...
|--------|-------------|---------------------|
| Customer Rating | 4.9/5 Google (Strong) | Experience 8.8/10 (Strong) — Aligned |
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 7.6/10 (Adequate) |
| Review Volume | 575 reviews (High) | Visibility 3.6/10 (Weak) |
...
Plantarium is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Vegan / Vegetarian" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | vegan_restaurant, vegetarian_restaurant, cafe, restaurant | Primary |
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.8 | — | — | — | Strong |
| Visibility | 3.6 | — | — | — | Needs work |
| Trust | 7.6 | — | — | — | In line |
...
**Management note:** At 575 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 2.0/10 | ⚠️ Significant drag | Last inspected 2024-04-30 (24 months ago). Meaningful score drag. Consider pr... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-04-30 (24 months ago). Meaningful score drag. Consider proactive action. The system discounts older inspections because they carry less certainty.
...
| Google review count | 575 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.9★ (575 reviews) | observed | ✓ |
...
| Last Inspection | 2024-04-30 | FSA | observed |
| Google Rating | 4.9/5 | Google Places API | observed |
| Google Reviews | 575 | Google Places API | observed |
...
| Category | Vegan / Vegetarian | google_types | derived |
| Postcode | CV37 6NF | FSA | observed |
| Companies House | — | Not checked | not_assessed |
