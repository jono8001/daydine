# The Food Of Love — Monthly Intelligence Report
...
**Overall score: 6.2/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.2) | Weakest: Visibility (3.3)

**Competitive position:** Local Peers (5mi): #3 of 5 (P50.0) — peer avg 5.75, top 6.43
  Catchment (15mi): #5 of 11 (P60.0) — peer avg 5.7, top 6.43
  UK Category Cohort: #5 of 11 (P60.0) — peer avg 5.7, top 6.43
...
Based on publicly observable data for The Food Of Love, your current operational gaps are putting an estimated **4–14 covers per week** at risk — representing approximately **£240–£1,740 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£120–£870/mo); Fix the digital shopfront — you're losing walk-ins (£120–£870/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~180–290 | Derived from 241 Google reviews (mid venue indicator), price level £ |
...
| Weekly revenue at risk | £60–£440 | Recoverable with priority action fixes |
| Monthly revenue at risk | £240–£1,740 | Aggregate across top 3 priorities |
| Annual projection | £2,880–£20,880 | If current gaps persist 12 months |
...
| Aggregate signals | Rating and volume from all platforms | 241 Google (4.3★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.3 rating across 241 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Food Of Love operates as a credible quick-service food venue with a 4.3/5 Google rating across 241 reviews — solid but not yet commanding.
...
- **Evidence:** `experience=9.18, conversion=5.0`
...
- **Review momentum.** At 241 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: snack_bar, cafe, breakfast_restaurant, meal_takeaway, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: snack_bar, cafe, breakfast_restaurant, meal_takeaway, restaurant*
...
- **Volume:** 241 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 241 reviews (Moderate) | Visibility 3.3/10 (Weak) |
...
The Food Of Love is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Fast Food / Quick Service" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | snack_bar, cafe, breakfast_restaurant, meal_takeaway, restaurant | Primary |
...
- **The Kingfisher FishBar** (6.4): Takeaway-focused — different service model; 0.2 miles away *(weak comparator)*
- **Starbucks** (6.3): Dining with comparable price band; 0.2 miles away
- **GAIL's Stratford-Upon-Avon** (5.8): Dining with comparable price band; 0.2 miles away
- **Subway** (4.5): Takeaway-focused — different service model; 0.5 miles away *(weak comparator)*

## Competitive Market Intelligence

**Local market:** 4 direct competitors identified.

Above the median (P50) but not leading. Peer average is 5.8; the top performer scores 6.4. The gap to the top is closeable.

**Where you lead:** Experience (+1.0), Conversion (+1.0)
...
You sit above the median but below the top tier. Your 6.2 compares to a peer average of 5.8. The gap to the top (6.4) is 0.2 points — closeable with focused improvement on your weakest dimension.
...
- The Kingfisher FishBar (6.4) — leads you by 0.2
- Starbucks (6.3) — leads you by 0.1
- GAIL's Stratford-Upon-Avon (5.8) — you lead by 0.4
- Subway (4.5) — you lead by 1.7
...
- **Why it matters:** A large trust gap (+1.8) — their compliance record is stronger — this creates a ceiling you hit and they don't. This is a structural disadvantage, not a rounding error.
- **Copy / test:** Review inspection documentation and sub-score gaps.
- **Defend:** Defend your conversion readiness (+1.5) — you are easier to book/find and your experience lead (+0.6) — drives repeats and word-of-mouth.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*
...
**Position:** #5 of 11 (Percentile 60.0)

You sit above the median but below the top tier. Your 6.2 compares to a peer average of 5.7. The gap to the top (6.4) is 0.2 points — closeable with focused improvement on your weakest dimension.
...
- The Kingfisher FishBar (6.4) — leads you by 0.2
- Starbucks Drive Thru (6.4) — leads you by 0.2
- Starbucks (6.3) — leads you by 0.1
- Bruno's Bakery (6.3) — leads you by 0.1
- GAIL's Stratford-Upon-Avon (5.8) — you lead by 0.4
...
**Management note:** At 241 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Peer context:** The Kingfisher FishBar's trust lead (+1.8) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.

**What you can do:**

1. **Request voluntary reinspection** (free, 4–8 weeks) — would recover ~1.9 trust points and overtake 2 peers. Only request reinspection if confident of maintaining 5/5. A drop to 4 would be worse than the staleness drag.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.9 on trust, +0.5 on overall (6.2 → 6.7).
...
| Google review count | 241 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.3★ (241 reviews) | observed | ✓ |
...
| Google Reviews | 241 | Google Places API | observed |
...
| Postcode | CV37 6QW | FSA | observed |
| Companies House | — | Not checked | not_assessed |
