# Ferment And Flour (Bastardos) — Monthly Intelligence Report
...
2. **Build review volume — you lack statistical credibility** [FIX] — Rating stability + discovery ranking
...
**Watch this month:**
- Ranked #4 of 5 locally — peers are ahead
...
**Overall score: 5.8/10** (baseline month — no prior comparison)
 | Strongest: Experience (8.9) | Weakest: Visibility (2.5)

**Competitive position:** Local Peers (5mi): #4 of 5 (P25.0) — peer avg 6.03, top 6.44
  Catchment (15mi): #24 of 39 (P39.5) — peer avg 5.81, top 6.78
  UK Category Cohort: #33 of 53 (P38.5) — peer avg 5.79, top 6.92
...
Based on publicly observable data for Ferment And Flour (Bastardos), your current operational gaps are putting an estimated **3–12 covers per week** at risk — representing approximately **£380–£2,880 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£190–£1,440/mo); Build review volume — you lack statistical credibility (discovery protection); Fix the digital shopfront — you're losing walk-ins (£190–£1,440/mo). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~40–80 | Derived from 18 Google reviews (micro venue indicator), price level ££ |
...
| Weekly revenue at risk | £100–£720 | Recoverable with priority action fixes |
| Monthly revenue at risk | £380–£2,880 | Aggregate across top 3 priorities |
| Annual projection | £4,560–£34,560 | If current gaps persist 12 months |
...
| Aggregate signals | Rating and volume from all platforms | 18 Google (4.1★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.1 rating across 18 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Ferment And Flour (Bastardos) is a cafe venue with an adequate public reputation (4.1/5, 18 reviews) that has room to build stronger proof.
...
### Priority 2: Build review volume — you lack statistical credibility [FIX | ESCALATED]

Only 18 Google reviews. A single bad review moves your average visibly. Encourage satisfied customers to leave reviews.
...
- **Evidence:** `experience=8.95, conversion=2.5`
...
- **Review momentum.** At 18 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: coffee_shop, cafe, food_store, store. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: coffee_shop, cafe, food_store, store*
...
Online visibility (2.5) hasn't kept pace with guest experience quality (8.9). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Unrealised review authority.** At 18 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** Only 18 reviews — insufficient for reliable assessment. Priority: build review count.
...
|--------|-------------|---------------------|
| Customer Rating | 4.1/5 Google (Good) | Experience 8.9/10 (Strong) — Gap |
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 8.8/10 (Strong) |
| Review Volume | 18 reviews (Low) | Visibility 2.5/10 (Weak) |
...
Ferment And Flour (Bastardos) is classified as **Cafe / Coffee Shop** (confidence: high). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | coffee_shop, cafe, food_store, store | Primary |

**Resolved category:** Cafe / Coffee Shop (confidence: high)

### Peer Justification

- **Cotswold Cafe** (6.4): Dining with comparable price band; 0.3 miles away
- **Cotswold Distillery Cafe** (6.2): Dining with comparable price band; 3.3 miles away
- **Revs Automobilia** (5.8): Dining with comparable price band; 2.0 miles away
- **Blue Bean Coffee Shop** (5.7): Dining with comparable price band; 0.1 miles away

## Competitive Market Intelligence

**Local market:** 4 direct competitors identified.

Below the median (P25). Customers have higher-rated alternatives nearby (peer avg 6.0, top 6.4).

**Where you lead:** Trust (+0.8)
**Where peers beat you:** Visibility (-0.9), Conversion (-0.5)
...
| Cotswold Distillery Cafe | 6.2 | 4.9★ | 1,239 |
| Revs Automobilia | 5.8 | 4.7★ | 118 |
| Blue Bean Coffee Shop | 5.7 | 4.7★ | 200 |
...
**Position:** #4 of 5 (Percentile 25.0)

You are below the median of your peer set. At 5.8 vs peer average 6.0, competitors are outperforming you. The top performer scores 6.4. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Trust: 8.8 (+0.8 above peer avg 8.0)
- Conversion: 2.5 (-0.5 below peer avg 3.0)
- Visibility: 2.5 (-0.9 below peer avg 3.4)

**Closest competitors:**

- Cotswold Cafe (6.4) — leads you by 0.7
- Cotswold Distillery Cafe (6.2) — leads you by 0.4
- Revs Automobilia (5.8) — leads you by 0.1
- Blue Bean Coffee Shop (5.7) — you lead by 0.1
...
**Cotswold Distillery Cafe** (signal-backed)

- **Also wins on:** Experience (+0.9): Google 4.9/5 vs your 4.1/5
- **Why it matters:** They lead on both Visibility and Experience — a combined advantage that is harder to close than a single-dimension gap.
- **Copy / test:** Build review volume — they have 1239 to your 18. Read their recent positive reviews (4.9/5) for operational clues.
- **Defend:** Defend your trust advantage (+1.2).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

**Revs Automobilia** (signal-backed)

- **Wins on:** Visibility (see pattern above)
- **Why it matters:** Their visibility lead means they are easier to find online — this controls top-of-funnel discovery.
- **Copy / test:** Build review volume — they have 118 to your 18.
- **Defend:** No clear defensive advantage — you are closely matched across dimensions.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

**Blue Bean Coffee Shop** (signal-backed)

- **Wins on:** Conversion (+1.0): more complete operational signals (hours, menu, delivery/takeaway, booking); Visibility (+0.8): 200 Google reviews vs your 18 — they have volume advantage
...
- **Copy / test:** Audit your Google profile vs theirs: hours, menu, booking, delivery. Build review volume — they have 200 to your 18.
- **Defend:** Defend your trust advantage (+1.7).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

### Extended Catchment (38 peers within 15 miles)

**Position:** #24 of 39 (Percentile 39.5)

You are below the median of your peer set. At 5.8 vs peer average 5.8, competitors are outperforming you. The top performer scores 6.8. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Trust: 8.8 (+1.1 above peer avg 7.7)
- Visibility: 2.5 (-0.8 below peer avg 3.2)
...
**Position:** #33 of 53 (Percentile 38.5)
...
- Trust: 8.8 (+1.3 above peer avg 7.5)
- Visibility: 2.5 (-0.7 below peer avg 3.2)
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.9 | — | 9.2 | -0.2 | Strong |
| Visibility | 2.5 | — | 3.4 | -0.9 | Below peers |
| Trust | 8.8 | — | 8.0 | +0.8 | Above peers |
...
**Assessment: Strong.** This is a genuine competitive strength at 8.9.
 In line with peers (avg 9.2).
...
**Assessment: Critical.** At 2.5, this represents a material operational gap.
 Slightly below peer average (3.4).
...
**Management note:** At 18 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 8.8.
 Slightly above peer average (8.0).
...
| Inspection Recency | 5.3/10 | ⚠️ Room to improve | Last inspected 2025-07-04 (9 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-07-04 (9 months ago). Full confidence. No action needed. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.2 on trust, +0.3 on overall (5.8 → 6.0).
...
**Ranked #4 of 5 locally — peers are ahead** [ESCALATED]

At percentile 25.0, customers in this area have higher-rated alternatives. This isn't a crisis but it means you're competing on convenience rather than reputation.
...
5 active items: **5 overdue** (6–11 months).
...
### Action 2: Build review volume — you lack statistical credibility
**Status:** Overdue (6 months) | **Priority:** High
...
### Action 4: Ranked #4 of 5 locally — peers are ahead
...
| Google review count | 18 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.1★ (18 reviews) | observed | ✓ |
...
| Last Inspection | 2025-07-04 | FSA | observed |
| Google Rating | 4.1/5 | Google Places API | observed |
| Google Reviews | 18 | Google Places API | observed |
...
| Postcode | CV36 4PP | FSA | observed |
| Companies House | — | Not checked | not_assessed |
