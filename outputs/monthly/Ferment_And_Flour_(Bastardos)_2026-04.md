...
Based on publicly observable data for Ferment And Flour (Bastardos), your current operational gaps are putting an estimated **3–30 covers per week** at risk — representing approximately **£360–£7,200 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£180–£3,600/mo); Build review volume — you lack statistical credibility (discovery protection); Fix the digital shopfront — you're losing walk-ins (£180–£3,600/mo). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).
