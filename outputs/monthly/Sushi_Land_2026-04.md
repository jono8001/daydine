# Sushi Land — Monthly Intelligence Report
...
| Aggregate signals | Rating and volume from all platforms | 141 Google (4.6★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.6 rating across 141 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Sushi Land operates as a credible japanese restaurant venue with a 4.6/5 Google rating across 141 reviews — solid but not yet commanding.
...
- **Review momentum.** At 141 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: japanese_restaurant, bar, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: japanese_restaurant, bar, restaurant*
...
- **Unrealised review authority.** At 141 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** 141 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 141 reviews (Moderate) | Visibility 3.1/10 (Weak) |
...
Sushi Land is classified as **Japanese Restaurant** (confidence: low). Google's raw category is "Japanese Restaurant" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | japanese_restaurant, bar, restaurant | Primary |

**Resolved category:** Japanese Restaurant (confidence: low)
...
**Management note:** At 141 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 3.2/10 | ⚠️ Significant drag | Last inspected 2024-11-27 (17 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-11-27 (17 months ago). Score starting to decay. Note it but don't escalate. 
...
| Google review count | 141 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.6★ (141 reviews) | observed | ✓ |
...
| Last Inspection | 2024-11-27 | FSA | observed |
| Google Rating | 4.6/5 | Google Places API | observed |
| Google Reviews | 141 | Google Places API | observed |
...
| Category | Japanese Restaurant | google_types | derived |
