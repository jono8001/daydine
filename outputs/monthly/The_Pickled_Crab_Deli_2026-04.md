# The Pickled Crab Deli — Monthly Intelligence Report
...
**Overall score: 6.5/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.5) | Weakest: Visibility (3.2)

**Competitive position:** Local Peers (5mi): #1 of 4 (P100.0) — peer avg 5.96, top 6.23
  Catchment (15mi): #1 of 5 (P100.0) — peer avg 5.77, top 6.23
  UK Category Cohort: #1 of 6 (P100.0) — peer avg 5.8, top 6.23
...
Based on publicly observable data for The Pickled Crab Deli, your current operational gaps are putting an estimated **3–11 covers per week** at risk — representing approximately **£340–£2,640 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£170–£1,320/mo); Fix the digital shopfront — you're losing walk-ins (£170–£1,320/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~140–220 | Derived from 188 Google reviews (mid venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 188 Google (4.6★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.6 rating across 188 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Pickled Crab Deli operates as a credible takeaway venue with a 4.6/5 Google rating across 188 reviews — solid but not yet commanding.
...
Within the local takeaway market (3 peers), this venue leads the field. The identity is that of a category leader — the venue others are compared against.
...
- **Review momentum.** At 188 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: deli, meal_takeaway, coffee_shop, cafe, food_store, restaurant, store. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: deli, meal_takeaway, coffee_shop, cafe, food_store, restaurant, store*
...
Online visibility (3.2) hasn't kept pace with guest experience quality (9.5). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Unrealised review authority.** At 188 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** 188 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 188 reviews (Moderate) | Visibility 3.2/10 (Weak) |
...
The Pickled Crab Deli is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Takeaway" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | deli, meal_takeaway, coffee_shop, cafe, food_store, restaurant, store | Primary |
...
- **Pickled & Tipsy's Cafe** (6.2): Takeaway-focused — different service model; 0.1 miles away *(weak comparator)*
- **The Bishops Fryer** (6.1): Takeaway-focused — different service model; 3.0 miles away *(weak comparator)*
...
**Where you lead:** Conversion (+0.7), Experience (+0.5)
...
You are in the top quintile of this peer set. Your overall score of 6.5 exceeds the peer average of 6.0 by 0.5 points. The competitive risk here is complacency — the nearest competitor scores 6.2.

**Dimension gaps vs peers:**

- Conversion: 5.0 (+0.7 above peer avg 4.3)
- Experience: 9.5 (+0.5 above peer avg 9.0)

**Closest competitors:**

- Pickled & Tipsy's Cafe (6.2) — you lead by 0.3
- The Bishops Fryer (6.1) — you lead by 0.4
- The Margin (5.5) — you lead by 1.0
...
- **Defend:** Defend your conversion readiness (+1.0) — you are easier to book/find and your 188-review advantage vs their 23 (discovery moat).
...
**The Margin** (signal-backed)

- **Wins on:** No Significant Dimension Lead — Scores Within 0.5 Of Yours Across The Board (see pattern above)
- **Why it matters:** You are closely matched — small improvements on either side shift the balance.
- **Copy / test:** No clear action to copy — maintain current standards.
- **Defend:** Defend your experience lead (+1.4) — drives repeats and word-of-mouth and your conversion readiness (+1.0) — you are easier to book/find.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*
...
You are in the top quintile of this peer set. Your overall score of 6.5 exceeds the peer average of 5.8 by 0.7 points. The competitive risk here is complacency — the nearest competitor scores 6.2.

**Dimension gaps vs peers:**

- Trust: 8.4 (+0.8 above peer avg 7.6)
- Experience: 9.5 (+0.8 above peer avg 8.8)
- Conversion: 5.0 (+0.8 above peer avg 4.2)
...
- The Bishops Fryer (6.1) — you lead by 0.4
- The Margin (5.5) — you lead by 1.0
- The Water Margin @ The Hollybush (5.2) — you lead by 1.3
...
- Trust: 8.4 (+0.8 above peer avg 7.7)
- Experience: 9.5 (+0.5 above peer avg 9.0)
...
- Pickled & Tipsy's Cafe (6.2) — you lead by 0.3
- The Bishops Fryer (6.1) — you lead by 0.4
- Chrissie's Kitchen (5.9) — you lead by 0.6
- The Margin (5.5) — you lead by 1.0
- The Water Margin @ The Hollybush (5.2) — you lead by 1.3
...
| Visibility | 3.2 | — | 2.8 | +0.5 | Above peers |
| Trust | 8.4 | — | 8.1 | +0.4 | Above peers |
| Conversion | 5.0 | — | 4.3 | +0.7 | Above peers |
| **Overall** | **6.5** | **—** | | | |
...
**Management note:** At 188 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Weak.** At 5.0, this dimension is actively limiting your overall position.
 Slightly above peer average (4.3).
...
| Inspection Recency | 3.7/10 | ⚠️ Significant drag | Last inspected 2025-01-27 (15 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-01-27 (15 months ago). Score starting to decay. Note it but don't escalate. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.6 on trust, +0.4 on overall (6.5 → 6.9).
...
| Google review count | 188 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.6★ (188 reviews) | observed | ✓ |
...
| Last Inspection | 2025-01-27 | FSA | observed |
| Google Rating | 4.6/5 | Google Places API | observed |
| Google Reviews | 188 | Google Places API | observed |
...
| Postcode | CV47 0HF | FSA | observed |
| Companies House | — | Not checked | not_assessed |
