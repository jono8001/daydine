# Starbucks — Monthly Intelligence Report
...
**Overall score: 6.3/10** (baseline month — no prior comparison)
 | Strongest: Trust (9.9) | Weakest: Conversion (3.5)

**Competitive position:** Local Peers (5mi): #2 of 5 (P75.0) — peer avg 5.73, top 6.43
  Catchment (15mi): #3 of 11 (P80.0) — peer avg 5.69, top 6.43
  UK Category Cohort: #3 of 11 (P80.0) — peer avg 5.69, top 6.43
...
Based on publicly observable data for Starbucks, your current operational gaps are putting an estimated **11–35 covers per week** at risk — representing approximately **£1,720–£12,600 per month** in lost or leaked revenue. The main drivers are: Identify and fix the recurring guest complaint (£400–£4,200/mo); Get your menu online — 77% of diners check before visiting (£660–£4,200/mo); Fix the digital shopfront — you're losing walk-ins (£660–£4,200/mo). Taking action on **Identify and fix the recurring guest complaint** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~220–350 | Derived from 548 Google reviews (large venue indicator), price level ££ |
...
| Weekly revenue at risk | £430–£3,150 | Recoverable with priority action fixes |
| Monthly revenue at risk | £1,720–£12,600 | Aggregate across top 3 priorities |
| Annual projection | £20,640–£151,200 | If current gaps persist 12 months |
...
| Aggregate signals | Rating and volume from all platforms | 548 Google (3.8★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 3.8 rating across 548 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Starbucks operates in the quick-service food category with a public rating of 3.8/5 that is currently limiting discovery.
...
- **Evidence:** `gr=3.8`
  ...
  **Commercial consequence** (directional):
  Value at stake: £400–£4,200/month | Cost to fix: Medium (1–2 days or < £200) | Payback: 1–3 months
...
- **Review momentum.** At 548 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: coffee_shop, cafe, sandwich_shop, food_store, store, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: coffee_shop, cafe, sandwich_shop, food_store, store, restaurant*
...
- **Volume:** 548 reviews — strong base. Rating is stable but a sustained negative pattern could shift it.
...
| Hygiene Rating | FSA 5/5 (Top mark) | Trust 9.9/10 (Strong) |
| Review Volume | 548 reviews (High) | Visibility 3.6/10 (Weak) |
...
Starbucks is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Fast Food / Quick Service" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | coffee_shop, cafe, sandwich_shop, food_store, store, restaurant | Primary |
...
- **The Kingfisher FishBar** (6.4): Takeaway-focused — different service model; 0.1 miles away *(weak comparator)*
- **The Food Of Love** (6.2): Takeaway-focused — different service model; 0.2 miles away *(weak comparator)*
- **GAIL's Stratford-Upon-Avon** (5.8): Dining with comparable price band; 0.0 miles away
- **Subway** (4.5): Takeaway-focused — different service model; 0.6 miles away *(weak comparator)*

## Competitive Market Intelligence

**Local market:** 4 direct competitors identified.

Above the median (P75) but not leading. Peer average is 5.7; the top performer scores 6.4. The gap to the top is closeable.

**Where you lead:** Trust (+2.4)
**Where peers beat you:** Conversion (-0.9)

*Commercial implication: you capture an adequate share of a 5-venue market, but the gap to the top (6.4) represents demand you could win. Closing the gap typically requires 1–2 targeted dimension improvements (indicative).*
...
**Position:** #2 of 5 (Percentile 75.0)

You sit above the median but below the top tier. Your 6.3 compares to a peer average of 5.7. The gap to the top (6.4) is 0.1 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Trust: 9.9 (+2.4 above peer avg 7.5)
- Conversion: 3.5 (-0.9 below peer avg 4.4)

**Closest competitors:**

- The Kingfisher FishBar (6.4) — leads you by 0.1
- The Food Of Love (6.2) — you lead by 0.1
- GAIL's Stratford-Upon-Avon (5.8) — you lead by 0.5
- Subway (4.5) — you lead by 1.8
...
- **Also wins on:** Experience (+0.8): Google 4.5/5 vs your 3.8/5
...
- **Defend:** Defend your trust advantage (+1.9).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

**The Food Of Love** (signal-backed)

- **Also wins on:** Experience (+0.6): Google 4.3/5 vs your 3.8/5
- **Why it matters:** They lead on both Conversion and Experience — a combined advantage that is harder to close than a single-dimension gap.
- **Copy / test:** Audit your Google profile vs theirs: hours, menu, booking, delivery. Read their recent positive reviews (4.3/5) for operational clues.
- **Defend:** Defend your trust advantage (+1.8).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*
...
**Position:** #3 of 11 (Percentile 80.0)

You are in the top quintile of this peer set. Your overall score of 6.3 exceeds the peer average of 5.7 by 0.6 points. The competitive risk here is complacency — the nearest competitor scores 6.4.

**Dimension gaps vs peers:**

- Trust: 9.9 (+2.4 above peer avg 7.5)
- Conversion: 3.5 (-0.7 below peer avg 4.2)

**Closest competitors:**

- The Kingfisher FishBar (6.4) — leads you by 0.1
- Starbucks Drive Thru (6.4) — leads you by 0.1
- Bruno's Bakery (6.3) — leads you by 0.0
- The Food Of Love (6.2) — you lead by 0.1
- GAIL's Stratford-Upon-Avon (5.8) — you lead by 0.5
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.6 | — | 8.3 | +0.3 | Above peers |
| Visibility | 3.6 | — | 3.3 | +0.3 | Above peers |
| Trust | 9.9 | — | 7.5 | +2.4 | Clear strength |
| Conversion | 3.5 | — | 4.4 | -0.9 | Below peers |
| **Overall** | **6.3** | **—** | | | |
...
**Management note:** At 548 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
**Assessment: Strong.** This is a genuine competitive strength at 9.9.
 You lead peers by 2.4 points (peer avg 7.5).
...
**Assessment: Critical.** At 3.5, this represents a material operational gap.
 Slightly below peer average (4.4).
...
| Inspection Recency | 9.6/10 | ✅ Strong | Last inspected 2026-03-20 (1 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2026-03-20 (1 months ago). Full confidence. No action needed. 

**Peer context:** The Kingfisher FishBar's trust lead (+1.7) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.1 on trust, +0.0 on overall (6.3 → 6.3).
...
| Google review count | 548 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 3.8★ (548 reviews) | observed | ✓ |
...
| Last Inspection | 2026-03-20 | FSA | observed |
| Google Rating | 3.8/5 | Google Places API | observed |
| Google Reviews | 548 | Google Places API | observed |
...
| Postcode | CV37 6AU | FSA | observed |
| Companies House | — | Not checked | not_assessed |
