# Cotswold Cafe — Monthly Intelligence Report
...
**Overall score: 6.4/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.7) | Weakest: Visibility (3.3)

**Competitive position:** Local Peers (5mi): #1 of 6 (P100.0) — peer avg 5.9, top 6.15
  Catchment (15mi): #7 of 38 (P83.8) — peer avg 5.78, top 6.78
  UK Category Cohort: #9 of 53 (P84.6) — peer avg 5.77, top 6.92
...
Based on publicly observable data for Cotswold Cafe, your current operational gaps are putting an estimated **9–29 covers per week** at risk — representing approximately **£580–£3,480 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£290–£1,740/mo); Fix the digital shopfront — you're losing walk-ins (£290–£1,740/mo); Protect the 4.7/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~180–290 | Derived from 258 Google reviews (mid venue indicator), price level £ |
...
| Aggregate signals | Rating and volume from all platforms | 258 Google (4.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.7 rating across 258 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Cotswold Cafe operates as a credible cafe venue with a 4.7/5 Google rating across 258 reviews — solid but not yet commanding.
...
Within the local cafe market (5 peers), this venue leads the field. The identity is that of a category leader — the venue others are compared against.
...
With 258 reviews at 4.7/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 258 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Online visibility (3.3) hasn't kept pace with guest experience quality (9.7). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 258 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 258 reviews (Moderate) | Visibility 3.3/10 (Weak) |
...
Cotswold Cafe is classified as **Cafe / Coffee Shop** (confidence: high). Google's raw category is "Cafe / Coffee Shop" but the resolved category triangulates across 3 signal sources.
...
| Name | "Cotswold Cafe" contains "cafe" | Supportive |

**Resolved category:** Cafe / Coffee Shop (confidence: high)

### Peer Justification

- **Cotswold Distillery Cafe** (6.2): Dining with comparable price band; 3.1 miles away
- **The Straw Kitchen** (6.1): Dining with comparable price band; 4.8 miles away
- **Revs Automobilia** (5.8): Dining with comparable price band; 1.8 miles away
- **Ferment And Flour (Bastardos)** (5.8): Dining with comparable price band; 0.3 miles away
- **Blue Bean Coffee Shop** (5.7): Dining with comparable price band; 0.4 miles away
...
**Where you lead:** Trust (+1.0), Conversion (+0.6)
...
You are in the top quintile of this peer set. Your overall score of 6.4 exceeds the peer average of 5.9 by 0.5 points. The competitive risk here is complacency — the nearest competitor scores 6.2.

**Dimension gaps vs peers:**

- Trust: 8.8 (+1.0 above peer avg 7.8)
- Conversion: 3.5 (+0.6 above peer avg 2.9)

**Closest competitors:**

- Cotswold Distillery Cafe (6.2) — you lead by 0.3
- The Straw Kitchen (6.1) — you lead by 0.4
- Revs Automobilia (5.8) — you lead by 0.6
- Ferment And Flour (Bastardos) (5.8) — you lead by 0.7
- Blue Bean Coffee Shop (5.7) — you lead by 0.8
...
- **Wins on:** Visibility (+0.5): 1239 Google reviews vs your 258 — they have volume advantage
- **Why it matters:** Their visibility lead means they are easier to find online — this controls top-of-funnel discovery.
- **Copy / test:** Build review volume — they have 1239 to your 258.
- **Defend:** Defend your trust advantage (+1.2) and your conversion readiness (+1.0) — you are easier to book/find.
...
**Position:** #7 of 38 (Percentile 83.8)

You are in the top quintile of this peer set. Your overall score of 6.4 exceeds the peer average of 5.8 by 0.7 points. The competitive risk here is complacency — the nearest competitor scores 6.8.
...
- South Costa (6.8) — leads you by 0.3
- Building 523 Costa And Kitchen (6.8) — leads you by 0.3
- Dec X Canteen (6.7) — leads you by 0.2
- Gilks' Garage Cafe (6.7) — leads you by 0.2
- Shakespaw Cat Cafe (6.6) — leads you by 0.2

### UK Category Cohort (52 peers in Cafe / Coffee Shop)

**Position:** #9 of 53 (Percentile 84.6)

You are in the top quintile of this peer set. Your overall score of 6.4 exceeds the peer average of 5.8 by 0.7 points. The competitive risk here is complacency — the nearest competitor scores 6.9.

**Dimension gaps vs peers:**

- Trust: 8.8 (+1.3 above peer avg 7.5)
- Experience: 9.7 (+0.8 above peer avg 8.9)
- Conversion: 3.5 (+0.6 above peer avg 2.9)

**Closest competitors:**

- Puddleduck Cafe Ltd (6.9) — leads you by 0.5
- South Costa (6.8) — leads you by 0.3
- Nanas Caff (6.8) — leads you by 0.3
- Building 523 Costa And Kitchen (6.8) — leads you by 0.3
- Dec X Canteen (6.7) — leads you by 0.2
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.7 | — | 9.2 | +0.5 | Above peers |
| Visibility | 3.3 | — | 3.2 | +0.1 | Needs work |
| Trust | 8.8 | — | 7.8 | +1.0 | Above peers |
...
**Assessment: Strong.** This is a genuine competitive strength at 9.7.
 Slightly above peer average (9.2).
...
**Management note:** At 258 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 7.2/10 | ✅ Adequate | Last inspected 2025-11-19 (5 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-11-19 (5 months ago). Full confidence. No action needed. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.7 on trust, +0.2 on overall (6.4 → 6.6).
...
| Google review count | 258 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.7★ (258 reviews) | observed | ✓ |
...
| Last Inspection | 2025-11-19 | FSA | observed |
| Google Rating | 4.7/5 | Google Places API | observed |
| Google Reviews | 258 | Google Places API | observed |
