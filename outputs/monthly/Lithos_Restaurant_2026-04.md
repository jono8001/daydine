# Lithos Restaurant — Monthly Intelligence Report
...
**Overall score: 6.5/10** (baseline month — no prior comparison)
 | Strongest: Experience (10.0) | Weakest: Conversion (2.5)

**Competitive position:** Local Peers (5mi): #1 of 3 (P100.0) — peer avg 5.72, top 6.4
  Catchment (15mi): #2 of 14 (P92.3) — peer avg 5.61, top 6.91
  UK Category Cohort: #2 of 15 (P92.9) — peer avg 5.67, top 6.91
...
| Aggregate signals | Rating and volume from all platforms | 72 Google (5★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 5 rating across 72 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Lithos Restaurant is a restaurant venue with an adequate public reputation (5.0/5, 72 reviews) that has room to build stronger proof.
...
Within the local restaurant market (2 peers), this venue leads the field. The identity is that of a category leader — the venue others are compared against.
...
- **Evidence:** `experience=10, conversion=2.5`
...
- **Review momentum.** At 72 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Online visibility (2.9) hasn't kept pace with guest experience quality (10.0). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Unrealised review authority.** At 72 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** Only 72 reviews — rating is volatile. A single 1-star review moves the average measurably.
...
| Review Volume | 72 reviews (Low) | Visibility 2.9/10 (Weak) |
...
Lithos Restaurant is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Restaurant (General)" but the resolved category triangulates across 2 signal sources.
...
| Name | "Lithos Restaurant" contains "restaurant" | Supportive |

**Resolved category:** Restaurant (General) (confidence: medium)

### Peer Justification

- **The Bluebell** (6.4): Dining with comparable price band; 0.0 miles away
...
**Where you lead:** Experience (+2.2), Trust (+0.6)
...
You are in the top quintile of this peer set. Your overall score of 6.5 exceeds the peer average of 5.7 by 0.8 points. The competitive risk here is complacency — the nearest competitor scores 6.4.

**Dimension gaps vs peers:**

- Experience: 10.0 (+2.2 above peer avg 7.8)
- Trust: 9.8 (+0.6 above peer avg 9.1)
- Conversion: 2.5 (-0.5 below peer avg 3.0)

**Closest competitors:**

- The Bluebell (6.4) — you lead by 0.1
- Gardener's Retreat (5.0) — you lead by 1.5
...
- **Wins on:** Visibility (+0.8): 912 Google reviews vs your 72 — they have volume advantage
- **Why it matters:** Their visibility lead means they are easier to find online — this controls top-of-funnel discovery.
- **Copy / test:** Build review volume — they have 912 to your 72.
- **Defend:** Defend your trust advantage (+1.3).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

### Extended Catchment (13 peers within 15 miles)

**Position:** #2 of 14 (Percentile 92.3)

You are in the top quintile of this peer set. Your overall score of 6.5 exceeds the peer average of 5.6 by 0.9 points. The competitive risk here is complacency — the nearest competitor scores 6.9.

**Dimension gaps vs peers:**

- Trust: 9.8 (+2.0 above peer avg 7.8)
- Experience: 10.0 (+1.6 above peer avg 8.4)

**Closest competitors:**

- 11/17 Salt Beef Bar (6.9) — leads you by 0.4
- The Bluebell (6.4) — you lead by 0.1
- Red Hot Mamma Pizzeria (6.3) — you lead by 0.2
- The Bridge (6.0) — you lead by 0.6
- Bannatyne Health Club And Spa Wildmoor (5.8) — you lead by 0.7

### UK Category Cohort (14 peers in Restaurant (General))

**Position:** #2 of 15 (Percentile 92.9)

You are in the top quintile of this peer set. Your overall score of 6.5 exceeds the peer average of 5.7 by 0.9 points. The competitive risk here is complacency — the nearest competitor scores 6.9.

**Dimension gaps vs peers:**

- Trust: 9.8 (+1.8 above peer avg 7.9)
- Experience: 10.0 (+1.5 above peer avg 8.5)

**Closest competitors:**

- 11/17 Salt Beef Bar (6.9) — leads you by 0.4
- Oxheart (6.5) — you lead by 0.0
- The Bluebell (6.4) — you lead by 0.1
- Red Hot Mamma Pizzeria (6.3) — you lead by 0.2
- The Bridge (6.0) — you lead by 0.6
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 10.0 | — | 7.8 | +2.2 | Clear strength |
| Visibility | 2.9 | — | 2.5 | +0.4 | Above peers |
| Trust | 9.8 | — | 9.1 | +0.6 | Above peers |
...
**Assessment: Strong.** This is a genuine competitive strength at 10.0.
 You lead peers by 2.2 points (peer avg 7.8).
...
**Assessment: Critical.** At 2.9, this represents a material operational gap.
 Slightly above peer average (2.5).
...
**Management note:** At 72 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 9.3/10 | ✅ Strong | Last inspected 2026-03-11 (1 months ago). Full confidence. No action needed.  |

**Biggest drag:** Inspection Recency. Last inspected 2026-03-11 (1 months ago). Full confidence. No action needed. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +0.2 on trust, +0.0 on overall (6.5 → 6.6).
...
| Google review count | 72 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 5.0★ (72 reviews) | observed | ✓ |
...
| Last Inspection | 2026-03-11 | FSA | observed |
| Google Rating | 5.0/5 | Google Places API | observed |
| Google Reviews | 72 | Google Places API | observed |
