# Pick Thai Ltd — Monthly Intelligence Report
...
**Overall score: 5.9/10** (baseline month — no prior comparison)
 | Strongest: Trust (8.9) | Weakest: Conversion (2.5)
...
Based on publicly observable data for Pick Thai Ltd, your current operational gaps are putting an estimated **11–33 covers per week** at risk — representing approximately **£1,340–£7,920 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£670–£3,960/mo); Fix the digital shopfront — you're losing walk-ins (£670–£3,960/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~140–220 | Derived from 176 Google reviews (mid venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 176 Google (4.6★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.6 rating across 176 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Pick Thai Ltd operates as a credible thai restaurant venue with a 4.6/5 Google rating across 176 reviews — solid but not yet commanding.
...
- **Review momentum.** At 176 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: thai_restaurant, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: thai_restaurant, restaurant*
...
- **Unrealised review authority.** At 176 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** 176 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 176 reviews (Moderate) | Visibility 3.2/10 (Weak) |
...
Pick Thai Ltd is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Thai Restaurant" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | thai_restaurant, restaurant | Primary |
...
**Management note:** At 176 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 9.1/10 | ✅ Strong | Last inspected 2026-02-25 (1 months ago). Full confidence. No action needed.  |
...
| Google review count | 176 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.6★ (176 reviews) | observed | ✓ |
...
| Last Inspection | 2026-02-25 | FSA | observed |
| Google Rating | 4.6/5 | Google Places API | observed |
| Google Reviews | 176 | Google Places API | observed |
...
| Category | Thai Restaurant | google_types | derived |
