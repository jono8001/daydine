# The Coach House — Monthly Intelligence Report
...
**Overall score: 5.6/10** (baseline month — no prior comparison)
 | Strongest: Experience (8.0) | Weakest: Conversion (3.5)

**Competitive position:** Local Peers (5mi): #7 of 9 (P25.0) — peer avg 6.17, top 7.34
  Catchment (15mi): #13 of 19 (P33.3) — peer avg 5.93, top 7.34
  UK Category Cohort: #13 of 19 (P33.3) — peer avg 5.93, top 7.34
...
Based on publicly observable data for The Coach House, your current operational gaps are putting an estimated **11–35 covers per week** at risk — representing approximately **£1,320–£8,400 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£660–£4,200/mo); Fix the digital shopfront — you're losing walk-ins (£660–£4,200/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~220–350 | Derived from 565 Google reviews (large venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 565 Google (4.2★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.2 rating across 565 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Coach House operates as a credible pub dining venue with a 4.2/5 Google rating across 565 reviews — solid but not yet commanding.
...
- **Review momentum.** At 565 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: pub, brewpub, bar, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: pub, brewpub, bar, restaurant*
...
Online visibility (3.6) hasn't kept pace with guest experience quality (8.0). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 565 reviews — strong base. Rating is stable but a sustained negative pattern could shift it.
...
| Review Volume | 565 reviews (High) | Visibility 3.6/10 (Weak) |
...
The Coach House is classified as **Pub / Bar** (confidence: medium). Google's raw category is "Pub / Bar" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | pub, brewpub, bar, restaurant | Primary |
...
- **Vintner Wine Bar** (7.3): Pub Dining with similar price band; 0.2 miles away
...
Below the median (P25). Customers have higher-rated alternatives nearby (peer avg 6.2, top 7.3).

**Where peers beat you:** Experience (-1.1), Visibility (-0.6)
...
You are below the median of your peer set. At 5.6 vs peer average 6.2, competitors are outperforming you. The top performer scores 7.3. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Visibility: 3.6 (-0.6 below peer avg 4.2)
- Experience: 8.0 (-1.1 below peer avg 9.1)

**Closest competitors:**

- Vintner Wine Bar (7.3) — leads you by 1.7
- The Fox Inn (6.5) — leads you by 0.9
- The Red Lion (6.4) — leads you by 0.8
- The Townhouse Also Trading As JR Hotel And Restaurants LTD (6.3) — leads you by 0.7
- Snitterfield Arms (6.2) — leads you by 0.6

### Competitor Strategy

**Vintner Wine Bar** (signal-backed)

- **Wins on:** Visibility (+6.2): 887 Google reviews vs your 565 — they have volume advantage; Conversion (+2.0): more complete operational signals (hours, menu, delivery/takeaway, booking)
...
- **Copy / test:** Build review volume — they have 887 to your 565. Audit your Google profile vs theirs: hours, menu, booking, delivery.
...
- **Wins on:** Trust (+1.6): same FSA rating but likely stronger sub-scores or more recent inspection; Experience (+1.2): Google 4.6/5 vs your 4.2/5
...
- **Wins on:** Experience (+1.6): Google 4.7/5 vs your 4.2/5; Trust (+1.3): same FSA rating but likely stronger sub-scores or more recent inspection
...
**Position:** #13 of 19 (Percentile 33.3)

You are below the median of your peer set. At 5.6 vs peer average 5.9, competitors are outperforming you. The top performer scores 7.3. Customers in this area have demonstrably better-rated alternatives.
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.0 | — | 9.1 | -1.1 | Below peers |
| Visibility | 3.6 | — | 4.2 | -0.6 | Below peers |
| Trust | 7.9 | — | 8.2 | -0.3 | Below peers |
...
**Assessment: Strong.** This is a genuine competitive strength at 8.0.
 You trail peers by 1.1 points (peer avg 9.1).
...
**Management note:** At 565 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 3.2/10 | ⚠️ Significant drag | Last inspected 2024-12-03 (16 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-12-03 (16 months ago). Score starting to decay. Note it but don't escalate. 

**Peer context:** Vintner Wine Bar's trust lead (+1.6) is largely built on a more recent inspection, not a better rating — all local peers also hold FSA 5/5.
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.7 on trust, +0.4 on overall (5.6 → 6.0).
...
| Google review count | 565 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.2★ (565 reviews) | observed | ✓ |
...
| Last Inspection | 2024-12-03 | FSA | observed |
| Google Rating | 4.2/5 | Google Places API | observed |
| Google Reviews | 565 | Google Places API | observed |
