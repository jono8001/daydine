# The Balti Hut — Monthly Intelligence Report
...
**Overall score: 5.3/10** (baseline month — no prior comparison)
 | Strongest: Experience (7.9) | Weakest: Visibility (3.1)

**Competitive position:** Catchment (15mi): #8 of 9 (P12.5) — peer avg 5.92, top 6.59
  UK Category Cohort: #13 of 17 (P25.0) — peer avg 5.63, top 6.59
...
Based on publicly observable data for The Balti Hut, your current operational gaps are putting an estimated **4–14 covers per week** at risk — representing approximately **£480–£3,860 per month** in lost or leaked revenue. The main drivers are: Close the hygiene gap — 4 to 5 (£0–£500/mo (defensive)); Get your menu online — 77% of diners check before visiting (£240–£1,680/mo); Fix the digital shopfront — you're losing walk-ins (£240–£1,680/mo). Taking action on **Close the hygiene gap — 4 to 5** could begin recovering this within weeks at low cost (< £200).
...
| Aggregate signals | Rating and volume from all platforms | 144 Google (4.1★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.1 rating across 144 Google reviews is the reputation bedrock and is factored into scoring separately.
...
The Balti Hut operates as a credible Indian dining venue with a 4.1/5 Google rating across 144 reviews — solid but not yet commanding.
...
- **Evidence:** `experience=7.91, conversion=4.0`
...
Online visibility (3.1) hasn't kept pace with guest experience quality (7.9). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
The Balti Hut is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Indian Restaurant" but the resolved category triangulates across 1 signal sources.
...
You are below the median of your peer set. At 5.3 vs peer average 5.9, competitors are outperforming you. The top performer scores 6.6. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Visibility: 3.1 (-0.6 below peer avg 3.7)
- Experience: 7.9 (-0.7 below peer avg 8.7)
- Trust: 6.8 (-0.9 below peer avg 7.7)

**Closest competitors:**

- Simla Takeaway (6.6) — leads you by 1.3
- Avon Spice (6.4) — leads you by 1.1
- Shah's (6.3) — leads you by 1.0
- Hussains (6.2) — leads you by 0.9
- Kolshi Restaurant (6.1) — leads you by 0.8

### UK Category Cohort (16 peers in Indian Restaurant)

**Position:** #13 of 17 (Percentile 25.0)

You are below the median of your peer set. At 5.3 vs peer average 5.6, competitors are outperforming you. The top performer scores 6.6. Customers in this area have demonstrably better-rated alternatives.

**Dimension gaps vs peers:**

- Experience: 7.9 (-0.6 below peer avg 8.5)

**Closest competitors:**

- Simla Takeaway (6.6) — leads you by 1.3
- Cardamom (6.6) — leads you by 1.3
- Avon Spice (6.4) — leads you by 1.1
- Shah's (6.3) — leads you by 1.0
- Hussains (6.2) — leads you by 0.9
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 7.9 | — | — | — | In line |
| Visibility | 3.1 | — | — | — | Needs work |
| Trust | 6.8 | — | — | — | In line |
...
| Inspection Recency | 5.5/10 | ⚠️ Room to improve | Last inspected 2025-07-22 (9 months ago). Full confidence. No action needed.  |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-07-22 (9 months ago). Full confidence. No action needed. 
...
| Google Business Profile | 4.1★ (144 reviews) | observed | ✓ |
...
| Last Inspection | 2025-07-22 | FSA | observed |
...
| Postcode | CV47 0HA | FSA | observed |
| Companies House | — | Not checked | not_assessed |
