# Corte Campana — Monthly Intelligence Report
...
- Ranked #6 of 10 locally — peers are ahead
...
**Overall score: 5.7/10** (baseline month — no prior comparison)
 | Strongest: Experience (8.6) | Weakest: Conversion (2.5)

**Competitive position:** Local Peers (5mi): #6 of 10 (P44.4) — peer avg 5.76, top 6.41
  Catchment (15mi): #8 of 12 (P36.4) — peer avg 5.82, top 6.41
  UK Category Cohort: #9 of 13 (P33.3) — peer avg 5.83, top 6.41
...
Based on publicly observable data for Corte Campana, your current operational gaps are putting an estimated **18–52 covers per week** at risk — representing approximately **£2,120–£12,600 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£1,060–£6,300/mo); Fix the digital shopfront — you're losing walk-ins (£1,060–£6,300/mo); Protect the 4.7/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~220–350 | Derived from 481 Google reviews (large venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 481 Google (4.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.7 rating across 481 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Corte Campana operates as a credible Italian dining venue with a 4.7/5 Google rating across 481 reviews — solid but not yet commanding.
...
- **Review momentum.** At 481 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: pizza_restaurant, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: pizza_restaurant, restaurant*
...
- **The 4.7/5 rating feels dominant but isn't.** In this market, peer venues achieve similar ratings. Your percentile position (P44.4) shows the rating is table stakes, not a differentiator.
...
- **Volume:** 481 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 481 reviews (Moderate) | Visibility 3.5/10 (Weak) |
...
Corte Campana is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Italian Restaurant" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | pizza_restaurant, restaurant | Primary |
...
**Position:** #6 of 10 (Percentile 44.4)

You are below the median of your peer set. At 5.7 vs peer average 5.8, competitors are outperforming you. The top performer scores 6.4. Customers in this area have demonstrably better-rated alternatives.

**Closest competitors:**

- The Phoenix (6.4) — leads you by 0.7
- Soma (6.2) — leads you by 0.4
- Carluccio's (6.1) — leads you by 0.3
- Pizza Hut Restaurants - Dine In (6.0) — leads you by 0.3
- Impasto Micro-Pizzeria (5.8) — leads you by 0.1
...
- **Also wins on:** Trust (+0.9): same FSA rating but likely stronger sub-scores or more recent inspection
...
- **Wins on:** Conversion (+1.0): more complete operational signals (hours, menu, delivery/takeaway, booking); Trust (+0.8): same FSA rating but likely stronger sub-scores or more recent inspection
...
**Position:** #8 of 12 (Percentile 36.4)
...
- The Phoenix (6.4) — leads you by 0.7
- Soma (6.2) — leads you by 0.4
- The Still House Café (6.1) — leads you by 0.4
- Bumbles (6.1) — leads you by 0.4
- Carluccio's (6.1) — leads you by 0.3
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.6 | — | 8.9 | -0.3 | Below peers |
| Visibility | 3.5 | — | 3.5 | +0.1 | Needs work |
...
**Management note:** At 481 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 2.4/10 | ⚠️ Significant drag | Last inspected 2024-07-29 (21 months ago). Meaningful score drag. Consider pr... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-07-29 (21 months ago). Meaningful score drag. Consider proactive action. The system discounts older inspections because they carry less certainty.

**What you can do:**

1. **Request voluntary reinspection** (free, 4–8 weeks) — would recover ~1.9 trust points and overtake 4 peers. Only request reinspection if confident of maintaining 5/5. A drop to 4 would be worse than the staleness drag.
...
**Ranked #6 of 10 locally — peers are ahead** [ESCALATED]
...
| Google review count | 481 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.7★ (481 reviews) | observed | ✓ |
...
| Last Inspection | 2024-07-29 | FSA | observed |
| Google Rating | 4.7/5 | Google Places API | observed |
| Google Reviews | 481 | Google Places API | observed |
