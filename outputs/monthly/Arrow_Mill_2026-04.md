...
- **Trust (9.7)**: FSA rating 5/5 with strong sub-scores. Recent inspection adds freshness.
- **Experience (9.4)**: Google rating of 4.5/5 — earned reputation, not artefact.
- **Visibility (8.5)**: 1988 Google reviews — significant search discovery advantage.

**Vulnerabilities:**

- **Prestige (1.5)**: No editorial recognition. Limits premium positioning potential.

**Biggest competitive advantage:** Visibility (+2.0 vs peers). Protect this.
