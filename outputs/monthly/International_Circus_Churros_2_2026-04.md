# International Circus Churros 2 — Monthly Intelligence Report
...
**Overall score: 6.1/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.5) | Weakest: Conversion (2.5)

**Competitive position:** Local Peers (5mi): #2 of 2 (P0.0) — peer avg 6.1, top 6.1
  Catchment (15mi): #2 of 3 (P50.0) — peer avg 6.0, top 6.1
  UK Category Cohort: #2 of 3 (P50.0) — peer avg 6.0, top 6.1
...
Based on publicly observable data for International Circus Churros 2, your current operational gaps are putting an estimated **18–52 covers per week** at risk — representing approximately **£2,120–£12,600 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£1,060–£6,300/mo); Fix the digital shopfront — you're losing walk-ins (£1,060–£6,300/mo); Protect the 4.6/5 rating — it took years to build (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~220–350 | Derived from 441 Google reviews (large venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 441 Google (4.6★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.6 rating across 441 Google reviews is the reputation bedrock and is factored into scoring separately.
...
International Circus Churros 2 operates as a credible bakery venue with a 4.6/5 Google rating across 441 reviews — solid but not yet commanding.
...
- **Evidence:** `experience=9.53, conversion=2.5`
...
With 441 reviews at 4.6/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
- **Review momentum.** At 441 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: dessert_shop, confectionery, food_store, store. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: dessert_shop, confectionery, food_store, store*
...
Online visibility (3.5) hasn't kept pace with guest experience quality (9.5). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 441 reviews — adequate but not dominant. 5 consecutive low ratings could drop average by ~0.1.
...
| Review Volume | 441 reviews (Moderate) | Visibility 3.5/10 (Weak) |
...
International Circus Churros 2 is classified as **Dessert Shop** (confidence: low). Google's raw category is "Bakery / Desserts" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | dessert_shop, confectionery, food_store, store | Primary |

**Resolved category:** Dessert Shop (confidence: low)

### Peer Justification

- **Mor** (6.1): Dining with comparable price band; 1.8 miles away
...
You are below the median of your peer set. At 6.1 vs peer average 6.1, competitors are outperforming you. The top performer scores 6.1. Customers in this area have demonstrably better-rated alternatives.

**Closest competitors:**

- Mor (6.1) — leads you by 0.0
...
**Greggs PLC** (signal-backed)

- **Wins on:** Trust (+1.2): same FSA rating but likely stronger sub-scores or more recent inspection; Conversion (+1.0): more complete operational signals (hours, menu, delivery/takeaway, booking)
...
- **Defend:** Defend your experience lead (+1.2) — drives repeats and word-of-mouth and your 441-review advantage vs their 58 (discovery moat).
- *Based on Google rating/reviews, FSA record, 4 dimension scores*
...
You sit above the median but below the top tier. Your 6.1 compares to a peer average of 6.0. The gap to the top (6.1) is 0.0 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Experience: 9.5 (+0.6 above peer avg 8.9)
- Conversion: 2.5 (-0.5 below peer avg 3.0)
- Trust: 8.0 (-0.7 below peer avg 8.7)

**Closest competitors:**

- Mor (6.1) — leads you by 0.0
- Greggs PLC (5.9) — you lead by 0.2
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.5 | — | 9.5 | +0.0 | Strong |
| Visibility | 3.5 | — | 3.4 | +0.1 | Needs work |
| Trust | 8.0 | — | 8.2 | -0.2 | Strong |
...
**Management note:** At 441 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Google review count | 441 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.6★ (441 reviews) | observed | ✓ |
...
| Google Reviews | 441 | Google Places API | observed |
...
| Category | Bakery / Desserts | google_types | derived |
| Postcode | CV37 0RN | FSA | observed |
| Companies House | — | Not checked | not_assessed |
