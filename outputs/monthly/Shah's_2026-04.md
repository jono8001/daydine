# Shah's — Monthly Intelligence Report
...
**Overall score: 6.3/10** (baseline month — no prior comparison)
 | Strongest: Experience (9.7) | Weakest: Visibility (3.4)

**Competitive position:** Local Peers (5mi): #3 of 7 (P66.7) — peer avg 6.04, top 6.59
  Catchment (15mi): #4 of 16 (P80.0) — peer avg 5.58, top 6.59
  UK Category Cohort: #4 of 17 (P81.2) — peer avg 5.57, top 6.59
...
| Aggregate signals | Rating and volume from all platforms | 331 Google (4.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.7 rating across 331 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Shah's operates as a credible Indian dining venue with a 4.7/5 Google rating across 331 reviews — solid but not yet commanding.
...
With 331 reviews at 4.7/5, your discovery advantage is substantial. Protect it by responding to every review within 48 hours and prompting satisfied tables for feedback.
...
Insufficient review data to cross-reference proposition. Google types show: indian_restaurant, asian_restaurant, restaurant. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: indian_restaurant, asian_restaurant, restaurant*
...
Shah's is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Indian Restaurant" but the resolved category triangulates across 2 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | indian_restaurant, asian_restaurant, restaurant | Primary |
...
- **Simla Takeaway** (6.6): Takeaway-focused — different service model; 4.9 miles away *(weak comparator)*
- **Avon Spice** (6.4): Dining with comparable price band; 4.9 miles away
- **Hussains** (6.2): Takeaway-focused — different service model; 4.7 miles away *(weak comparator)*
- **Kolshi Restaurant** (6.1): Dining with comparable price band; 0.1 miles away
- **Shukurs** (5.6): Dining with similar price band; 4.7 miles away

## Competitive Market Intelligence

**Local market:** 6 direct competitors identified.

Above the median (P67) but not leading. Peer average is 6.0; the top performer scores 6.6. The gap to the top is closeable.
...
You sit above the median but below the top tier. Your 6.3 compares to a peer average of 6.0. The gap to the top (6.6) is 0.3 points — closeable with focused improvement on your weakest dimension.
...
- Simla Takeaway (6.6) — leads you by 0.3
- Avon Spice (6.4) — leads you by 0.1
- Hussains (6.2) — you lead by 0.1
- Kolshi Restaurant (6.1) — you lead by 0.2
- Shukurs (5.6) — you lead by 0.7
...
- **Also wins on:** Visibility (+1.6): you have 331 reviews vs their 73 — but they score higher on other visibility signals
...
**Position:** #4 of 16 (Percentile 80.0)

You are in the top quintile of this peer set. Your overall score of 6.3 exceeds the peer average of 5.6 by 0.7 points. The competitive risk here is complacency — the nearest competitor scores 6.6.

**Dimension gaps vs peers:**

- Experience: 9.7 (+1.3 above peer avg 8.4)
- Trust: 8.1 (+1.2 above peer avg 6.9)

**Closest competitors:**

- Simla Takeaway (6.6) — leads you by 0.3
- Cardamom (6.6) — leads you by 0.3
- Avon Spice (6.4) — leads you by 0.1
- Hussains (6.2) — you lead by 0.1
- The Spice Room (6.1) — you lead by 0.2
...
| Inspection Recency | 4.0/10 | ⚠️ Significant drag | Last inspected 2025-03-12 (13 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2025-03-12 (13 months ago). Score starting to decay. Note it but don't escalate. 
...
**Commercial read:** This is not a revenue problem today. It's a competitive vulnerability — and an easy win if you want it. Estimated score recovery: +1.5 on trust, +0.4 on overall (6.3 → 6.7).
...
| Google Business Profile | 4.7★ (331 reviews) | observed | ✓ |
...
| Last Inspection | 2025-03-12 | FSA | observed |
...
| Postcode | CV35 9LU | FSA | observed |
| Companies House | — | Not checked | not_assessed |
