# Cinnamon Arch — Monthly Intelligence Report
...
**Competitive position:** UK Category Cohort: #10 of 17 (P43.8) — peer avg 5.62, top 6.59
...
| Aggregate signals | Rating and volume from all platforms | 52 Google (4.7★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.7 rating across 52 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Cinnamon Arch is a Indian dining venue with an adequate public reputation (4.7/5, 52 reviews) that has room to build stronger proof.
...
- **Review momentum.** At 52 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
- **Unrealised review authority.** At 52 reviews, you lack the volume to dominate local search. 500+ reviews at similar ratings rank measurably higher in Google Maps.
...
- **Volume:** Only 52 reviews — rating is volatile. A single 1-star review moves the average measurably.
...
| Review Volume | 52 reviews (Low) | Visibility 2.8/10 (Weak) |
...
Cinnamon Arch is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Indian Restaurant" but the resolved category triangulates across 1 signal sources.
...
- Visibility: 2.8 (-0.5 below peer avg 3.3)
...
- Avon Spice (6.4) — leads you by 0.9
- Shah's (6.3) — leads you by 0.8
- Hussains (6.2) — leads you by 0.7

## Dimension Scorecard

| Dimension | Score | Δ | Peer Avg | Gap | Read |
|-----------|------:|--:|---------:|----:|------|
| Experience | 8.6 | — | — | — | Strong |
...
**Management note:** At 52 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Google review count | 52 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.7★ (52 reviews) | observed | ✓ |
...
| Google Reviews | 52 | Google Places API | observed |
...
| Postcode | CV47 9QJ | FSA | observed |
| Companies House | — | Not checked | not_assessed |
