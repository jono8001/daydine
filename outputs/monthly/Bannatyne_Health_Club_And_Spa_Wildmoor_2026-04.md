# Bannatyne Health Club And Spa Wildmoor — Monthly Intelligence Report
...
**Competitive position:** Local Peers (5mi): #3 of 7 (P66.7) — peer avg 5.92, top 6.91
  Catchment (15mi): #6 of 14 (P61.5) — peer avg 5.67, top 6.91
  UK Category Cohort: #7 of 15 (P57.1) — peer avg 5.73, top 6.91
...
Based on publicly observable data for Bannatyne Health Club And Spa Wildmoor, your current operational gaps are putting an estimated **18–52 covers per week** at risk — representing approximately **£2,120–£12,600 per month** in lost or leaked revenue. The main drivers are: Get your menu online — 77% of diners check before visiting (£1,060–£6,300/mo); Fix the digital shopfront — you're losing walk-ins (£1,060–£6,300/mo); Establish basic web presence — you don't exist online beyond Google (discovery protection). Taking action on **Get your menu online — 77% of diners check before visiting** could begin recovering this within weeks at low cost (< £200).

| Metric | Estimate | Basis |
|---|---|---|
| Estimated weekly covers | ~220–350 | Derived from 530 Google reviews (large venue indicator), price level ££ |
...
| Aggregate signals | Rating and volume from all platforms | 530 Google (4.3★), 0 TripAdvisor (None★) | High for reputation baseline, cannot identify specific themes |
| Structural data | FSA record, Google Business Profile, web presence | 2 sources | High — factual data, not subjective |

**What this means:** The narrative insights (themes, complaints, praise, segment reads) are based on 0 deeply-analysed recent reviews — a detailed sample, not a census. The aggregate 4.3 rating across 530 Google reviews is the reputation bedrock and is factored into scoring separately.
...
Bannatyne Health Club And Spa Wildmoor operates as a credible restaurant venue with a 4.3/5 Google rating across 530 reviews — solid but not yet commanding.
...
- **Review momentum.** At 530 reviews, building toward the next milestone (100, 250, 500) directly improves Google Maps ranking. A systematic post-visit review prompt is the highest-ROI marketing action.
...
Insufficient review data to cross-reference proposition. Google types show: fitness_center, swimming_pool, spa, gym, sports_club, sports_activity_location, association_or_organization, restaurant, health. Whether this matches the lived experience cannot be confirmed.

**Commercial consequence:** Proposition alignment cannot be assessed without review theme data.

*Signals: Google types: fitness_center, swimming_pool, spa, gym, sports_club, sports_activity_location, association_or_organization, restaurant, health*
...
Online visibility (3.6) hasn't kept pace with guest experience quality (9.2). Good venues that aren't easily found online are subsidising competitors with better digital presence. This is fixable within 60 days.
...
- **Volume:** 530 reviews — strong base. Rating is stable but a sustained negative pattern could shift it.
...
| Review Volume | 530 reviews (High) | Visibility 3.6/10 (Weak) |
...
Bannatyne Health Club And Spa Wildmoor is classified as **Restaurant (General)** (confidence: medium). Google's raw category is "Restaurant (General)" but the resolved category triangulates across 1 signal sources.

### Category Evidence

| Signal Source | Category Signal | Weight |
|---|---|---|
| Google Place Types | fitness_center, swimming_pool, spa, gym, sports_club, sports_activity_location, association_or_organization, restaurant, health | Primary |

**Resolved category:** Restaurant (General) (confidence: medium)

### Peer Justification

- **11/17 Salt Beef Bar** (6.9): Dining with comparable price band; 2.0 miles away
- **Red Hot Mamma Pizzeria** (6.3): Dining with comparable price band; 1.9 miles away
- **Fast Flavour** (5.8): Dining with comparable price band; 2.0 miles away
- **NO4 Bar And Restaurant** (5.7): Dining with comparable price band; 2.1 miles away
- **Lily's** (5.6): Dining with comparable price band; 1.8 miles away

## Competitive Market Intelligence

**Local market:** 6 direct competitors identified.

Above the median (P67) but not leading. Peer average is 5.9; the top performer scores 6.9. The gap to the top is closeable.

*Commercial implication: you capture an adequate share of a 7-venue market, but the gap to the top (6.9) represents demand you could win. Closing the gap typically requires 1–2 targeted dimension improvements (indicative).*
...
You sit above the median but below the top tier. Your 5.8 compares to a peer average of 5.9. The gap to the top (6.9) is 1.1 points — closeable with focused improvement on your weakest dimension.

**Closest competitors:**

- 11/17 Salt Beef Bar (6.9) — leads you by 1.1
- Red Hot Mamma Pizzeria (6.3) — leads you by 0.5
- Fast Flavour (5.8) — you lead by 0.0
- NO4 Bar And Restaurant (5.7) — you lead by 0.1
- Lily's (5.6) — you lead by 0.2

### Competitor Strategy

**Red Hot Mamma Pizzeria** (signal-backed)

- **Wins on:** Experience (+0.6): Google 4.8/5 vs your 4.3/5; Trust (+0.5): same FSA rating but likely stronger sub-scores or more recent inspection
...
- **Wins on:** Trust (+0.8): same FSA rating but likely stronger sub-scores or more recent inspection
...
- **Defend:** Defend your 530-review advantage vs their 27 (discovery moat) and your experience lead (+0.7) — drives repeats and word-of-mouth.
- *Based on Google rating/reviews, FSA record, 4 dimension scores*

**NO4 Bar And Restaurant** (signal-backed)
...
**Position:** #6 of 14 (Percentile 61.5)

You sit above the median but below the top tier. Your 5.8 compares to a peer average of 5.7. The gap to the top (6.9) is 1.1 points — closeable with focused improvement on your weakest dimension.

**Dimension gaps vs peers:**

- Visibility: 3.6 (+0.8 above peer avg 2.8)
- Experience: 9.2 (+0.7 above peer avg 8.5)

**Closest competitors:**

- 11/17 Salt Beef Bar (6.9) — leads you by 1.1
- Lithos Restaurant (6.5) — leads you by 0.7
- The Bluebell (6.4) — leads you by 0.6
- Red Hot Mamma Pizzeria (6.3) — leads you by 0.5
- The Bridge (6.0) — leads you by 0.1
...
|-----------|------:|--:|---------:|----:|------|
| Experience | 9.2 | — | 8.8 | +0.4 | Above peers |
| Visibility | 3.6 | — | 3.1 | +0.4 | Above peers |
| Trust | 7.9 | — | 8.2 | -0.2 | In line |
...
**Management note:** At 530 reviews, you are likely invisible in 'near me' and category searches. This is fixable within 60 days with a systematic review request programme.
...
| Inspection Recency | 3.2/10 | ⚠️ Significant drag | Last inspected 2024-12-02 (16 months ago). Score starting to decay. Note it b... |
...
**Biggest drag:** Inspection Recency. Last inspected 2024-12-02 (16 months ago). Score starting to decay. Note it but don't escalate. 
...
| Google review count | 530 | 10+ new reviews/month = healthy momentum | Google Maps |
...
| Google Business Profile | 4.3★ (530 reviews) | observed | ✓ |
...
| Last Inspection | 2024-12-02 | FSA | observed |
| Google Rating | 4.3/5 | Google Places API | observed |
| Google Reviews | 530 | Google Places API | observed |
...
| Postcode | CV37 9RJ | FSA | observed |
| Companies House | — | Not checked | not_assessed |
